...
主表 `wtbd_cycdateset` 标品接入 **22** 个插件。
...
- `CycDateSetEdit` ← `kd.wtc.wtbd.fromplugin.web.duringcycle.CycDateSetEdit`
...
- `CycDateSetList` ← `kd.wtc.wtbd.fromplugin.web.duringcycle.CycDateSetList`
...
#### `HRBaseDataLogOp` · OP_PLUGIN @ `OPERATION` · opKey=`delete`
