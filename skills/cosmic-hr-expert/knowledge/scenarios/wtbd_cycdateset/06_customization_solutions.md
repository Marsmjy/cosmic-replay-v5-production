...
| `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | `delete` | beforeExecuteOperationTransaction, beginOperationTransaction, afterExecuteOperationTransaction |
...
## ℹ️ 标品已接入插件（22 个 · 详见 07_ext_points.md）
