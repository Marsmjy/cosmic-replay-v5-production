...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin -->

## chgaction 实证补充（FormulaFuncTreePlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hbp.formplugin.web.formula.FormulaItemTreePlugin -->

## chgaction 实证补充（FormulaItemTreePlugin 跨类追踪聚合）
...
| 异常码 | 业务消息 |
|---|---|
| `` | MessageFormat.format("{} is not a enum field in metadata {}", calItem.getPropert |
| `KDDateUtils_0` | %s不是有效的当前时区时间格式 |
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hbp.opplugin.web.formula.FormulaSettingOp -->

## chgaction 实证补充（FormulaSettingOp 跨类追踪聚合）
