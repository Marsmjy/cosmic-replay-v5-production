# core_hr_pfs_personfield · 业务规则

> **聚合场景**：人员字段池 + 单据基模板基础设施（2 个子实体）
> **生成时间**：2026-04-30
...
### `hpfs_personfield` · ⚠️ 标品 entity_metadata md 不存在

### `hpfs_base01` · ⚠️ 标品 entity_metadata md 不存在
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hpfs.formplugin.ext.HRFieldValidateBillExtPlugin -->

## chgaction 实证补充（HRFieldValidateBillExtPlugin 跨类追踪聚合）
