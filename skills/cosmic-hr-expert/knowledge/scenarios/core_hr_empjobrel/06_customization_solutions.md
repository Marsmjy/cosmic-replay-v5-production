# core_hr_empjobrel · 定制方案（ISV 扩展真实模板）
...
在开发平台给本 form（`hrpi_empjobrel`）加 ISV 字段：
...
```java
@SdkPlugin
public class MyEmpjobrelAfterOp extends HRDataBaseOp {
    @Override
...
```java
@SdkPlugin
public class MyEmpjobrelIsvFormPlugin extends HRDataBaseEdit {
    @Override
