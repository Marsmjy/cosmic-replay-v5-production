...
- `EmpJobRelSaveOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpJobRelSaveOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpJobRelSaveOp -->

## ISV 扩展指引（基于 EmpJobRelSaveOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpJobRelSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpJobRelSaveOp/extension_guide.md)
