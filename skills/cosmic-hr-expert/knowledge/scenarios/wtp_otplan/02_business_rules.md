...
## ✅ verified · 主表 `wtp_otplan` 共 66 个 opKey
...
| 5 | `OtPlanOp` | enabled=True |
| 6 | `HRBaseDataLogOp` | HR 基础资料操作日志 |
| 7 | `HRBaseDataEnableOp` | HR 基础资料启用态管理 · 控制 enable 字段 |
| 8 | `RuleEngingSaveOp` | enabled=True |
...
- `showallversion` · `newentry` · `deleteentry` · `moveentryup` · `moveentrydown` · `donothing_edit` · `donothing_manage` · `donothing_assgin`
