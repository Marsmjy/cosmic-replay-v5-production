...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hbp.opplugin.web.HRBaseDataCommonListDisableOp -->

## ISV 扩展指引（基于 HRBaseDataCommonListDisableOp 真实证）

> FQN: `kd.hr.hbp.opplugin.web.HRBaseDataCommonListDisableOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.HRBaseDataCommonListDisableOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.HRBaseDataCommonListDisableOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.HRBaseDataCommonListDisableOp/extension_guide.md)
