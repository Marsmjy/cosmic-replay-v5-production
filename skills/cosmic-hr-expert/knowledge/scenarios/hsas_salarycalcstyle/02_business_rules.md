...
### `hsas_salarycalcstyle`（1 条）

| ruleId | 类型 | preCondition | 描述 |
|---|---|---|---|
| `2+T=VT=ZF6CU` | formRule | `countrytype = "0"` | 国家地区显隐联动 |
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hbp.opplugin.web.HRBaseDataCommonListDisableOp -->

## chgaction 实证补充（HRBaseDataCommonListDisableOp 跨类追踪聚合）
