...
- **继承**：`HRDataBaseList`
- **生命周期方法**：`afterDoOperation`(L20)

### `CostBizObjEdit`

- **FQN**：`kd.hrmp.lcs.formplugin.web.basedata.CostBizObjEdit`
- **继承**：`CostAbstractPlugIn`
...
- 数据源：`_sdk_audit/_decompiled/scenarios/lcs_costbizobj/` 的 2 个反编译类 + `_shared/_standard_metadata/entity_metadata/lcs_costbizobj.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.lcs.formplugin.web.basedata.CostBizObjBillList -->

## chgaction 实证补充（CostBizObjBillList 跨类追踪聚合）
