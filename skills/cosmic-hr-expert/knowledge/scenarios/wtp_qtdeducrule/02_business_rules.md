...
## ✅ verified · 主表 `wtp_qtdeducrule` 共 66 个 opKey
...
- `showallversion` · `moveentryup` · `moveentrydown` · `deleteentry` · `newodentry` · `delodentry` · `moveodentryup` · `moveodentrydown`
