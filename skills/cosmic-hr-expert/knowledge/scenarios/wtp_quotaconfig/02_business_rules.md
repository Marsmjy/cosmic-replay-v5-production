...
## ✅ verified · 主表 `wtp_quotaconfig` 共 54 个 opKey
...
| 8 | `QuotaConfigSaveOp` | enabled=True |
...
| 7 | `QuotaConfigSaveOp` | enabled=True |
...
- `auto_assign` · `tbl_assign_import` · `logview` · `viewonelog` · `newentry` · `deleteentry` · `moveentryup` · `moveentrydown` · `addentry`
