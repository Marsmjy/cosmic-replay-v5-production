...
主表 `wtp_quotaconfig` 标品接入 **39** 个插件。
...
- `QuotaConfigEdit` ← `kd.wtc.wtp.formplugin.web.mobileattself.QuotaConfigEdit`
...
- `QuotaConfigSaveOp` ← `kd.wtc.wtp.opplugin.web.mobileattself.QuotaConfigSaveOp`
...
- order **7**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **8**: `QuotaConfigSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.mobileattself.QuotaConfigSaveOp`
...
- order **6**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **7**: `QuotaConfigSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.mobileattself.QuotaConfigSaveOp`
