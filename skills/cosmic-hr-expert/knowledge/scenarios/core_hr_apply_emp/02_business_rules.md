# core_hr_apply_emp · 业务规则

> **form**：`hrom_applybill_emp` · hrom_applybill_emp
> **生成时间**：2026-04-29
...
- 数据源：`_sdk_audit/_decompiled/scenarios/core_hr_apply_emp/` 的 11 个反编译类 + `_shared/_standard_metadata/entity_metadata/hrom_applybill_emp.md`