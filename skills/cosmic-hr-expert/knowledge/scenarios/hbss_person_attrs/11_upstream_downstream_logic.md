# hbss_person_attrs · 上下游逻辑与知识主题说明
...
性别(hbss_sex)/国籍(hbss_nationality)被核心人力云(hrpi)引用4次，政治面貌/民族(hbss_flok)/婚姻状态被薪酬云引用。修改前必查 _org_entity_ref_report.json 的 hbss 段。
