...
### `hbss_sex` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_nationality` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_bloodtype` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_constellation` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_zodiac` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_marriagestatus` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_healthstatus` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_religion` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_party` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_politicalstatus` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_flok` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_familiarity` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_familymemberrel` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_emergcontactype` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_addresstype` · ⚠️ 标品 entity_metadata md 不存在
