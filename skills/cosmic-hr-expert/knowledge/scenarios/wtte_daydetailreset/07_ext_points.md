...
主表 `wtte_daydetailreset` 标品接入 **26** 个插件。
...
- `WTCSnapPlugin` ← `kd.wtc.wtbs.formplugin.web.WTCSnapPlugin`
- `RevisionCommonEdit` ← `kd.wtc.wtte.formplugin.web.revision.RevisionCommonEdit`
...
- `RevisionCommonList` ← `kd.wtc.wtte.formplugin.web.revision.RevisionCommonList`
...
- `WTCSnapSaveOp` ← `kd.wtc.wtbs.opplugin.web.his.WTCSnapSaveOp`
- `HRBaseOriginalOp` ← `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- `RevisionCommonHRImportSaveOp` ← `kd.wtc.wtte.opplugin.web.revision.RevisionCommonHRImportSaveOp`
- `CodeRuleDeleteOp` ← `kd.bos.coderule.CodeRuleDeleteOp`
- `RevisionCommonOp` ← `kd.wtc.wtte.opplugin.web.revision.RevisionCommonOp`
...
## ✅ verified · opKey 扩展切入点详解（7 个有执行链的 opKey）
...
- order **5**: `HRBaseDataEnableOp` · HR 基础资料启用态管理 · 控制 enable 字段
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp`
- order **6**: `WTCSnapSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.his.WTCSnapSaveOp`
- order **7**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **8**: `RevisionCommonHRImportSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.revision.RevisionCommonHRImportSaveOp`
...
- order **3**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **4**: `WTCSnapSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.his.WTCSnapSaveOp`
- order **5**: `HRBaseDataEnableOp` · HR 基础资料启用态管理 · 控制 enable 字段
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp`
...
- order **1**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **2**: `WTCSnapSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.his.WTCSnapSaveOp`
- order **3**: `RevisionCommonOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.revision.RevisionCommonOp`
