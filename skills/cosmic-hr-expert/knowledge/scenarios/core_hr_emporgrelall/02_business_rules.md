...
- 数据源：`_sdk_audit/_decompiled/scenarios/core_hr_emporgrelall/` 的 11 个反编译类 + `_shared/_standard_metadata/entity_metadata/hrpi_emporgrelall.md`
