...
## ✅ verified · 主表 `wtte_calresult` 共 21 个 opKey

### 🔥 核心 opKey 执行链（21 个有真链）
...
| order | className | 角色 |
|:---:|---|---|
| 1 | `HRBaseDataImportEdit` | plugins.json 实证 · 标品 · extendable |
| 2 | `HRCertCheckEdit` | plugins.json 实证 · 标品 · extendable |
| 3 | `HRBaseUeEdit` | plugins.json 实证 · 标品 · extendable |
| 4 | `HRHiesButtonSwitchPlugin` | plugins.json 实证 · 标品 · extendable |
| 5 | `WTCTipsPlugin` | plugins.json 实证 · 标品 · extendable |
