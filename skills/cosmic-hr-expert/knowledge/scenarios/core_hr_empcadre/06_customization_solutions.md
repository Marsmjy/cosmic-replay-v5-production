# core_hr_empcadre · 定制方案（ISV 扩展真实模板）
...
在开发平台给本 form（`hrpi_empcadre`）加 ISV 字段：
...
```java
@SdkPlugin
public class MyEmpcadreAfterOp extends HRDataBaseOp {
    @Override
...
```java
@SdkPlugin
public class MyEmpcadreIsvFormPlugin extends HRDataBaseEdit {
    @Override
