...
> 本 form（`hrpi_empcadre`，所属 核心人力云）引用了其他云的 **1** 个底座实体：

### ⬆️ HR 基础服务云（`hr_hrmp`）1 个引用

| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `cadretype` | 干部类别 | BasedataField | `hbss_cadrecategory` | [hbss_position_dict](../hbss_position_dict/) |
