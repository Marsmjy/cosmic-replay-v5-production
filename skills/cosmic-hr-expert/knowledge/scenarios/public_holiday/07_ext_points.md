...
主表 `public_holiday` 标品接入 **10** 个插件。

### FormPlugin（5）
- `CodeRulePlugin` ← `kd.bos.form.plugin.CodeRulePlugin`
- `PublicHolidayFormPlugin` ← `kd.bd.assistant.plugin.calendar.PublicHolidayFormPlugin`
- `PublicHolidayPlugin` ← `kd.bd.assistant.plugin.calendar.PublicHolidayPlugin`
