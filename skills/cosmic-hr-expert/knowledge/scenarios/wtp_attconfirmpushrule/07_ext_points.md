...
主表 `wtp_attconfirmpushrule` 标品接入 **40** 个插件。
...
- `AttConfirmPushRuleEdit` ← `kd.wtc.wtp.formplugin.web.attconfirm.AttConfirmPushRuleEdit`
...
- `AttConfirmPushRuleList` ← `kd.wtc.wtp.formplugin.web.attconfirm.AttConfirmPushRuleList`
