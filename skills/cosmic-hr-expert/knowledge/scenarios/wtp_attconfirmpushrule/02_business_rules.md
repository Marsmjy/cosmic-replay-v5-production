...
## ✅ verified · 主表 `wtp_attconfirmpushrule` 共 49 个 opKey
...
| 8 | `AttConfirmRuleOp` | enabled=True |
...
| 7 | `AttConfirmRuleOp` | enabled=True |
...
| 3 | `AttConfirmRuleOp` | enabled=True |
