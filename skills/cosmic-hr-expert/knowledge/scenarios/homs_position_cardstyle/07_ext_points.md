...
主表 `homs_position_cardstyle` 标品接入 **23** 个插件。
...
- `CardStylePlugin` ← `kd.hr.homs.formplugin.web.orgchart.CardStylePlugin`
...
- `CardStyleListPlugin` ← `kd.hr.homs.formplugin.web.orgchart.CardStyleListPlugin`
- `CardStyleFilterListPlugin` ← `kd.hr.homs.formplugin.web.orgchart.CardStyleFilterListPlugin`
- `PositionCardStyleListPlugin` ← `kd.hr.homs.formplugin.web.orgchart.PositionCardStyleListPlugin`
...
- `OrgChartCardStyleSaveOp` ← `kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleSaveOp`
- `HRBaseOriginalOp` ← `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- `CodeRuleDeleteOp` ← `kd.bos.coderule.CodeRuleDeleteOp`
- `OrgChartCardStyleDeleteOp` ← `kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleDeleteOp`
- `OrgChartCardStyleEnableOp` ← `kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleEnableOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.formplugin.web.orgchart.CardStylePlugin -->

## ISV 扩展指引（基于 CardStylePlugin 真实证）

> FQN: `kd.hr.homs.formplugin.web.orgchart.CardStylePlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.CardStylePlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.bos.form.plugin.AbstractFormPlugin`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `preOpenForm`, `registerListener`, `afterCreateNewData`, `beforeBindData`, `afterBindData`, `propertyChanged`, `beforeF7Select`, `beforeDoOperation`, `itemClick`, `closedCallBack`, `afterDoOperation`
...
**CALL_CROSS_SERVICE** · ChartHelper L69
```java
  67           String appIdFromShowParam = HRPermUtil.getAppIdFromShowParam((FormShowParameter)formShowParameter);
  68           String appId = HRStringUtils.isEmpty((String)formShowParameter.getCheckRightAppId()) ? AppIdServiceHelper.getPermAppId((String)appIdFromShowParam, (String)permEntityId) : formShowParameter.getCheckRightAppId();
  69 >         AuthorizedOrgTeamResult permResult = (AuthorizedOrgTeamResult)HRMServiceHelper.invokeHRMPService((String)HRCS, (String)IHRCS_PERM_SERVICE, (String)"getAuthorizedOrgTeams", (Object[])new Object[]{userId, appId, permEntityId, permItemId, "boid"});
  70           if (permResult.isHasAllOrgPerm()) {
  71               LOG.info("user has all org perm");
```
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.CardStylePlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.CardStylePlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.formplugin.web.orgchart.CardStyleListPlugin -->

## ISV 扩展指引（基于 CardStyleListPlugin 真实证）

> FQN: `kd.hr.homs.formplugin.web.orgchart.CardStyleListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.CardStyleListPlugin/`
...
**QUERY_BUILDER** · CardStyleListPlugin L23
```java
  21           List filters = setFilterEvent.getQFilters();
  22           super.setFilter(setFilterEvent);
  23 >         filters.add(new QFilter("id", "!=", (Object)VIRTUAL_ORG_TYPE_ID));
  24       }
  25   }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.CardStyleListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.CardStyleListPlugin/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.formplugin.web.orgchart.CardStyleListPlugin -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.formplugin.web.orgchart.PositionCardStyleListPlugin -->

## ISV 扩展指引（基于 PositionCardStyleListPlugin 真实证）

> FQN: `kd.hr.homs.formplugin.web.orgchart.PositionCardStyleListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.PositionCardStyleListPlugin/`
...
**QUERY_BUILDER** · PositionCardStyleListPlugin L21
```java
  19           super.setFilter(setFilterEvent);
  20           List qFilters = setFilterEvent.getQFilters();
  21 >         QFilter idFilter = new QFilter("carddimension", "=", (Object)Long.parseLong("1110"));
  22           qFilters.add(idFilter);
  23       }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.PositionCardStyleListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.PositionCardStyleListPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleSaveOp -->

## ISV 扩展指引（基于 OrgChartCardStyleSaveOp 真实证）

> FQN: `kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleSaveOp/`

### 类型与继承
- 插件类型：**OP_PLUGIN**
- 父类: `kd.hr.hbp.opplugin.web.config.HRBaseDataOp`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleSaveOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleDeleteOp -->

## ISV 扩展指引（基于 OrgChartCardStyleDeleteOp 真实证）

> FQN: `kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleDeleteOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleDeleteOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleDeleteOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleDeleteOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleDeleteOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleEnableOp -->

## ISV 扩展指引（基于 OrgChartCardStyleEnableOp 真实证）

> FQN: `kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleEnableOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleEnableOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleEnableOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgchart.OrgChartCardStyleEnableOp/extension_guide.md)
