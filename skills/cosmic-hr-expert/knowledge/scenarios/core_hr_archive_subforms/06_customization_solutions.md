# core_hr_archive_subforms · 定制方案（ISV 扩展真实模板）

> **场景**：员工档案派生模板大聚合（hspm 200+ form · 按后缀分类）（8 个子实体）
> **生成时间**：2026-04-30

## CS-01 · 给子实体加 ISV 自定义字段

**适用**：`hspm_ermanfile_e`, `hspm_ermanfile_ly`, `hspm_ermanfile_emly`, `hspm_ermanfile_tl`, `hspm_ermanfile_tlmob`, `hspm_attmgr` ...（任一子实体）
