...
|---|---|---|---|
| `number` | 编码 | `TextField` | — |
| `starttime` | 开始时间 | `TimeField` | — |
| `endtime` | 结束时间 | `TimeField` | — |
...
- 数据源：`_sdk_audit/_decompiled/scenarios/working_hours/` 的 0 个反编译类 + `_shared/_standard_metadata/entity_metadata/working_hours.md`