# core_hr_kdhr_reports · 业务规则

> **聚合场景**：核心人力派生报表（kdhr_corehr_* · 实现归 hrptmc）（3 个子实体）
> **生成时间**：2026-04-30
...
### `kdhr_corehr_002` · ⚠️ 标品 entity_metadata md 不存在

### `kdhr_corehr_008` · ⚠️ 标品 entity_metadata md 不存在

### `kdhr_tenure_journaling` · ⚠️ 标品 entity_metadata md 不存在
