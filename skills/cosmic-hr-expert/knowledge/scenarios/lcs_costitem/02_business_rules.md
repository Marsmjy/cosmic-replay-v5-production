...
- **FQN**：`kd.hrmp.lcs.formplugin.web.basedata.CostItemEdit`
- **继承**：`HRDataBaseEdit`
- **生命周期方法**：`registerListener`(L40), `propertyChanged`(L46), `beforeF7Select`(L55)
- **读字段**（1）：`costbiztype.id`

### `CostItemList`

- **FQN**：`kd.hrmp.lcs.formplugin.web.basedata.CostItemList`
- **继承**：`HRDataBaseList`
...
- 数据源：`_sdk_audit/_decompiled/scenarios/lcs_costitem/` 的 2 个反编译类 + `_shared/_standard_metadata/entity_metadata/lcs_costitem.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.lcs.formplugin.web.basedata.CostItemEdit -->

## chgaction 实证补充（CostItemEdit 跨类追踪聚合）

> FQN: `kd.hrmp.lcs.formplugin.web.basedata.CostItemEdit`
> 跨类追踪: 2 个类访问
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.basedata.CostItemEdit/`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.lcs.formplugin.web.basedata.CostItemList -->

## chgaction 实证补充（CostItemList 跨类追踪聚合）

> FQN: `kd.hrmp.lcs.formplugin.web.basedata.CostItemList`
> 跨类追踪: 1 个类访问
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.basedata.CostItemList/`
