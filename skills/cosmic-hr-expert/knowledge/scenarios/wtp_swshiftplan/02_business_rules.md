...
## ✅ verified · 主表 `wtp_swshiftplan` 共 59 个 opKey
...
| 11 | `WTCHisModelBsedOp` | enabled=True |
...
| 10 | `WTCHisModelBsedOp` | enabled=True |
...
| 3 | `WTCHisModelBsedOp` | enabled=True |
| 4 | `RuleEngingSaveOp` | enabled=True |
