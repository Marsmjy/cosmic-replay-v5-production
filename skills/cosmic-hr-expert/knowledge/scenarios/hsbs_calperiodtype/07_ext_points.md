...
主表 `hsbs_calperiodtype` 标品接入 **36** 个插件。
...
- `CalPeriodTypeEdit` ← `kd.swc.hsbs.formplugin.web.basedata.cal.CalPeriodTypeEdit`
...
- `CalPeriodTypeList` ← `kd.swc.hsbs.formplugin.web.basedata.cal.CalPeriodTypeList`
...
- `CalPeriodSaveOp` ← `kd.swc.hsbs.opplugin.web.basedata.calperiod.CalPeriodSaveOp`
...
- order **6**: `HRBaseDataEnableOp` · HR 基础资料启用态管理 · 控制 enable 字段
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp`
- order **7**: `CalPeriodSaveOp` · enabled=True
  - 完整 FQN: `kd.swc.hsbs.opplugin.web.basedata.calperiod.CalPeriodSaveOp`
...
- order **4**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **5**: `CalPeriodSaveOp` · enabled=True
  - 完整 FQN: `kd.swc.hsbs.opplugin.web.basedata.calperiod.CalPeriodSaveOp`
- order **6**: `HRBaseDataEnableOp` · HR 基础资料启用态管理 · 控制 enable 字段
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp`
...
- order **2**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **3**: `CalPeriodSaveOp` · enabled=True
  - 完整 FQN: `kd.swc.hsbs.opplugin.web.basedata.calperiod.CalPeriodSaveOp`
