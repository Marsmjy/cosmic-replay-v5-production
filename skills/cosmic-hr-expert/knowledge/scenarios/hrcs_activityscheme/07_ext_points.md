...
主表 `hrcs_activityscheme` 标品接入 **37** 个插件。
...
- `ActivitySchemeEdit` ← `kd.hr.hrcs.formplugin.web.activity.ActivitySchemeEdit`
- `ActivityGroupConfigEdit` ← `kd.hr.hrcs.formplugin.web.activity.ActivityGroupConfigEdit`
...
- ...（共 20，详见 `_auto_plugin_registry.md`）
...
- `ActivitySchemeTreeListPlugin` ← `kd.hr.hrcs.formplugin.web.activity.ActivitySchemeTreeListPlugin`
...
- `ActivitySchemeSaveOp` ← `kd.hr.hrcs.opplugin.web.activity.ActivitySchemeSaveOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.activity.ActivitySchemeEdit -->

## ISV 扩展指引（基于 ActivitySchemeEdit 真实证）
...
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`, `beforeBindData`, `afterBindData`, `click`, `beforeDoOperation`, `afterDoOperation`, `closedCallBack`, `propertyChanged`, `beforeF7Select`
...
- `public public void entryRowClick(kd.bos.form.control.events.RowClickEvent)`
- `public public void entryRowDoubleClick(kd.bos.form.control.events.RowClickEvent)`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.activity.ActivitySchemeEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.activity.ActivitySchemeEdit/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.activity.ActivitySchemeEdit -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.activity.ActivityGroupConfigEdit -->

## ISV 扩展指引（基于 ActivityGroupConfigEdit 真实证）
...
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`, `beforeBindData`, `afterBindData`, `afterDoOperation`, `propertyChanged`, `beforeDoOperation`, `beforeF7Select`
...
**QUERY_BUILDER** · ActivityGroupConfigEdit L274
```java
 272               int rowIndex = this.getModel().getEntryCurrentRowIndex("actgroupentity");
 273               DynamicObject groupactivity = (DynamicObject)this.getModel().getValue("groupactivity", rowIndex);
 274 >             QFilter idFilter = new QFilter("id", "not in", activityGroupIds);
 275               if (groupactivity != null) {
 276                   Long groupactivityId = groupactivity.getLong("id");
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.activity.ActivityGroupConfigEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.activity.ActivityGroupConfigEdit/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.activity.ActivitySchemeTreeListPlugin -->

## ISV 扩展指引（基于 ActivitySchemeTreeListPlugin 真实证）
...
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `closedCallBack`, `filterContainerInit`, `setFilter`, `beforeDoOperation`
...
**QUERY_BUILDER** · ActivitySchemeTreeListPlugin L81
```java
  79       public void setFilter(SetFilterEvent evt) {
  80           super.setFilter(evt);
  81 >         evt.getQFilters().add(new QFilter("islatest", "=", (Object)"1"));
  82       }
  83   
```

**READ_VIA_HELPER** · ActivitySchemeTreeListPlugin L95
```java
  93               } else {
  94                   Long pkId = (Long)listSelectedData.get(0).getPrimaryKeyValue();
  95 >                 DynamicObject item = ActivitySchemeServiceHelper.getById((Long)pkId);
  96                   this.showHistory(item.getLong("sequence"));
  97               }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.activity.ActivitySchemeTreeListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.activity.ActivitySchemeTreeListPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.activity.ActivitySchemeSaveOp -->

## ISV 扩展指引（基于 ActivitySchemeSaveOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.activity.ActivitySchemeSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.activity.ActivitySchemeSaveOp/extension_guide.md)
