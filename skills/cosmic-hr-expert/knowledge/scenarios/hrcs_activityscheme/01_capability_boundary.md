...
- `delete` · 删除
- `disable` · 禁用
- `deleteentry_param` · 删行
- `deleteentry` · 删除分录
- `deleteplugin` · 删除分录
- `deletefieldmapping` · 删除分录
- `deletegroupentry` · 删除活动组规则分录
- `deletegroupresultentry` · 删除活动组返回值分录
...
- 主表 `hrcs_activityscheme`：**37** 个标品插件接入
- 字段总数：**76** 个（实抓自 OpenAPI listMeta）
