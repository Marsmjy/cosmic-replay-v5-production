...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.formplugin.mobile.QuitApplyHRApprovalPlugin -->

## ISV 扩展指引（基于 QuitApplyHRApprovalPlugin 真实证）

> FQN: `kd.hr.htm.formplugin.mobile.QuitApplyHRApprovalPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.htm.formplugin.mobile.QuitApplyHRApprovalPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.bos.bill.AbstractMobBillPlugIn`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `registerListener`, `afterBindData`, `afterDoOperation`, `click`, `beforeF7Select`, `propertyChanged`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.htm.formplugin.mobile.QuitApplyHRApprovalPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.htm.formplugin.mobile.QuitApplyHRApprovalPlugin/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.formplugin.mobile.QuitApplyHRApprovalPlugin -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.formplugin.mobile.QuitApplyMobCommonPlugin -->

## ISV 扩展指引（基于 QuitApplyMobCommonPlugin 真实证）

> FQN: `kd.hr.htm.formplugin.mobile.QuitApplyMobCommonPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.htm.formplugin.mobile.QuitApplyMobCommonPlugin/`
...
**CONTEXT_ACCESS** · QuitApplyMobCommonPlugin L52
```java
  50               FieldEdit fieldEdit = (FieldEdit)this.getView().getControl("toblacklistid");
  51               fieldEdit.setMustInput(true);
  52 >             this.getView().getModel().setValue("toblacklistoperator", (Object)RequestContext.get().getCurrUserId());
  53           } else {
  54               this.getView().setVisible(Boolean.FALSE, new String[]{"toblacklistid", "toblacklistreasondes"});
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.htm.formplugin.mobile.QuitApplyMobCommonPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.htm.formplugin.mobile.QuitApplyMobCommonPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hpfs.opplugin.op.htmtpl.PerChgTplHtmRollbackOp -->

## ISV 扩展指引（基于 PerChgTplHtmRollbackOp 真实证）

> FQN: `kd.hr.hpfs.opplugin.op.htmtpl.PerChgTplHtmRollbackOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hpfs.opplugin.op.htmtpl.PerChgTplHtmRollbackOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hpfs.opplugin.op.htmtpl.PerChgTplHtmRollbackOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hpfs.opplugin.op.htmtpl.PerChgTplHtmRollbackOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.opplugin.apply.ApprovalEmpAuditOp -->

## ISV 扩展指引（基于 ApprovalEmpAuditOp 真实证）

> FQN: `kd.hr.htm.opplugin.apply.ApprovalEmpAuditOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.htm.opplugin.apply.ApprovalEmpAuditOp/`

### 类型与继承
- 插件类型：**OP_PLUGIN**
- 父类: `kd.hr.hbp.opplugin.web.HRDataBaseOp`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `beginOperationTransaction`, `onPreparePropertys`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.htm.opplugin.apply.ApprovalEmpAuditOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.htm.opplugin.apply.ApprovalEmpAuditOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.opplugin.apply.ApprovalEmpAuditOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.opplugin.apply.ApprovalHROp -->

## ISV 扩展指引（基于 ApprovalHROp 真实证）

> FQN: `kd.hr.htm.opplugin.apply.ApprovalHROp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.htm.opplugin.apply.ApprovalHROp/`
...
- `public public void onPreparePropertys(kd.bos.entity.plugin.PreparePropertysEventArgs)` ⭐ lifecycle
- `public public void onAddValidators(kd.bos.entity.plugin.AddValidatorsEventArgs)` ⭐ lifecycle
- `public public void copyBeforeErmanInfoToAfter(kd.bos.dataentity.entity.DynamicObject)`
...
**CALL_CROSS_SERVICE** · HrmpExternalServiceImpl L23
```java
  21   implements IHrmpExternalService {
  22       public Map<Long, DynamicObject> invokeAdminOrgInfoQuery(List<Long> ids, Date date) {
  23 >         return (Map)HRMServiceHelper.invokeHRMPService((String)"haos", (String)"IHAOSBatchAdminOrgInfoQueryService", (String)"queryAdminOrgDetailInfoByBoidToMap", (Object[])new Object[]{ids, date, ""});
  24       }
  25   
```
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.htm.opplugin.apply.ApprovalHROp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.htm.opplugin.apply.ApprovalHROp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.opplugin.apply.ApprovalHROp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.opplugin.apply.ApprovalSupervisorOp -->

## ISV 扩展指引（基于 ApprovalSupervisorOp 真实证）

> FQN: `kd.hr.htm.opplugin.apply.ApprovalSupervisorOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.htm.opplugin.apply.ApprovalSupervisorOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.htm.opplugin.apply.ApprovalSupervisorOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.htm.opplugin.apply.ApprovalSupervisorOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.opplugin.apply.ApprovalSupervisorOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.opplugin.apply.ApprovalHRInitOp -->

## ISV 扩展指引（基于 ApprovalHRInitOp 真实证）

> FQN: `kd.hr.htm.opplugin.apply.ApprovalHRInitOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.htm.opplugin.apply.ApprovalHRInitOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.htm.opplugin.apply.ApprovalHRInitOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.htm.opplugin.apply.ApprovalHRInitOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.formplugin.apply.QuitApplyEmpPlugin -->

## ISV 扩展指引（基于 QuitApplyEmpPlugin 真实证）

> FQN: `kd.hr.htm.formplugin.apply.QuitApplyEmpPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.htm.formplugin.apply.QuitApplyEmpPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`, `beforeF7Select`, `preOpenForm`, `afterBindData`, `beforeDoOperation`, `afterDoOperation`
...
- `public public void preOpenForm(kd.bos.form.events.PreOpenFormEventArgs)` ⭐ lifecycle
- `public public void afterBindData(java.util.EventObject)` ⭐ lifecycle
- `public static public static boolean isAuditView(kd.bos.form.IFormView)`
- `public public void beforeDoOperation(kd.bos.form.events.BeforeDoOperationEventArgs)` ⭐ lifecycle
- `public public void afterDoOperation(kd.bos.form.events.AfterDoOperationEventArgs)` ⭐ lifecycle
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.htm.formplugin.apply.QuitApplyEmpPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.htm.formplugin.apply.QuitApplyEmpPlugin/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.formplugin.apply.QuitApplyEmpPlugin -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.htm.formplugin.apply.QuitApplyHRAuditePlugin -->

## ISV 扩展指引（基于 QuitApplyHRAuditePlugin 真实证）

> FQN: `kd.hr.htm.formplugin.apply.QuitApplyHRAuditePlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.htm.formplugin.apply.QuitApplyHRAuditePlugin/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.htm.formplugin.apply.QuitApplyHRAuditePlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.htm.formplugin.apply.QuitApplyHRAuditePlugin/extension_guide.md)
