...
> **聚合场景**：HR 审批通用基础（htm · hraudite + superaudite 2 form）（1 个子实体）
> **生成时间**：2026-04-30
...
### `core_hr_audit` · ⚠️ 标品 entity_metadata md 不存在
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.htm.formplugin.mobile.QuitApplyHRApprovalPlugin -->

## chgaction 实证补充（QuitApplyHRApprovalPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.htm.formplugin.mobile.QuitApplyMobCommonPlugin -->

## chgaction 实证补充（QuitApplyMobCommonPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hpfs.opplugin.op.htmtpl.PerChgTplHtmRollbackOp -->

## chgaction 实证补充（PerChgTplHtmRollbackOp 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.htm.opplugin.apply.ApprovalEmpAuditOp -->

## chgaction 实证补充（ApprovalEmpAuditOp 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.htm.opplugin.apply.ApprovalHROp -->

## chgaction 实证补充（ApprovalHROp 跨类追踪聚合）
...
### 调用的核心 Service（Top 10）
- `QueryVidServiceImpl.class`
- `QueryVidServiceImpl.queryOrgVid`
- `QueryVidServiceImpl.queryJobVid`

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.htm.opplugin.apply.ApprovalHROp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.htm.opplugin.apply.ApprovalSupervisorOp -->

## chgaction 实证补充（ApprovalSupervisorOp 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.htm.opplugin.apply.ApprovalHRInitOp -->

## chgaction 实证补充（ApprovalHRInitOp 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.htm.formplugin.apply.QuitApplyEmpPlugin -->

## chgaction 实证补充（QuitApplyEmpPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.htm.formplugin.apply.QuitApplyHRAuditePlugin -->

## chgaction 实证补充（QuitApplyHRAuditePlugin 跨类追踪聚合）
