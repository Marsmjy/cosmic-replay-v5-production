...
## ✅ verified · 主表 `hrptmc_reportmanage` + 继承层
...
- `HRBaseServiceHelper`
- `HRPTMCRepDelECSService`
- `HRReportMetaDataHelper`
- `HRReportPreSQLHelper`
- `HRReportPublishMenuService`
- `PermissionServiceHelper`
- `PresetIndexServiceHelper`
- `ReportConfigService`
- `ReportDataStoreServiceHelper`
- `ReportFileSourceService`
- `ReportHisVersionService`
- `ReportJumpConfigService`
- `ReportManageService`
- `ReportPermissionService`
- `ReportPreViewService`
- `ResManager`
- `RptDisplaySchemeService`
