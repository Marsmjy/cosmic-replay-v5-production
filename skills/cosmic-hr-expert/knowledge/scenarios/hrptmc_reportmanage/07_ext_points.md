...
主表 `hrptmc_reportmanage` 标品接入 **20** 个插件。
...
- `ReportManageEditPlugin` ← `kd.hr.hrptmc.formplugin.web.repdesign.ReportManageEditPlugin`
...
- `ReportManageList` ← `kd.hr.hrptmc.formplugin.web.repdesign.ReportManageList`
- `ReportManagePreSqlExportList` ← `kd.hr.hrptmc.formplugin.web.export.sql.ReportManagePreSqlExportList`
...
- `ReportManageOp` ← `kd.hr.hrptmc.opplugin.web.repdesign.ReportManageOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrptmc.formplugin.web.repdesign.ReportManageEditPlugin -->

## ISV 扩展指引（基于 ReportManageEditPlugin 真实证）
...
### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hrptmc.formplugin.web.repdesign.ReportManageServicePlugin`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `afterCreateNewData`, `afterLoadData`, `afterBindData`, `beforeDoOperation`, `afterDoOperation`, `closedCallBack`, `beforeClosed`

### 可重写方法（target.java self）
- `public public void pageRelease(java.util.EventObject)`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrptmc.formplugin.web.repdesign.ReportManageEditPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrptmc.formplugin.web.repdesign.ReportManageEditPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrptmc.formplugin.web.repdesign.ReportManageList -->

## ISV 扩展指引（基于 ReportManageList 真实证）
...
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `registerListener`, `beforeBindData`, `setFilter`, `beforeDoOperation`, `afterDoOperation`, `itemClick`, `closedCallBack`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrptmc.formplugin.web.repdesign.ReportManageList/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrptmc.formplugin.web.repdesign.ReportManageList/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrptmc.formplugin.web.repdesign.ReportManageList -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrptmc.formplugin.web.export.sql.ReportManagePreSqlExportList -->

## ISV 扩展指引（基于 ReportManagePreSqlExportList 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrptmc.formplugin.web.export.sql.ReportManagePreSqlExportList/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrptmc.formplugin.web.export.sql.ReportManagePreSqlExportList/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrptmc.opplugin.web.repdesign.ReportManageOp -->

## ISV 扩展指引（基于 ReportManageOp 真实证）
...
- `public public void beginOperationTransaction(kd.bos.entity.plugin.args.BeginOperationTransactionArgs)` ⭐ lifecycle
- `public public void afterExecuteOperationTransaction(kd.bos.entity.plugin.args.AfterOperationArgs)` ⭐ lifecycle
- `public static public static void recursive(java.util.List<kd.hr.hrptmc.business.repdesign.info.FieldInfo>, java.util.function.Consumer<kd.hr.hrptmc.business.repdesign.info.FieldInfo>)`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrptmc.opplugin.web.repdesign.ReportManageOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrptmc.opplugin.web.repdesign.ReportManageOp/extension_guide.md)
