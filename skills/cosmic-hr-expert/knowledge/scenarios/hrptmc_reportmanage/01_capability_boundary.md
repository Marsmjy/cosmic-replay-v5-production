...
- `bizsave` · 保存
- `saveandvalidate` · 保存
- `saveandpublish` · 发布到应用菜单
- `saveandpublishrpt` · 发布到报表中心
- `saveandpublishwork` · 发布到工作台
...
- `mobtoolbarselect` · 选择
- `mobtoolbarcancel` · 取消
- ...（共 24 个，参见 `_auto_operations.md`）

## ✅ verified · 标品插件链

- 主表 `hrptmc_reportmanage`：**20** 个标品插件接入
- 字段总数：**34** 个（实抓自 OpenAPI listMeta）
