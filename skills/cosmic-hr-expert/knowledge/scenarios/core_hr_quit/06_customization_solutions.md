# core_hr_quit · 定制方案（ISV 扩展真实模板）

> **场景**：离职管理（htm · 5 单据 · INFO_QUIT 大类）（2 个子实体）
> **生成时间**：2026-04-30

## CS-01 · 给子实体加 ISV 自定义字段

**适用**：`htm_quitapply`, `htm_quitapplybill`（任一子实体）
...
**真发证据 / 反编译示例（如有）**：
- `HtmTplEffectOp.java` (8498 bytes)
- `PerChgTplEffectOp.java` (9592 bytes)
- `PerChgTplSaveOp.java` (1636 bytes)
