...
主表 `homs_businessruleconfig` 标品接入 **1** 个插件。

### FormPlugin（1）
- `BusinessRuleConfigEditPlugin` ← `kd.hr.homs.formplugin.web.ruleconfig.BusinessRuleConfigEditPlugin`
