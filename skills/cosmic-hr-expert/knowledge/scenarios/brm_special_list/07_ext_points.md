...
主表 `brm_special_list` 标品接入 **19** 个插件。
...
- `SpecialListConfigPlugin` ← `kd.hr.brm.formplugin.web.SpecialListConfigPlugin`
...
- `SpecialListListPlugin` ← `kd.hr.brm.formplugin.web.SpecialListListPlugin`
...
- `SpecialListConfigOp` ← `kd.hr.brm.opplugin.web.SpecialListConfigOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.brm.formplugin.web.SpecialListConfigPlugin -->

## ISV 扩展指引（基于 SpecialListConfigPlugin 真实证）

> FQN: `kd.hr.brm.formplugin.web.SpecialListConfigPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.brm.formplugin.web.SpecialListConfigPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRBaseDataCommonEdit`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `beforeBindData`, `afterBindData`, `propertyChanged`, `beforeDoOperation`, `closedCallBack`, `registerListener`, `beforeF7Select`, `afterDoOperation`
...
**CONTEXT_ACCESS** · SpecialListConfigPlugin L135
```java
 133                   this.getModel().setValue("bu", (Object)Long.parseLong(createBu));
 134               } else {
 135 >                 this.getModel().setValue("bu", (Object)RequestContext.get().getOrgId());
 136                   this.resetHROrg(this.getModel(), "bu");
 137               }
```

**QUERY_BUILDER** · SpecialListConfigPlugin L288
```java
 286               List<Long> employeeIds = this.getEmpIds();
 287               if (!CollectionUtils.isEmpty(employeeIds)) {
 288 >                 filterParameter.setFilter(new QFilter("id", "not in", employeeIds));
 289                   fsp.setListFilterParameter(filterParameter);
 290               }
```

**READ_VIA_HELPER** · SpecialListConfigPlugin L357
```java
 355           }
 356           if (this.isEmployee()) {
 357 >             Map userIdMap = SpecialListServiceHelper.getUserIdMap(userIds);
 358               userRosterInfos = SpecialListServiceHelper.getBosUserRosterInfo(new ArrayList(userIdMap.keySet()));
 359               userRosterInfos.forEach(userRosterInfo -> userRosterInfo.setId((Long)userIdMap.get(userRosterInfo.getId())));
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.brm.formplugin.web.SpecialListConfigPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.brm.formplugin.web.SpecialListConfigPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.brm.formplugin.web.SpecialListListPlugin -->

## ISV 扩展指引（基于 SpecialListListPlugin 真实证）

> FQN: `kd.hr.brm.formplugin.web.SpecialListListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.brm.formplugin.web.SpecialListListPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRBaseDataCommonList`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.brm.formplugin.web.SpecialListListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.brm.formplugin.web.SpecialListListPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.brm.opplugin.web.SpecialListConfigOp -->

## ISV 扩展指引（基于 SpecialListConfigOp 真实证）

> FQN: `kd.hr.brm.opplugin.web.SpecialListConfigOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.brm.opplugin.web.SpecialListConfigOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.brm.opplugin.web.SpecialListConfigOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.brm.opplugin.web.SpecialListConfigOp/extension_guide.md)
