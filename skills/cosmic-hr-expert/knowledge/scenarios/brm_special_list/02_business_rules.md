...
|---|---|---|---|
| `number` | 编码 | `TextField` | — |
| `name` | 名单名称 | `MuliLangTextField` | — |
| `enable` | 使用状态 | `BillStatusField` | — |
| `bu` | 创建组织 | `OrgField` | `bos_org` |
| `listtype` | 名单类型 | `ComboField` | — |
| `liststringname` | 名单 | `TextField` | — |
...
- 数据源：`_sdk_audit/_decompiled/scenarios/brm_special_list/` 的 0 个反编译类 + `_shared/_standard_metadata/entity_metadata/brm_special_list.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.brm.formplugin.web.SpecialListConfigPlugin -->

## chgaction 实证补充（SpecialListConfigPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.brm.formplugin.web.SpecialListListPlugin -->

## chgaction 实证补充（SpecialListListPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.brm.opplugin.web.SpecialListConfigOp -->

## chgaction 实证补充（SpecialListConfigOp 跨类追踪聚合）
