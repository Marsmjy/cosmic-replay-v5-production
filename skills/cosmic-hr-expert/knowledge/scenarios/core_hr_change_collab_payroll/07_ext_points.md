...
本场景含 3 个标品订阅类 + 1 个调度作业锚点：

- `kd.swc.hcdm.business.application.event.CandidateStopEventServicePlugin` (extends None)
- `kd.swc.hcdm.business.application.event.CandidateStopEventServicePlugin` (extends None)
- `kd.swc.hpdi.business.coordination.HpdiEmployeeCoordEventServicePlugin` (extends kd.hr.hbp.business.coordination.impl.AbstractEmployeeCoordSubService)
  - 派单 → `hpdi_HpdiEmployeeCoordTask_SKDJ_S`
- `kd.swc.hpdi.business.coordination.HpdiEmployeeCoordEventServicePlugin` (extends kd.hr.hbp.business.coordination.impl.AbstractEmployeeCoordSubService)
  - 派单 → `hpdi_HpdiEmployeeCoordTask_SKDJ_S`
- `kd.swc.hsbs.business.application.event.PerBankcardSynHirePersonEventServicePlugin` (extends None)
