...
## ✅ verified · 主表 `wtte_recordreport` 共 8 个 opKey

### 其他 opKey（8 个无独立规则·复用主链或反编译为空）

- `reportquery` · `refresh` · `close` · `syncexportexcel` · `exportexcel` · `exportreport` · `showhistory` · `showcalculate`
