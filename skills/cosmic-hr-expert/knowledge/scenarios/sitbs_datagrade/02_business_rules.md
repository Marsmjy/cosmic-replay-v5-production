...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hbp.formplugin.web.datagrade.DataGradeEdit -->

## chgaction 实证补充（DataGradeEdit 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hbp.opplugin.web.datagrade.HRDataGradeOp -->

## chgaction 实证补充（HRDataGradeOp 跨类追踪聚合）
