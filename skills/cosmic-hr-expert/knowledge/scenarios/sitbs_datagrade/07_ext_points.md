...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hbp.formplugin.web.datagrade.DataGradeEdit -->

## ISV 扩展指引（基于 DataGradeEdit 真实证）

> FQN: `kd.hr.hbp.formplugin.web.datagrade.DataGradeEdit`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.datagrade.DataGradeEdit/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`, `beforeBindData`, `afterDoOperation`, `click`, `beforeClosed`, `beforeDoOperation`, `closedCallBack`
...
- `public public void beforeDoOperation(kd.bos.form.events.BeforeDoOperationEventArgs)` ⭐ lifecycle
- `public public void closedCallBack(kd.bos.form.events.ClosedCallBackEvent)` ⭐ lifecycle
- `protected protected void setUniqueCode()`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.datagrade.DataGradeEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.datagrade.DataGradeEdit/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hbp.opplugin.web.datagrade.HRDataGradeOp -->

## ISV 扩展指引（基于 HRDataGradeOp 真实证）

> FQN: `kd.hr.hbp.opplugin.web.datagrade.HRDataGradeOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.datagrade.HRDataGradeOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.datagrade.HRDataGradeOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.datagrade.HRDataGradeOp/extension_guide.md)
