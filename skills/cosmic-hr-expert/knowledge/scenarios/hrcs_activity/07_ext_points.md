...
- `ActivityEditPlugin` ← `kd.hr.hrcs.formplugin.web.activity.ActivityEditPlugin`
...
- `ActivityTreeListPlugin` ← `kd.hr.hrcs.formplugin.web.activity.ActivityTreeListPlugin`
...
- `ActivitySaveOp` ← `kd.hr.hrcs.opplugin.web.activity.ActivitySaveOp`
...
- `ActivityDeleteOp` ← `kd.hr.hrcs.opplugin.web.activity.ActivityDeleteOp`
- `ActivityDisableOp` ← `kd.hr.hrcs.opplugin.web.activity.ActivityDisableOp`
- `ActivityEnableOp` ← `kd.hr.hrcs.opplugin.web.activity.ActivityEnableOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.activity.ActivityEditPlugin -->

## ISV 扩展指引（基于 ActivityEditPlugin 真实证）
...
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`, `afterBindData`, `beforeBindData`, `propertyChanged`, `beforeF7Select`
...
**QUERY_BUILDER** · ActivityEditPlugin L65
```java
  63       public void beforeBindData(EventObject e) {
  64           super.beforeBindData(e);
  65 >         ((BasedataEdit)this.getControl("app")).setQFilter(new QFilter("bizcloud.number", "in", (Object)HRBizCloudServiceHelper.getBizCloudNumber()));
  66       }
  67   
```

**READ_VIA_HELPER** · ActivityEditPlugin L65
```java
  63       public void beforeBindData(EventObject e) {
  64           super.beforeBindData(e);
  65 >         ((BasedataEdit)this.getControl("app")).setQFilter(new QFilter("bizcloud.number", "in", (Object)HRBizCloudServiceHelper.getBizCloudNumber()));
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.activity.ActivityEditPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.activity.ActivityEditPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.activity.ActivityTreeListPlugin -->

## ISV 扩展指引（基于 ActivityTreeListPlugin 真实证）
...
### 类型与继承
- 插件类型：**LIST_PLUGIN**
- 父类: `kd.hr.hrcs.formplugin.web.activity.BaseActivityTreeListPlugin`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: (无)

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.activity.ActivityTreeListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.activity.ActivityTreeListPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.activity.ActivitySaveOp -->

## ISV 扩展指引（基于 ActivitySaveOp 真实证）
...
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `onAddValidators`, `endOperationTransaction`
...
**CONTEXT_ACCESS** · ActivitySaveOp L61
```java
  59               if ("1".equals(actInfo.get("enable"))) {
  60                   DynamicObject enableRec = BusinessDataServiceHelper.newDynamicObject((String)"hrcs_activityenablerec");
  61 >                 enableRec.set("creator", (Object)RequestContext.get().getCurrUserId());
  62                   enableRec.set("createtime", (Object)TimeServiceHelper.now());
  63                   enableRec.set("activity", (Object)actInfo);
```

**QUERY_BUILDER** · ActivitySaveOp L77
```java
  75       private void addWFNodeTemplate(DynamicObject actInfo) {
  76           String nodeStencilType = "HRActivity";
  77 >         DynamicObject actNodeInfo = BusinessDataServiceHelper.loadSingle((String)"hrcs_activity", (String)"activitytype,bizobj,bizclassify,description,app", (QFilter[])new QFilter[]{new QFilter("id", "=", actInfo.getPkValue())});
  78           String nodeName = actNodeInfo.getString("name");
  79           String nodeNumber = actNodeInfo.getString("number");
```

**READ_VIA_HELPER** · ActivitySaveOp L77
```java
  75       private void addWFNodeTemplate(DynamicObject actInfo) {
  76           String nodeStencilType = "HRActivity";
  77 >         DynamicObject actNodeInfo = BusinessDataServiceHelper.loadSingle((String)"hrcs_activity", (String)"activitytype,bizobj,bizclassify,description,app", (QFilter[])new QFilter[]{new QFilter("id", "=", actInfo.getPkValue())});
...
**WRITE_VIA_HELPER** · ActivitySaveOp L72
```java
  70               this.updateWFNodeTemplate(actInfo);
  71           }
  72 >         OperationServiceHelper.executeOperate((String)"submit", (String)"hrcs_activityenablerec", (DynamicObject[])actTransRecSet.toArray(new DynamicObject[0]), (OperateOption)OperateOption.create());
  73       }
  74   
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.activity.ActivitySaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.activity.ActivitySaveOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.activity.ActivityDeleteOp -->

## ISV 扩展指引（基于 ActivityDeleteOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.activity.ActivityDeleteOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.activity.ActivityDeleteOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.activity.ActivityDeleteOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.activity.ActivityDisableOp -->

## ISV 扩展指引（基于 ActivityDisableOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.activity.ActivityDisableOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.activity.ActivityDisableOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.activity.ActivityDisableOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.activity.ActivityEnableOp -->

## ISV 扩展指引（基于 ActivityEnableOp 真实证）
...
**CONTEXT_ACCESS** · ActivityEnableOp L35
```java
  33           for (DynamicObject dynObj : items) {
  34               DynamicObject enableRec = BusinessDataServiceHelper.newDynamicObject((String)ENTITY_ENABLEREC);
  35 >             enableRec.set("creator", (Object)RequestContext.get().getCurrUserId());
  36               enableRec.set("createtime", (Object)TimeServiceHelper.now());
  37               enableRec.set("activity", (Object)dynObj);
```

**READ_VIA_HELPER** · ActivityEnableOp L34
```java
  32           ArrayList<DynamicObject> actTransRecSet = new ArrayList<DynamicObject>(items.length);
  33           for (DynamicObject dynObj : items) {
  34 >             DynamicObject enableRec = BusinessDataServiceHelper.newDynamicObject((String)ENTITY_ENABLEREC);
  35               enableRec.set("creator", (Object)RequestContext.get().getCurrUserId());
  36               enableRec.set("createtime", (Object)TimeServiceHelper.now());
...
**WRITE_VIA_HELPER** · ActivityEnableOp L40
```java
  38               actTransRecSet.add(enableRec);
  39           }
  40 >         OperationServiceHelper.executeOperate((String)"submit", (String)ENTITY_ENABLEREC, (DynamicObject[])actTransRecSet.toArray(new DynamicObject[0]), (OperateOption)OperateOption.create());
  41       }
  42   }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.activity.ActivityEnableOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.activity.ActivityEnableOp/extension_guide.md)
