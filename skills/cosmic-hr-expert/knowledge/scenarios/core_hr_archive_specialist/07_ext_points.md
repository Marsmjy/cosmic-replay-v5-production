# 扩展点全图 · core_hr_archive_specialist
...
主表 `hspm_ermanfilereform` 标品接入 **1** 个插件。

### FormPlugin（1）
- `FileManageReformHomePlugin` ← `kd.hr.hspm.formplugin.web.reform.file.web.manage.FileManageReformHomePlugin`
