...
## ✅ verified · 主表 `wtp_dailydetsource` 共 53 个 opKey
...
| 7 | `PerSumSourceSaveOp` | enabled=True |
...
| 5 | `PerSumSourceSaveOp` | enabled=True |
| 6 | `HRBaseDataEnableOp` | HR 基础资料启用态管理 · 控制 enable 字段 |
...
- `auto_assign` · `tbl_assign_import` · `logview` · `viewonelog` · `newentry` · `deleteentry` · `moveentryup` · `moveentrydown`
