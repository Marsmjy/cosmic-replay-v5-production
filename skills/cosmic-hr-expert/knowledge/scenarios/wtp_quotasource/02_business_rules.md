...
## ✅ verified · 主表 `wtp_quotasource` 共 54 个 opKey
...
| 8 | `QuotaSourceSaveOp` | enabled=True |
...
| 7 | `QuotaSourceSaveOp` | enabled=True |
...
- `auto_assign` · `tbl_assign_import` · `logview` · `newentry` · `deleteentry` · `moveentryup` · `moveentrydown` · `viewonelog` · `addentry`
