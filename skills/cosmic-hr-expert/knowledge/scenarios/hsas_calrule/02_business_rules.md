...
|---|---|---|---|
| `19HVR84XH3HO` | formRule | `datasource = '4'` | 当数据来源是“手工录入”锁允许计算结果覆盖。 |
| `1HYYNB0WM7XJ` | formRule | `salaryitem.taxtag = "2" and datasource = "6"` | 个税标签=个税结果项目 数据来源不能修改 |
| `1HYZ62I47B4V` | formRule | `datasource = "6"` | 数据来源=【个税云服务】允许结果覆盖 实发项 |
| `35E75A6Y45KM` | formRule | `(datasource = '1' or datasource = '9' or datasource = '10') and salaryitem.datatype.id = 1020` | 数据来源不为计算公式、定调薪项目、业务项目并且薪酬项目不是金额型时，锁定分段折算策略 |
| `35O1VYOWW/63` | formRule | `isconvert = '1'` | 分段折算策略为不启用时，锁定分段折算规则 |
| `3M3P2DAB6W30` | formRule | `datasource = '1' or datasource = '9' or datasource = '10'` | 数据来源不是计算公式、定调薪项目、业务项目时，锁定来源公式/项目属性 |
| `5I0JX9PJK19H` | formRule | `datasource = '7'` | 数据来源是第三方算税时，数据来源不能被修改 |
| `19HW5OGTCVNC` | bizRule | `datasource = '4'` | 当数据来源是“手工录入”，必须允许计算结果覆盖。 |
