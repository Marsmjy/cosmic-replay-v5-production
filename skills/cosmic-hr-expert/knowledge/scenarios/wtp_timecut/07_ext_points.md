...
- `TimeCutEdit` ← `kd.wtc.wtp.formplugin.web.timecut.TimeCutEdit`
...
- `TimeCutEditOp` ← `kd.wtc.wtp.opplugin.web.timecut.TimeCutEditOp`
...
- order **7**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **8**: `TimeCutEditOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.timecut.TimeCutEditOp`
...
- order **6**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **7**: `TimeCutEditOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.timecut.TimeCutEditOp`
