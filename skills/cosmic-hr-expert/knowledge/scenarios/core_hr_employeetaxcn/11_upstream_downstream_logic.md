...
> 本 form（`hrpi_employeetaxcn`，所属 核心人力云）引用了其他云的 **5** 个底座实体：

### ⬆️ HR 基础服务云（`hr_hrmp`）4 个引用

| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `taxunit` | 纳税单位 | BasedataField | `hbss_taxunit` | [hbss_law_entity](../hbss_law_entity/) |
| `birthplace` | 出生地（税局） | BasedataField | `hbss_nationality` | [hbss_person_attrs](../hbss_person_attrs/) |
