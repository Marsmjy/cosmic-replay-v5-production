...
主表 `hrpi_employeetaxcn` 标品接入 **17** 个插件。
...
- `EmployeeTaxCNSaveOp` ← `kd.hrmp.hrpi.opplugin.web.employee.EmployeeTaxCNSaveOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.employee.EmployeeTaxCNSaveOp -->

## ISV 扩展指引（基于 EmployeeTaxCNSaveOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.employee.EmployeeTaxCNSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.EmployeeTaxCNSaveOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.EmployeeTaxCNSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.EmployeeTaxCNSaveOp/extension_guide.md)
