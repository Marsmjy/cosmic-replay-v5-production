...
### `hsbs_trdtaxfield`（6 条）

| ruleId | 类型 | preCondition | 描述 |
|---|---|---|---|
| `5G7OAUEL0VU+` | formRule | `datatype.number = '1030_S'` | 当“数据类型”为“文本”时显示数据长度 |
| `5G7P1/98VDZ=` | formRule | `datatype.number = '1010_S' or datatype.number = '1020_S'` | 当“数据类型”为“数值”“金额”时显示 |
| `5G7PH768TV6T` | formRule | `datatype.number = '1010_S'` | 当“数据类型”为“数值”时显示 |
| `5G7Q9ZFKN0RR` | formRule | `datatype.number = '1010_S' or datatype.number = '1020_S'` | 当“数据类型”为“数值”“金额”时,累计项显示可编辑 |
| `5GEN0JWS51VE` | formRule | `datatype.number = '1020_S'` | 当“数据类型”为“金额”时显示 |
| `5G7QQ1S/0PQW` | bizRule | `datatype.number = '1030_S' or datatype.number = '1050_S'` | 当“数据类型”为“文本”“日期”时默认为“否”不可编辑。 |
