...
主表 `hies_switchregistry` 标品接入 **18** 个插件。
...
- `SwitchRegistryEdit` ← `kd.hr.hies.formplugin.SwitchRegistryEdit`
...
- `SwitchRegistryTreeListPlugin` ← `kd.hr.hies.formplugin.SwitchRegistryTreeListPlugin`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hies.formplugin.SwitchRegistryEdit -->

## ISV 扩展指引（基于 SwitchRegistryEdit 真实证）

> FQN: `kd.hr.hies.formplugin.SwitchRegistryEdit`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hies.formplugin.SwitchRegistryEdit/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`, `click`, `propertyChanged`, `beforeBindData`, `afterDoOperation`, `beforeF7Select`, `closedCallBack`, `beforeDoOperation`
...
**QUERY_BUILDER** · MetaMenuUtil L153
```java
 151                   return "";
 152               }
 153 >             DynamicObject dynamicObject = cloudDbHelper.queryOriginalOne("id", new QFilter("cloud", "=", (Object)bizCloudId));
 154               if (Objects.nonNull(dynamicObject)) {
 155                   String businessFieldId = dynamicObject.getString("id");
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hies.formplugin.SwitchRegistryEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hies.formplugin.SwitchRegistryEdit/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hies.formplugin.SwitchRegistryTreeListPlugin -->

## ISV 扩展指引（基于 SwitchRegistryTreeListPlugin 真实证）

> FQN: `kd.hr.hies.formplugin.SwitchRegistryTreeListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hies.formplugin.SwitchRegistryTreeListPlugin/`

### 类型与继承
- 插件类型：**LIST_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.template.HRF7TreeListPlugin`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `closedCallBack`, `beforeDoOperation`, `itemClick`
...
**CONTEXT_ACCESS** · SwitchRegistryTreeListPlugin L111
```java
 109           super.initialize();
 110           this.addClickListeners(new String[]{BTN_NEW});
 111 >         long userId = RequestContext.get().getCurrUserId();
 112           String appId = "hies";
 113           String entityName = "hies_switchregistry";
```

**QUERY_BUILDER** · SwitchRegistryTreeListPlugin L199
```java
 197                           return;
 198                       }
 199 >                     DynamicObject[] dyns = baseServiceHelper.query("id,name,enablestatus,status,enable,issyspreset,oristatus", new QFilter[]{new QFilter("id", "in", (Object)ids)});
 200                       ArrayList<DynamicObject> updDyns = new ArrayList<DynamicObject>();
 201                       ArrayList msgs = Lists.newArrayListWithCapacity((int)16);
```

**READ_VIA_HELPER** · SwitchRegistryTreeListPlugin L199
```java
 197                           return;
 198                       }
 199 >                     DynamicObject[] dyns = baseServiceHelper.query("id,name,enablestatus,status,enable,issyspreset,oristatus", new QFilter[]{new QFilter("id", "in", (Object)ids)});
...
**WRITE_VIA_HELPER** · SwitchRegistryTreeListPlugin L215
```java
 213                           operateOption.setVariableValue("ishasright", "true");
 214                           operateOption.setVariableValue("skipCheckDataPermission", "true");
 215 >                         OperationServiceHelper.executeOperate((String)"save", (String)"hies_switchregistry", (DynamicObject[])updDyns.toArray(new DynamicObject[0]), (OperateOption)operateOption);
 216                       }
 217                       ListView listView = (ListView)this.getView();
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hies.formplugin.SwitchRegistryTreeListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hies.formplugin.SwitchRegistryTreeListPlugin/extension_guide.md)
