# core_hr_emp_super_rel_chart · 推荐定制方案
...
**预期产出**：完整工程包（2 java + N datamodel + 工程文件 + 部署 SOP）。
...
详见 [`_assets/emp_super_rel_chart/deploy_sop.md`](../../_assets/emp_super_rel_chart/deploy_sop.md)
...
- 加审批工作流
- 接其他外部系统
- 详见 [`_assets/emp_super_rel_chart/customization_points.md`](../../_assets/emp_super_rel_chart/customization_points.md)
