# core_hr_emp_super_rel_chart · 扩展点
...
|---|---|---|---|---|
| EP-01 | 改 `EmpSuprelChartPlugin` 行为 | EmpSuprelChartPlugin.java (15 方法) | ⭐⭐ | (按需) |
| EP-02 | 改 `EmpSuprelChartTreeNode` 行为 | EmpSuprelChartTreeNode.java (13 方法) | ⭐⭐ | (按需) |
