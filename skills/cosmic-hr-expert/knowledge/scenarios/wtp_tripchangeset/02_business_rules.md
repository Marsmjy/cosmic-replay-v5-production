...
## ✅ verified · 主表 `wtp_tripchangeset` 共 64 个 opKey
...
| 10 | `TripChangeSetMustInputOp` | enabled=True |
...
| 9 | `TripChangeSetMustInputOp` | enabled=True |
...
| 3 | `TripChangeSetMustInputOp` | enabled=True |
...
- `showallversion` · `newentry` · `deleteentry` · `moveentryup` · `moveentrydown` · `addentry`
