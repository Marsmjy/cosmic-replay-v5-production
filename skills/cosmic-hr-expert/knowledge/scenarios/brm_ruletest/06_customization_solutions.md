...
在开发平台给本 form（`brm_ruletest`）加 ISV 字段：
...
标品 `RuleTestPlugin` 已实现：
- `registerListener` (L143)
- `propertyChanged` (L155)
- `beforeF7Select` (L151)
...
```java
@SdkPlugin
public class MyRuletestIsvFormPlugin extends HRDataBaseEdit {
    @Override
