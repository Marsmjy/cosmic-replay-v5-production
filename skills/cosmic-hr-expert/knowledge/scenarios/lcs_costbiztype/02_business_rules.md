# lcs_costbiztype · 业务规则

> **form**：`lcs_costbiztype` · 人力成本业务类型
> **生成时间**：2026-04-29
...
- 数据源：`_sdk_audit/_decompiled/scenarios/lcs_costbiztype/` 的 2 个反编译类 + `_shared/_standard_metadata/entity_metadata/lcs_costbiztype.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.lcs.formplugin.web.basedata.CostBizTypeEdit -->

## chgaction 实证补充（CostBizTypeEdit 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.lcs.formplugin.web.basedata.CostBizTypeList -->

## chgaction 实证补充（CostBizTypeList 跨类追踪聚合）
