...
主表 `hrobs_appconfig` 标品接入 **20** 个插件。
...
- `AppConfigFormPlugin` ← `kd.hrmp.hrobs.formplugin.appconfig.AppConfigFormPlugin`
...
- `AppConfigListPlugin` ← `kd.hrmp.hrobs.formplugin.appconfig.AppConfigListPlugin`
...
- `AppConfigOp` ← `kd.hrmp.hrobs.opplugin.appconfig.AppConfigOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrobs.formplugin.appconfig.AppConfigFormPlugin -->

## ISV 扩展指引（基于 AppConfigFormPlugin 真实证）

> FQN: `kd.hrmp.hrobs.formplugin.appconfig.AppConfigFormPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrobs.formplugin.appconfig.AppConfigFormPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.bos.form.plugin.AbstractFormPlugin`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `afterCreateNewData`, `afterBindData`, `validate`, `beforeDoOperation`, `registerListener`, `closedCallBack`, `propertyChanged`, `beforeF7Select`

### 可重写方法（target.java self）
- `public public void afterCreateNewData(java.util.EventObject)` ⭐ lifecycle
- `public public void afterBindData(java.util.EventObject)` ⭐ lifecycle
- `public public void validate(kd.bos.form.events.BeforeDoOperationEventArgs)` ⭐ lifecycle
- `public public void beforeDoOperation(kd.bos.form.events.BeforeDoOperationEventArgs)` ⭐ lifecycle
...
- `public public void beforePropertyChanged(kd.bos.entity.datamodel.events.PropertyChangedArgs)`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrobs.formplugin.appconfig.AppConfigFormPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrobs.formplugin.appconfig.AppConfigFormPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrobs.formplugin.appconfig.AppConfigListPlugin -->

## ISV 扩展指引（基于 AppConfigListPlugin 真实证）

> FQN: `kd.hrmp.hrobs.formplugin.appconfig.AppConfigListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrobs.formplugin.appconfig.AppConfigListPlugin/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrobs.formplugin.appconfig.AppConfigListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrobs.formplugin.appconfig.AppConfigListPlugin/extension_guide.md)
