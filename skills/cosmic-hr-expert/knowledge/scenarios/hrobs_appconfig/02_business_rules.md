...
- 数据源：`_sdk_audit/_decompiled/scenarios/hrobs_appconfig/` 的 0 个反编译类 + `_shared/_standard_metadata/entity_metadata/hrobs_appconfig.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrobs.formplugin.appconfig.AppConfigFormPlugin -->

## chgaction 实证补充（AppConfigFormPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrobs.formplugin.appconfig.AppConfigListPlugin -->

## chgaction 实证补充（AppConfigListPlugin 跨类追踪聚合）
