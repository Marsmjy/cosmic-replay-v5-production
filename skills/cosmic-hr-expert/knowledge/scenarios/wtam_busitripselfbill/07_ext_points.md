...
主表 `wtam_busitripselfbill` 标品接入 **34** 个插件。
...
- `BusiTripBillEdit` ← `kd.wtc.wtam.formplugin.web.busitripbill.BusiTripBillEdit`
...
- `BusiTripSelfBillList` ← `kd.wtc.wtam.formplugin.web.busitripbill.BusiTripSelfBillList`
...
- order **6**: `BusiTripBillOp` · enabled=True
...
- order **5**: `TpArchiveControlCheckOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtam.opplugin.web.busitripbill.TpArchiveControlCheckOp`
- order **6**: `WTCBillSelfApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillSelfApplyOp`
- order **7**: `WTCBillUpdateAttfileOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillUpdateAttfileOp`
