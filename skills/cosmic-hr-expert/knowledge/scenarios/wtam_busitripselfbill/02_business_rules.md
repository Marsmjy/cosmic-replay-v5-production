...
## ✅ verified · 主表 `wtam_busitripselfbill` 共 62 个 opKey
...
| 4 | `BillTplOp` | enabled=True |
| 5 | `TpArchiveControlCheckOp` | enabled=True |
| 6 | `WTCBillSelfApplyOp` | enabled=True |
| 7 | `WTCBillUpdateAttfileOp` | enabled=True |
...
- `wfauditing` · `wfrejecttosubmit` · `wfauditnotpass` · `wfauditpass` · `viewflowchart` · `unaudit` · `deleteentry` · `editentry` · `mob_deleteentry` · `newentry` · `openselecttype` · `openselectperson`
- `showhisbill` · `singletype` · `multitype` · `returnlist`
