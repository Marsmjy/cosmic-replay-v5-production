...
## ✅ verified · 主表 `wtpm_checkcard` 共 4 个 opKey

### 其他 opKey（4 个无独立规则·复用主链或反编译为空）

- `export_from_list_hr` · `show_export_record_hr` · `exportlistbyselectfields` · `exportdetails`
