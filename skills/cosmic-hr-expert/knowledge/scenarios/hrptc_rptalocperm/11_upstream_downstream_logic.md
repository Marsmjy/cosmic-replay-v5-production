...
> 本 form（`hrptc_rptalocperm`，所属 HR 基础服务云）引用了其他云的 **1** 个底座实体：

### ⬆️ 组织发展云（`org_dev`）1 个引用

| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `adminorgstruct` | 行政组织架构 | BasedataField | `haos_structproject` | [haos_structproject](../haos_structproject/) |
