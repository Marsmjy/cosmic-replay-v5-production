...
## ✅ verified · 主表 `wts_swshiftselfbill` 共 60 个 opKey
...
- `wfauditpass` · `viewflowchart` · `deleteentry` · `tomodpage` · `addentry` · `editentry` · `viewentry` · `newentrymob` · `deleteentrymob` · `viewswshift` · `returnlist`
