...
主表 `hbpm_positiontype` 标品接入 **36** 个插件。
...
- `PositionBasedataEdit` ← `kd.hrmp.hbpm.formplugin.web.basedata.PositionBasedataEdit`
- `BaseDataNewPlugin` ← `kd.bos.form.plugin.bdctrl.BaseDataNewPlugin`
- `PositionnBaseDataOrderPlugin` ← `kd.hrmp.hbpm.formplugin.web.basedata.PositionnBaseDataOrderPlugin`
...
- `BaseDataBuOp` ← `kd.hrmp.hbpm.opplugin.web.basedata.BaseDataBuOp`
...
## ✅ verified · 反编译实抓真处理类（12 个 · ISV 可继承 8 / 禁继承 4）
...
#### `PositionBasedataEdit` · FORM_PLUGIN @ `BILL_FORM` · opKey=`save`

- **完整 FQN**: `kd.hrmp.hbpm.formplugin.web.basedata.PositionBasedataEdit`
- **完整继承链**: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- **重写生命周期方法（1）**:
  - `afterBindData` — ISV 子类可在此切入扩展逻辑
...
- **ISV 扩展套路**：
  ...
  import kd.hrmp.hbpm.formplugin.web.basedata.PositionBasedataEdit;
  ...
  ```
- **详细 ISV 扩展指南**: [`<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbpm.formplugin.web.basedata.PositionBasedataEdit/extension_guide.md`](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbpm.formplugin.web.basedata.PositionBasedataEdit/extension_guide.md)
...
#### `BaseDataBuOp` · OP_PLUGIN @ `OPERATION` · opKey=`save`

- **完整 FQN**: `kd.hrmp.hbpm.opplugin.web.basedata.BaseDataBuOp`
...
- **ISV 扩展套路**：
  ...
  import kd.hrmp.hbpm.opplugin.web.basedata.BaseDataBuOp;
  ...
  ```
- **详细 ISV 扩展指南**: [`<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbpm.opplugin.web.basedata.BaseDataBuOp/extension_guide.md`](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbpm.opplugin.web.basedata.BaseDataBuOp/extension_guide.md)
...
#### `PositionnBaseDataOrderPlugin` · FORM_PLUGIN · opKey=`save`
...
- order **6**: `HRBaseDataEnableOp` · HR 基础资料启用态管理 · 控制 enable 字段
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp`
- order **7**: `BaseDataBuOp` · 重写 1 个方法：onAddValidators（注册校验器）
  - 完整 FQN: `kd.hrmp.hbpm.opplugin.web.basedata.BaseDataBuOp`
