...
## ✅ verified · 主表 `hbpm_positiontype` 共 49 个 opKey
...
| 4 | `BdVersionSaveServicePlugin` | 基础资料版本管理 · 主表 name + 版本子表 name 的写历史 |
| 5 | `HRBaseDataLogOp` | HR 基础资料操作日志 |
| 6 | `HRBaseDataEnableOp` | HR 基础资料启用态管理 · 控制 enable 字段 |
| 7 | `BaseDataBuOp` | 重写 1 个方法：onAddValidators（注册校验器） |
...
- `auto_assign` · `tbl_assign_import` · `logview` · `viewonelog`

## ✅ verified · 反编译类画像（共 12 个真处理类）
...
| `PositionBasedataEdit` | FORM_PLUGIN | `save` | ✅ | afterBindData | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbpm.formplugin.web.basedata.PositionBasedataEdit/extension_guide.md) |
...
| `PositionnBaseDataOrderPlugin` | FORM_PLUGIN | `save` | ❌ | setFilter | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbpm.formplugin.web.basedata.PositionnBaseDataOrderPlugin/extension_guide.md) |
...
| `BaseDataBuOp` | OP_PLUGIN | `save` | ✅ | onAddValidators | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbpm.opplugin.web.basedata.BaseDataBuOp/extension_guide.md) |
