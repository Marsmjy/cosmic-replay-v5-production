...
主表 `hsas_personchange` 标品接入 **10** 个插件。
...
### OpPlugin（2）
- `PersonChangeGenProrationOp` ← `kd.swc.hsas.opplugin.web.personchange.PersonChangeGenProrationOp`
- `PersonChangeAbandonOp` ← `kd.swc.hsas.opplugin.web.personchange.PersonChangeAbandonOp`
...
- order **1**: `PersonChangeGenProrationOp` · plugins.json 实证 · 标品 · extendable
  - 完整 FQN: `kd.swc.hsas.opplugin.web.personchange.PersonChangeGenProrationOp`
- order **2**: `PersonChangeAbandonOp` · plugins.json 实证 · 标品 · extendable
  - 完整 FQN: `kd.swc.hsas.opplugin.web.personchange.PersonChangeAbandonOp`
...
### opKey `viewprorationevent` · 查看分段事件
