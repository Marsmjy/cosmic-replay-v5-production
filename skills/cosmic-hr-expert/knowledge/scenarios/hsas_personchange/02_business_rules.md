...
## ✅ verified · 主表 `hsas_personchange` 共 16 个 opKey
...
| order | className | 角色 |
|:---:|---|---|
| 1 | `PersonChangeGenProrationOp` | plugins.json 实证 · 标品 · extendable |
| 2 | `PersonChangeAbandonOp` | plugins.json 实证 · 标品 · extendable |
...
#### `viewprorationevent` · 查看分段事件（opType=donothing）
