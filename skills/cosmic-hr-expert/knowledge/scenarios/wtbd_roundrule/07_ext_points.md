...
- `RoundEdit` ← `kd.wtc.wtbd.fromplugin.web.round.RoundEdit`
...
- `RoundEditList` ← `kd.wtc.wtbd.fromplugin.web.round.RoundEditList`
- `WTCPresetList` ← `kd.wtc.wtbs.formplugin.web.model.WTCPresetList`

### OpPlugin（7）
- `CodeRuleOp` ← `kd.bos.business.plugin.CodeRuleOp`
- `RoundSaveOp` ← `kd.wtc.wtbd.opplugin.web.round.RoundSaveOp`
...
- order **3**: `RoundSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.round.RoundSaveOp`
...
- order **3**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **4**: `RoundSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.round.RoundSaveOp`
