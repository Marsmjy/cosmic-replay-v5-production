# payroll_swc_salaryapproval · 扩展点
...
|---|---|---|---|---|
| EP-01 | 改 `NumItemsDTO` 行为 | NumItemsDTO.java (8 方法) | ⭐⭐ | (按需) |
| EP-02 | 改 `SetFilterUtil` 行为 | SetFilterUtil.java (1 方法) | ⭐⭐ | (按需) |
| EP-03 | 改 `SWCPageCache` 行为 | SWCPageCache.java (8 方法) | ⭐⭐ | (按需) |
| EP-04 | 改 `PayrollApprovalMobileEditPlugin` 行为 | PayrollApprovalMobileEditPlugin.java (4 方法) | ⭐⭐ | (按需) |
| EP-05 | 改 `PayrollApprovalEditPlugin` 行为 | PayrollApprovalEditPlugin.java (1 方法) | ⭐⭐ | (按需) |
