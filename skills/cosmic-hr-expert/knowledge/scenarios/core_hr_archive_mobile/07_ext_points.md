...
主表 `hspm_ermanfilemob` 标品接入 **1** 个插件。

### FormPlugin（1）
- `ManFileMobileHomeTemplatePlugin` ← `kd.hr.hspm.formplugin.web.reform.file.mobile.ManFileMobileHomeTemplatePlugin`
