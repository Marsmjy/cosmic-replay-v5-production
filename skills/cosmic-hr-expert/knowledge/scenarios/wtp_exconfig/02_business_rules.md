...
## ✅ verified · 主表 `wtp_exconfig` 共 82 个 opKey
...
| 10 | `ExConfigureMustInputOp` | enabled=True |
| 11 | `WTCDateRangeOp` | enabled=True |
...
| 9 | `ExConfigureMustInputOp` | enabled=True |
| 10 | `WTCDateRangeOp` | enabled=True |
...
| 3 | `ExConfigureMustInputOp` | enabled=True |
| 4 | `WTCDateRangeOp` | enabled=True |
...
- `showallversion` · `newentry` · `deleteentry` · `moveentryup` · `moveentrydown` · `newentry3` · `deleteentry3` · `moveentryup3` · `moveentrydown3` · `newentry2` · `deleteentry2` · `moveentryup2`
