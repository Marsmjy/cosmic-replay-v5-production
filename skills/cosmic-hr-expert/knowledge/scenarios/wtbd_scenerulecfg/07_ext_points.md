...
主表 `wtbd_scenerulecfg` 标品接入 **40** 个插件。
...
- `RetrievalRuleEdit` ← `kd.wtc.wtbd.fromplugin.web.retrieval.RetrievalRuleEdit`
...
- `RetrievalRuleList` ← `kd.wtc.wtbd.fromplugin.web.retrieval.RetrievalRuleList`
...
- `RetrievalRuleOp` ← `kd.wtc.wtbd.opplugin.web.retrieval.RetrievalRuleOp`
...
- order **4**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **5**: `RetrievalRuleOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.retrieval.RetrievalRuleOp`
...
- order **2**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **3**: `RetrievalRuleOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.retrieval.RetrievalRuleOp`
