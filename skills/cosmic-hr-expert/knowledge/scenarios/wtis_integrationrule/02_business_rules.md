...
## ✅ verified · 主表 `wtis_integrationrule` 共 55 个 opKey
...
| 8 | `IntegrationRuleSaveOp` | enabled=True |
...
| 7 | `IntegrationRuleSaveOp` | enabled=True |
...
- `auto_assign` · `tbl_assign_import` · `logview` · `viewonelog` · `newentry` · `deleteentry` · `moveentryup` · `moveentrydown` · `submitandaudit` · `addrow`
