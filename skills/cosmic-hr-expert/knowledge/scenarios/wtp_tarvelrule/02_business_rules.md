...
## ✅ verified · 主表 `wtp_tarvelrule` 共 69 个 opKey
...
- `showallversion` · `donothing_edit` · `donothing_manage` · `newentry` · `deleteentry` · `moveentryup` · `moveentrydown` · `donothing_assgin` · `addrow` · `copyrow` · `editrow`
