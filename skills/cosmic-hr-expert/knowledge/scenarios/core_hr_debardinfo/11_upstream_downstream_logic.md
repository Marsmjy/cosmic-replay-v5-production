...
> 本 form（`hrpi_debardinfo`，所属 核心人力云）引用了其他云的 **2** 个底座实体：

### ⬆️ HR 基础服务云（`hr_hrmp`）2 个引用

| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `relation` | 与本人关系 | BasedataField | `hbss_payrollacrelation` | [hbss_law_entity](../hbss_law_entity/) |
| `sex` | 性别 | BasedataField | `hbss_sex` | [hbss_person_attrs](../hbss_person_attrs/) |
