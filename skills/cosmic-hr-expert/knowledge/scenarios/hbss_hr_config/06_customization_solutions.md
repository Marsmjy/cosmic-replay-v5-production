# hbss_hr_config · 定制方案（ISV 扩展真实模板）

> **场景**：HR 系统配置与安全（18 个子实体）
> **生成时间**：2026-04-29

## CS-01 · 给子实体加 ISV 自定义字段

**适用**：`hbss_safeuri`, `hbss_safeuriconfig`, `hbss_loginconfig`, `hbss_loginscene`, `hbss_appentryconfig`, `hbss_privacyusertype` ...（任一子实体）
