...
### `PromptRuleBatchImportSaveOp`

- **FQN**：`kd.hr.hrcs.opplugin.web.PromptRuleBatchImportSaveOp`
- **继承**：`HRDataBaseOp`

**触发的 Validator**（save/delete 前置校验）：
- `PromptRuleImportValidator`

**调用的 Service / Helper**（2 个）：`HRBaseServiceHelper`, `PromptRuleImportValidator`

**实现的生命周期方法**：`onAddValidators`(L63), `beforeExecuteOperationTransaction`(L69)

## 三、FormPlugin 类业务规则（UI 联动）

### `PromptRuleEditPlugin`

- **FQN**：`kd.hr.hrcs.formplugin.web.prompt.PromptRuleEditPlugin`
- **继承**：`AbstractFormPlugin`
- **生命周期方法**：`registerListener`(L125), `propertyChanged`(L270), `beforeF7Select`(L154), `beforeDoOperation`(L295), `click`(L136), `itemClick`(L372)
- **读字段**（5）：`dentityid`, `entryprompt`, `entryrule`, `id`, `number`
- **调用的 Service**：`HRBaseServiceHelper`

### `PromptRuleInitPlugin`

- **FQN**：`kd.hr.hrcs.formplugin.web.prompt.PromptRuleInitPlugin`
- **继承**：`HRBaseDataCommonEdit`

### `PromptRuleListPlugin`
...
- 数据源：`_sdk_audit/_decompiled/scenarios/hrcs_promptrule/` 的 4 个反编译类 + `_shared/_standard_metadata/entity_metadata/hrcs_promptrule.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hrcs.formplugin.web.prompt.PromptRuleInitPlugin -->

## chgaction 实证补充（PromptRuleInitPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hrcs.formplugin.web.prompt.PromptRuleEditPlugin -->

## chgaction 实证补充（PromptRuleEditPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hrcs.formplugin.web.prompt.PromptRuleListPlugin -->

## chgaction 实证补充（PromptRuleListPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hrcs.opplugin.web.PromptRuleBatchImportSaveOp -->

## chgaction 实证补充（PromptRuleBatchImportSaveOp 跨类追踪聚合）
