...
主表 `hrcs_promptrule` 标品接入 **21** 个插件。
...
- `PromptRuleInitPlugin` ← `kd.hr.hrcs.formplugin.web.prompt.PromptRuleInitPlugin`
- `PromptRuleEditPlugin` ← `kd.hr.hrcs.formplugin.web.prompt.PromptRuleEditPlugin`
...
- `HRBaseDataCommonList` ← `kd.hr.hbp.formplugin.web.HRBaseDataCommonList`
- `PromptRuleListPlugin` ← `kd.hr.hrcs.formplugin.web.prompt.PromptRuleListPlugin`

### OpPlugin（7）
- `CodeRuleOp` ← `kd.bos.business.plugin.CodeRuleOp`
- `PromptRuleBatchImportSaveOp` ← `kd.hr.hrcs.opplugin.web.PromptRuleBatchImportSaveOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.prompt.PromptRuleInitPlugin -->

## ISV 扩展指引（基于 PromptRuleInitPlugin 真实证）

> FQN: `kd.hr.hrcs.formplugin.web.prompt.PromptRuleInitPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.prompt.PromptRuleInitPlugin/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.prompt.PromptRuleInitPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.prompt.PromptRuleInitPlugin/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.prompt.PromptRuleInitPlugin -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.prompt.PromptRuleEditPlugin -->

## ISV 扩展指引（基于 PromptRuleEditPlugin 真实证）

> FQN: `kd.hr.hrcs.formplugin.web.prompt.PromptRuleEditPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.prompt.PromptRuleEditPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.bos.form.plugin.AbstractFormPlugin`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`, `click`, `beforeF7Select`, `closedCallBack`, `propertyChanged`, `beforeDoOperation`, `itemClick`
...
**QUERY_BUILDER** · PromptRuleEditPlugin L206
```java
 204           listSP.setCloseCallBack(new CloseCallBack());
 205           listSP.getCloseCallBack().setControlKey("businessobject");
 206 >         listSP.getListFilterParameter().setFilter(new QFilter("modeltype", "in", (Object)this.filterModelType));
 207           List cloudIdSortList = HRCloudServiceHelper.getAllHRCommonCloudIdsSort();
 208           listSP.setCustomParam("bizcloudids", (Object)Lists.newArrayList((Iterable)cloudIdSortList));
```

**READ_VIA_HELPER** · PromptRuleEditPlugin L207
```java
 205           listSP.getCloseCallBack().setControlKey("businessobject");
 206           listSP.getListFilterParameter().setFilter(new QFilter("modeltype", "in", (Object)this.filterModelType));
 207 >         List cloudIdSortList = HRCloudServiceHelper.getAllHRCommonCloudIdsSort();
 208           listSP.setCustomParam("bizcloudids", (Object)Lists.newArrayList((Iterable)cloudIdSortList));
 209           this.getView().showForm((FormShowParameter)listSP);
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.prompt.PromptRuleEditPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.prompt.PromptRuleEditPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.prompt.PromptRuleListPlugin -->

## ISV 扩展指引（基于 PromptRuleListPlugin 真实证）

> FQN: `kd.hr.hrcs.formplugin.web.prompt.PromptRuleListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.prompt.PromptRuleListPlugin/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.prompt.PromptRuleListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.prompt.PromptRuleListPlugin/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.prompt.PromptRuleListPlugin -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.PromptRuleBatchImportSaveOp -->

## ISV 扩展指引（基于 PromptRuleBatchImportSaveOp 真实证）

> FQN: `kd.hr.hrcs.opplugin.web.PromptRuleBatchImportSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.PromptRuleBatchImportSaveOp/`
...
**CONTEXT_ACCESS** · PromptRuleBatchImportSaveOp L104
```java
 102               dy.set("enable", (Object)"1");
 103               dy.set("status", (Object)"C");
 104 >             dy.set("creator", (Object)UserServiceHelper.getCurrentUserId());
 105               dy.set("createtime", (Object)new Date());
 106               dy.set("modifytime", (Object)new Date());
```

**QUERY_BUILDER** · PromptRuleBatchImportSaveOp L80
```java
  78           }
  79           HRBaseServiceHelper serviceHelper = new HRBaseServiceHelper("bos_entitymeta");
  80 >         DynamicObject[] results = serviceHelper.query(new QFilter[]{new QFilter("id", "in", (Object)entityIdSet)});
  81           Map<String, DynamicObject> entityMap = Arrays.stream(results).collect(Collectors.toMap(result -> result.getString("id"), result -> result));
  82           for (DynamicObject dy : dys) {
```

**READ_VIA_HELPER** · PromptRuleBatchImportSaveOp L86
```java
  84               DynamicObject formDy = dy.getDynamicObject("businessobject");
  85               if (Objects.isNull(dy.get("entity"))) {
  86 >                 MainEntityType entityType = MetadataServiceHelper.getDataEntityType((String)formDy.getString("number"));
  87                   dy.set("entity", HRStringUtils.isEmpty((String)entityType.getAlias()) ? null : entityMap.get(formDy.getString("dentityid")));
  88               }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.PromptRuleBatchImportSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.PromptRuleBatchImportSaveOp/extension_guide.md)
