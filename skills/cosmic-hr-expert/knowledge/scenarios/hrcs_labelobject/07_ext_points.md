...
主表 `hrcs_labelobject` 标品接入 **20** 个插件。
...
- `LabelObjectPlugin` ← `kd.hr.hrcs.formplugin.web.label.LabelObjectPlugin`
...
- `LabelObjectListPlugin` ← `kd.hr.hrcs.formplugin.web.label.LabelObjectListPlugin`
...
- `LabelObjectOp` ← `kd.hr.hrcs.opplugin.web.label.LabelObjectOp`
- `CodeRuleDeleteOp` ← `kd.bos.coderule.CodeRuleDeleteOp`

### 其他（2）
- `templatebaseedit` ← `dev.tpl.base.kd.bos.form.plugin.templatebaseedit`
- `LabelObjectController` ← `kd.hr.hrcs.formplugin.web.label.controller.LabelObjectController`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.label.LabelObjectPlugin -->

## ISV 扩展指引（基于 LabelObjectPlugin 真实证）
...
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `registerListener`, `beforeBindData`, `closedCallBack`, `itemClick`, `propertyChanged`, `beforeDoOperation`, `afterDoOperation`, `beforeItemClick`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.label.LabelObjectPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.label.LabelObjectPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.label.LabelObjectListPlugin -->

## ISV 扩展指引（基于 LabelObjectListPlugin 真实证）
...
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseList`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `beforeDoOperation`, `closedCallBack`, `afterDoOperation`, `setFilter`, `beforeClosed`
...
**QUERY_BUILDER** · LabelObjectListPlugin L173
```java
 171           ControlContext context = billList.getContext();
 172           if (context.isLookup()) {
 173 >             e.getQFilters().add(new QFilter("publishstatus", "=", (Object)"1"));
 174           }
 175       }
```

**READ_VIA_HELPER** · LabelObjectListPlugin L152
```java
 150               if (OP_SHOW_CONFIG.equals(operateKey)) {
 151                   showParameter = new BaseShowParameter();
 152 >                 DynamicObject lblObjConfig = LabelObjectServiceHelper.getLblObjConfig((Long)lblObjId);
 153                   if (lblObjConfig != null) {
 154                       ((BaseShowParameter)showParameter).setPkId((Object)lblObjConfig.getLong("id"));
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.label.LabelObjectListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.label.LabelObjectListPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.label.LabelObjectOp -->

## ISV 扩展指引（基于 LabelObjectOp 真实证）
...
**READ_VIA_HELPER** · LabelObjectOp L100
```java
  98           } else if ("delete".equals(e.getOperationKey())) {
  99               List idList = Arrays.stream(e.getDataEntities()).map(dyn -> dyn.getLong("id")).collect(Collectors.toList());
 100 >             DynamicObject[] fields = LabelObjectServiceHelper.getFields(idList);
 101               OperationServiceHelper.executeOperate((String)"delete", (String)"hrcs_lblobjectfield", (DynamicObject[])fields, (OperateOption)OperateOption.create());
 102               DynamicObject[] fieldTypes = LabelObjectServiceHelper.getFieldTypes(idList);
```

**WRITE_VIA_HELPER** · LabelObjectOp L101
```java
  99               List idList = Arrays.stream(e.getDataEntities()).map(dyn -> dyn.getLong("id")).collect(Collectors.toList());
 100               DynamicObject[] fields = LabelObjectServiceHelper.getFields(idList);
 101 >             OperationServiceHelper.executeOperate((String)"delete", (String)"hrcs_lblobjectfield", (DynamicObject[])fields, (OperateOption)OperateOption.create());
 102               DynamicObject[] fieldTypes = LabelObjectServiceHelper.getFieldTypes(idList);
 103               OperationServiceHelper.executeOperate((String)"delete", (String)"hrcs_lblfieldtype", (DynamicObject[])fieldTypes, (OperateOption)OperateOption.create());
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.label.LabelObjectOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.label.LabelObjectOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.label.LabelObjectOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.label.controller.LabelObjectController -->

## ISV 扩展指引（基于 LabelObjectController 真实证）
...
**QUERY_BUILDER** · LabelObjectController L26
```java
  24           ListShowParameter listShowParameter = event.getListShowParameter();
  25           List qFilters = listShowParameter.getListFilterParameter().getQFilters();
  26 >         qFilters.add(new QFilter("publishstatus", "=", (Object)"1"));
  27       }
  28   }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.label.controller.LabelObjectController/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.label.controller.LabelObjectController/extension_guide.md)
