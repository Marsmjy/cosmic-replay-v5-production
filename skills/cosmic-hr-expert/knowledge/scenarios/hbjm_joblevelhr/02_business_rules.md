...
## ✅ verified · 主表 `hbjm_joblevelhr` 共 59 个 opKey
...
| 8 | `HisUniqueValidateOp` | 时态模型唯一性校验（同一 boid 同一时间段唯一） |
| 9 | `HisModelOPCommonPlugin` | 时态模型通用 · his_bsed/his_bsled/effectdate 的维护 |
| 10 | `JobLevelSaveOp` | enabled=True |
...
| `JobHisBasedataEdit` | FORM_PLUGIN | `save` | ✅ | preOpenForm, beforeBindData, afterBindData, beforeDoOperation | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.basedata.JobHisBasedataEdit/extension_guide.md) |
| `JobHisBasedataFiledChangeEdit` | FORM_PLUGIN | `save` | ✅ | afterBindData, beforeDoOperation, afterDoOperation | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.basedata.JobHisBasedataFiledChangeEdit/extension_guide.md) |
...
| `JobLevelEditPlugin` | FORM_PLUGIN | `save` | ✅ | registerListener, afterBindData, afterF7Select, beforeF7Select | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.joblevel.JobLevelEditPlugin/extension_guide.md) |
...
| `JobBaseDataListPlugin` | FORM_PLUGIN | `save` | ❌ | setFilter | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.common.JobBaseDataListPlugin/extension_guide.md) |
...
| `JobLevelListPlugin` | FORM_PLUGIN | `save` | ❌ | setFilter | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.joblevel.list.JobLevelListPlugin/extension_guide.md) |
...
（共 28 · 详见 `_deep_resolve_index.json`）
