...
| `kd.hrmp.hbjm.formplugin.web.basedata.JobHisBasedataEdit` | `save` | preOpenForm, beforeBindData, afterBindData, beforeDoOperation, afterDoOperation |
| `kd.hrmp.hbjm.formplugin.web.basedata.JobHisBasedataFiledChangeEdit` | `save` | afterBindData, beforeDoOperation, afterDoOperation |
| `kd.hr.hbp.formplugin.web.cert.HRCertCheckEdit` | `save` | preOpenForm |
| `kd.hrmp.hbjm.formplugin.web.joblevel.JobLevelEditPlugin` | `save` | registerListener, afterBindData, afterF7Select, beforeF7Select, beforeItemClick |
...
- `JobBaseDataListPlugin` (FORM_PLUGIN) ← `kd.hrmp.hbjm.formplugin.web.common.JobBaseDataListPlugin`
- `JobBaseBuListPlugin` (FORM_PLUGIN) ← `kd.hrmp.hbjm.formplugin.web.basedata.JobBaseBuListPlugin`
- `JobLevelListPlugin` (FORM_PLUGIN) ← `kd.hrmp.hbjm.formplugin.web.joblevel.list.JobLevelListPlugin`
...
## ℹ️ 标品已接入插件（52 个 · 详见 07_ext_points.md）
