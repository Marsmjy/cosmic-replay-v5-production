# core_hr_downermanfileword · 推荐定制方案
...
**预期产出**：完整工程包（10 java + N datamodel + 工程文件 + 部署 SOP）。
...
详见 [`_assets/downermanfileword/deploy_sop.md`](../../_assets/downermanfileword/deploy_sop.md)
...
- 加审批工作流
- 接其他外部系统
- 详见 [`_assets/downermanfileword/customization_points.md`](../../_assets/downermanfileword/customization_points.md)
