...
### `hsas_caltasknewtpl`（2 条）

| ruleId | 类型 | preCondition | 描述 |
|---|---|---|---|
| `58W5TKX=/5X+` | formRule | `notifyobj = '1'` | 不通知 |
| `58W7WHA5=T/U` | bizRule | `notifyobj = '1'` | 不通知 |
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hbp.formplugin.web.hrbu.HRBUCAApplicationEdit -->

## chgaction 实证补充（HRBUCAApplicationEdit 跨类追踪聚合）
