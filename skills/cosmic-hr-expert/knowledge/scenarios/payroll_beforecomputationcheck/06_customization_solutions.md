# payroll_beforecomputationcheck · 推荐定制方案
...
**预期产出**：完整工程包（3 java + N datamodel + 工程文件 + 部署 SOP）。
...
详见 [`_assets/beforecomputationcheck/deploy_sop.md`](../../_assets/beforecomputationcheck/deploy_sop.md)
...
- 加审批工作流
- 接其他外部系统
- 详见 [`_assets/beforecomputationcheck/customization_points.md`](../../_assets/beforecomputationcheck/customization_points.md)
