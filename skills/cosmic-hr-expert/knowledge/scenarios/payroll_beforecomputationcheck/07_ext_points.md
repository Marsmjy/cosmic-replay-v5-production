# payroll_beforecomputationcheck · 扩展点
...
|---|---|---|---|---|
| EP-02 | 改 `CalPayPushPlugin` 行为 | CalPayPushPlugin.java (5 方法) | ⭐⭐ | (按需) |
| EP-03 | 改 `HsasCalpayRolltListPlugin` 行为 | HsasCalpayRolltListPlugin.java (2 方法) | ⭐⭐ | (按需) |
