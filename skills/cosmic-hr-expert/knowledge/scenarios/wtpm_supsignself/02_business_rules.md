...
## ✅ verified · 主表 `wtpm_supsignself` 共 58 个 opKey

### 🔥 核心 opKey 执行链（12 个有真链）
...
| 5 | `SupSignSubmitEffectOp` | enabled=True |
| 6 | `WTCBillUpdateAttfileOp` | enabled=True |
| 7 | `ApplyMustInputCheckOp` | enabled=True |
...
| 4 | `ApplyMustInputCheckOp` | enabled=True |
| 5 | `WTCBillUpdateAttfileOp` | enabled=True |
| 6 | `SupSignSaveOp` | enabled=True |
| 7 | `WTCBillSelfApplyOp` | enabled=True |
| 8 | `WTCBillReplenishOriginalOp` | enabled=True |
...
| 4 | `BillTplOp` | enabled=True |
| 5 | `WTCBillUpdateAttfileOp` | enabled=True |
| 6 | `ApplyMustInputCheckOp` | enabled=True |
| 7 | `SupSignSubmitOp` | enabled=True |
| 8 | `WTCBillReplenishOriginalOp` | enabled=True |
...
| 5 | `SupSignDiscardOp` | enabled=True |
| 6 | `WTCBillChangeDeleteOp` | enabled=True |
...
| 3 | `SupSignUnSubmitOp` | enabled=True |
| 4 | `WTCBillSelfApplyOp` | enabled=True |
...
| 2 | `SupSignArchiveControlValidateOp` | enabled=True |
| 3 | `SupSignAuditOp` | enabled=True |
...
| order | className | 角色 |
|:---:|---|---|
| 1 | `SupSignArchiveControlValidateOp` | enabled=True |
| 2 | `SupSignAuditOp` | enabled=True |
...
| order | className | 角色 |
|:---:|---|---|
| 1 | `SupSignRejectToSubmitOp` | enabled=True |
...
| order | className | 角色 |
|:---:|---|---|
| 1 | `SupSignAuditNotPassOp` | enabled=True |
...
- `wfauditing` · `wfauditpass` · `viewflowchart` · `unaudit` · `deleteentry` · `newentry` · `cus_delete` · `openselectperson` · `viewchangehis` · `returnlist`
