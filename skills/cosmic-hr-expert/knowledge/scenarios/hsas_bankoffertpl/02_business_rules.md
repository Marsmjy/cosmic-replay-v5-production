...
### `hsas_bankoffertpl`（6 条）

| ruleId | 类型 | preCondition | 描述 |
|---|---|---|---|
| `1LZ1S1UJ2WOE` | formRule | `fieldsource="1" or fieldsource="4"` | 字段来源为固定值/自定义 |
| `1LZ2922/YGJ5` | formRule | `fieldvalue<>""` | 字段取值为不为空 |
| `1LZ2P0KDEBIJ` | formRule | `fieldlength=0` | 字段长度为0 |
| `1LZ3/QTA/T9S` | formRule | `fixway = "3" or fixway = "4"` | 前补空格或者后补空格 |
| `3L4MQO5U5G+J` | formRule | `fieldsource = '3' or fieldsource = '5'` | 字段来源为序列号/无 |
| `1PDTEU15Q8=0` | formRule | `isempty=true` | 表头行为空 |
