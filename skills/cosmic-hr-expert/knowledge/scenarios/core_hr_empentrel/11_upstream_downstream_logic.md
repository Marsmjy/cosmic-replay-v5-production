...
> 本 form（`hrpi_empentrel`，所属 核心人力云）引用了其他云的 **5** 个底座实体：

### ⬆️ HR 基础服务云（`hr_hrmp`）4 个引用

| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `enterprise` | 用人单位 | BasedataField | `hbss_enterprise` | [hbss_law_entity](../hbss_law_entity/) |
| `laborreltype` | 用工关系类型 | BasedataField | `hbss_laborreltype` | [hbss_labor_rel](../hbss_labor_rel/) |
| `laborrelstatus` | 用工关系状态 | BasedataField | `hbss_laborrelstatus` | [hbss_labor_rel](../hbss_labor_rel/) |
| `onboardsource` | 入职来源 | BasedataField | `hbss_onboardsource` | [hbss_labor_rel](../hbss_labor_rel/) |
