...
- `EmpEntRelSaveOp` ← `kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelSaveOp`
- `EmployeeCommonStandardMustInputOp` ← `kd.hrmp.hrpi.opplugin.web.common.EmployeeCommonStandardMustInputOp`
- `EmpEntRelEmpStageSaveOp` ← `kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelEmpStageSaveOp`
- `IgnoreReferenceDeleteOp` ← `kd.hrmp.hrpi.opplugin.web.template.IgnoreReferenceDeleteOp`
- `EmpEntRelReviseEntryDateOp` ← `kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelReviseEntryDateOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelSaveOp -->

## ISV 扩展指引（基于 EmpEntRelSaveOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelSaveOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelSaveOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelEmpStageSaveOp -->

## ISV 扩展指引（基于 EmpEntRelEmpStageSaveOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelEmpStageSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelEmpStageSaveOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelEmpStageSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelEmpStageSaveOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelReviseEntryDateOp -->

## ISV 扩展指引（基于 EmpEntRelReviseEntryDateOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelReviseEntryDateOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelReviseEntryDateOp/`
...
**QUERY_BUILDER** · EmpEntRelDomainServiceImpl L34
```java
  32   implements IEmpEntRelDomainService {
  33       public DynamicObject[] queryEmpEntRels(Collection<Long> employeeIds, Date queryDate) {
  34 >         QFilter qf = new QFilter("employee", "in", employeeIds);
  35           qf.and("startdate", "<=", (Object)queryDate);
  36           qf.and("enddate", ">", (Object)queryDate);
```
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelReviseEntryDateOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelReviseEntryDateOp/extension_guide.md)
