# core_hr_empentrel · 定制方案（ISV 扩展真实模板）
...
在开发平台给本 form（`hrpi_empentrel`）加 ISV 字段：
...
```java
@SdkPlugin
public class MyEmpentrelAfterOp extends HRDataBaseOp {
    @Override
...
```java
@SdkPlugin
public class MyEmpentrelIsvFormPlugin extends HRDataBaseEdit {
    @Override
