...
### `EmpEntRelEmpStageSaveOp`

- **FQN**：`kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelEmpStageSaveOp`
- **继承**：`HRDataBaseOp`

**实现的生命周期方法**：`beginOperationTransaction`(L58)

### `EmpEntRelReviseEntryDateOp`
...
**实现的生命周期方法**：`beginOperationTransaction`(L33)
...
- 数据源：`_sdk_audit/_decompiled/scenarios/core_hr_empentrel/` 的 12 个反编译类 + `_shared/_standard_metadata/entity_metadata/hrpi_empentrel.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelSaveOp -->

## chgaction 实证补充（EmpEntRelSaveOp 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelEmpStageSaveOp -->

## chgaction 实证补充（EmpEntRelEmpStageSaveOp 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrpi.opplugin.web.employee.attach.EmpEntRelReviseEntryDateOp -->

## chgaction 实证补充（EmpEntRelReviseEntryDateOp 跨类追踪聚合）
