# hbss_supplier · 定制方案（ISV 扩展真实模板）

> **场景**：供应商/银行/工作地点字典（12 个子实体）
> **生成时间**：2026-04-29

## CS-01 · 给子实体加 ISV 自定义字段

**适用**：`hbss_supplier`, `hbss_supplierlevel`, `hbss_bankdeposit`, `hbss_workplace`, `hbss_encouragewords`, `hbss_addressdetail` ...（任一子实体）
