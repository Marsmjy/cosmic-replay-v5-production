# core_hr_contract_termination · 业务规则

> **聚合场景**：合同终止 + 协议解除（hlcm）（1 个子实体）
> **生成时间**：2026-04-30
...
### `core_hr_contract_termination` · ⚠️ 标品 entity_metadata md 不存在
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hlcm.formplugin.importplugin.ContractImportPlugin -->

## chgaction 实证补充（ContractImportPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hlcm.formplugin.billapply.ErManFilePlugin -->

## chgaction 实证补充（ErManFilePlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hlcm.formplugin.mobile.contract.ContractApplyStopMobPlugin -->

## chgaction 实证补充（ContractApplyStopMobPlugin 跨类追踪聚合）
