# 上下游联动 · core_hr_appointremoverel
...
> 本 form（`hrpi_appointremoverel`，所属 核心人力云）引用了其他云的 **14** 个底座实体：

### ⬆️ HR 基础服务云（`hr_hrmp`）7 个引用

| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `appointtype` | 任命类型 | BasedataField | `hbss_appointtype` | [hbss_labor_rel](../hbss_labor_rel/) |
| `cadrecat` | 干部类别 | BasedataField | `hbss_cadrecategory` | [hbss_position_dict](../hbss_position_dict/) |
| `apptreasonggroup` | 任命原因 | BasedataField | `hbss_apptreasongroup` | [hbss_labor_rel](../hbss_labor_rel/) |
| `dismisstype` | 免职类型 | BasedataField | `hbss_appointtype` | [hbss_labor_rel](../hbss_labor_rel/) |
| `dismissreason` | 免职原因 | BasedataField | `hbss_apptreasongroup` | [hbss_labor_rel](../hbss_labor_rel/) |
| `postype` | 任职类型 | BasedataField | `hbss_postype` | [hbss_position_dict](../hbss_position_dict/) |
| `posstatus` | 任职状态 | BasedataField | `hbss_poststate` | [hbss_position_dict](../hbss_position_dict/) |

### ⬆️ 组织发展云（`org_dev`）7 个引用

| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `jobvid` | 历史职位 | HisModelBasedataField | `hbjm_jobhr` | [hjm_jobhr_maintenance](../hjm_jobhr_maintenance/) |
