# core_hr_appointremoverel · 案例

> **生成时间**：2026-04-29

## CASE-1 · 标品 save 链处理逻辑实证

取 `AppointRemoveRelSaveOp` 作为样板：

- **触发 Validator**：无
- **opKey 分支**：无
- **Service 调用**：0 个

完整反编译实物：`knowledge/_sdk_audit/_decompiled/scenarios/core_hr_appointremoverel/AppointRemoveRelSaveOp.java`
