...
### `AppointRemoveRelSaveOp`

- **FQN**：`kd.hrmp.hrpi.opplugin.web.assignment.attach.AppointRemoveRelSaveOp`
- **继承**：`HRDataBaseOp`

**实现的生命周期方法**：`onAddValidators`(L38), `beginOperationTransaction`(L54)
...
- 数据源：`_sdk_audit/_decompiled/scenarios/core_hr_appointremoverel/` 的 12 个反编译类 + `_shared/_standard_metadata/entity_metadata/hrpi_appointremoverel.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrpi.opplugin.web.assignment.attach.AppointRemoveRelSaveOp -->

## chgaction 实证补充（AppointRemoveRelSaveOp 跨类追踪聚合）
