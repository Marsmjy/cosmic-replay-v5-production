# 扩展点全图 · core_hr_appointremoverel
...
主表 `hrpi_appointremoverel` 标品接入 **18** 个插件。
...
- `AppointRemoveRelSaveOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.AppointRemoveRelSaveOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.AppointRemoveRelSaveOp -->

## ISV 扩展指引（基于 AppointRemoveRelSaveOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.assignment.attach.AppointRemoveRelSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.AppointRemoveRelSaveOp/`
...
### 可重写方法（target.java self）
- `public public void onAddValidators(kd.bos.entity.plugin.AddValidatorsEventArgs)` ⭐ lifecycle
- `public public java.lang.Boolean getopenSihccadm()`
- `public public void beginOperationTransaction(kd.bos.entity.plugin.args.BeginOperationTransactionArgs)` ⭐ lifecycle
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.AppointRemoveRelSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.AppointRemoveRelSaveOp/extension_guide.md)
