...
- `donothing_show_setgraderank` · 弹窗设置薪等薪级关系
...
- `mobtoolbarselect` · 选择
- `mobtoolbarcancel` · 取消
- ...（共 40 个，参见 `_auto_operations.md`）

## ✅ verified · 标品插件链

- 主表 `hcdm_salarystandard`：**56** 个标品插件接入
- 字段总数：**116** 个（实抓自 OpenAPI listMeta）
