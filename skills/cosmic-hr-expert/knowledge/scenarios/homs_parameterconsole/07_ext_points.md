...
主表 `homs_parameterconsole` 标品接入 **4** 个插件。

### FormPlugin（4）
- `ParameterConsolePlugin` ← `kd.bos.form.plugin.param.ParameterConsolePlugin`
- `HRCertCheckEdit` ← `kd.hr.hbp.formplugin.web.cert.HRCertCheckEdit`
- `OrgParameterconsoleEdit` ← `kd.hr.haos.formplugin.web.staff.form.OrgParameterconsoleEdit`
- `PositionTplParameterConcoleEdit` ← `kd.hrmp.hbpm.formplugin.web.position.PositionTplParameterConcoleEdit`
