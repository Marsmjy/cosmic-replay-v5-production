...
本场景含 5 个标品订阅类 + 1 个调度作业锚点：

- `kd.${ISV_FLAG}.oatr.bussiness.event.RecordEffectEventServicePlugin` (extends None)
- `kd.${ISV_FLAG}.cadm.bussiness.event.QuitTenureEventServicePlugin` (extends None)
- `kd.${ISV_FLAG}.cadm.bussiness.event.EffectTenureEventServicePlugin` (extends None)
- `kd.${ISV_FLAG}.cadm.bussiness.event.RollBackTenureEventServicePlugin` (extends None)
- `kd.${ISV_FLAG}.tdcs.bussiness.event.TdcsEmployeeCoordEventServicePlugin` (extends kd.hr.hbp.business.coordination.impl.AbstractEmployeeCoordSubService)
  - 派单 → `tdcs_TdcsEmployeeCoordTask_SKDJ_S`
