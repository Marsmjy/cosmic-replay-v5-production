...
|---|---|---|---|
| `RecordEffectEventServicePlugin` | - | `${ISV_FLAG}.oatr.event.record` | - |
| `QuitTenureEventServicePlugin` | - | `${ISV_FLAG}.cadm.quit.tenure` | - |
| `EffectTenureEventServicePlugin` | - | `${ISV_FLAG}.cadm.tenure.relational` | - |
| `RollBackTenureEventServicePlugin` | - | `${ISV_FLAG}.cadm.tenure.relational` | - |
| `TdcsEmployeeCoordEventServicePlugin` | AbstractEmployeeCoordSubService | `${ISV_FLAG}.tdcs.tdcs_coordverifbill` | `tdcs_TdcsEmployeeCoordTask_SKDJ_S` |

## 关联调度作业详情

### `tdcs_TdcsEmployeeCoordTask_SKDJ_S`

- 作业名: 员工变动_人才档案调度任务
- 类型: BIZ
- 应用: tdcs
- sch_job_id: `5I/Y8YHBBTSR`
- ✅ **真处理类 FQN**: `kd.${ISV_FLAG}.tdcs.bussiness.task.TdcsEmployeeCoordTask`
- 真处理类 extends: `kd.hr.hbp.business.coordination.impl.AbstractEmployeeCoordTask`
- 反编译产物: `_sdk_audit/_decompiled_deep/kd.${ISV_FLAG}.tdcs.bussiness.task.TdcsEmployeeCoordTask/`

## 6 层 FQN 闭环证据（v5+ · 人才发展云 (tdc)）

```
[L1 BEC 订阅]                 共 5 条 · 5 FQN
   ↓ 入口·壳类
