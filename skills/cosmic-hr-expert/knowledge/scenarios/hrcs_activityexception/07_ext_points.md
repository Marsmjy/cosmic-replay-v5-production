...
主表 `hrcs_activityexception` 标品接入 **2** 个插件。

### FormPlugin（2）
- `ActivityExceptionLogEdit` ← `kd.hr.hrcs.formplugin.web.activity.ActivityExceptionLogEdit`
- `ActivityExceptionLogPlugin` ← `kd.hr.hrcs.formplugin.web.activity.ActivityExceptionLogPlugin`
