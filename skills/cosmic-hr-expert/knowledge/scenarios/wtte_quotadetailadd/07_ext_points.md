...
主表 `wtte_quotadetailadd` 标品接入 **24** 个插件。
...
- `QuotaDatailAddEdit` ← `kd.wtc.wtte.formplugin.web.quota.QuotaDatailAddEdit`
...
- `QuotaDetailAddList` ← `kd.wtc.wtte.formplugin.web.quota.QuotaDetailAddList`
...
- `QTAddSaveOp` ← `kd.wtc.wtte.opplugin.web.quota.QTAddSaveOp`
...
## ✅ verified · opKey 扩展切入点详解（6 个有执行链的 opKey）
...
- order **6**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **7**: `QTAddSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.quota.QTAddSaveOp`
...
- order **5**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **6**: `QTAddSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.quota.QTAddSaveOp`
...
- order **1**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **2**: `QTAddSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.quota.QTAddSaveOp`
