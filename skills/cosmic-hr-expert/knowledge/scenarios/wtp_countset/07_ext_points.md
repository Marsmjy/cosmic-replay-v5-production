...
- `SuppleCountLimitEdit` ← `kd.wtc.wtp.formplugin.web.supple.SuppleCountLimitEdit`
...
- `SuppleCountLimitOp` ← `kd.wtc.wtp.opplugin.web.supple.SuppleCountLimitOp`
...
- order **5**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **6**: `SuppleCountLimitOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.supple.SuppleCountLimitOp`
...
- order **4**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **5**: `SuppleCountLimitOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.supple.SuppleCountLimitOp`
...
- order **2**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **3**: `SuppleCountLimitOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.supple.SuppleCountLimitOp`
