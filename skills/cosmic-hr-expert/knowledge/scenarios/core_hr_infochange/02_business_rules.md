# core_hr_infochange · 业务规则

> **聚合场景**：⭐⭐⭐ 调配管理 - 信息变更（chgaction 用得最纯粹的场景）（1 个子实体）
> **生成时间**：2026-04-30
...
### `core_hr_infochange` · ⚠️ 标品 entity_metadata md 不存在
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hdm.formplugin.transfer.web.common.TransferInfoChangeEdit -->

## chgaction 实证补充（TransferInfoChangeEdit 跨类追踪聚合）
