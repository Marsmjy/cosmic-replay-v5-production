...
主表 `wtte_quotadetailmdfy` 标品接入 **24** 个插件。
...
- `QuotaDetailMdfyEdit` ← `kd.wtc.wtte.formplugin.web.quota.QuotaDetailMdfyEdit`
...
- `QuotaDetailMdfyList` ← `kd.wtc.wtte.formplugin.web.quota.QuotaDetailMdfyList`
