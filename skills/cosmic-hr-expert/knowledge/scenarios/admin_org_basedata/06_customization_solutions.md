# admin_org_basedata · 定制方案（ISV 扩展真实模板）

> **场景**：组织基础资料 5 件套（5 个子实体）
> **生成时间**：2026-04-30

## CS-01 · 给子实体加 ISV 自定义字段

**适用**：`haos_adminorgtype`, `haos_adminorglayer`, `haos_adminorgfunction`, `haos_orgchangereason`, `haos_changescene`（任一子实体）
