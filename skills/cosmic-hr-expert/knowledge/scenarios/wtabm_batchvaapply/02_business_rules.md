...
## ✅ verified · 主表 `wtabm_batchvaapply` 共 60 个 opKey

### 🔥 核心 opKey 执行链（14 个有真链）
...
| 2 | `BatchBillTplOp` | enabled=True |
| 3 | `BatchBillUpdateAttFileOp` | enabled=True |
| 4 | `WTCBillChangeShowOp` | enabled=True |
| 5 | `WTCBillChangeStatusOp` | enabled=True |
| 6 | `BatchBillOperationCtrlOp` | enabled=True |
| 7 | `BatchVaApplySaveOp` | enabled=True |
| 8 | `BatchVaArchiveControlCheckOp` | enabled=True |
...
| 2 | `BatchBillTplOp` | enabled=True |
| 3 | `BatchBillUpdateAttFileOp` | enabled=True |
| 4 | `BatchBillOperationCtrlOp` | enabled=True |
| 5 | `WTCBillChangeShowOp` | enabled=True |
| 6 | `BatchVaApplySaveOp` | enabled=True |
| 7 | `BatchVaArchiveControlCheckOp` | enabled=True |
...
| 2 | `WTCBillChangeDeleteOp` | enabled=True |
| 3 | `BatchBillOperationCtrlOp` | enabled=True |
| 4 | `BatchVaDeleteCheckOp` | enabled=True |
...
| order | className | 角色 |
|:---:|---|---|
| 1 | `BatchBillTplOp` | enabled=True |
| 2 | `WTCBillChangeDeleteOp` | enabled=True |
| 3 | `BatchBillOperationCtrlOp` | enabled=True |
| 4 | `BatchVaArchiveControlCheckOp` | enabled=True |
...
| 3 | `BatchVaArchiveControlCheckOp` | enabled=True |
| 4 | `BatchVaApplyOp` | enabled=True |
...
|:---:|---|---|
| 1 | `BatchBillTplOp` | enabled=True |
| 2 | `BatchBillOperationCtrlOp` | enabled=True |
| 3 | `BatchVaApplyOp` | enabled=True |
...
|:---:|---|---|
| 1 | `BatchBillTplOp` | enabled=True |
| 2 | `WTCBillChangeWfAuditNoPassOp` | enabled=True |
| 3 | `BatchVaApplyOp` | enabled=True |
...
| 1 | `BatchBillTplOp` | enabled=True |
| 2 | `BatchBillOperationCtrlOp` | enabled=True |
| 3 | `BatchVaChangeOp` | enabled=True |
...
| 2 | `BatchVaArchiveControlCheckOp` | enabled=True |
...
- `wfauditing` · `viewflowchart` · `deleteentry` · `openchangehis` · `donothing` · `updater` · `addentry` · `modifyentry` · `modifyentrychange` · `uncancelentry`
