...
主表 `wtabm_batchvaapply` 标品接入 **30** 个插件。
...
- `WTCBaseBillControlPlugin` ← `kd.wtc.wtbs.formplugin.web.WTCBaseBillControlPlugin`
- `BatchBillTplEdit` ← `kd.wtc.wtbs.formplugin.web.batchbill.BatchBillTplEdit`
- `BatchVaApplyBillTplEdit` ← `kd.wtc.wtabm.formplugin.web.vaapply.batch.BatchVaApplyBillTplEdit`
- `BatchVaApplyBillEdit` ← `kd.wtc.wtabm.formplugin.web.vaapply.batch.BatchVaApplyBillEdit`
...
- `BatchBillTplList` ← `kd.wtc.wtbs.formplugin.web.batchbill.BatchBillTplList`
- `BatchVaApplyBillTplList` ← `kd.wtc.wtabm.formplugin.web.vaapply.batch.BatchVaApplyBillTplList`
...
- `BatchBillOperationCtrlOp` ← `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillOperationCtrlOp`
- `BatchVaDeleteCheckOp` ← `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaDeleteCheckOp`
- `CodeRuleOp` ← `kd.bos.business.plugin.CodeRuleOp`
- `BatchBillTplOp` ← `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillTplOp`
- `BatchBillUpdateAttFileOp` ← `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillUpdateAttFileOp`
- `WTCBillChangeShowOp` ← `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeShowOp`
- `BatchVaApplySaveOp` ← `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaApplySaveOp`
- `BatchVaArchiveControlCheckOp` ← `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaArchiveControlCheckOp`
- `BatchVaApplyOp` ← `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaApplyOp`
...
## ✅ verified · opKey 扩展切入点详解（14 个有执行链的 opKey）
...
- order **1**: `HRCodeRuleOp` · 重写 1 个方法：onAddValidators（注册校验器）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.HRCodeRuleOp`
- order **2**: `BatchBillTplOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillTplOp`
- order **3**: `BatchBillUpdateAttFileOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillUpdateAttFileOp`
- order **4**: `WTCBillChangeShowOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeShowOp`
- order **5**: `WTCBillChangeStatusOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeStatusOp`
- order **6**: `BatchBillOperationCtrlOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillOperationCtrlOp`
- order **7**: `BatchVaApplySaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaApplySaveOp`
- order **8**: `BatchVaArchiveControlCheckOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaArchiveControlCheckOp`
...
- order **3**: `BatchBillUpdateAttFileOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillUpdateAttFileOp`
- order **4**: `BatchBillOperationCtrlOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillOperationCtrlOp`
- order **5**: `WTCBillChangeShowOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeShowOp`
- order **6**: `BatchVaApplySaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaApplySaveOp`
- order **7**: `BatchVaArchiveControlCheckOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaArchiveControlCheckOp`
...
- order **3**: `BatchBillOperationCtrlOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillOperationCtrlOp`
- order **4**: `BatchVaDeleteCheckOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaDeleteCheckOp`
...
- order **1**: `BatchBillTplOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillTplOp`
- order **2**: `WTCBillChangeDeleteOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeDeleteOp`
- order **3**: `BatchBillOperationCtrlOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillOperationCtrlOp`
- order **4**: `BatchVaArchiveControlCheckOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaArchiveControlCheckOp`
...
- order **2**: `WTCBillChangeStatusOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeStatusOp`
- order **3**: `BatchVaArchiveControlCheckOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaArchiveControlCheckOp`
- order **4**: `BatchVaApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaApplyOp`
...
- order **1**: `BatchBillTplOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillTplOp`
- order **2**: `BatchBillOperationCtrlOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillOperationCtrlOp`
- order **3**: `BatchVaApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaApplyOp`
...
- order **1**: `BatchBillTplOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillTplOp`
- order **2**: `WTCBillChangeWfAuditNoPassOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeWfAuditNoPassOp`
- order **3**: `BatchVaApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaApplyOp`
...
- order **2**: `BatchBillOperationCtrlOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillOperationCtrlOp`
- order **3**: `BatchVaChangeOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaChangeOp`
...
- order **1**: `BatchBillTplOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.batchbill.BatchBillTplOp`
- order **2**: `BatchVaApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaApplyOp`
...
- order **1**: `WTCBillChangeStatusOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeStatusOp`
- order **2**: `BatchVaArchiveControlCheckOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtabm.opplugin.web.vaapply.batchbill.BatchVaArchiveControlCheckOp`
