...
**预期产出**：完整工程包（57 java + N datamodel + 工程文件 + 部署 SOP）。
...
详见 [`_assets/swc_bonus_new/deploy_sop.md`](../../_assets/swc_bonus_new/deploy_sop.md)
...
- 加审批工作流
- 接其他外部系统
- 详见 [`_assets/swc_bonus_new/customization_points.md`](../../_assets/swc_bonus_new/customization_points.md)
