...
**调用的 Service / Helper**（1 个）：`CtrlStrategyValidator`

**实现的生命周期方法**：`onAddValidators`(L19)

## 三、FormPlugin 类业务规则（UI 联动）

### `ListOrderCommonPlugin`
...
- 数据源：`_sdk_audit/_decompiled/scenarios/haos_adminorglayer/` 的 2 个反编译类 + `_shared/_standard_metadata/entity_metadata/haos_adminorglayer.md`
