...
主表 `haos_adminorglayer` 标品接入 **35** 个插件。
...
- `ListOrderCommonPlugin` ← `kd.hr.haos.formplugin.web.database.ListOrderCommonPlugin`
...
- `BaseDataBuOp` ← `kd.hr.haos.opplugin.web.BaseDataBuOp`
