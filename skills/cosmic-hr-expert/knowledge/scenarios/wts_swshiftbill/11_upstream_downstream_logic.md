...
> 本 form（`wts_swshiftbill`，所属 other）引用了其他云的 **6** 个底座实体：
...
### ⬆️ unknown（`unknown`）5 个引用

| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `fromattfilebo` | 调班人BO | BasedataField | `wtp_attfilebase` | — |
| `toattfilebo` | 对调人BO | BasedataField | `wtp_attfilebase` | — |
| `toattfilebase` | 对调人 | BasedataField | `wtp_attfilebase` | — |
| `attfile` | 调班员工 | BasedataField | `wtp_attfilebase` | — |
