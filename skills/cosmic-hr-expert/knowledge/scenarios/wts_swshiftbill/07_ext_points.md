...
主表 `wts_swshiftbill` 标品接入 **28** 个插件。
...
- `SwShiftBillEdit` ← `kd.wtc.wts.formplugin.web.swshift.SwShiftBillEdit`
...
- `SwShiftBillList` ← `kd.wtc.wts.formplugin.web.swshift.SwShiftBillList`
...
- `SwShiftBillOp` ← `kd.wtc.wts.opplugin.web.swshift.SwShiftBillOp`
...
- `WTCBillChangeStatusOp` ← `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeStatusOp`
...
## ✅ verified · opKey 扩展切入点详解（13 个有执行链的 opKey）
...
- order **4**: `SwShiftBillOp` · enabled=True
  - 完整 FQN: `kd.wtc.wts.opplugin.web.swshift.SwShiftBillOp`
...
- order **5**: `WTCBillOtherApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillOtherApplyOp`
- order **6**: `SwShiftBillOp` · enabled=True
  - 完整 FQN: `kd.wtc.wts.opplugin.web.swshift.SwShiftBillOp`
...
- order **3**: `WTCBillVerifyStatusOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillVerifyStatusOp`
- order **4**: `WTCBillOtherApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillOtherApplyOp`
- order **5**: `SwShiftBillOp` · enabled=True
  - 完整 FQN: `kd.wtc.wts.opplugin.web.swshift.SwShiftBillOp`
...
- order **2**: `SwShiftBillOp` · enabled=True
  - 完整 FQN: `kd.wtc.wts.opplugin.web.swshift.SwShiftBillOp`
...
### opKey `wfauditing` · 审批中

**执行链**（1 个 plugin 按 order 顺序跑）：

- order **1**: `SwShiftBillOp` · enabled=True
  - 完整 FQN: `kd.wtc.wts.opplugin.web.swshift.SwShiftBillOp`
