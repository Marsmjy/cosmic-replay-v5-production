...
- `SceneConfigPlugin` ← `kd.hr.brm.formplugin.web.SceneConfigPlugin`
...
- `SceneListPlugin` ← `kd.hr.brm.formplugin.web.SceneListPlugin`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.brm.formplugin.web.SceneConfigPlugin -->

## ISV 扩展指引（基于 SceneConfigPlugin 真实证）

> FQN: `kd.hr.brm.formplugin.web.SceneConfigPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.brm.formplugin.web.SceneConfigPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `afterLoadData`, `afterBindData`, `beforeDoOperation`, `registerListener`, `closedCallBack`
...
**CONTEXT_ACCESS** · OperateLogService L31
```java
  29           appLogInfo.setBizObjID(entityNum);
  30           appLogInfo.setBizAppID(appId);
  31 >         appLogInfo.setUserID(Long.valueOf(RequestContext.get().getCurrUserId()));
  32           service.addLog((AppLogInfo)appLogInfo);
  33       }
```
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.brm.formplugin.web.SceneConfigPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.brm.formplugin.web.SceneConfigPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.brm.formplugin.web.SceneListPlugin -->

## ISV 扩展指引（基于 SceneListPlugin 真实证）

> FQN: `kd.hr.brm.formplugin.web.SceneListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.brm.formplugin.web.SceneListPlugin/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.brm.formplugin.web.SceneListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.brm.formplugin.web.SceneListPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.brm.opplugin.web.SceneConfigOp -->

## ISV 扩展指引（基于 SceneConfigOp 真实证）

> FQN: `kd.hr.brm.opplugin.web.SceneConfigOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.brm.opplugin.web.SceneConfigOp/`
...
**QUERY_BUILDER** · SceneConfigOp L270
```java
 268           String simpleKey = RuleNamesTool.getSimpleKey((String)appNum, (String)sceneNum);
 269           HRBaseServiceHelper kbaseHelper = new HRBaseServiceHelper("brm_kbase");
 270 >         kbaseHelper.deleteByFilter(new QFilter[]{new QFilter("kbasekey", "=", (Object)simpleKey)});
 271       }
 272   }
```
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.brm.opplugin.web.SceneConfigOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.brm.opplugin.web.SceneConfigOp/extension_guide.md)
