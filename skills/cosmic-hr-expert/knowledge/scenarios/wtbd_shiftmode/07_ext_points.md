...
- `ShiftModeEdit` ← `kd.wtc.wtbd.fromplugin.web.shiftmode.ShiftModeEdit`
...
#### `HRBaseDataEnableOp` · OP_PLUGIN @ `OPERATION` · opKey=`submit`
...
- order **1**: `BaseDataDeletePlugin` · enabled=False
  - 完整 FQN: `kd.bos.form.plugin.bdctrl.BaseDataDeletePlugin`
- order **2**: `CodeRuleDeleteOp` · enabled=False
