...
| `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp` | `submit` | beforeExecuteOperationTransaction |
...
## ℹ️ 标品已接入插件（39 个 · 详见 07_ext_points.md）
