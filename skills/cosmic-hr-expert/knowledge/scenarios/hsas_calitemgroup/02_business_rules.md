...
### `hsas_calitemgroup`（4 条）

| ruleId | 类型 | preCondition | 描述 |
|---|---|---|---|
| `05RYBP74950S` | formRule | `datasource = "1"` | 数据来源控制是否允许修改结果 |
| `05RYBP744+R3` | formRule | `datasource = "1"` | 数据来源控制是否允许修改结果计算公式名称 |
| `0PAG=FMJ8401` | formRule | `datasource = "1" or datasource = "6"` | 数据来源控制是否允许修改带到下期次 |
| `1HW0HJR2GTWB` | formRule | `salaryitem.taxtag = "2" and datasource = "6"` | 个税标签=个税结果项目 数据来源不能修改 |
