...
## ✅ verified · 主表 `wtp_vachangeset` 共 69 个 opKey
...
| 10 | `VacationChangeSetSaveOp` | enabled=True |
...
| 5 | `HRBaseDataLogOp` | HR 基础资料操作日志 |
| 6 | `VacationChangeSetSaveOp` | enabled=True |
...
| 3 | `VacationChangeSetSaveOp` | enabled=True |
...
- `showallversion` · `addentry` · `deleteentry` · `moveentryup` · `moveentrydown` · `donothing_edit` · `donothing_manage` · `tblassign_searchorg` · `tblunassign_search` · `tblassign_search` · `btn_bd_unassign`
