...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin -->

## ISV 扩展指引（基于 FormulaFuncTreePlugin 真实证）

> FQN: `kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.bos.form.plugin.AbstractFormPlugin`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`
...
**QUERY_BUILDER** · FormulaUtils L447
```java
 445       public static List<HRBaseServiceHelper> getFormulaTplAllChildMetaServiceHelper() {
 446           HRBaseServiceHelper metaHelper = new HRBaseServiceHelper("bos_formmeta");
 447 >         QFilter numberFilter = new QFilter("number", "=", (Object)"hbp_formulatpl");
 448           DynamicObject parentMeta = metaHelper.queryOne(new QFilter[]{numberFilter});
 449           String parentId = parentMeta.getString("id");
```
...
**THROW_BIZ_EXCEPTION** · FormulaUtils L223
```java
 221                       return true;
 222                   }
 223 >                 throw new KDBizException(MessageFormat.format(ResManager.loadKDString((String)"\u7b2c{0}\u884c\uff0c\u7b2c{1}\u5217\uff0c\u201c{2}\u201d\u4f5c\u4e3a\u6570\u7ec4\u7d22\u5f15\uff0c\u5fc5\u987b\u5b9a\u4e49\u4e3a\u6574\u6570\u3002", (String)"FormulaUtils_0", (String)"hrmp-hbp-business", (Object[])new Object[0]), node.getLineIndex() + 1, node.getStartColumnIndex() + 1, node.getNodeText()));
 224               }
 225           }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hbp.formplugin.web.formula.FormulaItemTreePlugin -->

## ISV 扩展指引（基于 FormulaItemTreePlugin 真实证）

> FQN: `kd.hr.hbp.formplugin.web.formula.FormulaItemTreePlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.formula.FormulaItemTreePlugin/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.formula.FormulaItemTreePlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.formula.FormulaItemTreePlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hbp.opplugin.web.formula.FormulaSettingOp -->

## ISV 扩展指引（基于 FormulaSettingOp 真实证）

> FQN: `kd.hr.hbp.opplugin.web.formula.FormulaSettingOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.formula.FormulaSettingOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.formula.FormulaSettingOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.formula.FormulaSettingOp/extension_guide.md)
