# hbss_capability · 定制方案（ISV 扩展真实模板）
...
**适用**：`hbss_capacitygroup`, `hbss_capacityitem`, `hbss_capacityaction`, `hbss_capacityrankscheme`, `hbss_passessnode`, `hbss_rewpnmlevel` ...（任一子实体）
