# 定制化方案集 · wtte_attperiodtotallist
...
- `AttPeriodTotalListRFPlugin` ← `kd.wtc.wtte.formplugin.web.accountinfo.AttPeriodTotalListRFPlugin`
