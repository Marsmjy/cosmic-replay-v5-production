# 业务规则全图 · wtte_attperiodtotallist
...
## ✅ verified · 主表 `wtte_attperiodtotallist` 共 15 个 opKey

### 其他 opKey（15 个无独立规则·复用主链或反编译为空）

- `reportquery` · `refresh` · `close` · `syncexportexcel` · `exportexcel` · `exportreport` · `frozenbypersonbutton` · `evaselect` · `evaall` · `notevaperson` · `notevabill` · `dailyrecord`
- `viewrecordsum` · `viewdetails` · `displayscheme`
