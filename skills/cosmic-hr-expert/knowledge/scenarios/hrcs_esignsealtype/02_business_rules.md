# hrcs_esignsealtype · 业务规则

> **form**：`hrcs_esignsealtype` · 印章类型
> **生成时间**：2026-04-29
...
- 数据源：`_sdk_audit/_decompiled/scenarios/hrcs_esignsealtype/` 的 0 个反编译类 + `_shared/_standard_metadata/entity_metadata/hrcs_esignsealtype.md`
