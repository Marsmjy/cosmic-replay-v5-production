...
|---|---|---|---|
| `number` | 编码 | `TextField` | — |
| `cyclemode` | 模式 | `ComboField` | — |
| `datetype` | 日期类型 | `ComboField` | — |
...
- 数据源：`_sdk_audit/_decompiled/scenarios/working_time/` 的 0 个反编译类 + `_shared/_standard_metadata/entity_metadata/working_time.md`