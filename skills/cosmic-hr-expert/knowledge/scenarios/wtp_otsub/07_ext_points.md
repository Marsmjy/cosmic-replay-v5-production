...
- `OtSubOp` ← `kd.wtc.wtp.opplugin.web.overtime.OtSubOp`
...
- order **4**: `HRBaseDataStatusOp` · HR 基础资料单据状态（draft/audit/disable）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp`
- order **5**: `OtSubOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.overtime.OtSubOp`
