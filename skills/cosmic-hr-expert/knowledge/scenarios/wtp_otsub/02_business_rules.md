...
## ✅ verified · 主表 `wtp_otsub` 共 74 个 opKey
...
- `showallversion` · `newentry` · `deleteentry` · `deleteentry_priority` · `moveentryup_priority` · `moveentrydown_priority` · `deleteentry_priority_d` · `moveentryup_priority_d` · `moveentrydownpriority_d` · `donothing_manage` · `moveentryup` · `moveentrydown`
