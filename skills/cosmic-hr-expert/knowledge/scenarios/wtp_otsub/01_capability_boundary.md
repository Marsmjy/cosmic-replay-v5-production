...
- `disable` · 禁用
- `deleteentry` · 删行
- `deleteentry_priority` · 删除分录
- `deleteentry_priority_d` · 删除
- `deleteentry_deduct` · 删行
...
- `mobtoolbarselect` · 选择
- `mobtoolbarcancel` · 取消
- ...（共 29 个，参见 `_auto_operations.md`）

## ✅ verified · 标品插件链

- 主表 `wtp_otsub`：**51** 个标品插件接入
- 字段总数：**43** 个（实抓自 OpenAPI listMeta）
