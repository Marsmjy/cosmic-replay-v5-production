# 扩展点全图 · homs_position_chartstyle
...
主表 `homs_position_chartstyle` 标品接入 **21** 个插件。
...
- `OrgChartStyleEditPlugin` ← `kd.hr.homs.formplugin.web.orgchart.OrgChartStyleEditPlugin`
...
- `OrgChartStyleListPlugin` ← `kd.hr.homs.formplugin.web.orgchart.OrgChartStyleListPlugin`
- `ChartStyleFilterListPlugin` ← `kd.hr.homs.formplugin.web.orgchart.ChartStyleFilterListPlugin`
- `PositionChartStyleListPlugin` ← `kd.hr.homs.formplugin.web.orgchart.PositionChartStyleListPlugin`
...
- `OrgChartStyleSaveOp` ← `kd.hr.homs.opplugin.web.orgchart.OrgChartStyleSaveOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.formplugin.web.orgchart.OrgChartStyleEditPlugin -->

## ISV 扩展指引（基于 OrgChartStyleEditPlugin 真实证）

> FQN: `kd.hr.homs.formplugin.web.orgchart.OrgChartStyleEditPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.OrgChartStyleEditPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `preOpenForm`, `propertyChanged`, `beforeDoOperation`, `afterDoOperation`, `beforeBindData`, `afterBindData`, `afterCreateNewData`, `registerListener`, `beforeF7Select`, `closedCallBack`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.OrgChartStyleEditPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.OrgChartStyleEditPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.formplugin.web.orgchart.OrgChartStyleListPlugin -->

## ISV 扩展指引（基于 OrgChartStyleListPlugin 真实证）

> FQN: `kd.hr.homs.formplugin.web.orgchart.OrgChartStyleListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.OrgChartStyleListPlugin/`
...
**CONTEXT_ACCESS** · OrgChartStyleListPlugin L78
```java
  76   
  77       private AuthorizedOrgResult getAuthorizedOrgResult() {
  78 >         Long userId = Long.parseLong(RequestContext.get().getUserId());
  79           String permEntityId = "haos_adminorgdetail";
  80           String permItemId = "47150e89000000ac";
```

**QUERY_BUILDER** · HRPermUtil L104
```java
 102   
 103       public static void setAdminOrgF7CustomPermList(BeforeFilterF7SelectEvent arg, Collection<Long> adminOrgs) {
 104 >         arg.addCustomQFilter(new QFilter("id", "in", adminOrgs));
 105       }
 106   
```

**READ_VIA_HELPER** · OrgChartStyleListPlugin L70
```java
  68           filters.add(new QFilter("id", "!=", (Object)VIRTUAL_ORG_CHART_TYPE_ID));
  69           QFilter cardIdFilter = new QFilter("cardstyleflag", "in", Arrays.asList("1", "2"));
  70 >         DynamicObject[] query = OrgChartNewServiceHelper.getCardStyleNewHelper().query("id", new QFilter[]{cardIdFilter});
  71           List idList = Arrays.stream(query).map(dyn -> dyn.getLong("id")).collect(Collectors.toList());
  72           if (!idList.isEmpty()) {
```
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.OrgChartStyleListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.OrgChartStyleListPlugin/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.formplugin.web.orgchart.OrgChartStyleListPlugin -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.formplugin.web.orgchart.PositionChartStyleListPlugin -->

## ISV 扩展指引（基于 PositionChartStyleListPlugin 真实证）

> FQN: `kd.hr.homs.formplugin.web.orgchart.PositionChartStyleListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.PositionChartStyleListPlugin/`
...
**QUERY_BUILDER** · PositionChartStyleListPlugin L28
```java
  26               itQfiters.remove();
  27           }
  28 >         QFilter carddimensionidFilter = new QFilter("carddimensionid", "=", (Object)Long.parseLong("1110"));
  29           qFilters.add(carddimensionidFilter);
  30       }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.PositionChartStyleListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.PositionChartStyleListPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.opplugin.web.orgchart.OrgChartStyleSaveOp -->

## ISV 扩展指引（基于 OrgChartStyleSaveOp 真实证）

> FQN: `kd.hr.homs.opplugin.web.orgchart.OrgChartStyleSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgchart.OrgChartStyleSaveOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgchart.OrgChartStyleSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgchart.OrgChartStyleSaveOp/extension_guide.md)
