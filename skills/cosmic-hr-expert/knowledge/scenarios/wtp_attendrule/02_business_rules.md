...
## ✅ verified · 主表 `wtp_attendrule` 共 67 个 opKey
...
- `showallversion` · `donothing` · `newentry` · `deleteentry` · `moveentryup` · `moveentrydown` · `addrow` · `copyrow` · `editrow`
