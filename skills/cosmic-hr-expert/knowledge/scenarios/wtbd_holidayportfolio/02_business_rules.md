...
## ✅ verified · 主表 `wtbd_holidayportfolio` 共 51 个 opKey
...
| 10 | `HpOp` | enabled=True |
| 11 | `HpInfoCalculateOp` | enabled=True |
...
| 9 | `HpOp` | enabled=True |
| 10 | `HpInfoCalculateOp` | enabled=True |
...
| 6 | `HpInfoCalculateOp` | enabled=True |
...
| 4 | `HpInfoCalculateOp` | enabled=True |
...
| 3 | `HpInfoCalculateOp` | enabled=True |
| 4 | `HpOp` | enabled=True |
...
- `newentry` · `addholiday` · `deleteentry` · `donothing` · `edit`
