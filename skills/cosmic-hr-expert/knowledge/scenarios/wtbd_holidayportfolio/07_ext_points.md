...
主表 `wtbd_holidayportfolio` 标品接入 **52** 个插件。
...
- `HpOp` ← `kd.wtc.wtbd.opplugin.web.hp.HpOp`
- `HpInfoCalculateOp` ← `kd.wtc.wtbd.opplugin.web.hp.HpInfoCalculateOp`
...
- order **9**: `HisModelOPCommonPlugin` · 时态模型通用 · his_bsed/his_bsled/effectdate 的维护
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin`
- order **10**: `HpOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.hp.HpOp`
...
- order **8**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **9**: `HpOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.hp.HpOp`
- order **10**: `HpInfoCalculateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.hp.HpInfoCalculateOp`
...
- order **5**: `HisModelOPCommonPlugin` · 时态模型通用 · his_bsed/his_bsled/effectdate 的维护
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin`
- order **6**: `HpInfoCalculateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.hp.HpInfoCalculateOp`
...
- order **3**: `HisModelOPCommonPlugin` · 时态模型通用 · his_bsed/his_bsled/effectdate 的维护
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin`
- order **4**: `HpInfoCalculateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.hp.HpInfoCalculateOp`
...
- order **2**: `HisUniqueValidateOp` · 时态模型唯一性校验（同一 boid 同一时间段唯一）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisUniqueValidateOp`
- order **3**: `HpInfoCalculateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.hp.HpInfoCalculateOp`
- order **4**: `HpOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.hp.HpOp`
