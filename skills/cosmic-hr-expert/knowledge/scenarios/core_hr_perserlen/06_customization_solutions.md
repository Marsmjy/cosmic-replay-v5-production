# core_hr_perserlen · 定制方案（ISV 扩展真实模板）
...
在开发平台给本 form（`hrpi_perserlen`）加 ISV 字段：
...
```java
@SdkPlugin
public class MyPerserlenAfterOp extends HRDataBaseOp {
    @Override
...
```java
@SdkPlugin
public class MyPerserlenIsvFormPlugin extends HRDataBaseEdit {
    @Override
