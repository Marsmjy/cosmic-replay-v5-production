...
主表 `hrcs_promptlist` 标品接入 **4** 个插件。

### ListPlugin（1）
- `PromptListPlugin` ← `kd.hr.hrcs.formplugin.web.prompt.PromptListPlugin`

### OpPlugin（3）
- `CodeRuleOp` ← `kd.bos.business.plugin.CodeRuleOp`
- `PromptSaveOp` ← `kd.hr.hbss.opplugin.web.PromptSaveOp`
