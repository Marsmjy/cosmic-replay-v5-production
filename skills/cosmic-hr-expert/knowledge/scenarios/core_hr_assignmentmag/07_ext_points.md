...
主表 `hrpi_assignmentmag` 标品接入 **20** 个插件。
...
- `AssignmentMagSaveOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.AssignmentMagSaveOp`
...
- `AssignmentMagDeleteOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.AssignmentMagDeleteOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.AssignmentMagSaveOp -->

## ISV 扩展指引（基于 AssignmentMagSaveOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.assignment.attach.AssignmentMagSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.AssignmentMagSaveOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.AssignmentMagSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.AssignmentMagSaveOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.AssignmentMagDeleteOp -->

## ISV 扩展指引（基于 AssignmentMagDeleteOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.assignment.attach.AssignmentMagDeleteOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.AssignmentMagDeleteOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.AssignmentMagDeleteOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.AssignmentMagDeleteOp/extension_guide.md)
