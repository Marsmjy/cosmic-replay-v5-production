...
## ✅ verified · 主表 `wtp_accountplan` 共 71 个 opKey
...
#### `submitandaudit` · 提交并生效（opType=save）
...
- `showallversion` · `newentry` · `deleteentry` · `newentry1` · `deleteentry1` · `savedata` · `submitdata` · `saveauditdata` · `donothing_manage` · `queryhighprop` · `edithighprop` · `savedatanew`
