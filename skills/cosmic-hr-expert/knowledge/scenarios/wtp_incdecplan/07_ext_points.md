...
- `IncrDecrPlanOp` ← `kd.wtc.wtp.opplugin.web.incrdecrrules.IncrDecrPlanOp`
...
- order **4**: `HRBaseDataStatusOp` · HR 基础资料单据状态（draft/audit/disable）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp`
- order **5**: `IncrDecrPlanOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.incrdecrrules.IncrDecrPlanOp`
...
- order **7**: `HisUniqueValidateOp` · 时态模型唯一性校验（同一 boid 同一时间段唯一）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisUniqueValidateOp`
- order **8**: `IncrDecrPlanOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.incrdecrrules.IncrDecrPlanOp`
- order **9**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
...
- order **3**: `RuleEngingSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.ruleenging.RuleEngingSaveOp`
- order **4**: `IncrDecrPlanOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.incrdecrrules.IncrDecrPlanOp`
