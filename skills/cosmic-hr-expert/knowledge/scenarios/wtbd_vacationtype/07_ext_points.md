...
主表 `wtbd_vacationtype` 标品接入 **38** 个插件。
...
- `VacationTypeEdit` ← `kd.wtc.wtbd.fromplugin.web.basedata.VacationTypeEdit`
...
- ...（共 21，详见 `_auto_plugin_registry.md`）
...
- `VacationTypeList` ← `kd.wtc.wtbd.fromplugin.web.basedata.VacationTypeList`
