...
## ✅ verified · 主表 `wtpm_multicard` 共 6 个 opKey
...
| order | className | 角色 |
|:---:|---|---|
| 1 | `MulticardSaveOp` | enabled=True |
...
### 其他 opKey（5 个无独立规则·复用主链或反编译为空）

- `export_from_list_hr` · `show_export_record_hr` · `update` · `exportlistbyselectfields` · `exportdetails`
