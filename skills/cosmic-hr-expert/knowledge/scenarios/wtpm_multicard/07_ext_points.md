...
- `ValidCardListTipsPlugin` ← `kd.wtc.wtpm.formplugin.cardmatch.ValidCardListTipsPlugin`

### ListPlugin（2）
- `HRCertCheckList` ← `kd.hr.hbp.formplugin.web.cert.HRCertCheckList`
- `MultiCardList` ← `kd.wtc.wtpm.formplugin.cardmatch.MultiCardList`

### OpPlugin（1）
- `MulticardSaveOp` ← `kd.wtc.wtpm.opplugin.web.multicard.MulticardSaveOp`
...
- order **1**: `MulticardSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.multicard.MulticardSaveOp`
