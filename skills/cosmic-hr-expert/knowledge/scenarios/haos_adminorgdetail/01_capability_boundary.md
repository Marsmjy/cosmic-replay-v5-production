...
- `showchargeperson` · showchargeperson
- ...（共 12 个，参见 `_auto_operations.md`）

### 历史版本（7 个 opKey）
- `namehistory` · namehistory
- `hisversioninfo` · hisversioninfo
- `hiscopy` · hiscopy
...
- 主表 `haos_adminorgdetail`：**41** 个标品插件接入
- 字段总数：**85** 个（实抓自 OpenAPI listMeta）
