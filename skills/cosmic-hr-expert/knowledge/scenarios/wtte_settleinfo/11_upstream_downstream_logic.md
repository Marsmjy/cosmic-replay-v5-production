...
> 本 form（`wtte_settleinfo`，所属 other）引用了其他云的 **4** 个底座实体：
...
| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `attfile` | 考勤档案版本 | BasedataField | `wtp_attfilebase` | — |
| `attperiod` | 考勤期间 | BasedataField | `wtp_attperiodentry` | — |
| `attperattperiodpk` | 人员考勤期间 | BasedataField | `wtp_perattperiod` | — |
