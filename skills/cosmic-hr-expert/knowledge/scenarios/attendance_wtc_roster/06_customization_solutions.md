...
**预期产出**：完整工程包（11 java + N datamodel + 工程文件 + 部署 SOP）。
...
详见 [`_assets/wtc_roster/deploy_sop.md`](../../_assets/wtc_roster/deploy_sop.md)
...
- 加审批工作流
- 接其他外部系统
- 详见 [`_assets/wtc_roster/customization_points.md`](../../_assets/wtc_roster/customization_points.md)
