...
> 本 form（`hrpi_empsuprel`，所属 核心人力云）引用了其他云的 **1** 个底座实体：

### ⬆️ 组织发展云（`org_dev`）1 个引用

| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `reporttype` | 汇报关系类型 | BasedataField | `hbpm_reportcoreltype` | [hbpm_reportcoreltype](../hbpm_reportcoreltype/) |
