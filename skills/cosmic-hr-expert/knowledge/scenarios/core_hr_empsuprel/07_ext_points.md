...
- `EmpSupRelSaveOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelSaveOp`
...
- `EmpSupRelExpireOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelExpireOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelSaveOp -->

## ISV 扩展指引（基于 EmpSupRelSaveOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelSaveOp/`
...
**CALL_CROSS_SERVICE** · HRPIOrgServiceImpl L31
```java
  29       public Map<String, Map<String, Object>> adminOrgStructQuery(List<Long> orgIds, Date queryDate) {
  30           try {
  31 >             return (Map)HRMServiceHelper.invokeHRMPService((String)"haos", (String)"IHAOSBatchAdminOrgInfoQueryService", (String)"queryOrgStructToMap", (Object[])new Object[]{orgIds, queryDate, Boolean.FALSE});
  32           }
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelSaveOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelExpireOp -->

## ISV 扩展指引（基于 EmpSupRelExpireOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelExpireOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelExpireOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelExpireOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelExpireOp/extension_guide.md)
