...
| `probation` | 试用期长度 | `IntegerField` | — |
| `probationunit` | 试用期单位 | `ComboField` | — |
| `preenddate` | 预计转正日期 | `DateField` | — |
| `trialstartdate` | 试用开始日期 | `DateField` | — |
...
- 数据源：`_sdk_audit/_decompiled/scenarios/core_hr_trialperiod/` 的 12 个反编译类 + `_shared/_standard_metadata/entity_metadata/hrpi_trialperiod.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrpi.opplugin.web.assignment.attach.TrialPeriodSaveOp -->

## chgaction 实证补充（TrialPeriodSaveOp 跨类追踪聚合）
