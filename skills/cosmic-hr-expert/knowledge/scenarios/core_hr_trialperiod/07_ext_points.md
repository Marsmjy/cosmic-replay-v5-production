...
主表 `hrpi_trialperiod` 标品接入 **18** 个插件。
...
- `TrialPeriodSaveOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.TrialPeriodSaveOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.TrialPeriodSaveOp -->

## ISV 扩展指引（基于 TrialPeriodSaveOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.assignment.attach.TrialPeriodSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.TrialPeriodSaveOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.TrialPeriodSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.TrialPeriodSaveOp/extension_guide.md)
