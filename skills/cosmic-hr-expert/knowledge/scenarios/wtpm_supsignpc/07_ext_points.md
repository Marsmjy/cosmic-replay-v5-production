...
- `SupSignOtherEdit` ← `kd.wtc.wtpm.formplugin.suppleapply.SupSignOtherEdit`
...
- `SupSignList` ← `kd.wtc.wtpm.formplugin.suppleapply.SupSignList`
...
- `SupSignSaveOp` ← `kd.wtc.wtpm.opplugin.web.suppleapply.bill.SupSignSaveOp`
- `WTCBillUpdateAttfileOp` ← `kd.wtc.wtbs.opplugin.web.bill.WTCBillUpdateAttfileOp`
- `ApplyMustInputCheckOp` ← `kd.wtc.wtpm.opplugin.web.suppleapply.bill.ApplyMustInputCheckOp`
- `WTCBillReplenishOriginalOp` ← `kd.wtc.wtbs.opplugin.web.bill.WTCBillReplenishOriginalOp`
- ...（共 23，详见 `_auto_plugin_registry.md`）
...
- order **4**: `WTCBillUpdateAttfileOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillUpdateAttfileOp`
- order **5**: `WTCBillOtherApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillOtherApplyOp`
- order **6**: `ApplyMustInputCheckOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.ApplyMustInputCheckOp`
- order **7**: `SupSignSubmitEffectOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.SupSignSubmitEffectOp`
...
- order **3**: `BillTplOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.BillTplOp`
- order **4**: `SupSignSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.SupSignSaveOp`
- order **5**: `WTCBillUpdateAttfileOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillUpdateAttfileOp`
- order **6**: `WTCBillOtherApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillOtherApplyOp`
- order **7**: `ApplyMustInputCheckOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.ApplyMustInputCheckOp`
- order **8**: `WTCBillReplenishOriginalOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillReplenishOriginalOp`
...
- order **3**: `BillTplOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.BillTplOp`
- order **4**: `ApplyMustInputCheckOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.ApplyMustInputCheckOp`
- order **5**: `SupSignSubmitOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.SupSignSubmitOp`
- order **6**: `WTCBillOtherApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillOtherApplyOp`
...
- order **4**: `WTCBillVerifyStatusOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillVerifyStatusOp`
- order **5**: `SupSignDiscardOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.SupSignDiscardOp`
- order **6**: `WTCBillChangeDeleteOp` · enabled=True
...
- order **1**: `WTCBillAttFileOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillAttFileOp`
- order **2**: `SupSignUnSubmitOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.SupSignUnSubmitOp`
...
- order **1**: `WTCBillChangeStatusOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeStatusOp`
- order **2**: `SupSignArchiveControlValidateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.SupSignArchiveControlValidateOp`
- order **3**: `SupSignAuditOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.SupSignAuditOp`
...
- order **1**: `SupSignArchiveControlValidateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.SupSignArchiveControlValidateOp`
- order **2**: `SupSignAuditOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.SupSignAuditOp`
...
- order **1**: `SupSignRejectToSubmitOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.SupSignRejectToSubmitOp`
...
- order **1**: `SupSignAuditNotPassOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtpm.opplugin.web.suppleapply.bill.SupSignAuditNotPassOp`
