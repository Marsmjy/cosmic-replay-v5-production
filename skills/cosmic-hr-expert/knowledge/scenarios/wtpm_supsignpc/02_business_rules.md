...
## ✅ verified · 主表 `wtpm_supsignpc` 共 57 个 opKey
...
| 7 | `SupSignSubmitEffectOp` | enabled=True |
...
| 5 | `SupSignSubmitOp` | enabled=True |
| 6 | `WTCBillOtherApplyOp` | enabled=True |
...
| 2 | `SupSignUnSubmitOp` | enabled=True |
...
- `wfauditing` · `wfauditpass` · `viewflowchart` · `unaudit` · `deleteentry` · `newentry` · `cus_delete` · `viewchangehis` · `returnlist`
