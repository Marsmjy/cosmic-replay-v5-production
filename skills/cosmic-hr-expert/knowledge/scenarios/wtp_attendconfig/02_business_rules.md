...
## ✅ verified · 主表 `wtp_attendconfig` 共 65 个 opKey
...
| 10 | `AttendConfigConditionOp` | enabled=True |
...
| 9 | `AttendConfigConditionOp` | enabled=True |
...
- `showallversion` · `newentry` · `deleteentry` · `moveentryup` · `moveentrydown` · `addentry` · `donothing`
