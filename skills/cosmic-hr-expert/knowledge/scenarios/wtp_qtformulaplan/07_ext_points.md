...
主表 `wtp_qtformulaplan` 标品接入 **54** 个插件。
...
- ...（共 27，详见 `_auto_plugin_registry.md`）
...
- `FormulaPlanSaveOp` ← `kd.wtc.wtp.opplugin.web.formula.FormulaPlanSaveOp`
- `RuleEngingSaveOp` ← `kd.wtc.wtp.opplugin.web.ruleenging.RuleEngingSaveOp`
...
- order **9**: `HisModelOPCommonPlugin` · 时态模型通用 · his_bsed/his_bsled/effectdate 的维护
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin`
- order **10**: `FormulaPlanSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.formula.FormulaPlanSaveOp`
...
- order **8**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **9**: `FormulaPlanSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.formula.FormulaPlanSaveOp`
- order **10**: `RuleEngingSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.ruleenging.RuleEngingSaveOp`
...
- order **3**: `HisModelOPCommonPlugin` · 时态模型通用 · his_bsed/his_bsled/effectdate 的维护
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin`
- order **4**: `RuleEngingSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.ruleenging.RuleEngingSaveOp`
- order **5**: `FormulaPlanSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.formula.FormulaPlanSaveOp`
...
- order **2**: `HisUniqueValidateOp` · 时态模型唯一性校验（同一 boid 同一时间段唯一）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisUniqueValidateOp`
- order **3**: `FormulaPlanSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.formula.FormulaPlanSaveOp`
- order **4**: `RuleEngingSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.ruleenging.RuleEngingSaveOp`
...
- order **2**: `HisModelOPCommonPlugin` · 时态模型通用 · his_bsed/his_bsled/effectdate 的维护
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin`
- order **3**: `RuleEngingSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.ruleenging.RuleEngingSaveOp`
