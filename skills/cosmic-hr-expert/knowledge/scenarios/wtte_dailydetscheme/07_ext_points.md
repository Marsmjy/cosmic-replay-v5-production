...
主表 `wtte_dailydetscheme` 标品接入 **42** 个插件。
...
- `DisplaySchemeEdit` ← `kd.wtc.wtte.formplugin.web.fieldscheme.DisplaySchemeEdit`
- `PerSumDisplayEdit` ← `kd.wtc.wtte.formplugin.web.fieldscheme.PerSumDisplayEdit`
...
- `DisplaySchemeSaveOp` ← `kd.wtc.wtte.opplugin.web.fieldscheme.DisplaySchemeSaveOp`
...
- order **6**: `HRBaseDataEnableOp` · HR 基础资料启用态管理 · 控制 enable 字段
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp`
- order **7**: `DisplaySchemeSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.fieldscheme.DisplaySchemeSaveOp`
...
- order **4**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **5**: `DisplaySchemeSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.fieldscheme.DisplaySchemeSaveOp`
- order **6**: `HRBaseDataEnableOp` · HR 基础资料启用态管理 · 控制 enable 字段
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp`
