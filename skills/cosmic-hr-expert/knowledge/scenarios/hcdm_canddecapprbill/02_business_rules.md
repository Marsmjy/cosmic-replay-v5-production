...
### `hcdm_canddecapprbill`（6 条）

| ruleId | 类型 | preCondition | 描述 |
|---|---|---|---|
| `58DY3VWJGFQB` | formRule | `JUDGE_STR_NULL( TRIM(matchtype) )` | 匹配类型为空 |
| `508VD6J4X8RY` | formRule | `isusesalaryrank and NOT JUDGE_STR_NULL( TRIM(matchtype) )` | 是否启用薪档 |
| `508VD6J4X82O` | formRule | `NOT isusesalaryrank` | 不启用薪档 |
| `508VD6J4X8RZ` | formRule | `excesscontrol = '1' and overstandardtype <> '2'` | 不允许超标准显示 |
| `508VD6J4X82P` | formRule | `excesscontrol = '0' and overstandardtype <> '2'` | 允许超标准显示 |
| `51L+M8N7612I` | formRule | `overstandardtype = '2'` | 区间范围 |
