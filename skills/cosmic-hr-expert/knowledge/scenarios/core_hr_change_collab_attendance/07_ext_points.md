...
本场景含 1 个标品订阅类 + 1 个调度作业锚点：

- `kd.wtc.wtp.business.newcoordination.WtcEmployeeCoordEventServicePlugin` (extends kd.hr.hbp.business.coordination.impl.AbstractEmployeeCoordSubService)
  - 派单 → `wtp_WtcEmployeeCoordTask_SKDJ_S`
- `kd.wtc.wtp.business.newcoordination.WtcEmployeeCoordEventServicePlugin` (extends kd.hr.hbp.business.coordination.impl.AbstractEmployeeCoordSubService)
  - 派单 → `wtp_WtcEmployeeCoordTask_SKDJ_S`
