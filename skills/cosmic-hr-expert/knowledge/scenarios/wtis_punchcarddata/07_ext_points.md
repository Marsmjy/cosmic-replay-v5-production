...
主表 `wtis_punchcarddata` 标品接入 **10** 个插件。
...
- `PunchCardDataList` ← `kd.wtc.wtis.fromplugin.web.punchcarddata.PunchCardDataList`

### OpPlugin（3）
- `PunchCardDataOp` ← `kd.wtc.wtis.opplugin.punchcarddata.PunchCardDataOp`
- `PunchCardDataSyncOp` ← `kd.wtc.wtis.opplugin.punchcarddata.PunchCardDataSyncOp`
- `PunchCardAutoSynOp` ← `kd.wtc.wtis.opplugin.punchcarddata.PunchCardAutoSynOp`
...
## ✅ verified · opKey 扩展切入点详解（3 个有执行链的 opKey）
...
- order **1**: `PunchCardDataOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtis.opplugin.punchcarddata.PunchCardDataOp`
...
### opKey `manualsyn` · 手动同步

**执行链**（1 个 plugin 按 order 顺序跑）：

- order **1**: `PunchCardDataSyncOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtis.opplugin.punchcarddata.PunchCardDataSyncOp`
...
### opKey `autosysn` · 同步原始卡

**执行链**（1 个 plugin 按 order 顺序跑）：

- order **1**: `PunchCardAutoSynOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtis.opplugin.punchcarddata.PunchCardAutoSynOp`
