...
## ✅ verified · 主表 `wtbd_retrievalgroup` 共 38 个 opKey
...
| 10 | `RetrievalGroupOp` | enabled=True |
...
| 6 | `HRBaseDataLogOp` | HR 基础资料操作日志 |
| 7 | `RetrievalGroupOp` | enabled=True |
...
- `tbl_assign_import` · `logview` · `viewonelog`
