...
主表 `wtbd_retrievalgroup` 标品接入 **47** 个插件。
...
- `RetrievalGroupEdit` ← `kd.wtc.wtbd.fromplugin.web.retrieval.RetrievalGroupEdit`
- `TemplateTreePlugin` ← `kd.bos.form.plugin.TemplateTreePlugin`
- ...（共 24，详见 `_auto_plugin_registry.md`）
...
- `RetrievalGroupList` ← `kd.wtc.wtbd.fromplugin.web.retrieval.RetrievalGroupList`
...
- `RetrievalGroupOp` ← `kd.wtc.wtbd.opplugin.web.retrieval.RetrievalGroupOp`
...
- order **9**: `HRBaseDataEnableOp` · HR 基础资料启用态管理 · 控制 enable 字段
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp`
- order **10**: `RetrievalGroupOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.retrieval.RetrievalGroupOp`
...
- order **6**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **7**: `RetrievalGroupOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.retrieval.RetrievalGroupOp`
