...
### Case 4：扩展 `HRCodeRuleOp` (opKey=`saveofsubmiteffect`)

**业务背景**：标品 `HRCodeRuleOp` 处理 `saveofsubmiteffect` 操作 · ISV 想加自定义校验/写表/通知
...
4. 单测：触发 opKey `saveofsubmiteffect` · 验证 ISV 逻辑 + super 行为都跑
