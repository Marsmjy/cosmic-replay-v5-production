...
## ✅ verified · 主表 `wtp_incdecrules` 共 72 个 opKey
...
- `showallversion` · `addentry` · `deleteentryforrs` · `moveentryupforrs` · `moveentrydownforrs` · `donothing_edit` · `daydetailnewentry` · `daydetaildeleteentry` · `periodnewentry` · `perioddeleteentry` · `daymoveentryup` · `daymoveentrydown`
