# core_hr_employee_resume · 定制方案（ISV 扩展真实模板）

> **场景**：员工履历聚合（教育/工作/技能/职称/培训/导师等 12 实体）（12 个子实体）
> **生成时间**：2026-04-30

## CS-01 · 给子实体加 ISV 自定义字段

**适用**：`hrpi_pereduexp`, `hrpi_preworkexp`, `hrpi_empproexp`, `hrpi_perlgability`, `hrpi_perocpqual`, `hrpi_perpractqual` ...（任一子实体）
