# org_dev_adminorgbill_extension · 推荐定制方案
...
**预期产出**：完整工程包（5 java + N datamodel + 工程文件 + 部署 SOP）。
...
详见 [`_assets/adminorgbill_extension/deploy_sop.md`](../../_assets/adminorgbill_extension/deploy_sop.md)
...
- 加审批工作流
- 接其他外部系统
- 详见 [`_assets/adminorgbill_extension/customization_points.md`](../../_assets/adminorgbill_extension/customization_points.md)
