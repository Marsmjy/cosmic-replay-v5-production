# org_dev_adminorgbill_extension · 扩展点
...
|---|---|---|---|---|
| EP-01 | 改 `AdminOrgBatchDetailDealSourceInfoFormPlugin` 行为 | AdminOrgBatchDetailDealSourceInfoFormPlugin.java (3 方法) | ⭐⭐ | (按需) |
| EP-02 | 改 `AdminOrgShowMobBillPlugin` 行为 | AdminOrgShowMobBillPlugin.java (14 方法) | ⭐⭐ | (按需) |
| EP-03 | 改 `OrgBatchBillSubmitDealSourceInfoOp` 行为 | OrgBatchBillSubmitDealSourceInfoOp.java (1 方法) | ⭐⭐ | (按需) |
| EP-04 | 改 `OrgBatchBillInfoHelper` 行为 | OrgBatchBillInfoHelper.java (3 方法) | ⭐⭐ | (按需) |
