...
- `PositionChangeDetailListPlugin` ← `kd.hrmp.hbpm.formplugin.web.position.PositionChangeDetailListPlugin`
- `BasePositionBuListPlugin` ← `kd.hrmp.hbpm.formplugin.web.position.BasePositionBuListPlugin`
