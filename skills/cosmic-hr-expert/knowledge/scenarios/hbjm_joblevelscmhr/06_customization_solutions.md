...
| `kd.hrmp.hbjm.formplugin.web.basedata.JobBasedataEdit` | `save` | afterBindData |
| `kd.hrmp.hbjm.formplugin.web.joblevelscm.JobLevelScmPlugin` | `save` | beforeBindData |
...
| `kd.hrmp.hbjm.opplugin.web.HBJMDataBaseOp` | `save` | onAddValidators |
| `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | `save` | onPreparePropertys, beforeExecuteOperationTransaction |
| `kd.hrmp.hbjm.opplugin.web.JobLevelScmSaveOp` | `save` | onAddValidators, beforeExecuteOperationTransaction, endOperationTransaction |
| `kd.hrmp.hbjm.opplugin.web.HbjmBaseNewDataOp` | `save` | onAddValidators |
| `kd.hrmp.hbjm.opplugin.web.JobLevelScmDeleteOp` | `delete` |  |
...
| `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | `confirmchange` | onPreparePropertys, onAddValidators, beforeExecuteOperationTransaction, beginOperationTransaction, afterExecuteOperationTransaction |
| `kd.hr.hbp.opplugin.web.history.HisUniqueValidateOp` | `confirmchange` | onPreparePropertys, onAddValidators |
...
- `JobLevelScmList` (FORM_PLUGIN) ← `kd.hrmp.hbjm.formplugin.web.joblevelscm.JobLevelScmList`
- `JobBaseBuListPlugin` (FORM_PLUGIN) ← `kd.hrmp.hbjm.formplugin.web.basedata.JobBaseBuListPlugin`
- `JobLevelScmEnableOp` (OP_PLUGIN) ← `kd.hrmp.hbjm.opplugin.web.JobLevelScmEnableOp`
