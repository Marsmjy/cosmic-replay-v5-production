...
## ✅ verified · 主表 `hbjm_joblevelscmhr` 共 67 个 opKey
...
| 7 | `HBJMDataBaseOp` | enabled=True |
| 8 | `HRBaseOriginalOp` | HR 基础资料原始值记录（对比变更前后） |
| 9 | `HisUniqueValidateOp` | 时态模型唯一性校验（同一 boid 同一时间段唯一） |
| 10 | `JobLevelScmSaveOp` | enabled=True |
| 11 | `HisModelOPCommonPlugin` | 时态模型通用 · his_bsed/his_bsled/effectdate 的维护 |
| 12 | `HbjmBaseNewDataOp` | enabled=True |
...
| 6 | `JobLevelScmDeleteOp` | enabled=True |
...
| 3 | `JobLevelScmEnableOp` | enabled=True |
...
- `showallversion` · `newentry` · `transfermanage` · `changecontrolstrategy` · `deleteentry` · `insertentry` · `moveentryup` · `moveentrydown` · `new1`
...
| `JobBasedataEdit` | FORM_PLUGIN | `save` | ✅ | afterBindData | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.basedata.JobBasedataEdit/extension_guide.md) |
| `JobLevelScmPlugin` | FORM_PLUGIN | `save` | ✅ | beforeBindData | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.joblevelscm.JobLevelScmPlugin/extension_guide.md) |
...
| `JobLevelScmList` | FORM_PLUGIN | `save` | ❌ | setFilter | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.joblevelscm.JobLevelScmList/extension_guide.md) |
| `JobBaseBuListPlugin` | FORM_PLUGIN | `save` | ❌ |  | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.basedata.JobBaseBuListPlugin/extension_guide.md) |
...
| `HBJMDataBaseOp` | OP_PLUGIN | `save` | ✅ | onAddValidators | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.HBJMDataBaseOp/extension_guide.md) |
...
| `JobLevelScmSaveOp` | OP_PLUGIN | `save` | ✅ | onAddValidators, beforeExecuteOperationTransaction, endOperationTransaction | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.JobLevelScmSaveOp/extension_guide.md) |
| `HbjmBaseNewDataOp` | OP_PLUGIN | `save` | ✅ | onAddValidators | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.HbjmBaseNewDataOp/extension_guide.md) |
| `JobLevelScmDeleteOp` | OTHER | `delete` | ✅ |  | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.JobLevelScmDeleteOp/extension_guide.md) |
...
| `HisModelOPCommonPlugin` | OP_PLUGIN | `confirmchange` | ✅ | onPreparePropertys, onAddValidators, beforeExecuteOperationTransaction, beginOperationTransaction | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin/extension_guide.md) |
| `HisUniqueValidateOp` | OP_PLUGIN | `confirmchange` | ✅ | onPreparePropertys, onAddValidators | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.history.HisUniqueValidateOp/extension_guide.md) |
| `JobLevelScmEnableOp` | OP_PLUGIN | `enable` | ❌ | onPreparePropertys, onAddValidators | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.JobLevelScmEnableOp/extension_guide.md) |
