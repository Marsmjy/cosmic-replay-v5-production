...
主表 `hbjm_joblevelscmhr` 标品接入 **56** 个插件。
...
- `JobBasedataEdit` ← `kd.hrmp.hbjm.formplugin.web.basedata.JobBasedataEdit`
...
- `JobHisBasedataEdit` ← `kd.hrmp.hbjm.formplugin.web.basedata.JobHisBasedataEdit`
- ...（共 28，详见 `_auto_plugin_registry.md`）
...
- `JobBaseDataListPlugin` ← `kd.hrmp.hbjm.formplugin.web.common.JobBaseDataListPlugin`
- `JobLevelScmList` ← `kd.hrmp.hbjm.formplugin.web.joblevelscm.JobLevelScmList`
...
- `HBJMDataBaseOp` ← `kd.hrmp.hbjm.opplugin.web.HBJMDataBaseOp`
...
- `JobLevelScmSaveOp` ← `kd.hrmp.hbjm.opplugin.web.JobLevelScmSaveOp`
- `HbjmBaseNewDataOp` ← `kd.hrmp.hbjm.opplugin.web.HbjmBaseNewDataOp`
- `CodeRuleDeleteOp` ← `kd.bos.coderule.CodeRuleDeleteOp`
- `JobLevelScmDeleteOp` ← `kd.hrmp.hbjm.opplugin.web.JobLevelScmDeleteOp`
- `JobLevelScmEnableOp` ← `kd.hrmp.hbjm.opplugin.web.JobLevelScmEnableOp`
...
## ✅ verified · 反编译实抓真处理类（20 个 · ISV 可继承 14 / 禁继承 6）
...
#### `JobBasedataEdit` · FORM_PLUGIN @ `BILL_FORM` · opKey=`save`

- **完整 FQN**: `kd.hrmp.hbjm.formplugin.web.basedata.JobBasedataEdit`
- **完整继承链**: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- **重写生命周期方法（1）**:
  - `afterBindData` — ISV 子类可在此切入扩展逻辑
...
- **ISV 扩展套路**：
  ...
  import kd.hrmp.hbjm.formplugin.web.basedata.JobBasedataEdit;
  
  public class IsvCustomJobBasedataEdit extends JobBasedataEdit {
      @Override
      public void afterBindData(... args) {
          super.afterBindData(args);  // 必调 super · 保留标品行为
          // 你的 ISV 业务逻辑 ...
  ...
  ```
- **详细 ISV 扩展指南**: [`<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.basedata.JobBasedataEdit/extension_guide.md`](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.basedata.JobBasedataEdit/extension_guide.md)

#### `JobLevelScmPlugin` · FORM_PLUGIN @ `BILL_FORM` · opKey=`save`

- **完整 FQN**: `kd.hrmp.hbjm.formplugin.web.joblevelscm.JobLevelScmPlugin`
- **完整继承链**: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- **重写生命周期方法（1）**:
...
- **ISV 扩展套路**：
  ...
  import kd.hrmp.hbjm.formplugin.web.joblevelscm.JobLevelScmPlugin;
  
  public class IsvCustomJobLevelScmPlugin extends JobLevelScmPlugin {
      @Override
  ...
  ```
- **详细 ISV 扩展指南**: [`<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.joblevelscm.JobLevelScmPlugin/extension_guide.md`](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.formplugin.web.joblevelscm.JobLevelScmPlugin/extension_guide.md)
...
#### `HBJMDataBaseOp` · OP_PLUGIN @ `OPERATION` · opKey=`save`

- **完整 FQN**: `kd.hrmp.hbjm.opplugin.web.HBJMDataBaseOp`
...
- **ISV 扩展套路**：
  ...
  public class IsvCustomHBJMDataBaseOp extends HBJMDataBaseOp {
      @Override
  ...
  ```
- **详细 ISV 扩展指南**: [`<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.HBJMDataBaseOp/extension_guide.md`](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.HBJMDataBaseOp/extension_guide.md)
...
#### `JobLevelScmSaveOp` · OP_PLUGIN @ `OPERATION` · opKey=`save`

- **完整 FQN**: `kd.hrmp.hbjm.opplugin.web.JobLevelScmSaveOp`
- **完整继承链**: `kd.hr.hbp.opplugin.web.HRDataBaseOp`
- **重写生命周期方法（3）**:
  - `onAddValidators` — ISV 子类可在此切入扩展逻辑
  - `beforeExecuteOperationTransaction` — ISV 子类可在此切入扩展逻辑
  - `endOperationTransaction` — ISV 子类可在此切入扩展逻辑
- **静态指标**: 写表 0 · 发事件 0 · 抛异常 0 · 调核心 Service 0 · trace 访问 1 类
- **ISV 扩展套路**：
  ```java
  package <你的 ISV 包>;
  
  import kd.hrmp.hbjm.opplugin.web.JobLevelScmSaveOp;
  
  public class IsvCustomJobLevelScmSaveOp extends JobLevelScmSaveOp {
      @Override
      public void onAddValidators(... args) {
          super.onAddValidators(args);  // 必调 super · 保留标品行为
          // 你的 ISV 业务逻辑 ...
  ...
  ```
- **详细 ISV 扩展指南**: [`<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.JobLevelScmSaveOp/extension_guide.md`](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.JobLevelScmSaveOp/extension_guide.md)

#### `HbjmBaseNewDataOp` · OP_PLUGIN @ `OPERATION` · opKey=`save`

- **完整 FQN**: `kd.hrmp.hbjm.opplugin.web.HbjmBaseNewDataOp`
- **完整继承链**: `kd.hr.hbp.opplugin.web.HRDataBaseOp`
- **重写生命周期方法（1）**:
  - `onAddValidators` — ISV 子类可在此切入扩展逻辑
...
- **ISV 扩展套路**：
  ...
  import kd.hrmp.hbjm.opplugin.web.HbjmBaseNewDataOp;
  
  public class IsvCustomHbjmBaseNewDataOp extends HbjmBaseNewDataOp {
      @Override
      public void onAddValidators(... args) {
          super.onAddValidators(args);  // 必调 super · 保留标品行为
          // 你的 ISV 业务逻辑 ...
  ...
  ```
- **详细 ISV 扩展指南**: [`<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.HbjmBaseNewDataOp/extension_guide.md`](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.HbjmBaseNewDataOp/extension_guide.md)

#### `JobLevelScmDeleteOp` · OTHER @ `OPERATION` · opKey=`delete`

- **完整 FQN**: `kd.hrmp.hbjm.opplugin.web.JobLevelScmDeleteOp`
- **完整继承链**: `kd.hr.hbp.opplugin.web.HRDataBaseOp`
- **静态指标**: 写表 0 · 发事件 0 · 抛异常 0 · 调核心 Service 0 · trace 访问 1 类
- **ISV 扩展套路**：
  ```java
  ...
  import kd.hrmp.hbjm.opplugin.web.JobLevelScmDeleteOp;
  
  public class IsvCustomJobLevelScmDeleteOp extends JobLevelScmDeleteOp {
  }
  ```
- **详细 ISV 扩展指南**: [`<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.JobLevelScmDeleteOp/extension_guide.md`](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hrmp.hbjm.opplugin.web.JobLevelScmDeleteOp/extension_guide.md)
...
#### `HisModelOPCommonPlugin` · OP_PLUGIN @ `OPERATION` · opKey=`confirmchange`
...
#### `HisUniqueValidateOp` · OP_PLUGIN @ `OPERATION` · opKey=`confirmchange`
...
#### `JobLevelScmList` · FORM_PLUGIN · opKey=`save`

- **FQN**: `kd.hrmp.hbjm.formplugin.web.joblevelscm.JobLevelScmList`
- **继承链**: `kd.hr.hbp.formplugin.web.HRDataBaseList`
- **为什么禁**: 标识为内部实现 · ISV 继承会破升级兼容
- **该用什么**: 上一节「可继承类」中找对应 opKey 的类

#### `JobBaseBuListPlugin` · FORM_PLUGIN · opKey=`save`

- **FQN**: `kd.hrmp.hbjm.formplugin.web.basedata.JobBaseBuListPlugin`
- **继承链**: `kd.hr.hbp.formplugin.web.HRDataBaseList`
- **为什么禁**: 标识为内部实现 · ISV 继承会破升级兼容
- **该用什么**: 上一节「可继承类」中找对应 opKey 的类

#### `JobLevelScmEnableOp` · OP_PLUGIN · opKey=`enable`

- **FQN**: `kd.hrmp.hbjm.opplugin.web.JobLevelScmEnableOp`
- **继承链**: `kd.hrmp.hbjm.opplugin.web.HBJMDataBaseOp`
- **为什么禁**: 标识为内部实现 · ISV 继承会破升级兼容
- **该用什么**: 上一节「可继承类」中找对应 opKey 的类
...
- order **5**: `HisModelOPCommonPlugin` · 时态模型通用 · his_bsed/his_bsled/effectdate 的维护
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin`
- order **6**: `JobLevelScmDeleteOp` · enabled=True
  - 完整 FQN: `kd.hrmp.hbjm.opplugin.web.JobLevelScmDeleteOp`
...
- order **2**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **3**: `JobLevelScmEnableOp` · enabled=True
  - 完整 FQN: `kd.hrmp.hbjm.opplugin.web.JobLevelScmEnableOp`
