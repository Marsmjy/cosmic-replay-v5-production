...
- `AttPeriodPlugin` ← `kd.wtc.wtp.formplugin.web.attperiod.AttPeriodPlugin`
...
- `AttPeriodList` ← `kd.wtc.wtp.formplugin.web.attperiod.AttPeriodList`
- `BaseDataMobListPlugin` ← `kd.bos.form.plugin.bdctrl.BaseDataMobListPlugin`

### OpPlugin（8）
- `CodeRuleOp` ← `kd.bos.business.plugin.CodeRuleOp`
- `AttPeriodSaveOp` ← `kd.wtc.wtp.opplugin.web.attperiod.AttPeriodSaveOp`
...
- order **4**: `AttPeriodSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.attperiod.AttPeriodSaveOp`
...
- order **4**: `AttPeriodSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.attperiod.AttPeriodSaveOp`
- order **5**: `WTCSnapSaveOp` · enabled=True
...
- order **1**: `AttPeriodSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.attperiod.AttPeriodSaveOp`
- order **2**: `BaseDataSavePlugin` · enabled=True
  - 完整 FQN: `kd.bos.form.plugin.bdctrl.BaseDataSavePlugin`
...
- order **4**: `HRBaseDataEnableOp` · HR 基础资料启用态管理 · 控制 enable 字段
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp`
- order **5**: `CodeRuleOp` · 编码规则（未启用时跳过）· onAddValidators 注册 numberValidator
  - 完整 FQN: `kd.bos.business.plugin.CodeRuleOp`
...
- order **2**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **3**: `AttPeriodSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.attperiod.AttPeriodSaveOp`
- order **4**: `WTCSnapSaveOp` · enabled=False
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.his.WTCSnapSaveOp`
...
- order **2**: `BaseDataSavePlugin` · enabled=True
  - 完整 FQN: `kd.bos.form.plugin.bdctrl.BaseDataSavePlugin`
- order **3**: `WTCSnapSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.his.WTCSnapSaveOp`
- order **4**: `AttPeriodSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.attperiod.AttPeriodSaveOp`
