...
主表 `hrpi_rotationinfo` 标品接入 **19** 个插件。
...
- `RotationSaveOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.RotationSaveOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.RotationSaveOp -->

## ISV 扩展指引（基于 RotationSaveOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.RotationSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.RotationSaveOp/extension_guide.md)
