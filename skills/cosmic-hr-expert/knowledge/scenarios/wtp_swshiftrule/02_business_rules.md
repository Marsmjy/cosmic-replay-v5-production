...
## ✅ verified · 主表 `wtp_swshiftrule` 共 64 个 opKey
...
- `showallversion` · `editentry` · `deleteentry` · `viewentry` · `moveentryup` · `moveentrydown`
