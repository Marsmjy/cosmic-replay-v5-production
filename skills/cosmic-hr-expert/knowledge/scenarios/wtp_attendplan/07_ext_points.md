...
- `AttendPlanOp` ← `kd.wtc.wtp.opplugin.web.attend.AttendPlanOp`
...
- order **9**: `RuleEngingSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.ruleenging.RuleEngingSaveOp`
- order **10**: `AttendPlanOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.attend.AttendPlanOp`
...
- order **3**: `RuleEngingSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.ruleenging.RuleEngingSaveOp`
- order **4**: `AttendPlanOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.attend.AttendPlanOp`
