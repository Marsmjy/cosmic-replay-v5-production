...
## ✅ verified · 主表 `wtp_travelmeter` 共 74 个 opKey
...
| 10 | `TripConfigMustInputOp` | enabled=True |
...
| 9 | `TripConfigMustInputOp` | enabled=True |
...
| 3 | `TripConfigMustInputOp` | enabled=True |
...
- `showallversion` · `newentry1` · `deleteentry` · `moveentryup1` · `moveentrydown1` · `newentry2` · `deleteentry2` · `moveentryup2` · `moveentrydown2` · `newentry3` · `deleteentry3` · `moveentryup3`
