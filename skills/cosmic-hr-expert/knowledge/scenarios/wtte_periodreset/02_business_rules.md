...
## ✅ verified · 主表 `wtte_periodreset` 共 35 个 opKey
...
- `refresh` · `option` · `submitandnew` · `saveandnew` · `first` · `previous` · `next` · `last` · `mobtoolbarselect` · `mobtoolbarcancel` · `namehistory` · `namehistoryview`
- `logview` · `viewonelog` · `addbatch` · `deleteentry`
