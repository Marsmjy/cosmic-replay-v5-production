...
- `HolidayEdit` ← `kd.wtc.wtbd.fromplugin.web.holiday.HolidayEdit`
...
- `HolidayList` ← `kd.wtc.wtbd.fromplugin.web.holiday.HolidayList`
- `WTCPresetList` ← `kd.wtc.wtbs.formplugin.web.model.WTCPresetList`

### OpPlugin（7）
- `CodeRuleOp` ← `kd.bos.business.plugin.CodeRuleOp`
- `HolidayOp` ← `kd.wtc.wtbd.opplugin.web.holiday.HolidayOp`
...
- order **3**: `HolidayOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.holiday.HolidayOp`
