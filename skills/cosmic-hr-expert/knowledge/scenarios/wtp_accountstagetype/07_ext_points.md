...
主表 `wtp_accountstagetype` 标品接入 **23** 个插件。
...
- `AcountOrderList` ← `kd.wtc.wtp.formplugin.web.accountsteps.AcountOrderList`
- `AccountStageTypeList` ← `kd.wtc.wtp.formplugin.web.accountsteps.AccountStageTypeList`
...
- `WTCDlgEditEnableSpecial` ← `kd.wtc.wtbs.formplugin.web.WTCDlgEditEnableSpecial`
