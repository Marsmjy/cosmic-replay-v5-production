...
## ✅ verified · 主表 `hrcs_esignspmgr` + 继承层
...
- `HRCSESignAppCfgServiceHelper`
- `HRCSESignCOSealMgrServiceHelper`
- `HRCSESignDBServiceServiceHelper`
- `HRCSESignSPMgrServiceHelper`
