...
主表 `hrcs_esignspmgr` 标品接入 **20** 个插件。
...
- `ESignSPMgrEdit` ← `kd.hr.hrcs.formplugin.web.esign.ESignSPMgrEdit`
- `ESignSPMgrCloseEdit` ← `kd.hr.hrcs.formplugin.web.esign.ESignSPMgrCloseEdit`
...
- `ESignSPMgrListPlugin` ← `kd.hr.hrcs.formplugin.web.esign.ESignSPMgrListPlugin`
...
- `ESignSPMgrOp` ← `kd.hr.hrcs.opplugin.web.esign.ESignSPMgrOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.esign.ESignSPMgrEdit -->

## ISV 扩展指引（基于 ESignSPMgrEdit 真实证）
...
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `afterCreateNewData`, `beforeBindData`, `beforeDoOperation`, `afterDoOperation`, `closedCallBack`, `registerListener`, `itemClick`
...
- `public public void showESignAppCfg(java.lang.Object)`
...
**READ_VIA_HELPER** · ESignSPMgrEdit L288
```java
 286               DynamicObject spDyn = appCfg.getDynamicObject("esignsp");
 287               String appId = appCfg.getString("appid");
 288 >             String enableAppNumber = HRCSESignAppCfgServiceHelper.getEnableAppNumber((String)appId, (Object)spDyn.get("id"));
 289               if (StringUtils.isNotBlank((CharSequence)enableAppNumber)) {
 290                   String appNumber = appCfg.getString("number");
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.esign.ESignSPMgrEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.esign.ESignSPMgrEdit/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.esign.ESignSPMgrEdit -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.esign.ESignSPMgrCloseEdit -->

## ISV 扩展指引（基于 ESignSPMgrCloseEdit 真实证）
...
### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRCloseCheckFormPlugin`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: (无)

### 可重写方法（target.java self）
- `public public void confirmCallBack(kd.bos.form.events.MessageBoxClosedEvent)`
- `protected protected java.util.List<java.lang.String> getUnCheckFields()`
- `protected protected java.lang.String getDelEntryMsg(java.util.List<java.lang.String>, java.util.Map<java.lang.String, kd.bos.entity.EntityType>, java.lang.String, kd.bos.dataentity.entity.DataEntityState)`

### SDK 范式（ISV 抄作业）

**READ_VIA_HELPER** · ESignSPMgrCloseEdit L70
```java
  68                       return;
  69                   }
  70 >                 DynamicObjectCollection entryAppCfgDys = HRCSESignSPMgrServiceHelper.getESignSPAppInfos((Object)pkValue);
  71                   Set<Object> dbAppEntryIds = entryAppCfgDys != null && entryAppCfgDys.size() > 0 ? entryAppCfgDys.stream().map(item -> item.getDynamicObject("bdesignappcfg").getLong("id")).collect(Collectors.toSet()) : new HashSet(0);
  72                   Set<Object> tempDelAppEntryIds = new HashSet(8);
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.esign.ESignSPMgrCloseEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.esign.ESignSPMgrCloseEdit/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.esign.ESignSPMgrListPlugin -->

## ISV 扩展指引（基于 ESignSPMgrListPlugin 真实证）
...
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseList`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `registerListener`, `beforeF7Select`, `filterContainerInit`, `beforeDoOperation`
...
- `public public void expandClick(kd.bos.form.field.events.ListExpandEvent)`
- `public public void beforeDoOperation(kd.bos.form.events.BeforeDoOperationEventArgs)` ⭐ lifecycle
- `public public void confirmCallBack(kd.bos.form.events.MessageBoxClosedEvent)`
...
**WRITE_VIA_HELPER** · ESignSPMgrListPlugin L240
```java
 238               OperationResult disabledOpResult = null;
 239               if (HRCollUtil.isNotEmpty(disabledDyns)) {
 240 >                 disabledOpResult = OperationServiceHelper.executeOperate((String)"disable", (String)"hrcs_esignspmgr", (DynamicObject[])disabledDyns.toArray(new DynamicObject[0]), (OperateOption)OperateOption.create());
 241               }
 242               ArrayList<String> errMsgs = new ArrayList<String>(8);
```
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.esign.ESignSPMgrListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.esign.ESignSPMgrListPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.esign.ESignSPMgrOp -->

## ISV 扩展指引（基于 ESignSPMgrOp 真实证）
...
**READ_VIA_HELPER** · ESignSPMgrOp L59
```java
  57                       curSaveEntryIds = new HashSet<Long>(0);
  58                   }
  59 >                 if ((entryAppCfgDys = HRCSESignSPMgrServiceHelper.getESignSPAppInfos((Object)dataDyn.getPkValue())) != null && entryAppCfgDys.size() > 0) {
  60                       Set delEntryIds;
  61                       Set dbEntryIds = entryAppCfgDys.stream().map(item -> item.getDynamicObject("bdesignappcfg").getLong("id")).collect(Collectors.toSet());
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.esign.ESignSPMgrOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.esign.ESignSPMgrOp/extension_guide.md)
