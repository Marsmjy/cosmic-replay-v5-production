...
## ✅ verified · 主表 `hsbs_salaryitem` 共 51 个 opKey

### 🔥 核心 opKey 执行链（51 个有真链）
...
| order | className | 角色 |
|:---:|---|---|
| 1 | `SalaryItemSaveOp` | plugins.json 实证 · 标品 · extendable |
| 2 | `HRBaseDataStatusOp` | plugins.json 实证 · 标品 · extendable |
| 3 | `HRBaseDataLogOp` | plugins.json 实证 · 标品 · extendable |
| 4 | `HRBaseDataEnableOp` | plugins.json 实证 · 标品 · extendable |
| 5 | `HRBaseOriginalOp` | plugins.json 实证 · 标品 · extendable |
| 6 | `SalaryItemDeleteOp` | plugins.json 实证 · 标品 · extendable |
| 7 | `SalaryItemAuditOp` | plugins.json 实证 · 标品 · extendable |
| 8 | `SalaryItemUnAuditOp` | plugins.json 实证 · 标品 · extendable |
...
| 2 | `SalaryItemSaveOp` | enabled=True |
| 3 | `BaseDataSavePlugin` | enabled=True |
