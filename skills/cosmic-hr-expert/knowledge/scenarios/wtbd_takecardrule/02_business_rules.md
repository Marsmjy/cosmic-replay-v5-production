...
## ✅ verified · 主表 `wtbd_takecardrule` 共 46 个 opKey
...
| 10 | `TakeCardRuleSaveOp` | enabled=True |
...
| 9 | `TakeCardRuleSaveOp` | enabled=True |
...
| 3 | `TakeCardRuleSaveOp` | enabled=True |
...
| order | className | 角色 |
|:---:|---|---|
| 1 | `TakeCardRuleSaveOp` | enabled=True |
...
- `tbl_assign_import` · `logview` · `viewonelog` · `hisversioninfo` · `hiscopy` · `newhisversion` · `revise` · `reviserecord` · `versionchangecompare` · `showallversion` · `orgpermchange`
