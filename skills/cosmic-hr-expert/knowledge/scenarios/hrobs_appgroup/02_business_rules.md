...
- 数据源：`_sdk_audit/_decompiled/scenarios/hrobs_appgroup/` 的 2 个反编译类 + `_shared/_standard_metadata/entity_metadata/hrobs_appgroup.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrobs.formplugin.appgroup.AppGroupFormPlugin -->

## chgaction 实证补充（AppGroupFormPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrobs.formplugin.appgroup.AppGroupListPlugin -->

## chgaction 实证补充（AppGroupListPlugin 跨类追踪聚合）
