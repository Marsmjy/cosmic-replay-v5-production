# hrobs_appgroup · 定制方案（ISV 扩展真实模板）
...
在开发平台给本 form（`hrobs_appgroup`）加 ISV 字段：
...
```java
@SdkPlugin
public class MyAppgroupIsvFormPlugin extends HRDataBaseEdit {
    @Override
