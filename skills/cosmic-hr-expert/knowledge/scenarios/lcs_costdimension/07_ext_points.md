...
主表 `lcs_costdimension` 标品接入 **27** 个插件。
...
- `CostDimensionEdit` ← `kd.hrmp.lcs.formplugin.web.basedata.CostDimensionEdit`
...
- `CostDimensionDeleteOp` ← `kd.hrmp.lcs.opplugin.web.CostDimensionDeleteOp`
- `CostDimensionDeleteOp` ← `kd.hrmp.lcs.opplugin.validator.web.CostDimensionDeleteOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.lcs.formplugin.web.basedata.CostDimensionEdit -->

## ISV 扩展指引（基于 CostDimensionEdit 真实证）

> FQN: `kd.hrmp.lcs.formplugin.web.basedata.CostDimensionEdit`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.basedata.CostDimensionEdit/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`, `beforeBindData`, `afterBindData`, `propertyChanged`, `beforeDoOperation`, `beforeF7Select`, `closedCallBack`
...
**QUERY_BUILDER** · CostDimensionEdit L178
```java
 176               case "assistant": {
 177                   List customQFilters = beforeF7SelectEvent.getCustomQFilters();
 178 >                 customQFilters.add(new QFilter("fbizcloudid", "in", Arrays.asList("0PEIU203SX4Y", "83bfebc800000bac")));
 179                   break;
 180               }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.basedata.CostDimensionEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.basedata.CostDimensionEdit/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.lcs.opplugin.web.CostDimensionDeleteOp -->

## ISV 扩展指引（基于 CostDimensionDeleteOp 真实证）

> FQN: `kd.hrmp.lcs.opplugin.web.CostDimensionDeleteOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.lcs.opplugin.web.CostDimensionDeleteOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.lcs.opplugin.web.CostDimensionDeleteOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.lcs.opplugin.web.CostDimensionDeleteOp/extension_guide.md)
