...
### Case 3：扩展 `HRBaseDataStatusOp` (opKey=`save1`)

**业务背景**：标品 `HRBaseDataStatusOp` 处理 `save1` 操作 · ISV 想加自定义校验/写表/通知
...
4. 单测：触发 opKey `save1` · 验证 ISV 逻辑 + super 行为都跑

### Case 4：扩展 `HRBaseDataLogOp` (opKey=`save1`)

**业务背景**：标品 `HRBaseDataLogOp` 处理 `save1` 操作 · ISV 想加自定义校验/写表/通知
...
### Case 5：扩展 `HRBaseDataEnableOp` (opKey=`save1`)

**业务背景**：标品 `HRBaseDataEnableOp` 处理 `save1` 操作 · ISV 想加自定义校验/写表/通知
...
### Case 6：扩展 `HRBaseOriginalOp` (opKey=`save1`)

**业务背景**：标品 `HRBaseOriginalOp` 处理 `save1` 操作 · ISV 想加自定义校验/写表/通知
