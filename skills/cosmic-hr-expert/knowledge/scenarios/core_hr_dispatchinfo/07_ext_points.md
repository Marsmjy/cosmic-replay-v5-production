...
主表 `hrpi_dispatchinfo` 标品接入 **19** 个插件。
...
- `DispatchSaveOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.DispatchSaveOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.DispatchSaveOp -->

## ISV 扩展指引（基于 DispatchSaveOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.DispatchSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.DispatchSaveOp/extension_guide.md)
