...
> 本 form（`hrpi_dispatchinfo`，所属 核心人力云）引用了其他云的 **7** 个底座实体：
...
| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `dispworkplace` | 常驻工作地 | BasedataField | `hbss_workplace` | [hbss_supplier](../hbss_supplier/) |
| `disptype` | 外派类型 | BasedataField | `hbss_disptype` | [hbss_position_dict](../hbss_position_dict/) |
