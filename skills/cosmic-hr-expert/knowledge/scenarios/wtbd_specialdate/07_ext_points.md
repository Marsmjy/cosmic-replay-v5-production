...
主表 `wtbd_specialdate` 标品接入 **41** 个插件。
...
- `SpecialDateEdit` ← `kd.wtc.wtbd.fromplugin.web.workschedule.specialdate.SpecialDateEdit`
- `WTCBaseDataEdit` ← `kd.wtc.wtbs.formplugin.web.common.WTCBaseDataEdit`
...
- `WTCCommonOrderByPageList` ← `kd.wtc.wtbs.formplugin.web.common.WTCCommonOrderByPageList`
...
- `WTCNumberCheckOp` ← `kd.wtc.wtbs.opplugin.web.bill.WTCNumberCheckOp`
- `HRBaseOriginalOp` ← `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- `SpecialDateSaveOp` ← `kd.wtc.wtbd.opplugin.web.workschedule.specialdate.SpecialDateSaveOp`
...
- order **6**: `HRBaseDataEnableOp` · HR 基础资料启用态管理 · 控制 enable 字段
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp`
- order **7**: `WTCNumberCheckOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCNumberCheckOp`
- order **8**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **9**: `SpecialDateSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.workschedule.specialdate.SpecialDateSaveOp`
