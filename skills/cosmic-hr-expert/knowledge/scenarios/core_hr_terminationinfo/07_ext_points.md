...
主表 `hrpi_terminationinfo` 标品接入 **21** 个插件。
...
- `TerminationInfoSaveOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoSaveOp`
- `EmpStageHandleOpPlugin` ← `kd.hrmp.hrpi.opplugin.web.assignment.EmpStageHandleOpPlugin`
- `TerminationInfoEmpStageOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoEmpStageOp`
...
- `TerminationReviseDepartDateOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationReviseDepartDateOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoSaveOp -->

## ISV 扩展指引（基于 TerminationInfoSaveOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoSaveOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoSaveOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoEmpStageOp -->

## ISV 扩展指引（基于 TerminationInfoEmpStageOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoEmpStageOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoEmpStageOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoEmpStageOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoEmpStageOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationReviseDepartDateOp -->

## ISV 扩展指引（基于 TerminationReviseDepartDateOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationReviseDepartDateOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationReviseDepartDateOp/`
...
**QUERY_BUILDER** · TerminationInfoDomainServiceImpl L28
```java
  26   implements ITerminationInfoDomainService {
  27       public List<DynamicObject> getTerminateInfoByEmployeeIdList(List<Long> employeeIdList) {
  28 >         Object[] dynamicObjects = this.query("employee,empstage,departdate,modifytime,modifier", new QFilter("employee", "in", employeeIdList).toArray());
  29           if (dynamicObjects == null || dynamicObjects.length == 0) {
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationReviseDepartDateOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationReviseDepartDateOp/extension_guide.md)
