...
| `termtype` | 离职类型 | `BasedataField` | `hrpi_quittype` |
...
| `TerminationInfoEmpStageOp` | `HRDataBaseOp` | OP |
| `TerminationInfoSaveOp` | `HRDataBaseOp` | OP |
| `TerminationReviseDepartDateOp` | `HRDataBaseOp` | OP |
