# core_hr_terminationinfo · 业务规则

> **form**：`hrpi_terminationinfo` · 离职信息
> **生成时间**：2026-04-29
> **方法**：从反编译实物（14 类）提取真业务规则 + standard md 字段必填约束
...
- 数据源：`_sdk_audit/_decompiled/scenarios/core_hr_terminationinfo/` 的 14 个反编译类 + `_shared/_standard_metadata/entity_metadata/hrpi_terminationinfo.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoSaveOp -->

## chgaction 实证补充（TerminationInfoSaveOp 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationInfoEmpStageOp -->

## chgaction 实证补充（TerminationInfoEmpStageOp 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrpi.opplugin.web.assignment.attach.TerminationReviseDepartDateOp -->

## chgaction 实证补充（TerminationReviseDepartDateOp 跨类追踪聚合）
...
### 调用的核心 Service（Top 10）
- `ReviseEntryDepartDateApplicationServiceImpl.class`
