...
- `FunctionEdit` ← `kd.hr.hrcs.formplugin.web.function.FunctionEdit`
- `HRUpdateTabNameEdit` ← `kd.hr.hbp.formplugin.web.HRUpdateTabNameEdit`
- `HRBaseDataCommonFieldLockEdit` ← `kd.hr.hbp.formplugin.web.HRBaseDataCommonFieldLockEdit`
- `TemplateGroupBaseDataPlugin` ← `kd.bos.form.plugin.TemplateGroupBaseDataPlugin`
...
- `FunctionList` ← `kd.hr.hrcs.formplugin.web.function.FunctionList`
...
- `FunctionOp` ← `kd.hr.hrcs.opplugin.web.function.FunctionOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.function.FunctionEdit -->

## ISV 扩展指引（基于 FunctionEdit 真实证）
...
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`, `beforeBindData`, `afterBindData`, `beforeDoOperation`, `afterDoOperation`, `propertyChanged`, `beforeClosed`
...
**THROW_BIZ_EXCEPTION** · FuncDefineSplitHelper L72
```java
  70           }
  71           if (!leftBraceStack.isEmpty()) {
  72 >             throw new KDBizException(ResManager.loadKDString((String)"\u51fd\u6570\u4f53\u5b58\u5728\u9519\u8bef\uff0c\u5b58\u5728\u591a\u4f59\u7684\u5de6\u5927\u62ec\u53f7{", (String)"FuncDefineSplitHelper_0", (String)"swc-hsbs-business", (Object[])new Object[0]));
  73           }
  74           return methodStr.toString().trim();
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.function.FunctionEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.function.FunctionEdit/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.function.FunctionEdit -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hbp.formplugin.web.HRUpdateTabNameEdit -->

## ISV 扩展指引（基于 HRUpdateTabNameEdit 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.HRUpdateTabNameEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.HRUpdateTabNameEdit/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.function.FunctionList -->

## ISV 扩展指引（基于 FunctionList 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.function.FunctionList/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.function.FunctionList/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.function.FunctionOp -->

## ISV 扩展指引（基于 FunctionOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.function.FunctionOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.function.FunctionOp/extension_guide.md)
