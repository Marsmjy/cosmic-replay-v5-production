...
- 数据源：`_sdk_audit/_decompiled/scenarios/homs_orgdifftemp/` 的 0 个反编译类 + `_shared/_standard_metadata/entity_metadata/homs_orgdifftemp.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempEditPlugin -->

## chgaction 实证补充（OrgDiffTempEditPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempListPlugin -->

## chgaction 实证补充（OrgDiffTempListPlugin 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempSaveOp -->

## chgaction 实证补充（OrgDiffTempSaveOp 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempEnableOp -->

## chgaction 实证补充（OrgDiffTempEnableOp 跨类追踪聚合）
