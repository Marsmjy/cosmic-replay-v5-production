...
主表 `homs_orgdifftemp` 标品接入 **20** 个插件。
...
- `OrgDiffTempEditPlugin` ← `kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempEditPlugin`
...
- `OrgDiffTempListPlugin` ← `kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempListPlugin`
...
- `OrgDiffTempSaveOp` ← `kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempSaveOp`
- `HRBaseOriginalOp` ← `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- `CodeRuleDeleteOp` ← `kd.bos.coderule.CodeRuleDeleteOp`
- `OrgDiffTempEnableOp` ← `kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempEnableOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempEditPlugin -->

## ISV 扩展指引（基于 OrgDiffTempEditPlugin 真实证）

> FQN: `kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempEditPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempEditPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRCoreBaseBillEdit`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `beforeBindData`, `afterBindData`, `propertyChanged`, `registerListener`, `beforeF7Select`
...
**READ_VIA_HELPER** · OrgPermHelper L43
```java
  41   
  42       public static HasPermOrgResult getHRPermOrg(boolean mustQuery) {
  43 >         return PermissionServiceHelper.getAllPermOrgs((long)RequestContext.get().getCurrUserId(), (String)HR_ORG_VIEW_TYPE, (String)HOMS_APP, (String)"haos_adminorgdetail", (String)"47150e89000000ac", (boolean)mustQuery);
  44       }
  45   
```
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempEditPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempEditPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempListPlugin -->

## ISV 扩展指引（基于 OrgDiffTempListPlugin 真实证）

> FQN: `kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempListPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseList`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `preOpenForm`, `filterContainerInit`, `setFilter`, `afterBindData`, `beforeDoOperation`, `afterDoOperation`
...
**CALL_CROSS_SERVICE** · OrgDiffTempListPlugin L154
```java
 152               return;
 153           }
 154 >         List tipList = (List)HRMServiceHelper.invokeHRMPService((String)"hrcs", (String)"IHRCSService", (String)"queryPromptForString", (Object[])new Object[]{"homs_orgdifftemp", "showlisttip", this.getModel().getDataEntity()});
 155           if (CollectionUtils.isEmpty((Collection)tipList)) {
 156               return;
```
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgdifftemp.OrgDiffTempListPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempSaveOp -->

## ISV 扩展指引（基于 OrgDiffTempSaveOp 真实证）

> FQN: `kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempSaveOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempSaveOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempEnableOp -->

## ISV 扩展指引（基于 OrgDiffTempEnableOp 真实证）

> FQN: `kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempEnableOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempEnableOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempEnableOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.opplugin.web.orgdifftemp.OrgDiffTempEnableOp/extension_guide.md)
