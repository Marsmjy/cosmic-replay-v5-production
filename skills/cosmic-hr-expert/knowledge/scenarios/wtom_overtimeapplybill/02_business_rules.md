...
## ✅ verified · 主表 `wtom_overtimeapplybill` 共 63 个 opKey
...
| 6 | `WTCBillOtherApplyOp` | enabled=True |
...
| 6 | `WTCBillReplenishOriginalOp` | enabled=True |
| 7 | `OtApplyArchiveControlValidateOp` | enabled=True |
| 8 | `WTCBillUpdateAttfileOp` | enabled=True |
...
| 6 | `OtApplyArchiveControlValidateOp` | enabled=True |
...
- `importdata_hr` · `show_import_record_hr` · `export_from_impttpl_hr` · `show_export_record_hr` · `export_from_expttpl_hr` · `new` · `close` · `copy` · `option` · `submitandnew` · `view` · `first`
- `previous` · `next` · `last` · `importtemplate` · `importtemplatelist` · `returndata` · `mobtoolbarselect` · `mobtoolbarcancel` · `viewtrash` · `trash` · `restoredata` · `modify`
- `wfauditing` · `wfrejecttosubmit` · `wfauditnotpass` · `wfauditpass` · `viewflowchart` · `unaudit` · `deleteentry` · `newentry` · `deletescentry` · `deletsdeentry` · `newentry2` · `mydeleteentry`
- `mynewentry` · `openoverworktype` · `openmutiselectdate` · `openselecttype` · `openselectperson` · `newowner` · `newother` · `importdetails` · `importdata` · `exportlist` · `importexport_userset` · `exportlistbyselectfields`
- `exportlist_expt` · `exportdetails` · `newscentry` · `newsdentry` · `showhisbill`
