...
主表 `wtom_overtimeapplybill` 标品接入 **39** 个插件。
...
- `OtApplyBillOtherList` ← `kd.wtc.wtom.fromplugin.web.otapplybill.OtApplyBillOtherList`
...
- order **8**: `WTCBillChangeStatusOp` · enabled=True
...
- order **5**: `WTCBillOtherApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillOtherApplyOp`
- order **6**: `WTCBillReplenishOriginalOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillReplenishOriginalOp`
- order **7**: `OtApplyArchiveControlValidateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyArchiveControlValidateOp`
- order **8**: `WTCBillUpdateAttfileOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillUpdateAttfileOp`
...
- order **6**: `OtApplyArchiveControlValidateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyArchiveControlValidateOp`
