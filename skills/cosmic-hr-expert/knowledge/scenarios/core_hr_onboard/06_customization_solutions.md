# core_hr_onboard · 定制方案（ISV 扩展真实模板）

> **场景**：入职管理（hom · 入职办理 + 预入职 + 候选人协作）（7 个子实体）
> **生成时间**：2026-04-30

## CS-01 · 给子实体加 ISV 自定义字段

**适用**：`hom_onbrdinfo`, `hom_onbrdinfo_emp`, `hom_preonbrdbasebill`, `hom_prebatchonbrdbill`, `hom_personallonbrd`, `hom_personwaitstart` ...（任一子实体）
...
**真发证据 / 反编译示例（如有）**：
- `OnbrdAfterEffectOp.java` (8052 bytes)
- `OnbrdBillSaveOp.java` (30153 bytes)
- `OnbrdEffectOp.java` (4189 bytes)
