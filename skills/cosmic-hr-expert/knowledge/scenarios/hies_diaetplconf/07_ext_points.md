...
主表 `hies_diaetplconf` 标品接入 **25** 个插件。
...
- `TemplateConfPlugin` ← `kd.hr.impt.formplugin.TemplateConfPlugin`
- `TemplateAddSubEntityPlugin` ← `kd.hr.hies.formplugin.TemplateAddSubEntityPlugin`
...
- `TemplateTreeListEdit` ← `kd.hr.hies.formplugin.TemplateTreeListEdit`
...
- `TemplateSaveOp` ← `kd.hr.hies.opplugin.web.TemplateSaveOp`
- `CodeRuleDeleteOp` ← `kd.bos.coderule.CodeRuleDeleteOp`
- `TemplateDeleteOp` ← `kd.hr.hies.opplugin.web.TemplateDeleteOp`
- `TemplateEnableOp` ← `kd.hr.hies.opplugin.web.TemplateEnableOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.impt.formplugin.TemplateConfPlugin -->
...
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `registerListener`, `preOpenForm`, `beforeItemClick`, `afterCreateNewData`, `afterLoadData`, `beforeBindData`, `afterBindData`, `beforeF7Select`, `beforeDoOperation`, `propertyChanged`, `click`, `afterDoOperation`, `closedCallBack`, `beforeClosed`
...
- `public static public static void showTplList(kd.bos.form.IFormView, java.lang.String, java.lang.String)`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.impt.formplugin.TemplateConfPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.impt.formplugin.TemplateConfPlugin/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.impt.formplugin.TemplateConfPlugin -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hies.formplugin.TemplateAddSubEntityPlugin -->
...
- 父类: `kd.hr.hbp.formplugin.web.HRBaseDataCommonEdit`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `afterLoadData`, `registerListener`, `beforeBindData`, `afterBindData`, `beforeItemClick`, `itemClick`, `afterDoOperation`, `click`, `afterCreateNewData`, `beforeF7Select`, `propertyChanged`, `closedCallBack`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hies.formplugin.TemplateAddSubEntityPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hies.formplugin.TemplateAddSubEntityPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hies.formplugin.TemplateTreeListEdit -->
...
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `itemClick`, `beforeDoOperation`, `beforeItemClick`, `setFilter`, `closedCallBack`, `afterDoOperation`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hies.formplugin.TemplateTreeListEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hies.formplugin.TemplateTreeListEdit/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hies.opplugin.web.TemplateSaveOp -->

## ISV 扩展指引（基于 TemplateSaveOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hies.opplugin.web.TemplateSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hies.opplugin.web.TemplateSaveOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hies.opplugin.web.TemplateSaveOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hies.opplugin.web.TemplateEnableOp -->

## ISV 扩展指引（基于 TemplateEnableOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hies.opplugin.web.TemplateEnableOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hies.opplugin.web.TemplateEnableOp/extension_guide.md)
