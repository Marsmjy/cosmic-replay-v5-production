...
- `ShiftHRImportSaveOp` ← `kd.wtc.wtbd.opplugin.web.shift.ShiftHRImportSaveOp`
...
- order **9**: `HisModelOPCommonPlugin` · 时态模型通用 · his_bsed/his_bsled/effectdate 的维护
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin`
- order **10**: `ShiftHRImportSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.shift.ShiftHRImportSaveOp`
