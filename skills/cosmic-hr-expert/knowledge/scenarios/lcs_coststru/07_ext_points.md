...
- `CostStruEdit` ← `kd.hrmp.lcs.formplugin.web.basedata.CostStruEdit`
...
- `CostStruUnAuditOp` ← `kd.hrmp.lcs.opplugin.web.CostStruUnAuditOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.lcs.formplugin.web.basedata.CostStruEdit -->

## ISV 扩展指引（基于 CostStruEdit 真实证）
...
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `beforeBindData`, `registerListener`, `beforeDoOperation`, `afterDoOperation`, `beforeF7Select`, `closedCallBack`, `beforeClosed`
...
- `public public void beforeDoOperation(kd.bos.form.events.BeforeDoOperationEventArgs)` ⭐ lifecycle
- `public public void afterMoveEntryUp(kd.bos.entity.datamodel.events.AfterMoveEntryEventArgs)`
- `public public void afterMoveEntryDown(kd.bos.entity.datamodel.events.AfterMoveEntryEventArgs)`
- `public public void afterDoOperation(kd.bos.form.events.AfterDoOperationEventArgs)` ⭐ lifecycle
...
- `public public void beforeClosed(kd.bos.form.events.BeforeClosedEvent)` ⭐ lifecycle
- `public static public static kd.bos.orm.query.QFilter getBaseDataFilter(java.lang.String, java.lang.Long)`

### SDK 范式（ISV 抄作业）

**QUERY_BUILDER** · CostBasaDataHelper L37
```java
  35       public static DynamicObject[] getDimensionObjArrByPkIdList(Object[] primaryKeyValue) {
  36           HRBaseServiceHelper serviceHelper = new HRBaseServiceHelper("lcs_costdimension");
  37 >         QFilter enableFilter = new QFilter("enable", "=", (Object)"1");
  38           QFilter auditFilter = new QFilter("status", "=", (Object)"C");
  39           QFilter idFilter = new QFilter("id", "in", (Object)primaryKeyValue);
```

**READ_VIA_HELPER** · CostStruEdit L491
```java
 489   
 490       public static QFilter getBaseDataFilter(String entityID, Long orgID) {
 491 >         return BaseDataServiceHelper.getBaseDataFilter((String)entityID, (Long)orgID);
 492       }
 493   
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.basedata.CostStruEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.basedata.CostStruEdit/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.lcs.opplugin.web.CostStruUnAuditOp -->

## ISV 扩展指引（基于 CostStruUnAuditOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.lcs.opplugin.web.CostStruUnAuditOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.lcs.opplugin.web.CostStruUnAuditOp/extension_guide.md)
