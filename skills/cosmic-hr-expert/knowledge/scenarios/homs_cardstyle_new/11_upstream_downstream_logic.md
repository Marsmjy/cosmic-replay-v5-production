...
> 本 form（`homs_cardstyle_new`，所属 组织发展云）引用了其他云的 **1** 个底座实体：

### ⬆️ HR 基础服务云（`hr_hrmp`）1 个引用

| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `policy` | 不可见策略字段 | BasedataField | `brm_policy_edit` | [brm_policy_edit](../brm_policy_edit/) |
