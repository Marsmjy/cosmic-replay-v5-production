...
### `hbss_diploma` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_degree` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_diplomatype` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_educerttype` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_languagecert` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_languagetype` · 语言种类
...
### `hbss_trainmode` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_traintype` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_ocpqual` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_ocpquallevel` · ⚠️ 标品 entity_metadata md 不存在
...
- `modifier` (修改人) → `bos_user` · `ModifierField`
- `disabler` (禁用人) → `bos_user` · `UserField`
- `protitletype` (职称类别) → `hbss_protitletype` · `BasedataField`

**标品公共字段**：`number`, `name`, `status`, `creator`, `modifier`, `enable`, `createtime`, `modifytime`, `masterid`, `issyspreset`

> ⚠️ 这些字段由 HRBaseDataTplEdit 标品维护 · ISV **不可改值**（除特殊场景）

### `hbss_protitlelevel` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_protitletype` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_operationqual` · 执业资格
...
### `hbss_patentstatus` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_patentscategory` · ⚠️ 标品 entity_metadata md 不存在

### `hbss_credentialstype` · 证件类型
...
- `modifier` (修改人) → `bos_user` · `ModifierField`
- `disabler` (禁用人) → `bos_user` · `UserField`
- `certnumformat` (证件号码格式) → `cts_personal_identity` · `BasedataField`
