...
主表 `wtte_qtdetailcarryaj` 标品接入 **24** 个插件。
...
- `QTDetailCarryAjEdit` ← `kd.wtc.wtte.formplugin.web.quota.QTDetailCarryAjEdit`
...
- `QTDetailCarryAjList` ← `kd.wtc.wtte.formplugin.web.quota.QTDetailCarryAjList`
...
- `QuotaDetailCarryAdjustOp` ← `kd.wtc.wtte.opplugin.web.quota.QuotaDetailCarryAdjustOp`
...
## ✅ verified · opKey 扩展切入点详解（8 个有执行链的 opKey）
...
- order **6**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **7**: `QuotaDetailCarryAdjustOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.quota.QuotaDetailCarryAdjustOp`
...
- order **5**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **6**: `QuotaDetailCarryAdjustOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.quota.QuotaDetailCarryAdjustOp`
...
- order **1**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **2**: `QuotaDetailCarryAdjustOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.quota.QuotaDetailCarryAdjustOp`
