...
**预期产出**：完整工程包（4 java + N datamodel + 工程文件 + 部署 SOP）。
...
详见 [`_assets/bankcardchange/deploy_sop.md`](../../_assets/bankcardchange/deploy_sop.md)
...
- 加审批工作流
- 接其他外部系统
- 详见 [`_assets/bankcardchange/customization_points.md`](../../_assets/bankcardchange/customization_points.md)
