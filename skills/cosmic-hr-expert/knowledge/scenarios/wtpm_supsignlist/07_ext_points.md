...
主表 `wtpm_supsignlist` 标品接入 **11** 个插件。
...
- `SupSignBatchList` ← `kd.wtc.wtpm.formplugin.suppleapply.SupSignBatchList`

### OpPlugin（1）
- `CodeRuleOp` ← `kd.bos.business.plugin.CodeRuleOp`

## ✅ verified · 反编译实抓真处理类（7 个 · ISV 可继承 3 / 禁继承 4）
