...
## ✅ verified · 主表 `wtpm_supsignlist` 共 42 个 opKey
...
- `print` · `submitandnew` · `view` · `printsetting` · `mobtoolbarselect` · `mobtoolbarcancel` · `viewtrash` · `trash` · `restoredata` · `modify` · `discard` · `wfauditing`
- `wfrejecttosubmit` · `wfauditnotpass` · `wfauditpass` · `unaudit` · `audit` · `batchnew` · `viewlog` · `dodelete` · `dodiscard` · `dounsubmit` · `exportlist_expt` · `exportlist`
- `exportlistbyselectfields` · `exportdetails` · `viewflowchart` · `saveofsubmit` · `saveofsubmiteffect`
