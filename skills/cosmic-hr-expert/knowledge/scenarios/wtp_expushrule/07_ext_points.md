...
- `ExPushRulePlugin` ← `kd.wtc.wtp.formplugin.web.abnormal.ExPushRulePlugin`
...
- `ExPushRuleList` ← `kd.wtc.wtp.formplugin.web.abnormal.ExPushRuleList`
...
- `ExPushRuleSaveOp` ← `kd.wtc.wtp.opplugin.web.ex.ExPushRuleSaveOp`
...
- order **7**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **8**: `ExPushRuleSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.ex.ExPushRuleSaveOp`
...
- order **6**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **7**: `ExPushRuleSaveOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.ex.ExPushRuleSaveOp`
