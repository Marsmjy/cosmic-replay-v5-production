...
## ✅ verified · 主表 `wtp_expushrule` 共 57 个 opKey
...
| 8 | `ExPushRuleSaveOp` | enabled=True |
...
| 7 | `ExPushRuleSaveOp` | enabled=True |
...
- `auto_assign` · `tbl_assign_import` · `logview` · `viewonelog` · `msgnewentry` · `msgdeleteentry` · `msgmoveentryup` · `msgmoveentrydown` · `pusnewentry` · `pusdeleteentry` · `pusmoveentryup` · `pusmoveentrydown`
