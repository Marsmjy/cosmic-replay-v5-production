...
## ✅ verified · 主表 `wtp_qtformulaset` 共 64 个 opKey
...
| 9 | `FormulaSettingOp` | enabled=True |
| 10 | `FormulaSetOp` | enabled=True |
...
| 4 | `FormulaSettingOp` | enabled=True |
...
| 3 | `FormulaSettingOp` | enabled=True |
...
- `showallversion` · `formulaformat` · `grammarcheck` · `formulapreview` · `simulation` · `vieweg`

## ✅ verified · 反编译类画像（共 23 个真处理类）
...
| `FormulaFuncTreePlugin` | FORM_PLUGIN | `save` | ✅ | registerListener | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin/extension_guide.md) |
| `FormulaItemTreePlugin` | FORM_PLUGIN | `save` | ✅ | registerListener | [查看](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.formula.FormulaItemTreePlugin/extension_guide.md) |
...
（共 23 · 详见 `_deep_resolve_index.json`）
