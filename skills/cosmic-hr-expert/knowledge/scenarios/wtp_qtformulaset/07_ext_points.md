...
主表 `wtp_qtformulaset` 标品接入 **56** 个插件。
...
- `FormulaSettingEdit` ← `kd.hr.hbp.formplugin.web.formula.FormulaSettingEdit`
- `FormulaFuncTreePlugin` ← `kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin`
- `FormulaItemTreePlugin` ← `kd.hr.hbp.formplugin.web.formula.FormulaItemTreePlugin`
- ...（共 29，详见 `_auto_plugin_registry.md`）
...
- `FormulaSetOp` ← `kd.wtc.wtp.opplugin.web.formula.FormulaSetOp`
- `CodeRuleDeleteOp` ← `kd.bos.coderule.CodeRuleDeleteOp`
- `FormulaSettingOp` ← `kd.hr.hbp.opplugin.web.formula.FormulaSettingOp`
...
## ✅ verified · 反编译实抓真处理类（23 个 · ISV 可继承 13 / 禁继承 10）
...
#### `FormulaFuncTreePlugin` · FORM_PLUGIN @ `BILL_FORM` · opKey=`save`

- **完整 FQN**: `kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin`
- **完整继承链**: `kd.bos.form.plugin.AbstractFormPlugin`
- **重写生命周期方法（1）**:
  - `registerListener` — ISV 子类可在此切入扩展逻辑
- **静态指标**: 写表 0 · 发事件 0 · 抛异常 11 · 调核心 Service 0 · trace 访问 10 类
- **ISV 扩展套路**：
  ```java
  package <你的 ISV 包>;
  
  import kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin;
  
  public class IsvCustomFormulaFuncTreePlugin extends FormulaFuncTreePlugin {
      @Override
  ...
  ```
- **详细 ISV 扩展指南**: [`<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin/extension_guide.md`](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.formula.FormulaFuncTreePlugin/extension_guide.md)

#### `FormulaItemTreePlugin` · FORM_PLUGIN @ `BILL_FORM` · opKey=`save`

- **完整 FQN**: `kd.hr.hbp.formplugin.web.formula.FormulaItemTreePlugin`
- **完整继承链**: `kd.bos.form.plugin.AbstractFormPlugin`
- **重写生命周期方法（1）**:
  - `registerListener` — ISV 子类可在此切入扩展逻辑
- **静态指标**: 写表 0 · 发事件 0 · 抛异常 11 · 调核心 Service 0 · trace 访问 17 类
- **ISV 扩展套路**：
  ```java
  package <你的 ISV 包>;
  
  import kd.hr.hbp.formplugin.web.formula.FormulaItemTreePlugin;
  
  public class IsvCustomFormulaItemTreePlugin extends FormulaItemTreePlugin {
      @Override
      public void registerListener(... args) {
          super.registerListener(args);  // 必调 super · 保留标品行为
          // 你的 ISV 业务逻辑 ...
  ...
  ```
- **详细 ISV 扩展指南**: [`<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.formula.FormulaItemTreePlugin/extension_guide.md`](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.formula.FormulaItemTreePlugin/extension_guide.md)
...
#### `FormulaSettingOp` · OP_PLUGIN @ `OPERATION` · opKey=`audit`

- **完整 FQN**: `kd.hr.hbp.opplugin.web.formula.FormulaSettingOp`
- **完整继承链**: `kd.hr.hbp.opplugin.web.HRDataBaseOp`
- **重写生命周期方法（2）**:
  - `onPreparePropertys` — ISV 子类可在此切入扩展逻辑
  - `onAddValidators` — ISV 子类可在此切入扩展逻辑
...
- **ISV 扩展套路**：
  ...
  import kd.hr.hbp.opplugin.web.formula.FormulaSettingOp;
  
  public class IsvCustomFormulaSettingOp extends FormulaSettingOp {
      @Override
      public void onPreparePropertys(... args) {
          super.onPreparePropertys(args);  // 必调 super · 保留标品行为
          // 你的 ISV 业务逻辑 ...
  ...
  ```
- **详细 ISV 扩展指南**: [`<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.formula.FormulaSettingOp/extension_guide.md`](../../<skills-dir>/cosmic-hr-expert/knowledge/_sdk_audit/_decompiled_deep/kd.hr.hbp.opplugin.web.formula.FormulaSettingOp/extension_guide.md)
...
- order **9**: `HisModelOPCommonPlugin` · 时态模型通用 · his_bsed/his_bsled/effectdate 的维护
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin`
- order **10**: `FormulaSetOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.formula.FormulaSetOp`
...
- order **8**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **9**: `FormulaSettingOp` · enabled=True
  - 完整 FQN: `kd.hr.hbp.opplugin.web.formula.FormulaSettingOp`
- order **10**: `FormulaSetOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.formula.FormulaSetOp`
...
- order **3**: `HisModelOPCommonPlugin` · 时态模型通用 · his_bsed/his_bsled/effectdate 的维护
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin`
- order **4**: `FormulaSettingOp` · enabled=True
  - 完整 FQN: `kd.hr.hbp.opplugin.web.formula.FormulaSettingOp`
...
- order **2**: `HisUniqueValidateOp` · 时态模型唯一性校验（同一 boid 同一时间段唯一）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.history.HisUniqueValidateOp`
- order **3**: `FormulaSettingOp` · enabled=True
  - 完整 FQN: `kd.hr.hbp.opplugin.web.formula.FormulaSettingOp`
