...
- `CostCenterEdit` ← `kd.hrmp.lcs.formplugin.web.costcenter.CostCenterEdit`
...
- `CostCenterList` ← `kd.hrmp.lcs.formplugin.web.costcenter.CostCenterList`
...
- `CostCenterAuditOp` ← `kd.hrmp.lcs.opplugin.web.CostCenterAuditOp`
- `CostCenterEnableOp` ← `kd.hrmp.lcs.opplugin.web.CostCenterEnableOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.lcs.formplugin.web.costcenter.CostCenterEdit -->

## ISV 扩展指引（基于 CostCenterEdit 真实证）

> FQN: `kd.hrmp.lcs.formplugin.web.costcenter.CostCenterEdit`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.costcenter.CostCenterEdit/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`, `afterBindData`, `beforeF7Select`
...
**QUERY_BUILDER** · CostCenterEdit L57
```java
  55               case "parent": {
  56                   long parentId = this.getModel().getDataEntity().getLong("id");
  57 >                 QFilter idFilter = new QFilter("id", "!=", (Object)parentId);
  58                   event.addCustomQFilter(idFilter);
  59                   break;
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.costcenter.CostCenterEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.costcenter.CostCenterEdit/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.lcs.formplugin.web.costcenter.CostCenterList -->

## ISV 扩展指引（基于 CostCenterList 真实证）

> FQN: `kd.hrmp.lcs.formplugin.web.costcenter.CostCenterList`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.costcenter.CostCenterList/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseList`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `registerListener`, `setFilter`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.costcenter.CostCenterList/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.costcenter.CostCenterList/extension_guide.md)
