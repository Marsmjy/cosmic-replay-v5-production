...
主表 `hrcs_orgstrategy` 标品接入 **22** 个插件。
...
- `AdminOrgManageStrategyEdit` ← `kd.hr.hrcs.formplugin.web.managestrategy.AdminOrgManageStrategyEdit`
- `HRPermCommonEdit` ← `kd.hr.hbp.formplugin.web.HRPermCommonEdit`
- `OrgManageStrategyQueryPlugin` ← `kd.hr.hrcs.formplugin.web.managestrategy.OrgManageStrategyQueryPlugin`
...
- `OrgManageStrategySaveOp` ← `kd.hr.hrcs.opplugin.web.OrgManageStrategySaveOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.managestrategy.AdminOrgManageStrategyEdit -->

## ISV 扩展指引（基于 AdminOrgManageStrategyEdit 真实证）
...
### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hrcs.formplugin.web.managestrategy.OrgManageStrategyEdit`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: (无)
...
**READ_VIA_HELPER** · AdminOrgManageStrategyEdit L33
```java
  31               return null;
  32           }
  33 >         return ManageStrategyServiceHelper.getStrategyTypes((DynamicObject)adminorg, (Long)this.getOrgType(), (Long)ManageStrategyConstants.LONG_BUSSINESSOBJECTID_ID_ORG, (Long)0L);
  34       }
  35   }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.AdminOrgManageStrategyEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.AdminOrgManageStrategyEdit/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.managestrategy.OrgManageStrategyQueryPlugin -->

## ISV 扩展指引（基于 OrgManageStrategyQueryPlugin 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.OrgManageStrategyQueryPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.OrgManageStrategyQueryPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.OrgManageStrategySaveOp -->

## ISV 扩展指引（基于 OrgManageStrategySaveOp 真实证）
...
**READ_VIA_HELPER** · OrgManageStrategySaveOp L25
```java
  23           HRBaseServiceHelper hrBaseServiceHelper = new HRBaseServiceHelper("hrcs_orgstrategy");
  24           for (DynamicObject newOrgStrategyDy : newOrgStrategyDys) {
  25 >             DynamicObject oldOrgStrategyDy = hrBaseServiceHelper.queryOne("id, orgteam, inheritedorg, hrbu, sourceorg, strategytype, status, enable,effdt, effectivedate,changetype, modifytime, modifier, entryentity.id,entryentity.entryhrbu,entryentity.entryinheritedorg, entryentity.entryenable,entryentity.entryorgteam,entryentity.bussinessfield, entryentity.strategyentrytype,entryentity.entrysourceorg, entryeffdt, entryentity.entrydefstrategy, defstrategytype,entryentity.entrychangetype", (Object)newOrgStrategyDy.getLong("id"));
  26               StrategyServiceHelper.sysnSubOrgStrategy((DynamicObject)oldOrgStrategyDy, (DynamicObject)newOrgStrategyDy, (String)"org");
  27           }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.OrgManageStrategySaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.OrgManageStrategySaveOp/extension_guide.md)
