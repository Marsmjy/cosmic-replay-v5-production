...
- `delete` · 删除
- `disable` · 禁用
- `deletefetchfieldentry` · 空操作
- `deleterelationentry` · 删除条件分录
- `deletedatasortentry` · 空操作
- `deletecalitementry` · 删除计算项目映射列表分录
- `deleteentry` · 删除条件分录
...
- `mobtoolbarselect` · 选择
- `mobtoolbarcancel` · 取消
- ...（共 23 个，参见 `_auto_operations.md`）

## ✅ verified · 标品插件链

- 主表 `wtbd_retrievalconfig`：**40** 个标品插件接入
- 字段总数：**49** 个（实抓自 OpenAPI listMeta）
