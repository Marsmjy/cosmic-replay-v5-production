...
## ✅ verified · 主表 `wtbd_retrievalconfig` 共 61 个 opKey
...
| 8 | `RetrievalConfigOp` | enabled=True |
...
| 4 | `HRBaseDataLogOp` | HR 基础资料操作日志 |
| 5 | `RetrievalConfigOp` | enabled=True |
...
| 3 | `RetrievalConfigOp` | enabled=True |
...
- `auto_assign` · `tbl_assign_import` · `logview` · `viewonelog` · `movefieldentryup` · `movefieldentrydown` · `movesortentryup` · `movesortentrydown` · `deletefetchfieldentry` · `deleterelationentry` · `deletedatasortentry` · `deletecalitementry`
- `addfetchfieldentry` · `addrelationentry` · `adddatasortentry` · `deleteentry`
