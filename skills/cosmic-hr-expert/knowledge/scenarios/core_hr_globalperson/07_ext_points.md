...
主表 `hrpi_globalperson` 标品接入 **8** 个插件。
...
- `GlobalPersonDeleteOp` ← `kd.hrmp.hrpi.opplugin.web.globalperson.GlobalPersonDeleteOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.globalperson.GlobalPersonDeleteOp -->

## ISV 扩展指引（基于 GlobalPersonDeleteOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.globalperson.GlobalPersonDeleteOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.globalperson.GlobalPersonDeleteOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.globalperson.GlobalPersonDeleteOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.globalperson.GlobalPersonDeleteOp/extension_guide.md)
