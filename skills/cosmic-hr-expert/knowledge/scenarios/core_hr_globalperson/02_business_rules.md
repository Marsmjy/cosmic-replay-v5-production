# core_hr_globalperson · 业务规则

> **form**：`hrpi_globalperson` · 全球员工
> **生成时间**：2026-04-29
...
### `GlobalPersonDeleteOp`

- **FQN**：`kd.hrmp.hrpi.opplugin.web.globalperson.GlobalPersonDeleteOp`
- **继承**：`HRDataBaseOp`

**实现的生命周期方法**：`onAddValidators`(L19), `beginOperationTransaction`(L23)
...
- 数据源：`_sdk_audit/_decompiled/scenarios/core_hr_globalperson/` 的 6 个反编译类 + `_shared/_standard_metadata/entity_metadata/hrpi_globalperson.md`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hrmp.hrpi.opplugin.web.globalperson.GlobalPersonDeleteOp -->

## chgaction 实证补充（GlobalPersonDeleteOp 跨类追踪聚合）
