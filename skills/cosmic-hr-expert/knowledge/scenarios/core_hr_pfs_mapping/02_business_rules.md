# core_hr_pfs_mapping · 业务规则

> **聚合场景**：⭐⭐⭐ pfs 字段映射引擎（ISV 零代码扩展利器）（4 个子实体）
> **生成时间**：2026-04-30
...
### `hpfs_filemapmanager` · ⚠️ 标品 entity_metadata md 不存在

### `hpfs_fieldrelation` · ⚠️ 标品 entity_metadata md 不存在

### `hpfs_fieldrelationc` · ⚠️ 标品 entity_metadata md 不存在

### `hpfs_hrbm_config` · ⚠️ 标品 entity_metadata md 不存在
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hpfs.formplugin.fieldmap.FileMapManagerEdit -->

## chgaction 实证补充（FileMapManagerEdit 跨类追踪聚合）
...
| 实体 | 操作 | 入口类 | 来源链 |
|---|---|---|---|
| `bos_entityobject` | deleteByFilter | HRBaseServiceHelper | kd.hr.hpfs.business.application.service.fileMap.FileMapManag |

### 业务异常清单（含异常码 + 中文消息）
| 异常码 | 业务消息 |
|---|---|
| `` | sb.length() > 0 ? sb.toString() : "save error" |
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hpfs.formplugin.fieldmap.FileMapManagerNewAddEdit -->

## chgaction 实证补充（FileMapManagerNewAddEdit 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hpfs.opplugin.fieldmap.FileMapManagerSaveOp -->

## chgaction 实证补充（FileMapManagerSaveOp 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hpfs.formplugin.fieldmap.FieldRelationEdit -->

## chgaction 实证补充（FieldRelationEdit 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hpfs.formplugin.fieldmap.BeforeCloseValidEdit -->

## chgaction 实证补充（BeforeCloseValidEdit 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hpfs.formplugin.fieldmap.FieldRelationCEdit -->

## chgaction 实证补充（FieldRelationCEdit 跨类追踪聚合）
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hpfs.formplugin.ext.HpfsChgHrbmExtConfigPlugin -->

## chgaction 实证补充（HpfsChgHrbmExtConfigPlugin 跨类追踪聚合）
