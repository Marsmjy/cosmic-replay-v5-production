...
## ✅ verified · 主表 `wtp_varule` 共 69 个 opKey
...
| 10 | `VacationRuleSaveOp` | enabled=True |
...
| 9 | `VacationRuleSaveOp` | enabled=True |
...
| 4 | `VacationRuleSaveOp` | enabled=True |
...
| 3 | `VacationRuleSaveOp` | enabled=True |
...
- `showallversion` · `addabnormaldispose` · `newentry` · `newsubentry` · `donothing_edit` · `addrow` · `deleteentry` · `copyentryrow` · `moveentryup` · `moveentrydown` · `editrow`
