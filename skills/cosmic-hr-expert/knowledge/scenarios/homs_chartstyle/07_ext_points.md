...
主表 `homs_chartstyle` 标品接入 **20** 个插件。
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.homs.formplugin.web.orgchart.ChartStyleFilterListPlugin -->

## ISV 扩展指引（基于 ChartStyleFilterListPlugin 真实证）

> FQN: `kd.hr.homs.formplugin.web.orgchart.ChartStyleFilterListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.ChartStyleFilterListPlugin/`
...
**QUERY_BUILDER** · ChartStyleFilterListPlugin L22
```java
  20           super.setFilter(setFilterEvent);
  21           List qFilters = setFilterEvent.getQFilters();
  22 >         QFilter carddimensionidFilter = new QFilter("carddimensionid", "in", Arrays.asList(Long.parseLong("1010"), Long.parseLong("1020")));
  23           qFilters.add(carddimensionidFilter);
  24       }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.ChartStyleFilterListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.homs.formplugin.web.orgchart.ChartStyleFilterListPlugin/extension_guide.md)
