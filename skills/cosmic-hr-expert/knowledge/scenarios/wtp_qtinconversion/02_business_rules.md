...
## ✅ verified · 主表 `wtp_qtinconversion` 共 54 个 opKey
...
| 9 | `QTInConversionOp` | enabled=True |
...
| 8 | `QTInConversionOp` | enabled=True |
...
- `tbl_assign_import` · `logview` · `viewonelog` · `donothing_assgin` · `donothing_manage` · `copy` · `newentry` · `deleteentry`
