...
主表 `wtp_qtinconversion` 标品接入 **43** 个插件。
...
- `QTInConversionEdit` ← `kd.wtc.wtp.formplugin.web.quota.inconver.QTInConversionEdit`
...
- `WTCSnapList` ← `kd.wtc.wtbs.formplugin.web.WTCSnapList`
- `QTInConversionList` ← `kd.wtc.wtp.formplugin.web.quota.inconver.QTInConversionList`
...
- `QTInConversionOp` ← `kd.wtc.wtp.opplugin.web.quota.QTInConversionOp`
...
- order **8**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **9**: `QTInConversionOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.quota.QTInConversionOp`
...
- order **7**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **8**: `QTInConversionOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.quota.QTInConversionOp`
