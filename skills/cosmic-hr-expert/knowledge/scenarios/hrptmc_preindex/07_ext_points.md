...
主表 `hrptmc_preindex` 标品接入 **18** 个插件。
...
- `ReportPresetIndexEdit` ← `kd.hr.hrptmc.formplugin.web.preindex.ReportPresetIndexEdit`
...
- `ReportPresetIndexListPlugin` ← `kd.hr.hrptmc.formplugin.web.preindex.ReportPresetIndexListPlugin`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrptmc.formplugin.web.preindex.ReportPresetIndexEdit -->

## ISV 扩展指引（基于 ReportPresetIndexEdit 真实证）

> FQN: `kd.hr.hrptmc.formplugin.web.preindex.ReportPresetIndexEdit`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrptmc.formplugin.web.preindex.ReportPresetIndexEdit/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`, `beforeF7Select`, `beforeBindData`, `afterBindData`, `afterLoadData`, `itemClick`, `propertyChanged`, `closedCallBack`, `beforeDoOperation`
...
**QUERY_BUILDER** · ReportPresetIndexEdit L120
```java
 118       public void beforeF7Select(BeforeF7SelectEvent evt) {
 119           ListShowParameter formShowParameter = (ListShowParameter)evt.getFormShowParameter();
 120 >         QFilter qFilter = new QFilter("objecttype", "=", (Object)"multientity");
 121           formShowParameter.getListFilterParameter().setFilter(qFilter);
 122       }
```

**READ_VIA_HELPER** · ReportCommonUtils L38
```java
  36   public class ReportCommonUtils {
  37       public static boolean validateNumberByISVIsKD() {
  38 >         ISVInfo isvInfo = ISVServiceHelper.getISVInfo();
  39           String isvId = isvInfo.getId();
  40           return HRStringUtils.equals((String)isvId, (String)"kingdee");
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrptmc.formplugin.web.preindex.ReportPresetIndexEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrptmc.formplugin.web.preindex.ReportPresetIndexEdit/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrptmc.formplugin.web.preindex.ReportPresetIndexListPlugin -->

## ISV 扩展指引（基于 ReportPresetIndexListPlugin 真实证）

> FQN: `kd.hr.hrptmc.formplugin.web.preindex.ReportPresetIndexListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrptmc.formplugin.web.preindex.ReportPresetIndexListPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseList`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `afterDoOperation`, `closedCallBack`, `setFilter`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrptmc.formplugin.web.preindex.ReportPresetIndexListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrptmc.formplugin.web.preindex.ReportPresetIndexListPlugin/extension_guide.md)
