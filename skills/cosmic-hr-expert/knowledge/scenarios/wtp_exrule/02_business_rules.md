...
## ✅ verified · 主表 `wtp_exrule` 共 75 个 opKey
...
- `showallversion` · `deleteentry` · `newentry` · `previousentry` · `nextentry` · `newecentry` · `deleteentry2` · `moveentryup` · `nextentry1` · `donothing_edit` · `donothing_assgin` · `deleteentry3`
