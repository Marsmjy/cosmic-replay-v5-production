...
主表 `wtp_suppletimeset` 标品接入 **39** 个插件。
...
- `SuppleTimeLimitEdit` ← `kd.wtc.wtp.formplugin.web.supple.SuppleTimeLimitEdit`
...
- `SuppleTimeLimitOp` ← `kd.wtc.wtp.opplugin.web.supple.SuppleTimeLimitOp`
...
- order **7**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **8**: `SuppleTimeLimitOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.supple.SuppleTimeLimitOp`
...
- order **6**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **7**: `SuppleTimeLimitOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtp.opplugin.web.supple.SuppleTimeLimitOp`
