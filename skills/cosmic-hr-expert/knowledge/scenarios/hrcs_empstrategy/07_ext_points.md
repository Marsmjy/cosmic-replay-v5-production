...
主表 `hrcs_empstrategy` 标品接入 **22** 个插件。
...
- `AdminEmpStrategyEditPlugin` ← `kd.hr.hrcs.formplugin.web.managestrategy.AdminEmpStrategyEditPlugin`
- `HRPermCommonEdit` ← `kd.hr.hbp.formplugin.web.HRPermCommonEdit`
- `EmpManageStrategyQueryPlugin` ← `kd.hr.hrcs.formplugin.web.managestrategy.EmpManageStrategyQueryPlugin`
...
- `ManageStrategyListPlugin` ← `kd.hr.hrcs.formplugin.web.managestrategy.log.ManageStrategyListPlugin`
...
- `ManageStrategyLogOp` ← `kd.hr.hrcs.opplugin.web.strategy.ManageStrategyLogOp`
- `EmpManageStrategySaveOp` ← `kd.hr.hrcs.opplugin.web.EmpManageStrategySaveOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.managestrategy.AdminEmpStrategyEditPlugin -->

## ISV 扩展指引（基于 AdminEmpStrategyEditPlugin 真实证）

> FQN: `kd.hr.hrcs.formplugin.web.managestrategy.AdminEmpStrategyEditPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.AdminEmpStrategyEditPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hrcs.formplugin.web.managestrategy.EmpStrategyEditPlugin`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: (无)

### 可重写方法（target.java self）
- `protected protected java.lang.Long getOrgType()`
- `protected protected java.lang.Long getBusinessObjectId()`
- `protected protected java.util.List<java.lang.String> getStrategyTypes()`

### SDK 范式（ISV 抄作业）

**READ_VIA_HELPER** · AdminEmpStrategyEditPlugin L33
```java
  31               return null;
  32           }
  33 >         return ManageStrategyServiceHelper.getStrategyTypes((DynamicObject)adminorg, (Long)this.getOrgType(), (Long)ManageStrategyConstants.LONG_BUSSINESSOBJECTID_ID_EMP, (Long)0L);
  34       }
  35   }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.AdminEmpStrategyEditPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.AdminEmpStrategyEditPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.managestrategy.log.ManageStrategyListPlugin -->

## ISV 扩展指引（基于 ManageStrategyListPlugin 真实证）

> FQN: `kd.hr.hrcs.formplugin.web.managestrategy.log.ManageStrategyListPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.log.ManageStrategyListPlugin/`
...
**QUERY_BUILDER** · ManageStrategyListPlugin L56
```java
  54           lsp.setBillFormId("hbss_history_logview");
  55           ListFilterParameter listFilterParameter = new ListFilterParameter();
  56 >         QFilter bizobj = new QFilter("bizobj", "=", (Object)billFormId);
  57           if (primaryKeyValue != 0L) {
  58               QFilter qFilter = new QFilter("modifybillid", "in", (Object)new String[]{String.valueOf(primaryKeyValue), primaryKeyValue + "+", primaryKeyValue + "-"});
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.log.ManageStrategyListPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.log.ManageStrategyListPlugin/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.managestrategy.log.ManageStrategyListPlugin -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.managestrategy.EmpManageStrategyQueryPlugin -->

## ISV 扩展指引（基于 EmpManageStrategyQueryPlugin 真实证）

> FQN: `kd.hr.hrcs.formplugin.web.managestrategy.EmpManageStrategyQueryPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.EmpManageStrategyQueryPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hrcs.formplugin.web.managestrategy.ManageStrategyQueryPlugin`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `registerListener`, `beforeDoOperation`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.EmpManageStrategyQueryPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.managestrategy.EmpManageStrategyQueryPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.strategy.ManageStrategyLogOp -->

## ISV 扩展指引（基于 ManageStrategyLogOp 真实证）

> FQN: `kd.hr.hrcs.opplugin.web.strategy.ManageStrategyLogOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.strategy.ManageStrategyLogOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.strategy.ManageStrategyLogOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.strategy.ManageStrategyLogOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.strategy.ManageStrategyLogOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.EmpManageStrategySaveOp -->

## ISV 扩展指引（基于 EmpManageStrategySaveOp 真实证）

> FQN: `kd.hr.hrcs.opplugin.web.EmpManageStrategySaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.EmpManageStrategySaveOp/`

### 类型与继承
- 插件类型：**OTHER**
- 父类: `kd.hr.hrcs.opplugin.web.ManageStrategySaveOp`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: (无)

### 可重写方法（target.java self）
- `protected protected void doSaveStrategyHis(kd.bos.dataentity.entity.DynamicObject[], java.lang.String)`

### SDK 范式（ISV 抄作业）

**READ_VIA_HELPER** · EmpManageStrategySaveOp L28
```java
  26           HRBaseServiceHelper hrBaseServiceHelper = new HRBaseServiceHelper("hrcs_empstrategy");
  27           for (DynamicObject newEmpStrategyDy : newEmpStrategyDys) {
  28 >             DynamicObject oldEmpStrategyDyc = hrBaseServiceHelper.queryOne("id, orgteam, inheritedorg, hrbu, sourceorg, strategytype, status, enable,effdt, effectivedate,changetype, modifytime, modifier, entryentity.id,entryentity.entryhrbu,entryentity.entryinheritedorg, entryentity.entryenable,entryentity.entryorgteam,entryentity.bussinessfield, entryentity.strategyentrytype,entryentity.entrysourceorg, entryeffdt, entryentity.entrydefstrategy, defstrategytype,entryentity.entrychangetype", (Object)newEmpStrategyDy.getLong("id"));
  29               StrategyServiceHelper.sysnSubOrgStrategy((DynamicObject)oldEmpStrategyDyc, (DynamicObject)newEmpStrategyDy, (String)"emp");
  30           }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.EmpManageStrategySaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.EmpManageStrategySaveOp/extension_guide.md)
