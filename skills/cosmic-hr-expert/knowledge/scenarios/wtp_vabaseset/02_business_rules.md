...
## ✅ verified · 主表 `wtp_vabaseset` 共 69 个 opKey
...
| 10 | `VacationBaseSetSaveOp` | enabled=True |
...
| 9 | `VacationBaseSetSaveOp` | enabled=True |
...
| 3 | `VacationBaseSetSaveOp` | enabled=True |
...
- `showallversion` · `donothing_edit` · `donothing_manage` · `btn_bd_unassign` · `tblassign_search` · `tblunassign_search` · `tblassign_searchorg` · `newentry` · `deleteentry` · `newtypeentry` · `deltypeentry`
