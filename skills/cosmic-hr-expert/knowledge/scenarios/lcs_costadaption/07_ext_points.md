...
主表 `lcs_costadaption` 标品接入 **37** 个插件。
...
- `CostAdaptionEdit` ← `kd.hrmp.lcs.formplugin.web.basedata.CostAdaptionEdit`
...
- `CostAdaptionList` ← `kd.hrmp.lcs.formplugin.web.basedata.CostAdaptionList`
...
- `CostAdaptionSaveOp` ← `kd.hrmp.lcs.opplugin.web.CostAdaptionSaveOp`
- `HRBaseOriginalOp` ← `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- `CodeRuleDeleteOp` ← `kd.bos.coderule.CodeRuleDeleteOp`
- `CostAdaptionUnAuditOp` ← `kd.hrmp.lcs.opplugin.web.CostAdaptionUnAuditOp`
- `HRBaseDataEnableOp` ← `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp`
- `CostAdaptionSubmitOp` ← `kd.hrmp.lcs.opplugin.web.CostAdaptionSubmitOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.lcs.formplugin.web.basedata.CostAdaptionEdit -->

## ISV 扩展指引（基于 CostAdaptionEdit 真实证）
...
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `propertyChanged`, `beforeBindData`, `afterBindData`
...
- `public public void afterBindData(java.util.EventObject)` ⭐ lifecycle
- `public public void updateTabNameBySuffixValue()`

详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.basedata.CostAdaptionEdit/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.basedata.CostAdaptionEdit/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.lcs.formplugin.web.basedata.CostAdaptionList -->

## ISV 扩展指引（基于 CostAdaptionList 真实证）
...
**CONTEXT_ACCESS** · CostAdaptionList L37
```java
  35           String fieldName = args.getFieldName();
  36           List filters = args.getQfilters();
  37 >         if (("coststru.id".equals(fieldName) || "coststru.name".equals(fieldName)) && (permOrgs = PermissionServiceHelper.getAllPermOrgs((long)(userId = RequestContext.get().getCurrUserId()), (String)"11", (String)"198IF7HLNV46", (String)"lcs_costadaption", (String)"47150e89000000ac")) != null && !permOrgs.hasAllOrgPerm() && CollectionUtils.isNotEmpty((Collection)(hasPermOrgs = permOrgs.getHasPermOrgs())) && (baseDataFilter = BaseDataServiceHelper.getBaseDataFilter((String)"lcs_coststru", (List)hasPermOrgs, (boolean)true)) != null) {
  38               filters.add(baseDataFilter);
  39           }
```

**READ_VIA_HELPER** · CostAdaptionList L37
```java
  35           String fieldName = args.getFieldName();
  36           List filters = args.getQfilters();
  37 >         if (("coststru.id".equals(fieldName) || "coststru.name".equals(fieldName)) && (permOrgs = PermissionServiceHelper.getAllPermOrgs((long)(userId = RequestContext.get().getCurrUserId()), (String)"11", (String)"198IF7HLNV46", (String)"lcs_costadaption", (String)"47150e89000000ac")) != null && !permOrgs.hasAllOrgPerm() && CollectionUtils.isNotEmpty((Collection)(hasPermOrgs = permOrgs.getHasPermOrgs())) && (baseDataFilter = BaseDataServiceHelper.getBaseDataFilter((String)"lcs_coststru", (List)hasPermOrgs, (boolean)true)) != null) {
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.basedata.CostAdaptionList/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.lcs.formplugin.web.basedata.CostAdaptionList/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.lcs.opplugin.web.CostAdaptionSaveOp -->

## ISV 扩展指引（基于 CostAdaptionSaveOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.lcs.opplugin.web.CostAdaptionSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.lcs.opplugin.web.CostAdaptionSaveOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.lcs.opplugin.web.CostAdaptionUnAuditOp -->

## ISV 扩展指引（基于 CostAdaptionUnAuditOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.lcs.opplugin.web.CostAdaptionUnAuditOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.lcs.opplugin.web.CostAdaptionUnAuditOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.lcs.opplugin.web.CostAdaptionSubmitOp -->

## ISV 扩展指引（基于 CostAdaptionSubmitOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.lcs.opplugin.web.CostAdaptionSubmitOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.lcs.opplugin.web.CostAdaptionSubmitOp/extension_guide.md)
