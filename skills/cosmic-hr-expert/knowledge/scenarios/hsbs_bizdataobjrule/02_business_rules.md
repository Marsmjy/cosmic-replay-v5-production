...
### `hsbs_bizdataobjrule`（1 条）

| ruleId | 类型 | preCondition | 描述 |
|---|---|---|---|
| `5=D6KW78BPG9` | bizRule | `fillmethod = '1' or fillmethod = '2'` | 是否显示字段默认值设置 |
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · business_rules · kd.hr.hbp.opplugin.web.hismodel.HisUniqueValidateOp -->
