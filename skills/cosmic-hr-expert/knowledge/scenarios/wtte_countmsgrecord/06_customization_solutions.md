...
- `HRBaseDataCreateOrgPluginExt` (OTHER) ← `kd.hr.hbp.formplugin.web.bdctrl.HRBaseDataCreateOrgPluginExt`

**原因**：这些类带 `@SdkInternal` 或 `@SdkPlugin(role=internal)` 注解 · ISV 不得继承。

## ℹ️ 标品已接入插件（12 个 · 详见 07_ext_points.md）
