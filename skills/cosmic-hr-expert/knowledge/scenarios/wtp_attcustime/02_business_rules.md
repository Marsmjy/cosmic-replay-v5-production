...
## ✅ verified · 主表 `wtp_attcustime` 共 66 个 opKey
...
- `showallversion` · `newentry` · `deleteentry` · `moveentryup` · `moveentrydown` · `donothing` · `deletecon` · `addentry`
