...
主表 `wtom_otbillself` 标品接入 **38** 个插件。
...
- `OtApplyBillEdit` ← `kd.wtc.wtom.fromplugin.web.otapplybill.OtApplyBillEdit`
- `OtApplyScBillEdit` ← `kd.wtc.wtom.fromplugin.web.otapplybill.OtApplyScBillEdit`
- `OtApplySdBillEdit` ← `kd.wtc.wtom.fromplugin.web.otapplybill.OtApplySdBillEdit`
...
- `OtApplyBillList` ← `kd.wtc.wtom.fromplugin.web.otapplybill.OtApplyBillList`
- `WTCApplyTypeSelfList` ← `kd.wtc.wtbs.formplugin.web.WTCApplyTypeSelfList`
- `OtApplySelfBillList` ← `kd.wtc.wtom.fromplugin.web.otapplybill.OtApplySelfBillList`
...
- `OtApplyOp` ← `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyOp`
...
- `OtApplyArchiveControlValidateOp` ← `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyArchiveControlValidateOp`
- ...（共 16，详见 `_auto_plugin_registry.md`）

### 其他（1）
- `wtom_otbilltest` ← `kingdee.wtc.wtom.wtom_overtimeapplynew.wtom_otbilltest`
...
- order **6**: `WTCBillChangeShowOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeShowOp`
- order **7**: `WTCBillChangeStatusOp` · enabled=True
...
- order **9**: `OtApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyOp`
- order **10**: `OtApplyArchiveControlValidateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyArchiveControlValidateOp`
...
- order **4**: `WTCBillApplyTypeOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillApplyTypeOp`
- order **5**: `OtApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyOp`
- order **6**: `WTCBillUpdateAttfileOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillUpdateAttfileOp`
- order **7**: `WTCBillChangeShowOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeShowOp`
- order **8**: `WTCBillReplenishOriginalOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillReplenishOriginalOp`
- order **9**: `OtApplyArchiveControlValidateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyArchiveControlValidateOp`
...
- order **3**: `BillTplOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.BillTplOp`
- order **4**: `OtApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyOp`
- order **5**: `WTCBillSelfApplyOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillSelfApplyOp`
- order **6**: `WTCBillUpdateAttfileOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillUpdateAttfileOp`
- order **7**: `WTCBillReplenishOriginalOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillReplenishOriginalOp`
- order **8**: `OtApplyArchiveControlValidateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyArchiveControlValidateOp`
...
- order **1**: `WTCBillApplyTypeOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillApplyTypeOp`
- order **2**: `OtChangeOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtChangeOp`
- order **3**: `OtApplyArchiveControlValidateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyArchiveControlValidateOp`
...
- order **1**: `WTCBillChangeStatusOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbs.opplugin.web.bill.WTCBillChangeStatusOp`
- order **2**: `OtApplyArchiveControlValidateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyArchiveControlValidateOp`
...
- order **1**: `OtApplyArchiveControlValidateOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtom.opplugin.web.overworkapply.ot.OtApplyArchiveControlValidateOp`
...
### opKey `donothing0` · 空操作

**执行链**（1 个 plugin 按 order 顺序跑）：

- order **1**: `wtom_otbilltest` · enabled=True
  - 完整 FQN: `kingdee.wtc.wtom.wtom_overtimeapplynew.wtom_otbilltest`
