...
- `deleteentry_rela` · deleteentry_rela
- `deleteentry_role` · deleteentry_role
- `adminorgdeleteentry` · adminorgdeleteentry
- `positiondeleteentry` · positiondeleteentry
- `plugindeleteentry` · plugindeleteentry
...
- 主表 `hrcs_warnscheme`：**28** 个标品插件接入
- 字段总数：**73** 个（实抓自 OpenAPI listMeta）
