...
主表 `hrcs_econtemplate` 标品接入 **19** 个插件。
...
- `EContractTemplateEditPlugin` ← `kd.hr.hrcs.formplugin.web.econtract.EContractTemplateEditPlugin`
...
- `EContractTemplateSaveOp` ← `kd.hr.hrcs.opplugin.web.EContractTemplateSaveOp`
- `CodeRuleDeleteOp` ← `kd.bos.coderule.CodeRuleDeleteOp`

### 其他（2）
- `templatebaseedit` ← `dev.tpl.base.kd.bos.form.plugin.templatebaseedit`
- `TplVariableConfigTest` ← `kd.hr.hrcs.formplugin.web.econtract.TplVariableConfigTest`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.econtract.EContractTemplateEditPlugin -->

## ISV 扩展指引（基于 EContractTemplateEditPlugin 真实证）

> FQN: `kd.hr.hrcs.formplugin.web.econtract.EContractTemplateEditPlugin`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.econtract.EContractTemplateEditPlugin/`

### 类型与继承
- 插件类型：**FORM_PLUGIN**
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `registerListener`, `beforeDoOperation`, `propertyChanged`, `afterBindData`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.econtract.EContractTemplateEditPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.econtract.EContractTemplateEditPlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.formplugin.web.econtract.TplVariableConfigTest -->

## ISV 扩展指引（基于 TplVariableConfigTest 真实证）

> FQN: `kd.hr.hrcs.formplugin.web.econtract.TplVariableConfigTest`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.econtract.TplVariableConfigTest/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.econtract.TplVariableConfigTest/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.formplugin.web.econtract.TplVariableConfigTest/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hrcs.opplugin.web.EContractTemplateSaveOp -->

## ISV 扩展指引（基于 EContractTemplateSaveOp 真实证）

> FQN: `kd.hr.hrcs.opplugin.web.EContractTemplateSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.EContractTemplateSaveOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.EContractTemplateSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hrcs.opplugin.web.EContractTemplateSaveOp/extension_guide.md)
