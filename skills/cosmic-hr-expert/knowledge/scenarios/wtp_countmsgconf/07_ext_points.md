...
主表 `wtp_countmsgconf` 标品接入 **41** 个插件。
...
- `CountMsgConfEdit` ← `kd.wtc.wtp.formplugin.web.countmsg.CountMsgConfEdit`
...
- `CountMsgConfList` ← `kd.wtc.wtp.formplugin.web.countmsg.CountMsgConfList`
