...
> 本 form（`hrpi_assignment`，所属 核心人力云）引用了其他云的 **4** 个底座实体：

### ⬆️ HR 基础服务云（`hr_hrmp`）2 个引用

| 字段 | 字段名 | 类型 | 引用实体 | 上游场景 |
|---|---|---|---|---|
| `businesstype` | 业务类型 | BasedataField | `hbss_bussinessfield` | [hbss_position_dict](../hbss_position_dict/) |
