...
## ✅ verified · 主表 `hrpi_assignment` + 继承层
...
- `HRBaseServiceHelper`
- `HisModelServiceHelper`
- `HrEntityCommonService`
- `IAssignmentApplicationService`
- `IDevParamConfigDomainService`
- `IDevParamConfigService`
- `IEmployeeApplicationService`

## ✅ verified · 流水写入

- ✅ 命中 `HisModel*` → 历史版本模型，写历史表 `t_*_h` + 维护 `iscurrentversion`
