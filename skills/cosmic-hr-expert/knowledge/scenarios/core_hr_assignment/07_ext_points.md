...
主表 `hrpi_assignment` 标品接入 **15** 个插件。
...
- `AssignmentSaveOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.AssignmentSaveOp`
...
- `AssignmentDeleteOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.AssignmentDeleteOp`
- `InfoCollectStartOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.infocollect.InfoCollectStartOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.AssignmentSaveOp -->

## ISV 扩展指引（基于 AssignmentSaveOp 真实证）
...
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `onPreparePropertys`, `onAddValidators`, `beginOperationTransaction`, `beforeExecuteOperationTransaction`, `endOperationTransaction`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.AssignmentSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.AssignmentSaveOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.AssignmentDeleteOp -->

## ISV 扩展指引（基于 AssignmentDeleteOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.AssignmentDeleteOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.AssignmentDeleteOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.AssignmentDeleteOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.infocollect.InfoCollectStartOp -->

## ISV 扩展指引（基于 InfoCollectStartOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.infocollect.InfoCollectStartOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.infocollect.InfoCollectStartOp/extension_guide.md)
