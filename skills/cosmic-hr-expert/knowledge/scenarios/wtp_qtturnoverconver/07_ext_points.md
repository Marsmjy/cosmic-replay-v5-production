...
主表 `wtp_qtturnoverconver` 标品接入 **42** 个插件。
...
- `QTTurnoverConvertEdit` ← `kd.wtc.wtp.formplugin.web.quota.turnovercnver.QTTurnoverConvertEdit`
...
- `QTTurnoverConvertList` ← `kd.wtc.wtp.formplugin.web.quota.turnovercnver.QTTurnoverConvertList`
