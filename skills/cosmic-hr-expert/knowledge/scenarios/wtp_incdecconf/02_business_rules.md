...
## ✅ verified · 主表 `wtp_incdecconf` 共 96 个 opKey
...
| 10 | `IncrDecrConfOp` | enabled=True |
...
- `showallversion` · `newentry4da` · `deleteentry4da` · `moveentryup4da` · `moveentrydown4da` · `newentry4dt` · `newentry4dtp` · `deleteentry4dt` · `deleteentry4dtp` · `moveentryup4dt` · `moveentryup4dtp` · `moveentrydown4dt`
