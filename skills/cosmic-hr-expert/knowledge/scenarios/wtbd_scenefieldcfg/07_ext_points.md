...
主表 `wtbd_scenefieldcfg` 标品接入 **49** 个插件。
...
- `RetrievalItemEdit` ← `kd.wtc.wtbd.fromplugin.web.retrieval.RetrievalItemEdit`
- `WTCNoHisSumaryEdit` ← `kd.wtc.wtbs.formplugin.web.WTCNoHisSumaryEdit`
- ...（共 25，详见 `_auto_plugin_registry.md`）
...
- `BaseDataTreeListPlugin` ← `kd.bos.form.plugin.bdctrl.BaseDataTreeListPlugin`
...
- `RetrievalItemList` ← `kd.wtc.wtbd.fromplugin.web.retrieval.RetrievalItemList`
...
- `SceneFieldCfgMustInputOp` ← `kd.wtc.wtbd.opplugin.web.scenecfg.SceneFieldCfgMustInputOp`
- `HRBaseOriginalOp` ← `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- `RetrievalItemOp` ← `kd.wtc.wtbd.opplugin.web.retrieval.RetrievalItemOp`
...
- order **5**: `TreeBaseDataSavePlugin` · enabled=True
  - 完整 FQN: `kd.bos.form.plugin.bdctrl.TreeBaseDataSavePlugin`
- order **6**: `BaseDataSavePlugin` · enabled=True
  - 完整 FQN: `kd.bos.form.plugin.bdctrl.BaseDataSavePlugin`
- order **7**: `HRBaseDataStatusOp` · HR 基础资料单据状态（draft/audit/disable）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp`
- order **8**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **9**: `HRBaseDataEnableOp` · HR 基础资料启用态管理 · 控制 enable 字段
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp`
- order **10**: `SceneFieldCfgMustInputOp` · enabled=False
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.scenecfg.SceneFieldCfgMustInputOp`
...
- order **1**: `BaseDataSubmitPlugin` · enabled=True
  - 完整 FQN: `kd.bos.form.plugin.bdctrl.BaseDataSubmitPlugin`
- order **2**: `CodeRuleOp` · 编码规则（未启用时跳过）· onAddValidators 注册 numberValidator
  - 完整 FQN: `kd.bos.business.plugin.CodeRuleOp`
- order **3**: `BdVersionSaveServicePlugin` · 基础资料版本管理 · 主表 name + 版本子表 name 的写历史
  - 完整 FQN: `kd.bos.base.bdversion.BdVersionSaveServicePlugin`
- order **4**: `BaseTreeOp` · enabled=True
  - 完整 FQN: `kd.bos.business.plugin.BaseTreeOp`
- order **5**: `BaseTreeLongNumberOp` · enabled=True
  - 完整 FQN: `kd.bos.business.plugin.BaseTreeLongNumberOp`
...
- order **8**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **9**: `SceneFieldCfgMustInputOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.scenecfg.SceneFieldCfgMustInputOp`
...
- order **1**: `BaseTreeOp` · enabled=True
  - 完整 FQN: `kd.bos.business.plugin.BaseTreeOp`
- order **2**: `BaseTreeDeleteValidate` · enabled=False
  - 完整 FQN: `kd.bos.business.plugin.BaseTreeDeleteValidate`
- order **3**: `BaseDataTreeDeletePlugin` · enabled=True
  - 完整 FQN: `kd.bos.form.plugin.bdctrl.BaseDataTreeDeletePlugin`
- order **4**: `CodeRuleDeleteOp` · enabled=True
  - 完整 FQN: `kd.bos.coderule.CodeRuleDeleteOp`
- order **5**: `HRBaseDataStatusOp` · HR 基础资料单据状态（draft/audit/disable）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp`
- order **6**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **7**: `RetrievalItemOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtbd.opplugin.web.retrieval.RetrievalItemOp`
...
- order **2**: `BaseDataEnablePlugin` · enabled=True
  - 完整 FQN: `kd.bos.form.plugin.bdctrl.BaseDataEnablePlugin`
- order **3**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
