...
- `HisModelFormOriginPlugin` ← `kd.hr.hbp.formplugin.web.history.form.HisModelFormOriginPlugin`
- `EmployeeNumberCodeRulePlugin` ← `kd.hrmp.hrpi.formplugin.web.employee.EmployeeNumberCodeRulePlugin`
- `EmployeePlugin` ← `kd.hrmp.hrpi.formplugin.web.person.EmployeePlugin`
...
- `OperateLogOp` ← `kd.hrmp.hrpi.opplugin.web.log.OperateLogOp`
- `ChgRecordSaveOp` ← `kd.hrmp.hrpi.opplugin.web.chgrecord.ChgRecordSaveOp`
- `EmployeeSaveOp` ← `kd.hrmp.hrpi.opplugin.web.employee.EmployeeSaveOp`
- `EmployeeCommonStandardMustInputOp` ← `kd.hrmp.hrpi.opplugin.web.common.EmployeeCommonStandardMustInputOp`
- `EmployeeNumberCodeRuleOp` ← `kd.hrmp.hrpi.opplugin.web.employee.EmployeeNumberCodeRuleOp`
- `EmployeeNumberCodeRuleDeleteOp` ← `kd.hrmp.hrpi.opplugin.web.employee.EmployeeNumberCodeRuleDeleteOp`
- `EmployeeDeleteOp` ← `kd.hrmp.hrpi.opplugin.web.employee.EmployeeDeleteOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hbp.formplugin.web.history.form.HisModelFormOriginPlugin -->

## ISV 扩展指引（基于 HisModelFormOriginPlugin 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.history.form.HisModelFormOriginPlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.history.form.HisModelFormOriginPlugin/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hbp.formplugin.web.history.form.HisModelFormOriginPlugin -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.formplugin.web.employee.EmployeeNumberCodeRulePlugin -->

## ISV 扩展指引（基于 EmployeeNumberCodeRulePlugin 真实证）
...
### 类型与继承
- 插件类型：**OTHER**
- 父类: `kd.bos.form.plugin.CodeRulePlugin`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: (无)

### 可重写方法（target.java self）
- `protected protected java.lang.String getBillNoField()`

详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.formplugin.web.employee.EmployeeNumberCodeRulePlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.formplugin.web.employee.EmployeeNumberCodeRulePlugin/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.formplugin.web.employee.EmployeeNumberCodeRulePlugin -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.formplugin.web.person.EmployeePlugin -->

## ISV 扩展指引（基于 EmployeePlugin 真实证）
...
- 父类: `kd.hr.hbp.formplugin.web.HRDataBaseEdit`
- ISV 可继承: ✅ 推荐继承本父类
- 推荐挂载方法: `beforeItemClick`, `propertyChanged`, `beforeDoOperation`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.formplugin.web.person.EmployeePlugin/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.formplugin.web.person.EmployeePlugin/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.log.OperateLogOp -->

## ISV 扩展指引（基于 OperateLogOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.log.OperateLogOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.log.OperateLogOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.employee.EmployeeSaveOp -->

## ISV 扩展指引（基于 EmployeeSaveOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.EmployeeSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.EmployeeSaveOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.employee.EmployeeSaveOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.common.EmployeeCommonStandardMustInputOp -->

## ISV 扩展指引（基于 EmployeeCommonStandardMustInputOp 真实证）
...
**QUERY_BUILDER** · DevParamConfigRepository L33
```java
  31   
  32       public static DynamicObject queryConfigByBusinessKey(String businessKey) {
  33 >         return DEV_PARAM_CONFIG.queryOriginalOne("businessvalue,largebusinessvalue_tag", new QFilter[]{new QFilter("businesskey", "=", (Object)businessKey)});
  34       }
  35   
```

**READ_VIA_HELPER** · DevParamConfigRepository L49
```java
  47   
  48       public static DynamicObject loadFormCache(String businessKey) {
  49 >         return BusinessDataServiceHelper.loadSingleFromCache((String)"hrpi_devconfig", (QFilter[])new QFilter[]{new QFilter("businesskey", "=", (Object)businessKey)});
  50       }
  51   
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.common.EmployeeCommonStandardMustInputOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.common.EmployeeCommonStandardMustInputOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.common.EmployeeCommonStandardMustInputOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.employee.EmployeeNumberCodeRuleOp -->

## ISV 扩展指引（基于 EmployeeNumberCodeRuleOp 真实证）
...
### 类型与继承
- 插件类型：**OP_PLUGIN**
- 父类: `kd.bos.business.plugin.CodeRuleOp`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `onPreparePropertys`

### 可重写方法（target.java self）
- `public public void onPreparePropertys(kd.bos.entity.plugin.PreparePropertysEventArgs)` ⭐ lifecycle
- `protected protected java.lang.String getBillNoField(kd.bos.entity.BillEntityType)`

详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.EmployeeNumberCodeRuleOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.EmployeeNumberCodeRuleOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.employee.EmployeeNumberCodeRuleOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.employee.EmployeeNumberCodeRuleDeleteOp -->

## ISV 扩展指引（基于 EmployeeNumberCodeRuleDeleteOp 真实证）
...
### 类型与继承
- 插件类型：**OP_PLUGIN**
- 父类: `kd.bos.coderule.CodeRuleDeleteOp`
- ISV 可继承: ⚠️ 标品 @SdkInternal·改继承基类
- 推荐挂载方法: `onPreparePropertys`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.EmployeeNumberCodeRuleDeleteOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.EmployeeNumberCodeRuleDeleteOp/extension_guide.md)

<!-- /AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.employee.EmployeeNumberCodeRuleDeleteOp -->

<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.employee.EmployeeDeleteOp -->

## ISV 扩展指引（基于 EmployeeDeleteOp 真实证）
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.EmployeeDeleteOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.employee.EmployeeDeleteOp/extension_guide.md)
