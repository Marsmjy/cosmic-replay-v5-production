...
## ✅ verified · 主表 `wtp_qtformularule` 共 65 个 opKey
...
| 10 | `FormulaRuleSaveOp` | enabled=True |
...
| 9 | `FormulaRuleSaveOp` | enabled=True |
...
| 4 | `FormulaRuleSaveOp` | enabled=True |
...
| 3 | `FormulaRuleSaveOp` | enabled=True |
...
- `showallversion` · `moveto` · `sort` · `deleteentry` · `moveentrydown` · `moveentryup` · `addentry`
