...
## ✅ verified · 主表 `wtp_supplerule` 共 64 个 opKey
...
- `showallversion` · `deleteentry` · `selmodify` · `exdeleteentry` · `exaddentry` · `reasonaddentry`
