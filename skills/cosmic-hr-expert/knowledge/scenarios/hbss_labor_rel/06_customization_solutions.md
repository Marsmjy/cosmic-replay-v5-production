# hbss_labor_rel · 定制方案（ISV 扩展真实模板）

> **场景**：劳动/用工关系字典（13 个子实体）
> **生成时间**：2026-04-29

## CS-01 · 给子实体加 ISV 自定义字段

**适用**：`hbss_laborreltype`, `hbss_laborreltypecls`, `hbss_laborrelstatus`, `hbss_laborrelsub`, `hbss_contracttypes`, `hbss_contracttypecat` ...（任一子实体）
