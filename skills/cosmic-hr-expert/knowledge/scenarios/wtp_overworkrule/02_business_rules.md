...
## ✅ verified · 主表 `wtp_overworkrule` 共 65 个 opKey
...
- `showallversion` · `moveentryup` · `moveentrydown` · `deleteentry` · `editrow` · `copyrow` · `addrow`
