...
## ℹ️ 标品已接入插件（8 个 · 详见 07_ext_points.md）
...
- `AttConfirmBillEdit` ← `kd.wtc.wtam.formplugin.web.attconfirm.AttConfirmBillEdit`
- `HRCertCheckList` ← `kd.hr.hbp.formplugin.web.cert.HRCertCheckList`
- `AttConfirmBillList` ← `kd.wtc.wtam.formplugin.web.attconfirm.AttConfirmBillList`
