...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hr.hbp.formplugin.web.controller.swc.hsbs.SalaryRankF7FastFilter -->

## ISV 扩展指引（基于 SalaryRankF7FastFilter 真实证）

> FQN: `kd.hr.hbp.formplugin.web.controller.swc.hsbs.SalaryRankF7FastFilter`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.controller.swc.hsbs.SalaryRankF7FastFilter/`
...
**QUERY_BUILDER** · SalaryRankF7FastFilter L26
```java
  24           super.buildBaseDataCoreFilter(event);
  25           ArrayList qFilters = Lists.newArrayListWithCapacity((int)16);
  26 >         qFilters.add(new QFilter("type", "=", (Object)"STANDARD"));
  27           event.addQFilters((List)qFilters);
  28       }
```

详细参考：[`_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.controller.swc.hsbs.SalaryRankF7FastFilter/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hr.hbp.formplugin.web.controller.swc.hsbs.SalaryRankF7FastFilter/extension_guide.md)
