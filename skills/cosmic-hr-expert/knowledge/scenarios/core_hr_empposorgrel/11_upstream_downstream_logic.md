...
> 本 form（`hrpi_empposorgrel`，所属 核心人力云）引用了其他云的 **19** 个底座实体：
...
| `workplace` | 常驻工作地 | BasedataField | `hbss_workplace` | [hbss_supplier](../hbss_supplier/) |
| `contractworkplace` | 协议工作地 | BasedataField | `hbss_workplace` | [hbss_supplier](../hbss_supplier/) |
| `workcalendar` | 工作日历 | QueryField | `hrcs_workingplanquery` | — |

### ⬆️ 组织发展云（`org_dev`）12 个引用
...
| `jobvid` | 历史职位 | BasedataField | `hbjm_jobhr` | [hjm_jobhr_maintenance](../hjm_jobhr_maintenance/) |
...
**汇总**：1 个本场景实体 · 共 7 处引用 · 其中 3 处跨云。

### `hrpi_empposorgrel` （跨云引用 3 处）

#### ⬇️ 组织发展云（`org_dev`）3 处

| form | field | type |
|---|---|---|
| `haos_chargeperson` | `empposorgrel` | BasedataField |
| `haos_orgpersonstaffinfo` | `empposorgrel` | BasedataField |
| `haos_orgusestaffdetail` | `empposorgrel` | BasedataField |
