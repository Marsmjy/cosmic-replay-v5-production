...
主表 `hrpi_empposorgrel` 标品接入 **23** 个插件。
...
- `EmpPosOrgRelSaveOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpPosOrgRelSaveOp`
...
- `EmpPosOrgRelDeleteOp` ← `kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpPosOrgRelDeleteOp`
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpPosOrgRelSaveOp -->

## ISV 扩展指引（基于 EmpPosOrgRelSaveOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpPosOrgRelSaveOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpPosOrgRelSaveOp/`
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpPosOrgRelSaveOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpPosOrgRelSaveOp/extension_guide.md)
...
<!-- AUTO-INJECTED-BY-CLASS-RESOLVER · extension_points · kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpPosOrgRelDeleteOp -->

## ISV 扩展指引（基于 EmpPosOrgRelDeleteOp 真实证）

> FQN: `kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpPosOrgRelDeleteOp`
> 反编译产物: `_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpPosOrgRelDeleteOp/`
...
**QUERY_BUILDER** · EmpPosOrgRelApplicationServiceImpl L186
```java
 184               empPosOrgRelSet.add(empPosOrgRelId);
 185           }
 186 >         QFilter idFilter = new QFilter("id", "not in", (Object)empPosOrgRelSet);
 187           QFilter primaryFilter = new QFilter("isprimary", "=", (Object)Boolean.TRUE);
 188           QFilter assignmentFilter = new QFilter("assignment", "in", (Object)assignmentSet);
```
...
详细参考：[`_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpPosOrgRelDeleteOp/extension_guide.md`](../../_sdk_audit/_decompiled_deep/kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpPosOrgRelDeleteOp/extension_guide.md)
