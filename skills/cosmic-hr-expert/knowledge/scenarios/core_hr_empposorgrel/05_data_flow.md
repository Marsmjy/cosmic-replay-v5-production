...
## ✅ verified · 主表 `hrpi_empposorgrel` + 继承层
...
- `IAssignmentDomainService`
- `IAssignmentMagDomainService`
- `IDevParamConfigDomainService`
- `IDevParamConfigService`
- `IEmpPosOrgRelApplicationService`
- `IEmpPosOrgRelDomainService`
