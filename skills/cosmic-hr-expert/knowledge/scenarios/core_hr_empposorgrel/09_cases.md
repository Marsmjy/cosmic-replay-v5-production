...
完整反编译实物：`knowledge/_sdk_audit/_decompiled/scenarios/core_hr_empposorgrel/AssignmentTplCommonSaveOp.java`

## CASE-2 · 跨云引用真实场景

本 form 被以下云的 form 引用（共 7 处）：
...
| 改字段名 / 类型 / refEntity | 影响 7 处下游 | ❌ 下游 form 加载错 |
