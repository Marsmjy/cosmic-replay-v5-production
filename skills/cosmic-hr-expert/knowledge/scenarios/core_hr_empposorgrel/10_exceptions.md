...
- `V_EmpPosOrgRelSaveOp_1` (opKey=`save`) · (errorMessage 未实抓 · 待 jar 反查)
- `V_EmpPosOrgRelSaveOp_2` (opKey=`save`) · (errorMessage 未实抓 · 待 jar 反查)
- `V_EmpPosOrgRelSaveOp_3` (opKey=`save`) · (errorMessage 未实抓 · 待 jar 反查)
- `V_EmpPosOrgRelSaveOp_4` (opKey=`save`) · (errorMessage 未实抓 · 待 jar 反查)
- `V_EmpPosOrgRelDeleteOp_1` (opKey=`delete`) · (errorMessage 未实抓 · 待 jar 反查)
...
- `KDBizException` 在 `EmpPosOrgRelSaveOp` · `(动态消息 · 变量=ResManager)`
- `KDBizException` 在 `EmpPosOrgRelSaveOp` · `(动态消息 · 变量=String)`
