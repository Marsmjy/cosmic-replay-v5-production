# core_hr_pfs_personflow · 业务规则

> **聚合场景**：人员流入流出（核心人力内部 · 非员工变动协作）（2 个子实体）
> **生成时间**：2026-04-30
...
### `hpfs_personflow` · ⚠️ 标品 entity_metadata md 不存在

### `hpfs_personflow_file` · ⚠️ 标品 entity_metadata md 不存在
