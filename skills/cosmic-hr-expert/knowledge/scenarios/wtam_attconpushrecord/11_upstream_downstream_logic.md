...
> 本 form（`wtam_attconpushrecord`，所属 other）引用了其他云的 **4** 个底座实体：
...
| `perattperiod` | 人员考勤期间 | BasedataField | `wtp_perattperiod` | — |
| `pushrule` | 考勤确认推送规则 | BasedataField | `wtp_attconfirmpushrule` | — |
