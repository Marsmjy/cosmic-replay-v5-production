...
## ✅ verified · 主表 `wtte_qtdetailextension` 共 42 个 opKey
...
| 7 | `QuotaDetailAdjustOp` | enabled=True |
...
| 6 | `QuotaDetailAdjustOp` | enabled=True |
...
| 2 | `QuotaDetailAdjustOp` | enabled=True |
...
- `exportlistbyselectfields` · `exportlist_expt` · `exportdetails` · `importexport_userset` · `mobtoolbarselect` · `mobtoolbarcancel` · `namehistory` · `namehistoryview` · `logview` · `viewonelog`
