...
主表 `wtte_qtdetailextension` 标品接入 **24** 个插件。
...
- `QuotaDetailExtensionEdit` ← `kd.wtc.wtte.formplugin.web.quota.QuotaDetailExtensionEdit`
...
- `QuotaDetailExtensionList` ← `kd.wtc.wtte.formplugin.web.quota.QuotaDetailExtensionList`
...
- `QuotaDetailAdjustOp` ← `kd.wtc.wtte.opplugin.web.quota.QuotaDetailAdjustOp`
...
- order **6**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **7**: `QuotaDetailAdjustOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.quota.QuotaDetailAdjustOp`
...
- order **5**: `HRBaseOriginalOp` · HR 基础资料原始值记录（对比变更前后）
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp`
- order **6**: `QuotaDetailAdjustOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.quota.QuotaDetailAdjustOp`
...
- order **1**: `HRBaseDataLogOp` · HR 基础资料操作日志
  - 完整 FQN: `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp`
- order **2**: `QuotaDetailAdjustOp` · enabled=True
  - 完整 FQN: `kd.wtc.wtte.opplugin.web.quota.QuotaDetailAdjustOp`
