...
import kd.hr.hies.formplugin.TemplateListDataProvider;
...
extends TreeListBizAppsPlugin {
    ...
    private void openNewTempTab(String tplGenMode, String isImport) {
        ...
        parameter.setFormId("hies_diaetplconf");
        if (HRStringUtils.equals((String)"1", (String)isImport)) {
            parameter.setCaption(ResManager.loadKDString((String)"\u65b0\u589e\u5bfc\u5165\u6a21\u677f", (String)HiesCommonRes.TemplateTreeListEdit_13.resId(), (String)"hrmp-hies-common", (Object[])new Object[0]));
        } else {
            parameter.setCaption(ResManager.loadKDString((String)"\u65b0\u589e\u5bfc\u51fa\u6a21\u677f", (String)HiesCommonRes.TemplateTreeListEdit_14.resId(), (String)"hrmp-hies-common", (Object[])new Object[0]));
        }
        parameter.setStatus(OperationStatus.ADDNEW);
        parameter.getOpenStyle().setShowType(ShowType.MainNewTabPage);
        IPageCache pageCache = (IPageCache)this.getView().getService(IPageCache.class);
        String bindEntityId = pageCache.get("_IMPORTTEMPLATETREELIST_BIZOBJID_");
        if (HRStringUtils.isNotBlank((CharSequence)bindEntityId)) {
            parameter.setCustomParam(BINDENTITYID, (Object)bindEntityId);
        }
        parameter.setCustomParam("tplgenmode", (Object)tplGenMode);
        parameter.setCustomParam(IS_IMPORT, (Object)isImport);
    ...
    public void beforeDoOperation(BeforeDoOperationEventArgs args) {
        ...
        if (HRStringUtils.equals((String)key, (String)"assign")) {
            ...
            showParameter.setFormId("hies_diaetplconf");
            showParameter.setStatus(OperationStatus.EDIT);
            showParameter.setCaption(ResManager.loadKDString((String)"\u5206\u914d\u4f7f\u7528\u4eba", (String)HiesCommonRes.TemplateTreeListEdit_7.resId(), (String)"hrmp-hies-common", (Object[])new Object[0]));
    ...
    public void beforeItemClick(BeforeItemClickEvent evt) {
        ...
        switch (evt.getItemKey()) {
            case "tblcopy": {
                ...
                this.getView().showTipNotification(ResManager.loadKDString((String)"\u8bf7\u9009\u62e9\u9700\u8981\u590d\u5236\u7684\u6a21\u677f\u3002", (String)HiesCommonRes.TemplateTreeListEdit_6.resId(), (String)"hrmp-hies-common", (Object[])new Object[0]));
                evt.setCancel(true);
                break;
            }
            case "assign": {
                if (selectedRows.isEmpty()) {
                    this.getView().showTipNotification(ResManager.loadKDString((String)"\u8bf7\u9009\u62e9\u6a21\u677f\u3002", (String)HiesCommonRes.TemplateTreeListEdit_11.resId(), (String)"hrmp-hies-common", (Object[])new Object[0]));
                    evt.setCancel(true);
                    break;
                }
                if (selectedRows.size() > 1) {
                    this.getView().showTipNotification(ResManager.loadKDString((String)"\u4e0d\u652f\u6301\u6279\u91cf\u64cd\u4f5c\uff0c\u8bf7\u91cd\u65b0\u9009\u62e9\u6570\u636e\u3002", (String)HiesCommonRes.TemplateTreeListEdit_12.resId(), (String)"hrmp-hies-common", (Object[])new Object[0]));
                    evt.setCancel(true);
                    break;
                }
                Object primaryKeyValue = selectedRows.get(0).getPrimaryKeyValue();
                DynamicObject dy = TemplateConfService.load((Object)primaryKeyValue);
                Boolean issyspreset = dy.getBoolean("issyspreset");
                if (!Boolean.TRUE.equals(issyspreset)) break;
                this.getView().showTipNotification(ResManager.loadKDString((String)"\u9884\u7f6e\u6a21\u677f\u4e0d\u652f\u6301\u64cd\u4f5c\u3002", (String)HiesCommonRes.TemplateTreeListEdit_8.resId(), (String)"hrmp-hies-common", (Object[])new Object[0]));
                evt.setCancel(true);
                break;
            }
            case "tblnew_import": {
    ...
    private List<TreeNode> getCloudNodes() {
        ...
        TreeNode root = AppUtils.getSubsysTree((String[])cloudIds.toArray(new String[cloudIds.size()]), (String[])appIds.toArray(new String[appIds.size()]), null, (String)"app", (boolean)true, (boolean)false, (boolean)true);
        List clouds = null;
        if (root != null) {
    ...
    public Pair<Set<Object>, Set<Object>> getEntityCloudIdList() {
        ...
        Object[] objects = BusinessDataServiceHelper.load((String)"hies_diaetplconf", (String)BIZOBJECT, (QFilter[])new QFilter[0]);
    ...
    public void setFilter(SetFilterEvent setFilterEvent) {
        ...
        setFilterEvent.addCustomQFilter(new QFilter(BIZOBJECT, "in", (Object)TemplateUtil.getValidEntityNumbers((boolean)true)));
        ...
        if (HRStringUtils.isNotBlank((CharSequence)oprFormId)) {
            ...
            Set relTplId = TemplateUtil.getRelTplId((String)oprFormId);
            if (HRCollUtil.isNotEmpty((Collection)relTplId)) {
                qFilters.add(matchEntityNumberQFilter.or(new QFilter("id", "in", (Object)relTplId)));
            } else {
    ...
    protected List<TreeNode> getBillNodesBy(List<String> appIds) {
        ...
        Object[] diaeTplObjects = BusinessDataServiceHelper.load((String)"hies_diaetplconf", (String)BIZOBJECT, (QFilter[])new QFilter[0]);
    ...
    public List<TreeNode> getAppNodesBy(String cloudNodeId) {
        ...
        TreeNode root = AppUtils.getSubsysTree((String[])new String[]{cloudNodeId}, (String[])appIds.toArray(new String[appIds.size()]), null, (String)"app", (boolean)true, (boolean)false, (boolean)true);
        List clouds = null;
        if (root != null) {
            clouds = root.getChildren();
        }
    ...
    public void afterDoOperation(AfterDoOperationEventArgs args) {
        ...
        if (formOperate instanceof Delete && HRStringUtils.equals((String)"delete", (String)operateKey) && args.getOperationResult() != null && !args.getOperationResult().isSuccess()) {
            ...
            List sortSelectedRowKeys = selectedRows.stream().sorted(Comparator.comparing(selectedRow -> selectedRow.getRowKey())).collect(Collectors.toList());
            ArrayList<Integer> finalRowKey = new ArrayList<Integer>(8);
            int sucessNum = 0;
            for (int i = 0; i < sortSelectedRowKeys.size(); ++i) {
                ListSelectedRow selectedRow2 = (ListSelectedRow)sortSelectedRowKeys.get(i);
                int rowKey = selectedRow2.getRowKey();
                if (errorPkIds.contains(selectedRow2.getPrimaryKeyValue())) {
