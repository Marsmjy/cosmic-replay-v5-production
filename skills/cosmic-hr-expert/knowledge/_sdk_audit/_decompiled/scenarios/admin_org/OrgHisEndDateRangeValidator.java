...
public class OrgHisEndDateRangeValidator
extends OrgHisAbstractValidator {
    ...
    protected void bizValidate(List<DynamicObject> hisOrgDynList) {
        this.validService.validEndDateRange(hisOrgDynList, this.dbEffBizBoDynMap, this.dbEffOrgVerDynListMap, this.validErrMap);
    }
}
