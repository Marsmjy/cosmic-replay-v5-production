...
public class OrgHisEffDateContinuityValidator
extends OrgHisAbstractValidator {
    ...
    protected void bizValidate(List<DynamicObject> hisOrgDynList) {
        this.validService.validStartDateLessEndDate(hisOrgDynList, this.validErrMap);
        this.validService.validEffDateContinuity(hisOrgDynList, this.validErrMap);
    }
}
