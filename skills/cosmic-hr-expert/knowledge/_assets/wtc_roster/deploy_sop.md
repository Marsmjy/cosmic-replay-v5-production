...
python scripts/assemble_asset.py \
    ...
    --output D:/myproject/wtc_roster-bjss/
```
...
# 如已有同名 → 必须合并·不能覆盖
diff <现场 ext>.dym D:/myproject/wtc_roster-bjss/datamodel/.../*.dym
```
...
```bash
cd D:/myproject/wtc_roster-bjss
gradle build
