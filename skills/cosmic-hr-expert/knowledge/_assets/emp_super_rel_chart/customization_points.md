# 员工汇报关系图 (emp_super_rel_chart) · 扩展点（Customization Points）
...
|---|---|---|---|---|
| EP-01 | 改 EmpSuprelChartPlugin 行为 | EmpSuprelChartPlugin.java | ⭐⭐ | (按需) |
| EP-02 | 改 EmpSuprelChartTreeNode 行为 | EmpSuprelChartTreeNode.java | ⭐⭐ | (按需) |

---

## EP-01 · 改 EmpSuprelChartPlugin 行为
...
`EmpSuprelChartPlugin.java`

### 改造方案

EmpSuprelChartPlugin 继承 HRDynamicFormBasePlugin·扩展时按 SDK 白名单 @Override 重写
...
## EP-02 · 改 EmpSuprelChartTreeNode 行为
...
`EmpSuprelChartTreeNode.java`

### 改造方案

EmpSuprelChartTreeNode 继承 TreeNode·扩展时按 SDK 白名单 @Override 重写
