# hrptmc_syncpolicy — 同步策略 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrptmc_syncpolicy`  **操作数**: 11
---
## 操作总览
...
|---|--------|---------|------------|------|
| 1 | — | `hrptmc_syncpolicy` | `kd.hr.hrptmc.opplugin.web.anobj.AnObjSyncPolicyOp` | kd.hr.hrptmc.opplugin.web.anobj.AnObjSyncPolicyOp |
