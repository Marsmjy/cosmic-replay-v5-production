# hbpm_positiontype — 岗位类型 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_bd_orgtpl_dlg` → `hbpm_bd_orgtpl_dlg` → `hbpm_positiontype`  **操作数**: 51
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 8 | 5 |
...
| 50 | `21A5O/3PV7IL` | donothing | 查看全部日志 | logview | `hbpm_positiontype` | 0 | 0 |
| 51 | `2COQ5049N75G` | donothing | 查看日志 | viewonelog | `hbpm_positiontype` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 4 | 2 | `bos_basetpl` | `kd.bos.base.bdversion.BdVersionSaveServicePlugin` | 基础资料版本化保存操作插件 |
| 5 | 2 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
| 6 | 3 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp` | 控制使用状态 |
| 7 | 5 | `hbpm_bd_orgtpl_dlg` | `kd.hrmp.hbpm.opplugin.web.basedata.BaseDataBuOp` | kd.hrmp.hbpm.opplugin.web.basedata.BaseDataBuOp |
...
| 4 | GrpfieldsuniqueValidation | `2NCR68C+P/DG` | 创建组织和名称组合字段唯一性校验 | `hbpm_bd_orgtpl_dlg` |
| 5 | GrpfieldsuniqueValidation | `2+R3Y9FBSJ51` | 编码唯一性校验 | `hbpm_positiontype` |
...
| 2 | ConditionValidation | `f789ca66000000ac` | 启用状态校验 | `bos_basetpl` |
| 3 | CustValidation | `2+U=J7R7IEF/` | HR基础资料删除校验 | `hbp_bd_orgtpl_all` |
| 4 | CustValidation | `2+RE4J37K857` | HR基础资料删除校验 | `hbpm_positiontype` |
...
| 4 | ConditionValidation | `/NNA=SJXYN9E` | 合法性校验 | `hbpm_positiontype` |
...
| 2 | ConditionValidation | `f2843bab0000bbac` | 启用状态合法性校验 | `bos_basetpl` |
...
| 2 | GrpfieldsuniqueValidation | `2AC0CT/9CUHO` | 名称唯一性校验 | `hbpm_positiontype` |
...
| 4 | 1 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
| 5 | 2 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp |
...
| 6 | GrpfieldsuniqueValidation | `424b895300015bac` | 组合字段唯一性校验 | `hbpm_positiontype` |
| 7 | GrpfieldsuniqueValidation | `2DDGGGIVWM1U` | 名称唯一性校验 | `hbpm_positiontype` |
