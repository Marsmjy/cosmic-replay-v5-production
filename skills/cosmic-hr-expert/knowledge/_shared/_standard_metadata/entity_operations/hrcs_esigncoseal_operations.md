# hrcs_esigncoseal — 企业印章 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `hrcs_esigncoseal`  **操作数**: 44
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 7 | 5 |
...
| 43 | `3F6CD7Z+TZ/H` | donothing | 从服务商同步电子签章 | barsynfromsp | `hrcs_esigncoseal` | 0 | 0 |
| 44 | `3HDZJ4VQ/FC4` | donothing | 印章授权 | barsealauth | `hrcs_esigncoseal` | 1 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 6 | `hrcs_esigncoseal` | `kd.hr.hrcs.opplugin.web.esign.ESignCOSealOp` | 电子签印章OP插件 |
...
| 5 | GrpfieldsuniqueValidation | `3F5H8C2TCPZJ` | 组合字段唯一性校验 | `hrcs_esigncoseal` |
...
| 4 | 3 | `hrcs_esigncoseal` | `kd.hr.hrcs.opplugin.web.esign.ESignCOSealOp` | HR电子签印章OP插件 |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hrcs_esigncoseal` | `kd.hr.hrcs.opplugin.web.esign.ESignCOSealOp` | 电子签印章OP插件 |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hrcs_esigncoseal` | `kd.hr.hrcs.opplugin.web.esign.ESignCOSealOp` | 电子签签章OP插件 |
| 2 | — | `hbp_bd_tpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
...
---
### 44. 印章授权（donothing / Key: barsealauth / oid: 3HDZJ4VQ/FC4）
> 根定义: `hrcs_esigncoseal`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hrcs_esigncoseal` | `kd.hr.hrcs.opplugin.web.esign.ESignCOSealOp` | 电子签印章OP操作 |
