# hbpm_chgrecord — 岗位变动明细 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hbpm_chgrecord`  **操作数**: 15
---
## 操作总览
...
| 12 | `2XW=S7GUC9PS` | exportdetails | 查看导出结果 | exportdetails | `hbpm_chgrecord` | 0 | 0 |
| 13 | `2XWA9XY59+JP` | refresh | 刷新 | refresh | `hbpm_chgrecord` | 0 | 0 |
| 14 | `2XWA=G424+VU` | close | 关闭 | close | `hbpm_chgrecord` | 0 | 0 |
| 15 | `2XWAGIP+ETI4` | exportlist | 导出数据（按导入模板） | exportlistbyselectfields | `hbpm_chgrecord` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
