# hrpi_preworkexp — 前工作经历 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_preworkexp`  **操作数**: 19
---
## 操作总览
...
| 19 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_preworkexp` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 4 | ConditionValidation | `4VUTNGOF=GHV` | 开始日期应早于或等于结束日期 | `hrpi_preworkexp` |
