# hbss_loginconfig — 登录页配置 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbss_loginconfig`  **操作数**: 41
---
## 操作总览
...
| 34 | `2COQ5049N75G` | donothing | 查看日志 | viewonelog | `hbp_bd_tpl_all` | 0 | 0 |
| 35 | `36NMYUPXH7+Y` | importdata_hr | 导入数据 | importdata_hr | `hbp_bd_tpl_all` | 0 | 0 |
| 36 | `36NN+52WYF1Y` | show_import_record_hr | 查看导入记录 | show_import_record_hr | `hbp_bd_tpl_all` | 0 | 0 |
| 37 | `36NN1BHX+R/A` | export_from_list_hr | 按列表导出 | export_from_list_hr | `hbp_bd_tpl_all` | 0 | 0 |
| 38 | `36NN2SRUE7N/` | export_from_impttpl_hr | 按导入模板导出 | export_from_impttpl_hr | `hbp_bd_tpl_all` | 0 | 0 |
| 39 | `36NN3ZT9PZNE` | export_from_expttpl_hr | 按导出模板导出 | export_from_expttpl_hr | `hbp_bd_tpl_all` | 0 | 0 |
| 40 | `36NN590J0H1R` | show_export_record_hr | 查看导出记录 | show_export_record_hr | `hbp_bd_tpl_all` | 0 | 0 |
| 41 | `49RXYKEJ+NGS` | audit | 审核 | audit | `hbss_loginconfig` | 1 | 2 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
---
### 41. 审核（audit / Key: audit / oid: 49RXYKEJ+NGS）
> 根定义: `hbss_loginconfig`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hbss_loginconfig` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |

**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | ConditionValidation | `49RZV6GHUQ+D` | 合法性校验 | `hbss_loginconfig` |
| 2 | ConditionValidation | `49RZYAY+P6PT` | 合法性校验 | `hbss_loginconfig` |
