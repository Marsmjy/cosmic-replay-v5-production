# haos_adminorglayer — 管理层级 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_bd_orgtpl_dlg` → `haos_adminorglayer`  **操作数**: 51
---
## 操作总览
...
| 50 | `21A5O/3PV7IL` | donothing | 查看全部日志 | logview | `haos_adminorglayer` | 0 | 0 |
| 51 | `2COQ5049N75G` | donothing | 查看日志 | viewonelog | `haos_adminorglayer` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 5 | `haos_adminorglayer` | `kd.hr.haos.opplugin.web.BaseDataBuOp` | kd.hr.haos.opplugin.web.BaseDataBuOp |
...
| 5 | GrpfieldsuniqueValidation | `2+R3Y9FBSJ51` | 编码唯一性校验 | `haos_adminorglayer` |
| 6 | GrpfieldsuniqueValidation | `2+R3ZR7WI4N2` | 名称唯一性校验 | `haos_adminorglayer` |
| 7 | GrpfieldsuniqueValidation | `2NCU/NZ5RL0Z` | 创建组织和名称组合字段唯一性校验 | `haos_adminorglayer` |
...
| 4 | CustValidation | `2+RE4J37K857` | HR基础资料删除校验 | `haos_adminorglayer` |
...
| 3 | ConditionValidation | `2LURKBZ6HGUT` | 合法性校验 | `haos_adminorglayer` |
...
| 6 | GrpfieldsuniqueValidation | `424b895300015bac` | 组合字段唯一性校验 | `haos_adminorglayer` |
| 7 | GrpfieldsuniqueValidation | `2DDGGGIVWM1U` | 名称唯一性校验 | `haos_adminorglayer` |
