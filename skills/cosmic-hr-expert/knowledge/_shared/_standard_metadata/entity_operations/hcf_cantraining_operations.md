# hcf_cantraining — 拟入职人员培训经历 操作清单
**继承链**: `hbp_bd_originaltpl` → `hcf_candidatereltpl` → `hcf_cantraining`  **操作数**: 17
---
## 操作总览
...
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `4YZALRCXXHDK` | 字段值合规性校验 | `hcf_cantraining` |
