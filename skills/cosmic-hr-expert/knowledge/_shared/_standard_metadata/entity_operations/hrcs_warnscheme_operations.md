# hrcs_warnscheme — 预警方案 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_warnscheme`  **操作数**: 58
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 10 | 4 |
...
| 43 | `40H37M8CFXPD` | donothing | 手工执行 | manualexecute | `hrcs_warnscheme` | 0 | 0 |
| 44 | `40H39E0L/WDY` | donothing | 引出配置 | exportconfigsql | `hrcs_warnscheme` | 0 | 0 |
| 45 | `40H3HO+7=XFA` | donothing | 查看日志 | viewexelog | `hrcs_warnscheme` | 0 | 0 |
| 46 | `445AJOIS1X9Y` | deleteentry | 删除分录(人员) | deleteentry | `hrcs_warnscheme` | 0 | 0 |
| 47 | `44B20ZWVOVFF` | donothing | 添加指定人员 | rcfixadd | `hrcs_warnscheme` | 0 | 0 |
| 48 | `485KNIRJNJ/B` | donothing | 添加人员关系 | rcrelationadd | `hrcs_warnscheme` | 0 | 0 |
| 49 | `485KQODNT9I4` | donothing | 添加角色 | rcroleadd | `hrcs_warnscheme` | 0 | 0 |
| 50 | `485KW3EL2JP3` | deleteentry | 删除（人员关系） | deleteentry_rela | `hrcs_warnscheme` | 0 | 0 |
| 51 | `485KZ+PMHV/6` | deleteentry | 删除（角色） | deleteentry_role | `hrcs_warnscheme` | 0 | 0 |
| 52 | `4FZ8NHUT071W` | donothing | 添加 | adminorgadd | `hrcs_warnscheme` | 0 | 0 |
| 53 | `4FZ8PCCCTT3F` | deleteentry | 删除（行政组织） | adminorgdeleteentry | `hrcs_warnscheme` | 0 | 0 |
| 54 | `4FZ8QSS=ZOXD` | donothing | 添加 | positionadd | `hrcs_warnscheme` | 0 | 0 |
| 55 | `4FZ8S5LA=8AV` | deleteentry | 删除（岗位） | positiondeleteentry | `hrcs_warnscheme` | 0 | 0 |
| 56 | `4FZ8TO91BFW=` | newentry | 新增分录（插件单据体） | pluginnewentry | `hrcs_warnscheme` | 0 | 0 |
| 57 | `4FZ8UY66ELTY` | deleteentry | 删除分录（插件单据体） | plugindeleteentry | `hrcs_warnscheme` | 0 | 0 |
| 58 | `4N935FN8R+A8` | donothing | 穿行测试 | walktest | `hrcs_warnscheme` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | 6 | `hrcs_warnscheme` | `kd.hr.hrcs.opplugin.web.earlywarn.WarnSchemeOp` | 预警方案OP |
| 7 | 7 | `hrcs_warnscheme` | `kd.hr.hrcs.opplugin.web.earlywarn.scheme.WarnSchemeBaseConditionOp` | 预警方案基本条件op |
| 8 | 8 | `hrcs_warnscheme` | `kd.hr.hrcs.opplugin.web.earlywarn.WarnReceiverSaveOp` | 消息接收人op |
| 9 | 9 | `hrcs_warnscheme` | `kd.hr.hrcs.opplugin.web.earlywarn.scheme.WarnSchemeAdConditionOp` | 预警方案高级条件op |
| 10 | 10 | `hrcs_warnscheme` | `kd.hr.hrcs.opplugin.web.earlywarn.WarnSchemeLogOp` | 预警消息保存自定义操作日志写入插件 |
