# hcf_canprojectexp — 拟入职人员项目经历 操作清单
**继承链**: `hbp_bd_originaltpl` → `hcf_candidatereltpl` → `hcf_canprojectexp`  **操作数**: 17
---
## 操作总览
...
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `4YZAJ0MMRRFL` | 字段值合规性校验 | `hcf_canprojectexp` |
