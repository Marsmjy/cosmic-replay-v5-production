# hrpi_partymember — 党员信息 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_partymember`  **操作数**: 18
---
## 操作总览
...
| 4 | MustInputValidation | `22GYV=PCW6A/` | 字段值合规性校验 | `hrpi_partymember` |
