# hrcs_orgstrategy — 行政组织-组织管理关系策略设置 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_managestrategy` → `hrcs_orgstrategy_tpl` → `hrcs_orgstrategy`  **操作数**: 47
---
## 操作总览
...
| 43 | `0O68451YUI/5` | newentry | 新增分录 | newentry | `hrcs_managestrategy` | 0 | 0 |
| 44 | `0O685=2+GRU0` | deleteentry | 删除分录 | deleteentry | `hrcs_managestrategy` | 0 | 0 |
| 45 | `11KY+6/+8674` | donothing | 变更 | change | `hrcs_orgstrategy` | 0 | 0 |
| 46 | `1ZN056KYEGK1` | donothing | 初始化组织管理关系策略 | initorgstrategy | `hrcs_orgstrategy` | 0 | 0 |
| 47 | `26/HLSPDYZ2/` | donothing | 查看变更记录 | barviewchange | `hrcs_orgstrategy` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | 4 | `hrcs_orgstrategy` | `kd.hr.hrcs.opplugin.web.OrgManageStrategySaveOp` | kd.hr.hrcs.opplugin.web.OrgManageStrategySaveOp |
