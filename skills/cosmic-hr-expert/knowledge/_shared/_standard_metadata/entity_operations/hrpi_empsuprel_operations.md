# hrpi_empsuprel — 汇报关系 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hbp_bd_timelinemintpl` → `hrpi_assigntimelinetpl` → `hrpi_empsuprel`  **操作数**: 23
---
## 操作总览
...
| 21 | `4T+1=A86RYH/` | close | 关闭 | close | `hrpi_empsuprel` | 0 | 0 |
| 22 | `52QDSZMBW4SD` | donothing | 失效 | expire | `hrpi_empsuprel` | 2 | 0 |
| 23 | `53WA3W5CPKIX` | donothing | 失效 | donothing_expire | `hrpi_empsuprel` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | 5 | `hrpi_empsuprel` | `kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelSaveOp` | 个体汇报关系保存Op |
...
---
### 22. 失效（donothing / Key: expire / oid: 52QDSZMBW4SD）
> 根定义: `hrpi_empsuprel`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hrpi_empsuprel` | `kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpSupRelExpireOp` | 个体汇报关系失效Op |
| 2 | 1 | `hrpi_empsuprel` | `kd.hrmp.hrpi.opplugin.web.chgrecord.ChgRecordSaveOp` | 操作成功后更新变动事务记录 |
