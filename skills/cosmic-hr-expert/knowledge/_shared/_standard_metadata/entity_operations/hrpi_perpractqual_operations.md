# hrpi_perpractqual — 执业资格 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_perpractqual`  **操作数**: 19
---
## 操作总览
...
| 5 | `/X9FTE5ABBM6` | save | 保存 | save | `hbp_bd_originalmintpl` | 3 | 4 |
...
| 19 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_perpractqual` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 4 | MustInputValidation | `4VU3Z57HM/O5` | 字段值合规性校验 | `hrpi_perpractqual` |
