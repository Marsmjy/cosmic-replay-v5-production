# hrptmc_filter — 筛选器设置 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrptmc_filter`  **操作数**: 15
---
## 操作总览
...
| 12 | `2WT0YAQ7W50/` | donothing | 保存 | donothing | `hrptmc_filter` | 0 | 0 |
| 13 | `2YOFRRGUXP5/` | close | 关闭 | close | `hrptmc_filter` | 0 | 0 |
| 14 | `4TEG31X6UEL0` | donothing | +添加时段查询组 | addgroupdate | `hrptmc_filter` | 0 | 0 |
| 15 | `4TEG4WPCOXHS` | donothing | 删除 | delgroupdate | `hrptmc_filter` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
