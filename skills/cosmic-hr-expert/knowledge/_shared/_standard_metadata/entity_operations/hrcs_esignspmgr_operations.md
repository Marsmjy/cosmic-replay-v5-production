# hrcs_esignspmgr — 电子签服务商管理 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_esignspmgr`  **操作数**: 48
---
## 操作总览
...
| 43 | `3ETZKG7Z8=LG` | donothing | 集成应用配置 | doappconfig | `hrcs_esignspmgr` | 0 | 0 |
| 44 | `3EU0XF7KWWU+` | donothing | 新增 | doentrybar_new | `hrcs_esignspmgr` | 0 | 0 |
| 45 | `3EU1/7GV1AB5` | deleteentry | 删除 | deleteentry | `hrcs_esignspmgr` | 0 | 0 |
| 46 | `3EU13Q8Q0Y15` | donothing | 启用 | doentrybar_enable | `hrcs_esignspmgr` | 0 | 0 |
| 47 | `3EU16FNGOA+3` | donothing | 禁用 | doentrybar_disable | `hrcs_esignspmgr` | 0 | 0 |
| 48 | `3EWSU29=VDA9` | donothing | 在线调试 | dodebug | `hrcs_esignspmgr` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 6 | `hrcs_esignspmgr` | `kd.hr.hrcs.opplugin.web.esign.ESignSPMgrOp` | 电子签服务商管理OP插件 |
