# hrcs_entitysyncconfig — 实体同步配置 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_entitysyncconfig`  **操作数**: 14
---
## 操作总览
...
| 12 | `1PIJWDW+BZ3/` | delete | 删除 | delete | `hrcs_entitysyncconfig` | 0 | 1 |
| 13 | `1PIK05X69F9D` | modify | 修改 | modify | `hrcs_entitysyncconfig` | 0 | 0 |
| 14 | `2+=1MRADD/1C` | new | 新增 | new | `hrcs_entitysyncconfig` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
### 12. 删除（delete / Key: delete / oid: 1PIJWDW+BZ3/）
> 根定义: `hrcs_entitysyncconfig`
**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | ConditionValidation | `1Q74Z3P971OP` | 未初始化数据删除校验 | `hrcs_entitysyncconfig` |
