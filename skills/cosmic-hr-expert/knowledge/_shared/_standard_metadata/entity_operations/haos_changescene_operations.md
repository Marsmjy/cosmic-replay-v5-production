# haos_changescene — 行政组织变动场景 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_bd_orgtpl_dlg` → `haos_changescene`  **操作数**: 51
---
## 操作总览
...
| 50 | `21A5O/3PV7IL` | donothing | 查看全部日志 | logview | `haos_changescene` | 0 | 0 |
| 51 | `2COQ5049N75G` | donothing | 查看日志 | viewonelog | `haos_changescene` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 8 | 6 | `haos_changescene` | `kd.hr.haos.opplugin.web.ChangeSceneSaveOp` | kd.hr.haos.opplugin.web.ChangeSceneSaveOp |
...
| 5 | GrpfieldsuniqueValidation | `otclassify.id` | 创建组织、名称和组织团队分类组合字段唯一性校验 | `haos_changescene` |
| 6 | GrpfieldsuniqueValidation | `2+R3Y9FBSJ51` | 编码唯一性校验 | `haos_changescene` |
| 7 | GrpfieldsuniqueValidation | `2+R3ZR7WI4N2` | 名称唯一性校验 | `haos_changescene` |
...
| 4 | CustValidation | `2+RE4J37K857` | HR基础资料删除校验 | `haos_changescene` |
...
| 3 | ConditionValidation | `2LUTHXCDTY4Q` | 合法性校验 | `haos_changescene` |
...
| 6 | GrpfieldsuniqueValidation | `424b895300015bac` | 组合字段唯一性校验 | `haos_changescene` |
| 7 | GrpfieldsuniqueValidation | `2DDGGGIVWM1U` | 名称唯一性校验 | `haos_changescene` |
