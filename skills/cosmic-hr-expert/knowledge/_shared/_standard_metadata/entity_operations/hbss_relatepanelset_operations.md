# hbss_relatepanelset — 侧边栏配置 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `hbss_relatepanelset`  **操作数**: 42
---
## 操作总览
...
| 5 | GrpfieldsuniqueValidation | `/HHPK9JFR=H9` | 组合字段唯一性校验 | `hbss_relatepanelset` |
...
| 4 | 2 | `hbss_relatepanelset` | `kd.hr.hbss.opplugin.web.RelatePanelSetOp` |  |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hbss_relatepanelset` | `kd.hr.hbss.opplugin.web.RelatePanelSetOp` |  |
