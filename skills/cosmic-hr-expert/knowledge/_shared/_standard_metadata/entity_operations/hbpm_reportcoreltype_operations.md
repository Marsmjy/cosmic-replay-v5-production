# hbpm_reportcoreltype — 协作类型 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_bd_orgtpl_dlg` → `hbpm_bd_orgtpl_dlg` → `hbpm_reportcoreltype`  **操作数**: 51
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 8 | 10 |
| 5 | `b599405400001bac` | delete | 删除 | delete | `bos_basetpl` | 4 | 5 |
...
| 12 | `f381c03f00002cac` | submit | 提交 | submit | `bos_basetpl` | 5 | 7 |
...
| 50 | `21A5O/3PV7IL` | donothing | 查看全部日志 | logview | `hbpm_reportcoreltype` | 0 | 0 |
| 51 | `2COQ5049N75G` | donothing | 查看日志 | viewonelog | `hbpm_reportcoreltype` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 5 | 4 | `bos_baseorgtpl` | `kd.bos.form.plugin.bdctrl.BaseDataSavePlugin` |  |
| 6 | 5 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp` | 控制使用状态 |
| 7 | 6 | `hbpm_bd_orgtpl_dlg` | `kd.hrmp.hbpm.opplugin.web.basedata.BaseDataBuOp` | kd.hrmp.hbpm.opplugin.web.basedata.BaseDataBuOp |
...
| 5 | GrpfieldsuniqueValidation | `2NCR68C+P/DG` | 创建组织和名称组合字段唯一性校验 | `hbpm_bd_orgtpl_dlg` |
| 6 | GrpfieldsuniqueValidation | `2+R3ZR7WI4N2` | 名称唯一性校验 | `hbpm_reportcoreltype` |
| 7 | ConditionValidation | `1a51dc0a0000a1ac` | 合法性校验 | `hbpm_reportcoreltype` |
| 8 | GrpfieldsuniqueValidation | `1B9SI1HB3NKW` | 编码唯一性校验 | `hbpm_reportcoreltype` |
| 9 | CustValidation | `0R3DU5Z42SN0` | HR基础资料保存校验 | `hbpm_reportcoreltype` |
| 10 | GrpfieldsuniqueValidation | `0W2=QZ0V609S` | 组合字段唯一性校验 | `hbpm_reportcoreltype` |
...
| 2 | 1 | `bos_baseorgtpl` | `kd.bos.form.plugin.bdctrl.BaseDataDeletePlugin` |  |
| 3 | 1 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp |
...
| 2 | ConditionValidation | `f789ca66000000ac` | 数据已经启用，不能删除 | `bos_basetpl` |
| 3 | CustValidation | `2+U=J7R7IEF/` | HR基础资料删除校验 | `hbp_bd_orgtpl_all` |
| 4 | CustValidation | `2+RE4J37K857` | HR基础资料删除校验 | `hbpm_reportcoreltype` |
| 5 | CustValidation | `0R6U8WEZK8/W` | HR基础资料删除校验 | `hbpm_reportcoreltype` |
...
| 4 | ConditionValidation | `/NNA=SJXYN9E` | 合法性校验 | `hbpm_reportcoreltype` |
...
| 3 | 1 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
| 4 | 2 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp |
| 5 | 5 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp |
...
| 6 | GrpfieldsuniqueValidation | `424b895300015bac` | 组合字段唯一性校验 | `hbpm_reportcoreltype` |
| 7 | GrpfieldsuniqueValidation | `2DDGGGIVWM1U` | 名称唯一性校验 | `hbpm_reportcoreltype` |
