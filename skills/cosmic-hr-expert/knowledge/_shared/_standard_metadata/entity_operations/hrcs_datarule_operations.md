# hrcs_datarule — 数据规则 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_datarule`  **操作数**: 43
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 7 | 6 |
...
| 43 | `5DL=WV8LD0UQ` | donothing | 查看全部日志 | logview | `hrcs_datarule` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 3 | 1 | `hrcs_datarule` | `kd.hr.hrcs.opplugin.web.perm.HRDataRuleSaveOp` |  |
...
| 3 | ConditionValidation | `1a51dc0a0000a1ac` | 合法性校验 | `hrcs_datarule` |
| 4 | CustValidation | `0R3DU5Z42SN0` | HR基础资料保存校验 | `hrcs_datarule` |
| 5 | GrpfieldsuniqueValidation | `1B9SI1HB3NKW` | 编码唯一性校验 | `hrcs_datarule` |
| 6 | GrpfieldsuniqueValidation | `1B9SIU+IP6+=` | 名称唯一性校验 | `hrcs_datarule` |
...
| 3 | CustValidation | `0R6U8WEZK8/W` | HR基础资料删除校验 | `hrcs_datarule` |
