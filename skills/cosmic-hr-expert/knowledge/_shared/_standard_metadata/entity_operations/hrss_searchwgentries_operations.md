# hrss_searchwgentries — 搜索权重等级分录 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrss_searchwgentries`  **操作数**: 42
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 5 | 2 |
| 5 | `b599405400001bac` | delete | 删除 | delete | `bos_basetpl` | 2 | 2 |
