# hbjm_jobgradehr — 职等 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_hisbutimeseqtpl` → `hbjm_hisbutimeseqtpl` → `hbjm_jobgradehr`  **操作数**: 59
---
## 操作总览
...
| 9 | 9 | `hbjm_jobgradehr` | `kd.hrmp.hbjm.opplugin.web.JobGradeSaveOp` | 职等保存插件 |
...
| 3 | 2 | `hbjm_jobgradehr` | `kd.hrmp.hbjm.opplugin.web.JobGradeSaveOp` | 职等保存OP |
