# hbjm_jobfamilyhr — 职位族 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_hisbutimeseqtpl` → `hbjm_hisbutimeseqtpl` → `hbjm_jobfamilyhr`  **操作数**: 59
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 9 | 6 |
| 5 | `b599405400001bac` | delete | 删除 | delete | `bos_basetpl` | 5 | 2 |
| 6 | `b599405400001cac` | audit | 审核 | audit | `bos_basetpl` | 2 | 3 |
| 7 | `b599405400001dac` | unaudit | 反审核 | unaudit | `bos_basetpl` | 2 | 4 |
| 8 | `b599405400001eac` | disable | 禁用 | disable | `bos_basetpl` | 3 | 1 |
...
| 12 | `f381c03f00002cac` | submit | 提交 | submit | `bos_basetpl` | 7 | 4 |
...
| 50 | `20KPN/W=M4GG` | donothing | 历史版本信息 | hisversioninfo | `hbp_hisbutimeseqtpl` | 0 | 0 |
| 51 | `20KPPRMXGF/V` | donothing | 变更 | change | `hbp_hisbutimeseqtpl` | 0 | 0 |
| 52 | `20KQI22R5KE2` | donothing | 复制 | hiscopy | `hbp_hisbutimeseqtpl` | 0 | 0 |
| 53 | `23LKXRJB52SD` | donothing | 管理权转让 | orgpermchange | `hbp_hisbutimeseqtpl` | 0 | 0 |
| 54 | `2BL9A7LJ+MLD` | donothing | 新增数据版本 | newhisversion | `hbp_hisbutimeseqtpl` | 0 | 1 |
| 55 | `2NY+GRV0I75K` | donothing | 修订 | revise | `hbp_hisbutimeseqtpl` | 0 | 0 |
| 56 | `2NY+IA24TJAH` | donothing | 版本修订历史 | reviserecord | `hbp_hisbutimeseqtpl` | 0 | 0 |
| 57 | `2P7P1YQ616DW` | donothing | 版本对比 | versionchangecompare | `hbp_hisbutimeseqtpl` | 0 | 0 |
| 58 | `2XZ45+=QLS0M` | donothing | 查看所有版本 | showallversion | `hbp_hisbutimeseqtpl` | 0 | 0 |
| 59 | `4V/7ENQAUB31` | save | 确认变更 | confirmchange | `hbp_hisbutimeseqtpl` | 2 | 3 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | 6 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp |
| 7 | 7 | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisUniqueValidateOp` | 历史模型唯一性校验插件 |
| 8 | 7 | `hbjm_jobfamilyhr` | `kd.hrmp.hbjm.opplugin.web.HbjmBaseNewDataOp` | hbjm基础新增op |
| 9 | 8 | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
...
| 4 | GrpfieldsuniqueValidation | `2=K9URZCEUUS` | 编码唯一性校验 | `hbjm_hisbutimeseqtpl` |
| 5 | GrpfieldsuniqueValidation | `23ILP6JS0TBC` | 创建组织和名称组合字段唯一性校验 | `hbjm_hisbutimeseqtpl` |
| 6 | ConditionValidation | `2M42D=Y0/0XK` | 生效日期不能填写未来 | `hbjm_hisbutimeseqtpl` |
...
| 3 | 4 | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
| 4 | 6 | `hbjm_jobfamilyhr` | `kd.hrmp.hbjm.opplugin.web.DeleteIgnorInitMetaOp` | 排除引用 |
| 5 | — | `bos_baseorgtpl` | `kd.bos.form.plugin.bdctrl.BaseDataDeletePlugin` |  |

**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | ConditionValidation | `f789ca66000000ac` | 合法性校验 | `bos_basetpl` |
| 2 | CustValidation | `2+U=J7R7IEF/` | HR基础资料删除校验 | `hbp_bd_orgtpl_all` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 2 | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
...
| 4 | ConditionValidation | `/U2/165YZ4K5` | 合法性校验 | `hbjm_jobfamilyhr` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
| 2 | 1 | `hbjm_jobfamilyhr` | `kd.hrmp.hbjm.opplugin.web.JobFamilyDisableOp` |  |
...
|---|--------|---------|------------|------|
| 1 | 1 | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
| 2 | 2 | `hbjm_jobfamilyhr` | `kd.hrmp.hbjm.opplugin.web.JobFamilyEnableOp` | 职位族启用op |
...
| 4 | 2 | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
| 5 | 4 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp |
| 6 | 5 | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisUniqueValidateOp` | 历史模型唯一性校验器 |
...
> 根定义: `hbp_hisbutimeseqtpl`
**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | ConditionValidation | `2K+JH30V7OJV` | 合法性校验 | `hbjm_hisbutimeseqtpl` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
| 2 | 1 | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisUniqueValidateOp` | 历史模型唯一性校验插件 |

**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `4V/78ID=HERR` | 字段值合规性校验 | `hbp_hisbutimeseqtpl` |
| 2 | GrpfieldsuniqueValidation | `4V/7C958CRVD` | 名称唯一性校验 | `hbp_hisbutimeseqtpl` |
| 3 | GrpfieldsuniqueValidation | `4V/7I6HFRZ3+` | 创建组织字段和编码唯一性校验 | `hbp_hisbutimeseqtpl` |
