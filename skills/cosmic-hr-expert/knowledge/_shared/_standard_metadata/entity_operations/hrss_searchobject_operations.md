# hrss_searchobject — 搜索对象 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrss_searchobject`  **操作数**: 43
---
## 操作总览
...
| 42 | `3TYI7XM1EP6I` | donothing | 下一步 | nextstep | `hrss_searchobject` | 0 | 3 |
| 43 | `3TYI94YRP2SD` | donothing | 上一步 | laststep | `hrss_searchobject` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 6 | `hrss_searchobject` | `kd.hr.hrss.opplugin.web.searchobj.SearchObjectOp` | 搜索对象op插件 |
...
| 4 | 3 | `hrss_searchobject` | `kd.hr.hrss.opplugin.web.searchobj.SearchObjectOp` | 搜索对象op插件 |
...
---
### 42. 下一步（donothing / Key: nextstep / oid: 3TYI7XM1EP6I）
> 根定义: `hrss_searchobject`
**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `3W9E13IQEH=1` | 字段值合规性校验 | `hrss_searchobject` |
| 2 | GrpfieldsuniqueValidation | `3W9E2R++=W0A` | 名称唯一性校验 | `hrss_searchobject` |
| 3 | GrpfieldsuniqueValidation | `3W9E4AS9K7ML` | 编码唯一性校验 | `hrss_searchobject` |
