# hrcs_dynacond — 动态数据范围配置 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `hrcs_dynacond`  **操作数**: 43
---
## 操作总览
...
| 43 | `3WH+U/NI71D7` | donothing | 查看适用维度 | do_showapplydimension | `hrcs_dynacond` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
