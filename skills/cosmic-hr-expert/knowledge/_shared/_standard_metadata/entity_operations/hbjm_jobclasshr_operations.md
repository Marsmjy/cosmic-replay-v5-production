# hbjm_jobclasshr — 职位类 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_hisbutimeseqtpl` → `hbjm_hisbutimeseqtpl` → `hbjm_jobclasshr`  **操作数**: 59
---
## 操作总览
...
| 59 | `4V/7ENQAUB31` | save | 确认变更 | confirmchange | `hbp_hisbutimeseqtpl` | 3 | 3 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 8 | 7 | `hbjm_jobclasshr` | `kd.hrmp.hbjm.opplugin.web.JobClassSaveOp` | 职位类保存插件 |
...
| 4 | 6 | `hbjm_jobclasshr` | `kd.hrmp.hbjm.opplugin.web.DeleteIgnorInitMetaOp` | 排除引用 |
...
| 4 | ConditionValidation | `/U2/165YZ4K5` | 合法性校验 | `hbjm_jobclasshr` |
...
| 2 | 1 | `hbjm_jobclasshr` | `kd.hrmp.hbjm.opplugin.web.JobClassDisableOp` |  |
...
|---|--------|---------|------------|------|
| 1 | 1 | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
| 2 | 2 | `hbjm_jobclasshr` | `kd.hrmp.hbjm.opplugin.web.JobClassEnableOp` | 职位类启用op |
...
| 3 | 2 | `hbjm_jobclasshr` | `kd.hrmp.hbjm.opplugin.web.JobClassSaveOp` | kd.hrmp.hbjm.opplugin.web.JobClassSaveOp |
