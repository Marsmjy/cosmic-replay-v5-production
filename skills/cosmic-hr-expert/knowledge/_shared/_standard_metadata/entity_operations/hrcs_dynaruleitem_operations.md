# hrcs_dynaruleitem — 规则参数项 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_dynaruleitem`  **操作数**: 44
---
## 操作总览
...
| 43 | `4ZRN1JGKK=1O` | newentry | 添加 | newentry | `hrcs_dynaruleitem` | 0 | 0 |
| 44 | `4ZRN2YA1/PCM` | deleteentry | 删除 | deleteentry | `hrcs_dynaruleitem` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 4 | 3 | `hrcs_dynaruleitem` | `kd.hr.hrcs.opplugin.web.perm.dyna.DynaItemDeleteOp` | 规则项删除引用校验 |
