# hbss_protitle — 职称 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `hbss_protitle`  **操作数**: 42
---
## 操作总览
...
| 5 | GrpfieldsuniqueValidation | `3B/+ASEH52FD` | 名称职称类别唯一性校验 | `hbss_protitle` |
