# haos_staffruleconfig — 编制计划设置 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `haos_staffruleconfig`  **操作数**: 46
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 7 | 2 |
...
| 43 | `2W3WCLSP66ZO` | save | 保存 | saveforchange | `haos_staffruleconfig` | 6 | 0 |
| 44 | `2XATUILXN37G` | newentry | 新增分录 | newentry | `haos_staffruleconfig` | 0 | 0 |
| 45 | `2XBT/MWQ611=` | deleteentry | 删除分录 | deleteentry | `haos_staffruleconfig` | 0 | 0 |
| 46 | `3C58FZA5Q3HE` | donothing | 空操作 | donothing | `haos_staffruleconfig` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | 4 | `haos_staffruleconfig` | `kd.hr.haos.opplugin.web.staff.OrgStaffRuleConfigSaveOp` | kd.hr.haos.opplugin.web.staff.OrgStaffRuleConfigSaveOp |
...
| 4 | 3 | `haos_staffruleconfig` | `kd.hr.haos.opplugin.web.staff.OrgStaffRuleConfigDeleteOp` | kd.hr.haos.opplugin.web.staff.OrgStaffRuleConfigDeleteOp |
...
---
### 43. 保存（save / Key: saveforchange / oid: 2W3WCLSP66ZO）
> 根定义: `haos_staffruleconfig`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `haos_staffruleconfig` | `kd.bos.business.plugin.CodeRuleOp` | kd.bos.business.plugin.CodeRuleOp |
| 2 | 1 | `haos_staffruleconfig` | `kd.bos.base.bdversion.BdVersionSaveServicePlugin` | kd.bos.base.bdversion.BdVersionSaveServicePlugin |
| 3 | 2 | `haos_staffruleconfig` | `kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp |
| 4 | 3 | `haos_staffruleconfig` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
| 5 | 4 | `haos_staffruleconfig` | `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp |
| 6 | 5 | `haos_staffruleconfig` | `kd.hr.haos.opplugin.web.staff.OrgStaffRuleConfigSaveOp` | kd.hr.haos.opplugin.web.staff.OrgStaffRuleConfigSaveOp |
