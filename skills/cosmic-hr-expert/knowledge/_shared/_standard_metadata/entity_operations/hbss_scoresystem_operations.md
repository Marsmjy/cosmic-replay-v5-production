# hbss_scoresystem — 评分分制 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbss_scoresystem`  **操作数**: 57
---
## 操作总览
...
| 50 | `23LKXRJB52SD` | donothing | 管理权转让 | orgpermchange | `hbss_scoresystem` | 0 | 0 |
| 51 | `2PWEMBQMIIEF` | moveentryup | 上移 | moveentryup | `hbss_scoresystem` | 0 | 0 |
| 52 | `2PWENH9ONLS7` | moveentrydown | 下移 | moveentrydown | `hbss_scoresystem` | 0 | 0 |
| 53 | `2PWEP5O+OFG4` | newentry | 增行 | newentry | `hbss_scoresystem` | 0 | 0 |
| 54 | `2PWEQYD699XZ` | deleteentry | 删行 | deleteentry | `hbss_scoresystem` | 0 | 0 |
| 55 | `4O+/V18G/LN9` | donothing | 添加评分间隔 | addinterval | `hbss_scoresystem` | 0 | 0 |
| 56 | `4OIR26LZWLT9` | newentry | 新增分录 | newentry1 | `hbss_scoresystem` | 0 | 0 |
| 57 | `4OZ3KOR5+ACU` | deleteentry | 删除评分间隔 | deleteinterval | `hbss_scoresystem` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 7 | `hbss_scoresystem` | `kd.hr.hbss.opplugin.web.scoresystem.ScoreSystemSaveOp` | 保存插件 |
...
| 3 | — | `bos_baseorgtpl` | `kd.bos.form.plugin.bdctrl.BaseDataDeletePlugin` |  |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `bos_baseorgtpl` | `kd.bos.form.plugin.bdctrl.BaseDataDisablePlugin` |  |

**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | ConditionValidation | `f2843bab0000baac` | 合法性校验 | `bos_basetpl` |
| 2 | ConditionValidation | `5FCAZIGI+FVB` | 合法性校验 | `hbss_scoresystem` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hbss_scoresystem` | `kd.hr.hbss.opplugin.web.opmc.ScoreSystemOp` | kd.hr.hbss.opplugin.web.opmc.ScoreSystemOp |
