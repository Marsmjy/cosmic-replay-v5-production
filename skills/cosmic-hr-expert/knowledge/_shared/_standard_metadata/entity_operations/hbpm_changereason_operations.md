# hbpm_changereason — 变动原因 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_bd_orgtpl_dlg` → `hbpm_bd_orgtpl_dlg` → `hbpm_changereason`  **操作数**: 51
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 8 | 7 |
...
| 50 | `21A5O/3PV7IL` | donothing | 查看全部日志 | logview | `hbpm_changereason` | 0 | 0 |
| 51 | `2COQ5049N75G` | donothing | 查看日志 | viewonelog | `hbpm_changereason` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | GrpfieldsuniqueValidation | `2+R3Y9FBSJ51` | 编码唯一性校验 | `hbpm_changereason` |
| 7 | GrpfieldsuniqueValidation | `2+R3ZR7WI4N2` | 名称唯一性校验 | `hbpm_changereason` |
...
| 4 | CustValidation | `2+RE4J37K857` | HR基础资料删除校验 | `hbpm_changereason` |
...
| 2 | GrpfieldsuniqueValidation | `2AC0CT/9CUHO` | 名称唯一性校验 | `hbpm_changereason` |
...
| 6 | GrpfieldsuniqueValidation | `424b895300015bac` | 组合字段唯一性校验 | `hbpm_changereason` |
| 7 | GrpfieldsuniqueValidation | `2DDGGGIVWM1U` | 名称唯一性校验 | `hbpm_changereason` |
