# hrpi_fertilityinfo — 生育信息 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_fertilityinfo`  **操作数**: 19
---
## 操作总览
...
| 5 | `/X9FTE5ABBM6` | save | 保存 | save | `hbp_bd_originalmintpl` | 3 | 5 |
...
| 19 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_fertilityinfo` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 4 | MustInputValidation | `4THY5K17RQ4J` | 字段值合规性校验 | `hrpi_fertilityinfo` |
| 5 | ConditionValidation | `4TKOMOKY+UD7` | 出生日期应早于当前日期 | `hrpi_fertilityinfo` |
