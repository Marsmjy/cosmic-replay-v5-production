# hbpm_positiontpl — 岗位模板 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbpm_positiontpl`  **操作数**: 44
---
## 操作总览
...
| 43 | `3G0W2J=W2E1R` | donothing | 变更 | change | `hbpm_positiontpl` | 0 | 0 |
| 44 | `3QRIM1+VR01P` | donothing | 设置适用范围 | donothing_setscope | `hbpm_positiontpl` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 5 | `hbpm_positiontpl` | `kd.hrmp.hbpm.opplugin.web.position.PositionTplSaveOp` | kd.hrmp.hbpm.opplugin.web.position.PositionTplSaveOp |
...
| 5 | GrpfieldsuniqueValidation | `4JCF7Y7/8G6+` | 组合字段唯一性校验 | `hbpm_positiontpl` |
