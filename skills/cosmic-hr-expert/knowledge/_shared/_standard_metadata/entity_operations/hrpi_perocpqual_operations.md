# hrpi_perocpqual — 职业资格 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_perocpqual`  **操作数**: 19
---
## 操作总览
...
| 5 | `/X9FTE5ABBM6` | save | 保存 | save | `hbp_bd_originalmintpl` | 4 | 4 |
...
| 19 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_perocpqual` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 3 | 3 | `hrpi_perocpqual` | `kd.hrmp.hrpi.opplugin.web.employee.attach.PerOcpQualSaveOp` | 职业资格插件 |
...
| 4 | MustInputValidation | `4VU4/M3B1V9V` | 字段值合规性校验 | `hrpi_perocpqual` |
