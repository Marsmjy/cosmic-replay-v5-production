# hrpi_personentityconf — 人员模型配置信息（废弃） 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_personentityconf`  **操作数**: 12
---
## 操作总览
...
| 12 | `21A7FDQUMC3F` | donothing | 查看日志 | logview | `hrpi_personentityconf` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
