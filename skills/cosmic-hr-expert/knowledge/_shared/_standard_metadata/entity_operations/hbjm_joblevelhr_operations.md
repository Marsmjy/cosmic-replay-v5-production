# hbjm_joblevelhr — 职级 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_hisbutimeseqtpl` → `hbjm_hisbutimeseqtpl` → `hbjm_joblevelhr`  **操作数**: 59
---
## 操作总览
...
| 8 | `b599405400001eac` | disable | 禁用 | disable | `bos_basetpl` | 2 | 1 |
...
| 9 | 9 | `hbjm_joblevelhr` | `kd.hrmp.hbjm.opplugin.web.JobLevelSaveOp` | 职级保存OP |
...
| 3 | 2 | `hbjm_joblevelhr` | `kd.hrmp.hbjm.opplugin.web.JobLevelSaveOp` | kd.hrmp.hbjm.opplugin.web.JobLevelSaveOp |
