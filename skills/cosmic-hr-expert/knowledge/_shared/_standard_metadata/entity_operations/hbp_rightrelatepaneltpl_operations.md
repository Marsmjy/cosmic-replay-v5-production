# hbp_rightrelatepaneltpl — HR右侧标签栏模板 操作清单
**继承链**: `bos_basetpl` → `hbp_rightrelatepaneltpl`  **操作数**: 34
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 2 | 6 |
| 5 | `b599405400001bac` | delete | 删除 | delete | `bos_basetpl` | 1 | 1 |
...
| 12 | `f381c03f00002cac` | submit | 提交 | submit | `bos_basetpl` | 2 | 3 |
| 13 | `f381c03f00002dac` | unsubmit | 撤销 | unsubmit | `bos_basetpl` | 0 | 2 |
...
| 3 | ConditionValidation | `1a51dc0a0000a1ac` | 合法性校验 | `hbp_rightrelatepaneltpl` |
| 4 | GrpfieldsuniqueValidation | `8ad4dee3000000ac` | 编码唯一性校验 | `hbp_rightrelatepaneltpl` |
| 5 | GrpfieldsuniqueValidation | `62a4cf98000107ac` | 名称唯一性校验 | `hbp_rightrelatepaneltpl` |
| 6 | MustInputValidation | `6073a58000004cac` | 必录校验 | `hbp_rightrelatepaneltpl` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hbp_rightrelatepaneltpl` | `kd.bd.assistant.plugin.basedata.BaseDataDisablePlugin` |  |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hbp_rightrelatepaneltpl` | `kd.bd.assistant.plugin.basedata.BaseDataEnablePlugin` |  |
