# hrpi_empproexp — 项目经历 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_empproexp`  **操作数**: 19
---
## 操作总览
...
| 19 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_empproexp` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 3 | 2 | `hrpi_empproexp` | `kd.hrmp.hrpi.opplugin.web.employee.attach.EmpProExpSaveOp` | 保存插件 |
...
| 4 | MustInputValidation | `4VTYWK1PRMPG` | 字段值合规性校验 | `hrpi_empproexp` |
