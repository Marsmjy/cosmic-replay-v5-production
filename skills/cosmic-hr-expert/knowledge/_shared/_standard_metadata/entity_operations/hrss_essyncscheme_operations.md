# hrss_essyncscheme — ES同步任务管理 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrss_essyncscheme`  **操作数**: 17
---
## 操作总览
...
| 5 | `/X9FTE5ABBM6` | save | 保存 | save | `hbp_bd_originalmintpl` | 0 | 0 |
...
| 12 | `4+/NY50O6U09` | donothing | 查看同步记录 | viewsynrecord | `hrss_essyncscheme` | 0 | 0 |
| 13 | `4+/O=90E+50/` | donothing | ES环境配置 | donothing_esconfig | `hrss_essyncscheme` | 0 | 0 |
| 14 | `4+/OC2U8HM3B` | donothing | 手动同步 | handsynes | `hrss_essyncscheme` | 0 | 0 |
| 15 | `4+/OKO8T2=4T` | donothing | 配置同步计划 | synplan | `hrss_essyncscheme` | 0 | 0 |
| 16 | `4+/OO/1YUIVF` | donothing | 查看全部同步记录 | viewallrecord | `hrss_essyncscheme` | 0 | 0 |
| 17 | `40L9WPIC66PN` | donothing | 创建同步任务 | createsyntask | `hrss_essyncscheme` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
