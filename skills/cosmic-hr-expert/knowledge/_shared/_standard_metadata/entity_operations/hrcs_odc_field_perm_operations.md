# hrcs_odc_field_perm — 组织基础资料控权 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_odc_field_perm`  **操作数**: 12
---
## 操作总览
...
| 5 | `/X9FTE5ABBM6` | save | 保存 | save | `hbp_bd_originalmintpl` | 0 | 1 |
...
| 12 | `4AIKMKYTOHUR` | delete | 删除 | delete | `hrcs_odc_field_perm` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | GrpfieldsuniqueValidation | `4=NDAR+L17VK` | 组合字段唯一性校验 | `hrcs_odc_field_perm` |
