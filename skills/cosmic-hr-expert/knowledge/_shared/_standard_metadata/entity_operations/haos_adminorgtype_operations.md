# haos_adminorgtype — 行政组织类型 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_bd_orgtpl_dlg` → `haos_adminorgtype`  **操作数**: 49
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 9 | 8 |
...
| 8 | `b599405400001eac` | disable | 禁用 | disable | `bos_basetpl` | 2 | 3 |
...
| 48 | `21A5O/3PV7IL` | donothing | 查看全部日志 | logview | `haos_adminorgtype` | 0 | 0 |
| 49 | `2COQ5049N75G` | donothing | 查看日志 | viewonelog | `haos_adminorgtype` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 5 | 4 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | HRBaseDataLogOp |
| 6 | 5 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp` | 控制使用状态 |
| 7 | 6 | `haos_adminorgtype` | `kd.hr.haos.opplugin.web.BaseDataBuOp` | kd.hr.haos.opplugin.web.BaseDataBuOp |
| 8 | 7 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp |
| 9 | 8 | `haos_adminorgtype` | `kd.hr.haos.opplugin.web.AdminOrgTypeSaveOp` | kd.hr.haos.opplugin.web.AdminOrgTypeSaveOp |
...
| 5 | GrpfieldsuniqueValidation | `1B9SI1HB3NKW` | 编码唯一性校验 | `haos_adminorgtype` |
| 6 | GrpfieldsuniqueValidation | `1B9SIU+IP6+=` | 组合字段唯一性校验 | `haos_adminorgtype` |
| 7 | ConditionValidation | `1a51dc0a0000a1ac` | 合法性校验 | `haos_adminorgtype` |
| 8 | GrpfieldsuniqueValidation | `2NCWPW4BGP9E` | 创建组织和名称和归属组合字段唯一性校验 | `haos_adminorgtype` |
...
| 3 | 1 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | HRBaseDataLogOp |
...
| 4 | CustValidation | `0R6U8WEZK8/W` | HR基础资料删除校验 | `haos_adminorgtype` |
...
| 4 | ConditionValidation | `/NNA=SJXYN9E` | 合法性校验 | `haos_adminorgtype` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | HRBaseDataLogOp |
...
| 3 | ConditionValidation | `2LUR7U6J29CM` | 合法性校验 | `haos_adminorgtype` |
...
| 2 | GrpfieldsuniqueValidation | `23TBOAP1V9ML` | 名称唯一性校验 | `haos_adminorgtype` |
...
| 6 | GrpfieldsuniqueValidation | `424b895300015bac` | 组合字段唯一性校验 | `haos_adminorgtype` |
| 7 | GrpfieldsuniqueValidation | `2DDGGGIVWM1U` | 名称唯一性校验 | `haos_adminorgtype` |
