# hrss_searchscene — 搜索场景 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrss_searchscene`  **操作数**: 59
---
## 操作总览
...
| 42 | `2KM1+V/F4OJ/` | moveentryup | 上移 | searchmoveentryup | `hrss_searchscene` | 0 | 0 |
| 43 | `2KM105YX7QT1` | moveentrydown | 下移 | searchmoveentrydown | `hrss_searchscene` | 0 | 0 |
| 44 | `2KM14T/SFIXP` | deleteentry | 删除 | searchdeleteentry | `hrss_searchscene` | 0 | 0 |
| 45 | `3UDQOIHOLY=Y` | newentry | 添加 | searchnewentry | `hrss_searchscene` | 0 | 0 |
| 46 | `3UDR7C4DJZVL` | newentry | 添加 | filternewentry | `hrss_searchscene` | 0 | 0 |
| 47 | `3UDR9B7NKUSC` | deleteentry | 删除 | filterdeleteentry | `hrss_searchscene` | 0 | 0 |
| 48 | `3UDVH3CY0W6V` | donothing | 下一步 | nextstep | `hrss_searchscene` | 0 | 3 |
| 49 | `3UDVITZ9/=C4` | donothing | 上一步 | laststep | `hrss_searchscene` | 0 | 0 |
| 50 | `3UDZ=7ZLIXP=` | donothing | 添加 | newrange | `hrss_searchscene` | 0 | 0 |
| 51 | `3UUI8QIRZYGL` | moveentryup | 上移 | moveentryup | `hrss_searchscene` | 0 | 0 |
| 52 | `3UUI=IUWJCP+` | moveentrydown | 下移 | moveentrydown | `hrss_searchscene` | 0 | 0 |
| 53 | `3ZY1L2P+2Y==` | donothing | 空操作 | movetonew | `hrss_searchscene` | 0 | 0 |
| 54 | `4+6MYO5BWUEO` | moveentryup | 上移 | moveentryupfilter | `hrss_searchscene` | 0 | 0 |
| 55 | `4+6N+FSP3KBU` | moveentrydown | 下移 | moveentrydownfilter | `hrss_searchscene` | 0 | 0 |
| 56 | `4JBFUD6RSVP+` | donothing | 新增分组 | addgroup | `hrss_searchscene` | 0 | 0 |
| 57 | `4JBFX94HOTT8` | donothing | 修改分组 | editgroup | `hrss_searchscene` | 0 | 0 |
| 58 | `4JBFZM1F5XTA` | donothing | 删除分组 | deletegroup | `hrss_searchscene` | 0 | 0 |
| 59 | `4JBUX6CX7PUN` | donothing | 批量设置分组 | batchsetgroup | `hrss_searchscene` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 6 | `hrss_searchscene` | `kd.hr.hrss.opplugin.web.searchscene.SearchSceneOp` | kd.hr.hrss.opplugin.web.searchscene.SearchSceneOp |
...
---
### 48. 下一步（donothing / Key: nextstep / oid: 3UDVH3CY0W6V）
> 根定义: `hrss_searchscene`
**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | GrpfieldsuniqueValidation | `3W9P/AN7A9BJ` | 编码字段唯一性校验 | `hrss_searchscene` |
| 2 | GrpfieldsuniqueValidation | `3W9P073J2NCF` | 名称字段唯一性校验 | `hrss_searchscene` |
| 3 | MustInputValidation | `3W9P39GTFF+B` | 字段值合规性校验 | `hrss_searchscene` |
