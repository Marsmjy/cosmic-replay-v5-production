# hrpi_percre — 证件信息 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_percre`  **操作数**: 19
---
## 操作总览
...
| 19 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_percre` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 3 | 2 | `hrpi_percre` | `kd.hrmp.hrpi.opplugin.web.employee.attach.PerCreSaveOp` | 证件信息保存Op |
...
| 4 | MustInputValidation | `4X1Y3BMUX2HO` | 字段值合规性校验 | `hrpi_percre` |
