# hrcs_labelobject_t_hrcs_labelobject 系列 — 操作清单（合并去重）
**涵盖实体数**: 2  **去重后操作数**: 48
---
## 1. 继承树
以下展示目标实体的继承关系（缩进表示父子关系）：
```bos_basetpl (基础资料模板)    └── hbp_bd_tpl_all (HR基础资料全页面模板)        └── hrcs_labelobject (打标对象)            └── hrcs_lbldelineatdim (打标圈定维度)```
---
## 2. 操作总览
...
| 43 | `2XVOKLHO0APL` | donothing | 启用 | enablestatus | 1 | 0 | 1 | 2 |
| 44 | `2XVOMEFI0E1+` | donothing | 禁用 | disablestatus | 1 | 0 | 1 | 2 |
| 45 | `2ZU1Y4=ST6W9` | donothing | 下一步 | nextone | 0 | 2 | 1 | 2 |
| 46 | `38AV84XS+ARD` | donothing | 上一步 | lastone | 0 | 0 | 1 | 2 |
| 47 | `3KE70ESEVUHV` | donothing | 因子管理 | showfactor | 0 | 0 | 1 | 2 |
| 48 | `3KE73PA8/3F6` | donothing | 能力配置 | showconfig | 0 | 0 | 1 | 2 |
---
## 3. 操作详情（仅展示有插件或校验器的操作）
---
### 4. 保存（save / Key: save / oid: b599405400001aac）
> 根定义: `bos_basetpl` | 涉及实体 (2): `hrcs_labelobject`, `hrcs_lbldelineatdim`
**插件清单**：
...
| 7 | 5 | `hrcs_labelobject` | `kd.hr.hrcs.opplugin.web.label.LabelObjectOp` | kd.hr.hrcs.opplugin.web.label.LabelObjectOp |
...
| 4 | 3 | `hrcs_labelobject` | `kd.hr.hrcs.opplugin.web.label.LabelObjectOp` | kd.hr.hrcs.opplugin.web.label.LabelObjectOp |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hrcs_labelobject` | `kd.hr.hrcs.opplugin.web.label.LabelObjectOp` | kd.hr.hrcs.opplugin.web.label.LabelObjectOp |
...
---
### 43. 启用（donothing / Key: enablestatus / oid: 2XVOKLHO0APL）
> 根定义: `hrcs_labelobject` | 涉及实体 (2): `hrcs_labelobject`, `hrcs_lbldelineatdim`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hrcs_labelobject` | `kd.hr.hrcs.opplugin.web.label.LabelObjectOp` | kd.hr.hrcs.opplugin.web.label.LabelObjectOp |

---
### 44. 禁用（donothing / Key: disablestatus / oid: 2XVOMEFI0E1+）
> 根定义: `hrcs_labelobject` | 涉及实体 (2): `hrcs_labelobject`, `hrcs_lbldelineatdim`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
...
---
### 45. 下一步（donothing / Key: nextone / oid: 2ZU1Y4=ST6W9）
> 根定义: `hrcs_labelobject` | 涉及实体 (2): `hrcs_labelobject`, `hrcs_lbldelineatdim`
**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | GrpfieldsuniqueValidation | `2ZU1X38PVGQ3` | 编码唯一性校验 | `hrcs_labelobject` |
| 2 | GrpfieldsuniqueValidation | `2ZU20E8G7ORS` | 名称唯一性校验 | `hrcs_labelobject` |
