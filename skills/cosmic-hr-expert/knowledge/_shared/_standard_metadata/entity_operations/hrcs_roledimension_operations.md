# hrcs_roledimension — 角色维度关系 操作清单
**继承链**: `hbp_bd_originaltpl` → `hrcs_roledimension`  **操作数**: 13
---
## 操作总览
...
| 12 | `1=6XR5TQ2V6K` | newentry | 新增分录 | newentry | `hrcs_roledimension` | 0 | 0 |
| 13 | `1=6XS9IQWM89` | deleteentry | 删除分录 | deleteentry | `hrcs_roledimension` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
