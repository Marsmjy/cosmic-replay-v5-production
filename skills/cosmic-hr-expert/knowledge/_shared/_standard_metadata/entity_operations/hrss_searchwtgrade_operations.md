# hrss_searchwtgrade — 权重等级 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrss_searchwtgrade`  **操作数**: 46
---
## 操作总览
...
| 42 | `2AQC68BQMS3O` | newentry | 新增分录 | newentry | `hrss_searchwtgrade` | 0 | 0 |
| 43 | `2AQC7X5U0BEI` | deleteentry | 删除分录 | deleteentry | `hrss_searchwtgrade` | 0 | 0 |
| 44 | `2L80A+89C2B7` | moveentryup | 上移一行 | moveentryup | `hrss_searchwtgrade` | 0 | 0 |
| 45 | `2L80ATO/88U2` | moveentrydown | 下移一行 | moveentrydown | `hrss_searchwtgrade` | 0 | 0 |
| 46 | `2LLAUA0KCY7E` | donothing | 空操作 | delline | `hrss_searchwtgrade` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 6 | `hrss_searchwtgrade` | `kd.hr.hrss.opplugin.web.searchscene.SearchwtGradeSaveOp` | kd.hr.hrss.opplugin.web.searchscene.SearchwtGradeSaveOp |
...
| 5 | GrpfieldsuniqueValidation | `2LDABWD0PHG9` | 组合字段唯一性校验 | `hrss_searchwtgrade` |
...
| 4 | 3 | `hrss_searchwtgrade` | `kd.hr.hrss.opplugin.web.searchscene.SearchwtGradeDeleteOpPlugin` | 删除插件 |
