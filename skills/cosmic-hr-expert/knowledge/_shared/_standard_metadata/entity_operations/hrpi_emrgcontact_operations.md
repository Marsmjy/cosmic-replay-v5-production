# hrpi_emrgcontact — 紧急联系人 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_emrgcontact`  **操作数**: 19
---
## 操作总览
...
| 19 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_emrgcontact` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 4 | MustInputValidation | `4THY0Z1ZZ2VN` | 字段值合规性校验 | `hrpi_emrgcontact` |
