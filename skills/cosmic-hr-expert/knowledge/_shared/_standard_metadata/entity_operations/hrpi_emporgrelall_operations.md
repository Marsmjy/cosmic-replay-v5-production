# hrpi_emporgrelall — 任职经历总表 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hbp_bd_timelinemintpl` → `hrpi_assigntimelinetpl` → `hrpi_emporgrelall`  **操作数**: 20
---
## 操作总览
...
| 5 | `/X9FTE5ABBM6` | save | 保存 | save | `hbp_bd_originalmintpl` | 7 | 3 |
...
| 6 | 6 | `hrpi_assigntimelinetpl` | `kd.hrmp.hrpi.opplugin.web.common.EmployeeCommonStandardMustInputOp` | 标品字段必填Op |
...
| 3 | MustInputValidation | `22GYV=PCW6A/` | 字段值合规性校验 | `hrpi_emporgrelall` |
