# hrcs_filterscene — 过滤场景 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_filterscene`  **操作数**: 52
---
## 操作总览
...
| 43 | `1CI6EWD==VFK` | donothing | 空操作 | do_addinput | `hrcs_filterscene` | 0 | 0 |
| 44 | `1CI6JTIIM43K` | donothing | 空操作 | do_addoutput | `hrcs_filterscene` | 0 | 0 |
| 45 | `1D0VWSDEOM2H` | donothing | 空操作 | do_delinput | `hrcs_filterscene` | 0 | 0 |
| 46 | `1D0VYWW2C+GR` | donothing | 空操作 | do_deloutput | `hrcs_filterscene` | 0 | 0 |
| 47 | `1GARWQJAZWJC` | deleteentry | 删除分录 | deleteinputparams | `hrcs_filterscene` | 0 | 0 |
| 48 | `1GASH7LDSLLL` | deleteentry | 删除分录 | deleteoutputparams | `hrcs_filterscene` | 0 | 0 |
| 49 | `1S1SER+U7JHU` | moveentryup | 上移一行 | inputmoveup | `hrcs_filterscene` | 0 | 0 |
| 50 | `1S1SI=X751=P` | moveentrydown | 下移一行 | inputmovedown | `hrcs_filterscene` | 0 | 0 |
| 51 | `1S1SLO+QAJJA` | moveentryup | 上移一行 | outputmoveup | `hrcs_filterscene` | 0 | 0 |
| 52 | `1S1SOZ26AX5/` | moveentrydown | 下移一行 | outputmovedown | `hrcs_filterscene` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 5 | CustValidation | `1K++T35WCDF2` | HR基础资料保存校验 | `hrcs_filterscene` |
| 6 | GrpfieldsuniqueValidation | `1K+ODS7=OOW0` | 组合字段唯一性校验 | `hrcs_filterscene` |
| 7 | GrpfieldsuniqueValidation | `1K+OETAWIKWI` | 组合字段唯一性校验 | `hrcs_filterscene` |
...
| 3 | 2 | `hrcs_filterscene` | `kd.hr.brm.opplugin.web.SceneConfigOp` |  |
| 4 | 3 | `hbp_bd_tpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |

**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | ConditionValidation | `f789ca66000000ac` | 数据已经禁用，不能删除。 | `bos_basetpl` |
| 2 | CustValidation | `2KP75WGUEZK6` | HR基础资料删除校验 | `hrcs_filterscene` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hrcs_filterscene` | `kd.hr.brm.opplugin.web.SceneConfigOp` |  |
| 2 | — | `hbp_bd_tpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
| 3 | — | `hrcs_filterscene` | `kd.hr.hbss.opplugin.drools.web.SceneConfigOp` |  |
