# hrcs_functiontype — 公式函数分类 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `hrcs_functiontype`  **操作数**: 42
---
## 操作总览
...
| 6 | 4 | `hrcs_functiontype` | `kd.hr.hrcs.opplugin.web.function.FunctionTypeOp` | 函数分类OP |
...
| 4 | 3 | `hrcs_functiontype` | `kd.hr.hrcs.opplugin.web.function.FunctionTypeOp` | 函数分类OP |
