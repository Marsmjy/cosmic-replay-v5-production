# hbss_scoreinterval — 评分间隔 操作清单
**继承链**: `hbp_bd_originaltpl` → `hbp_bd_originaldlgtpl` → `hbss_scoreinterval`  **操作数**: 34
---
## 操作总览
...
| 32 | `4O90A1BYIXMU` | donothing | 保存 | savecache | `hbss_scoreinterval` | 0 | 1 |
| 33 | `4O9O70G6KJAW` | newentry | 新增分录 | newentry | `hbss_scoreinterval` | 0 | 0 |
| 34 | `4P+QJLY2NNH6` | donothing | 生成 | generate | `hbss_scoreinterval` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
---
### 32. 保存（donothing / Key: savecache / oid: 4O90A1BYIXMU）
> 根定义: `hbss_scoreinterval`
**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `4P1XKLXR9Z8I` | 字段值合规性校验 | `hbss_scoreinterval` |
