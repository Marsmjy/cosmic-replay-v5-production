# hbss_supplier — 供应商 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbss_supplier`  **操作数**: 44
---
## 操作总览
...
| 43 | `0=71HGICH591` | deleteentry | 删除分录 | deleteentry | `hbss_supplier` | 0 | 0 |
| 44 | `0=71IJ+/V=Z4` | newentry | 新增分录 | newentry | `hbss_supplier` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 5 | GrpfieldsuniqueValidation | `1HUPVQQG7EQD` | 电子邮箱唯一性 | `hbss_supplier` |
| 6 | GrpfieldsuniqueValidation | `1HUPY=7AGK3N` | 手机号座机唯一校验 | `hbss_supplier` |
