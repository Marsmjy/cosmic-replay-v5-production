# hrpi_trialperiod — 试用期 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hbp_bd_timelinemintpl` → `hrpi_assigntimelinetpl` → `hrpi_trialperiod`  **操作数**: 21
---
## 操作总览
...
| 5 | `/X9FTE5ABBM6` | save | 保存 | save | `hbp_bd_originalmintpl` | 8 | 3 |
...
| 21 | `5B+QYW6QJAPR` | close | 取消 | close | `hrpi_trialperiod` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | 5 | `hrpi_trialperiod` | `kd.hrmp.hrpi.opplugin.web.assignment.attach.TrialPeriodSaveOp` | 计算预离职日期 |
...
| 3 | MustInputValidation | `22GYV=PCW6A/` | 字段值合规性校验 | `hrpi_trialperiod` |
