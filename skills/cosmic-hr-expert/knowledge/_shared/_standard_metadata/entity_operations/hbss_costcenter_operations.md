# hbss_costcenter — HR成本承担单位 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbss_costcenter`  **操作数**: 44
---
## 操作总览
...
| 43 | `21A5G1REGO=D` | donothing | 查看日志 | logview | `hbss_costcenter` | 0 | 0 |
| 44 | `0CWG4I5K982E` | edit | 编辑 | edit | `hbss_costcenter` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 5 | GrpfieldsuniqueValidation | `0+/SL/MZ=VJB` | 创建组织和编码组合字段唯一性校验 | `hbss_costcenter` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 2 | `hbss_costcenter` | `kd.hr.hbss.opplugin.web.CostCenterAuditOp` |  |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hbss_costcenter` | `kd.hr.hbss.opplugin.web.CostCenterEnableOp` |  |
| 2 | — | `hbp_bd_tpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
...
| 5 | GrpfieldsuniqueValidation | `424b895300015bac` | 创建组织和编码组合字段唯一性校验 | `hbss_costcenter` |
