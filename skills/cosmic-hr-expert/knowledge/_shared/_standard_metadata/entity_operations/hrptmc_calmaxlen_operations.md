# hrptmc_calmaxlen — 计算字段最大长度配置表 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrptmc_calmaxlen`  **操作数**: 12
---
## 操作总览
...
| 12 | `45A8Q83PHS8I` | delete | 删除 | delete | `hrptmc_calmaxlen` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `45A8S1Y=T=5F` | 字段值合规性校验 | `hrptmc_calmaxlen` |
