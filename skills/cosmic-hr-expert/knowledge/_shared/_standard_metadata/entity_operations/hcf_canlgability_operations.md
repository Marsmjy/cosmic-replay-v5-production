# hcf_canlgability — 拟入职人员语言技能 操作清单
**继承链**: `hbp_bd_originaltpl` → `hcf_candidatereltpl` → `hcf_canlgability`  **操作数**: 17
---
## 操作总览
...
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `4YZAA=7RJ+62` | 字段值合规性校验 | `hcf_canlgability` |
