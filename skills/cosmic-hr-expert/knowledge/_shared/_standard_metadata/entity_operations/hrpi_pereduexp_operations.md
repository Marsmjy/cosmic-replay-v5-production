# hrpi_pereduexp — 教育经历 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_pereduexp`  **操作数**: 21
---
## 操作总览
...
| 19 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_pereduexp` | 0 | 0 |
| 20 | `4TASQMR0/B9F` | newentry | 新增分录 | newentry | `hrpi_pereduexp` | 0 | 0 |
| 21 | `4TASSMXVTFW3` | deleteentry | 删除分录 | deleteentry | `hrpi_pereduexp` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 3 | 2 | `hrpi_pereduexp` | `kd.hrmp.hrpi.opplugin.web.employee.attach.PerEduExpSaveOp` | 教育经历保存插件 |
