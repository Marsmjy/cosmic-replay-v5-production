# hrcs_lblobjconfig — 能力配置 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_lblobjconfig`  **操作数**: 56
---
## 操作总览
...
| 43 | `2VGKZ=SQWFZM` | newentry | 新增分录 | newentry | `hrcs_lblobjconfig` | 0 | 0 |
| 44 | `2VGL+==GIORF` | deleteentry | 删除 | deletedisplay | `hrcs_lblobjconfig` | 0 | 0 |
| 45 | `2VGLH+U8J0DP` | moveentryup | 上移 | moveentryup | `hrcs_lblobjconfig` | 0 | 0 |
| 46 | `2VGLIA0TTHID` | moveentrydown | 下移 | moveentrydown | `hrcs_lblobjconfig` | 0 | 0 |
| 47 | `3J2V3AU3J75M` | moveentryup | 上移 | moveentryup1 | `hrcs_lblobjconfig` | 0 | 0 |
| 48 | `3J2X5EWR0MJE` | moveentrydown | 下移 | moveentrydown1 | `hrcs_lblobjconfig` | 0 | 0 |
| 49 | `3J2X813T3H0Z` | moveentryup | 上移 | moveentryup2 | `hrcs_lblobjconfig` | 0 | 0 |
| 50 | `3J2X9C+PBYII` | moveentrydown | 下移 | moveentrydown2 | `hrcs_lblobjconfig` | 0 | 0 |
| 51 | `3J2ZRES+160B` | deleteentry | 删除 | deleteruledim | `hrcs_lblobjconfig` | 0 | 0 |
| 52 | `3J2ZTWESSQZ=` | deleteentry | 删除 | deletemanualdim | `hrcs_lblobjconfig` | 0 | 0 |
| 53 | `3J2ZXOS95QMA` | donothing | 添加 | addruledim | `hrcs_lblobjconfig` | 0 | 0 |
| 54 | `3J3++8=SPA4=` | donothing | 添加 | addmanualdim | `hrcs_lblobjconfig` | 0 | 0 |
| 55 | `3JPTINMJ9ZFD` | donothing | 添加 | adddisplay | `hrcs_lblobjconfig` | 0 | 0 |
| 56 | `3JTC/V6HK98E` | donothing | 空操作 | dataup | `hrcs_lblobjconfig` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
