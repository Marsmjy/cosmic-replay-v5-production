# hrcs_userroledimgrp — 用户角色维度组 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_userroledimgrp`  **操作数**: 14
---
## 操作总览
...
| 12 | `2+7/0ZRXUS6P` | newentry | 新增分录 | newentry | `hrcs_userroledimgrp` | 0 | 0 |
| 13 | `2+7/2H758JR+` | deleteentry | 删除 | deleteentry | `hrcs_userroledimgrp` | 0 | 0 |
| 14 | `3WB=IFMK95W6` | new | 新增 | new | `hrcs_userroledimgrp` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
