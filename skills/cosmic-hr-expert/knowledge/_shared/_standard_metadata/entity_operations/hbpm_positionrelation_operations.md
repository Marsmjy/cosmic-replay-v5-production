# hbpm_positionrelation — 岗位汇报关系 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hbp_bd_timelinemintpl` → `hbpm_positionrelation`  **操作数**: 20
---
## 操作总览
...
| 17 | `4ST67BUVS5HA` | donothing | 保存 | save_api | `hbpm_positionrelation` | 1 | 0 |
| 18 | `4ST6=NB46SQK` | donothing | 启用 | enable_api | `hbpm_positionrelation` | 1 | 0 |
| 19 | `4ST6D85L03HA` | donothing | 禁用 | disable_api | `hbpm_positionrelation` | 1 | 0 |
| 20 | `4ST6HB0W4SSV` | donothing | 变更 | change_api | `hbpm_positionrelation` | 1 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
---
### 17. 保存（donothing / Key: save_api / oid: 4ST67BUVS5HA）
> 根定义: `hbpm_positionrelation`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hbpm_positionrelation` | `kd.hrmp.hbpm.opplugin.web.workroles.ReportRelationOp` | 汇报关系保存插件 |

---
### 18. 启用（donothing / Key: enable_api / oid: 4ST6=NB46SQK）
> 根定义: `hbpm_positionrelation`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hbpm_positionrelation` | `kd.hrmp.hbpm.opplugin.web.workroles.ReportRelationEnableAndDisableOp` | 汇报关系历史保存插件 |

---
### 19. 禁用（donothing / Key: disable_api / oid: 4ST6D85L03HA）
> 根定义: `hbpm_positionrelation`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
...
---
### 20. 变更（donothing / Key: change_api / oid: 4ST6HB0W4SSV）
> 根定义: `hbpm_positionrelation`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hbpm_positionrelation` | `kd.hrmp.hbpm.opplugin.web.workroles.ReportRelationOp` | 汇报关系历史保存插件 |
