# hrcs_projorgstrategy — 项目团队-组织管理关系策略设置 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_managestrategy` → `hrcs_orgstrategy_tpl` → `hrcs_projorgstrategy`  **操作数**: 45
---
## 操作总览
...
| 45 | `2J2R1WM2Z98R` | donothing | 初始化组织管理关系策略 | initstrategy | `hrcs_projorgstrategy` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | 4 | `hrcs_projorgstrategy` | `kd.hr.hrcs.opplugin.web.projteam.OrgProjManageStrategySaveOp` | kd.hr.hrcs.opplugin.web.projteam.OrgProjManageStrategySaveOp |
