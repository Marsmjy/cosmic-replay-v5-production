# hrcs_permfilegrp — 用户权限档案组 操作清单
**继承链**: `bos_basetpl` → `bos_basetreetpl` → `hbp_bd_treetpl_all` → `hbp_bd_treetpl_dlg` → `hrcs_permfilegrp`  **操作数**: 41
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 6 | 7 |
| 5 | `b599405400001bac` | delete | 删除 | delete | `bos_basetpl` | 4 | 2 |
| 6 | `b599405400001cac` | audit | 审核 | audit | `bos_basetpl` | 0 | 3 |
| 7 | `b599405400001dac` | unaudit | 反审核 | unaudit | `bos_basetpl` | 0 | 3 |
| 8 | `b599405400001eac` | disable | 禁用 | disable | `bos_basetpl` | 0 | 2 |
...
| 12 | `f381c03f00002cac` | submit | 提交 | submit | `bos_basetpl` | 6 | 4 |
...
| 35 | `2COR52N52LPD` | donothing | 查看日志 | viewonelog | `hbp_bd_treetpl_all` | 0 | 0 |
| 36 | `36NPU2DI6FXA` | importdata_hr | 导入数据 | importdata_hr | `hbp_bd_treetpl_all` | 0 | 0 |
| 37 | `36NPVCLGSZN4` | show_import_record_hr | 查看导入记录 | show_import_record_hr | `hbp_bd_treetpl_all` | 0 | 0 |
| 38 | `36NPWODABTRF` | export_from_list_hr | 按列表导出 | export_from_list_hr | `hbp_bd_treetpl_all` | 0 | 0 |
| 39 | `36NPYUG2BL2D` | export_from_impttpl_hr | 按导入模板导出 | export_from_impttpl_hr | `hbp_bd_treetpl_all` | 0 | 0 |
| 40 | `36NQ+5HU6UIF` | export_from_expttpl_hr | 按导出模板导出 | export_from_expttpl_hr | `hbp_bd_treetpl_all` | 0 | 0 |
| 41 | `36NQ/DH4BCQA` | show_export_record_hr | 查看导出记录 | show_export_record_hr | `hbp_bd_treetpl_all` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 4 | 4 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp |
| 5 | 7 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp |
| 6 | — | `hrcs_permfilegrp` | `kd.hr.hrcs.opplugin.web.perm.PermFilesGrpSaveOp` |  |
...
| 4 | ConditionValidation | `1a51dc0a0000d9ac` | 合法性校验 | `hrcs_permfilegrp` |
| 5 | GrpfieldsuniqueValidation | `8ad4dee3000139ac` | 编码唯一性校验 | `hrcs_permfilegrp` |
| 6 | GrpfieldsuniqueValidation | `62a4cf9800014bac` | 名称唯一性校验 | `hrcs_permfilegrp` |
| 7 | MustInputValidation | `6073a580000078ac` | 必录校验 | `hrcs_permfilegrp` |
...
| 2 | 1 | `bos_basetreetpl` | `kd.bos.business.plugin.BaseTreeOp` |  |
| 3 | 2 | `bos_basetreetpl` | `kd.bos.business.plugin.BaseTreeDeleteValidate` |  |
| 4 | 3 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp |

**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | ConditionValidation | `f789ca66000000ac` | 合法性校验 | `bos_basetpl` |
| 2 | CustValidation | `0R6US=D464PB` | HR基础资料删除校验 | `hrcs_permfilegrp` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `bos_basetreetpl` | `kd.bos.business.plugin.BaseTreeEnableValidate` |  |
...
| 5 | 5 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp |
| 6 | 6 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp |
