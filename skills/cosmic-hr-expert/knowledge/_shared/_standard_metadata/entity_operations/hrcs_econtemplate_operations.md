# hrcs_econtemplate — 电子签署配置 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_econtemplate`  **操作数**: 42
---
## 操作总览
...
| 7 | 6 | `hrcs_econtemplate` | `kd.hr.hrcs.opplugin.web.EContractTemplateSaveOp` | kd.hr.hrcs.opplugin.web.EContractTemplateSaveOp |
