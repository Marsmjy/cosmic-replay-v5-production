# hrptmc_virtentityclass — 虚拟对象处理类 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrptmc_virtentityclass`  **操作数**: 44
---
## 操作总览
...
| 43 | `3DNACFL4M76E` | newentry | 新增分录 | newentry | `hrptmc_virtentityclass` | 0 | 0 |
| 44 | `3DNADU9V70I4` | deleteentry | 删除分录 | deleteentry | `hrptmc_virtentityclass` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
