# hrcs_entityspecfuncgen — 实体特殊职能_自动生成 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_entityspecfunc` → `hrcs_entityspecfuncgen`  **操作数**: 16
---
## 操作总览
...
| 12 | `2CI4HHAHRHI2` | new | 新增 | new | `hrcs_entityspecfunc` | 0 | 0 |
| 13 | `2CI4IV3XB7T3` | modify | 修改 | modify | `hrcs_entityspecfunc` | 0 | 0 |
| 14 | `2CI4KA8ONL5R` | delete | 删除 | delete | `hrcs_entityspecfunc` | 0 | 0 |
| 15 | `2CI4QYCV/=V+` | donothing | 初始化计算 | donothing_initcal | `hrcs_entityspecfunc` | 0 | 0 |
| 16 | `2CNZCUG17SKL` | exportlist_expt | 引出数据（按引出模板） | exportlist_expt | `hrcs_entityspecfuncgen` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
