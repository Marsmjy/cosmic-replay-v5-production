# hrcs_lbljoinentity — 标签关联实体 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hbp_joinentitytpl` → `hrcs_lbljoinentity`  **操作数**: 12
---
## 操作总览
...
| 12 | `3+JR67=H+HT6` | delete | 删除 | delete | `hrcs_lbljoinentity` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
