# haos_adminorgtypestd — 行政组织类型归属 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `haos_adminorgtypestd`  **操作数**: 42
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 5 | 6 |
| 5 | `b599405400001bac` | delete | 删除 | delete | `bos_basetpl` | 2 | 3 |
| 6 | `b599405400001cac` | audit | 审核 | audit | `bos_basetpl` | 0 | 3 |
| 7 | `b599405400001dac` | unaudit | 反审核 | unaudit | `bos_basetpl` | 0 | 4 |
| 8 | `b599405400001eac` | disable | 禁用 | disable | `bos_basetpl` | 0 | 2 |
| 9 | `b599405400001fac` | enable | 启用 | enable | `bos_basetpl` | 0 | 1 |
| 10 | `b5994054000021ac` | close | 关闭 | close | `bos_basetpl` | 0 | 0 |
| 11 | `c54e30e7000010ac` | returndata | 返回数据 | returndata | `bos_basetpl` | 0 | 0 |
| 12 | `f381c03f00002cac` | submit | 提交 | submit | `bos_basetpl` | 4 | 4 |
...
| 3 | ConditionValidation | `1a51dc0a0000a1ac` | 合法性校验 | `haos_adminorgtypestd` |
| 4 | GrpfieldsuniqueValidation | `8ad4dee3000000ac` | 编码唯一性校验 | `haos_adminorgtypestd` |
| 5 | GrpfieldsuniqueValidation | `62a4cf98000107ac` | 名称唯一性校验 | `haos_adminorgtypestd` |
| 6 | MustInputValidation | `6073a58000004cac` | 必录校验 | `haos_adminorgtypestd` |
...
| 2 | ConditionValidation | `/KMIDPUKMJTS` | 审核状态不能删除 | `haos_adminorgtypestd` |
| 3 | CustValidation | `0R6U8WEZK8/W` | HR基础资料删除校验 | `haos_adminorgtypestd` |
...
| 4 | ConditionValidation | `/NNA=SJXYN9E` | 合法性校验 | `haos_adminorgtypestd` |
