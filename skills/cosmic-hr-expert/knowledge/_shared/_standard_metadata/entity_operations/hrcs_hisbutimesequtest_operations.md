# hrcs_hisbutimesequtest — 时序受控模板单元测试 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_hisbutimeseqtpl` → `hrcs_hisbutimesequtest`  **操作数**: 59
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 8 | 4 |
...
| 54 | `2BL9A7LJ+MLD` | donothing | 新增数据版本 | newhisversion | `hbp_hisbutimeseqtpl` | 0 | 0 |
