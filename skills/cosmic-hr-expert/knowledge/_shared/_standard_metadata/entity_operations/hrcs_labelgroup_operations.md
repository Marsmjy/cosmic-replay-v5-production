# hrcs_labelgroup — 标签分类 操作清单
**继承链**: `bos_basetpl` → `bos_basetreetpl` → `hbp_bd_treetpl_all` → `hbp_bd_treetpl_dlg` → `hrcs_labelgroup`  **操作数**: 42
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 9 | 5 |
...
| 35 | `21A667R9=MRE` | donothing | 查看全部日志 | logview | `hbp_bd_treetpl_all` | 0 | 0 |
| 36 | `2COR52N52LPD` | donothing | 查看日志 | viewonelog | `hbp_bd_treetpl_all` | 0 | 0 |
| 37 | `36NPU2DI6FXA` | importdata_hr | 导入数据 | importdata_hr | `hbp_bd_treetpl_all` | 0 | 0 |
| 38 | `36NPVCLGSZN4` | show_import_record_hr | 查看导入记录 | show_import_record_hr | `hbp_bd_treetpl_all` | 0 | 0 |
| 39 | `36NPWODABTRF` | export_from_list_hr | 按列表导出 | export_from_list_hr | `hbp_bd_treetpl_all` | 0 | 0 |
| 40 | `36NPYUG2BL2D` | export_from_impttpl_hr | 按导入模板导出 | export_from_impttpl_hr | `hbp_bd_treetpl_all` | 0 | 0 |
| 41 | `36NQ+5HU6UIF` | export_from_expttpl_hr | 按导出模板导出 | export_from_expttpl_hr | `hbp_bd_treetpl_all` | 0 | 0 |
| 42 | `36NQ/DH4BCQA` | show_export_record_hr | 查看导出记录 | show_export_record_hr | `hbp_bd_treetpl_all` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 5 | 4 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp |
| 6 | 5 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
| 7 | 6 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp` | 控制使用状态 |
| 8 | 7 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp |
| 9 | 7 | `hrcs_labelgroup` | `kd.hr.hrcs.opplugin.web.label.LabelGroupEditOp` | 编辑的校验 |
...
| 4 | GrpfieldsuniqueValidation | `2+UBQR52MZPL` | 编码唯一性校验 | `hbp_bd_treetpl_all` |
| 5 | GrpfieldsuniqueValidation | `2+UBRNZ73MPD` | 名称唯一性校验 | `hbp_bd_treetpl_all` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `bos_basetreetpl` | `kd.bos.business.plugin.BaseTreeDeleteValidate` |  |
| 2 | 2 | `bos_basetpl` | `kd.bos.coderule.CodeRuleDeleteOp` |  |
| 3 | 3 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp |
| 4 | 4 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
...
| 3 | CustValidation | `2+UBV409MZA0` | HR基础资料删除校验 | `hbp_bd_treetpl_all` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
| 2 | — | `bos_basetreetpl` | `kd.bos.business.plugin.BaseTreeEnableValidate` |  |
...
| 3 | 2 | `bos_basetreetpl` | `kd.bos.business.plugin.BaseTreeOp` |  |
| 4 | 3 | `bos_basetreetpl` | `kd.bos.business.plugin.BaseTreeLongNumberOp` |  |
| 5 | 4 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
| 6 | 5 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp |
| 7 | 6 | `hbp_bd_treetpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp |
...
| 4 | GrpfieldsuniqueValidation | `2DDGVBA4NNWC` | 名称唯一性校验 | `hbp_bd_treetpl_all` |
