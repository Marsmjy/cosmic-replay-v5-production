# haos_companytype — 公司类型 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_bd_orgtpl_dlg` → `haos_companytype`  **操作数**: 51
---
## 操作总览
...
| 50 | `21A5O/3PV7IL` | donothing | 查看全部日志 | logview | `haos_companytype` | 0 | 0 |
| 51 | `2COQ5049N75G` | donothing | 查看日志 | viewonelog | `haos_companytype` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 5 | `haos_companytype` | `kd.hr.haos.opplugin.web.BaseDataBuOp` | kd.hr.haos.opplugin.web.BaseDataBuOp |
...
| 5 | GrpfieldsuniqueValidation | `name` | 创建组织和名称组合字段唯一性校验 | `haos_companytype` |
| 6 | ConditionValidation | `1a51dc0a0000a1ac` | 合法性校验 | `haos_companytype` |
| 7 | CustValidation | `0R3DU5Z42SN0` | HR基础资料保存校验 | `haos_companytype` |
| 8 | GrpfieldsuniqueValidation | `1B9SI1HB3NKW` | 编码唯一性校验 | `haos_companytype` |
| 9 | GrpfieldsuniqueValidation | `1B9SIU+IP6+=` | 名称唯一性校验 | `haos_companytype` |
...
| 4 | CustValidation | `0R6U8WEZK8/W` | HR基础资料删除校验 | `haos_companytype` |
...
| 4 | ConditionValidation | `/NNA=SJXYN9E` | 合法性校验 | `haos_companytype` |
...
| 3 | ConditionValidation | `2LUSS59BWGFY` | 合法性校验 | `haos_companytype` |
...
| 6 | GrpfieldsuniqueValidation | `424b895300015bac` | 组合字段唯一性校验 | `haos_companytype` |
| 7 | GrpfieldsuniqueValidation | `2DDGGGIVWM1U` | 名称唯一性校验 | `haos_companytype` |
