# hrpi_empjobrel — 职级职等 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hbp_bd_timelinemintpl` → `hrpi_assigntimelinetpl` → `hrpi_empjobrel`  **操作数**: 22
---
## 操作总览
...
| 21 | `4SZE7TMK45GE` | close | 取消 | close | `hrpi_empjobrel` | 0 | 0 |
| 22 | `5ACJPTQKU4X2` | donothing | 保存 | adjust | `hrpi_empjobrel` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | 5 | `hrpi_empjobrel` | `kd.hrmp.hrpi.opplugin.web.assignment.attach.EmpJobRelSaveOp` | 职级职等保存插件 |
