# hrss_essynrecord — ES同步记录 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrss_essynrecord`  **操作数**: 14
---
## 操作总览
...
| 12 | `3WFKQ=S8R395` | donothing | 取消任务 | btncancelsync | `hrss_essynrecord` | 0 | 0 |
| 13 | `3WFNM=4MHA5N` | close | 关闭 | close | `hrss_essynrecord` | 0 | 0 |
| 14 | `40P526GIBLH3` | donothing | 终止任务 | stoptask | `hrss_essynrecord` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
|---|--------|---------|------------|------|
| 1 | — | `hrss_essynrecord` | `kd.hr.hrss.opplugin.web.essyn.ESSynRecordSaveOp` | 保存插件 |
