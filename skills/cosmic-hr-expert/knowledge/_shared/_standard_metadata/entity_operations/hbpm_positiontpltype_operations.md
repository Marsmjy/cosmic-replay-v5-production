# hbpm_positiontpltype — 岗位模板类型 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_bd_orgtpl_dlg` → `hbpm_positiontpltype`  **操作数**: 57
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 8 | 8 |
| 5 | `b599405400001bac` | delete | 删除 | delete | `bos_basetpl` | 4 | 4 |
...
| 50 | `21A5O/3PV7IL` | donothing | 查看全部日志 | logview | `hbpm_positiontpltype` | 0 | 0 |
| 51 | `2COQ5049N75G` | donothing | 查看日志 | viewonelog | `hbpm_positiontpltype` | 0 | 0 |
| 52 | `36NMYUPXH7+Y` | importdata_hr | 导入数据 | importdata_hr | `hbpm_positiontpltype` | 0 | 0 |
| 53 | `36NN+52WYF1Y` | show_import_record_hr | 查看导入记录 | show_import_record_hr | `hbpm_positiontpltype` | 0 | 0 |
| 54 | `36NN1BHX+R/A` | export_from_list_hr | 按列表导出 | export_from_list_hr | `hbpm_positiontpltype` | 0 | 0 |
| 55 | `36NN2SRUE7N/` | export_from_impttpl_hr | 按导入模板导出 | export_from_impttpl_hr | `hbpm_positiontpltype` | 0 | 0 |
| 56 | `36NN3ZT9PZNE` | export_from_expttpl_hr | 按导出模板导出 | export_from_expttpl_hr | `hbpm_positiontpltype` | 0 | 0 |
| 57 | `36NN590J0H1R` | show_export_record_hr | 查看导出记录 | show_export_record_hr | `hbpm_positiontpltype` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 3 | 1 | `bos_baseorgtpl` | `kd.bos.form.plugin.bdctrl.BaseDataSavePlugin` |  |
| 4 | 2 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp |
| 5 | 3 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
| 6 | 4 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataEnableOp` | 控制使用状态 |
| 7 | 5 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp |
| 8 | 6 | `hbpm_positiontpltype` | `kd.hrmp.hbpm.opplugin.web.position.PositionTplTypeSaveOp` | kd.hrmp.hbpm.opplugin.web.position.PositionTplTypeSaveOp |
...
| 5 | GrpfieldsuniqueValidation | `2+R3Y9FBSJ51` | 编码唯一性校验 | `hbpm_positiontpltype` |
| 6 | GrpfieldsuniqueValidation | `2+R3ZR7WI4N2` | 名称唯一性校验 | `hbpm_positiontpltype` |
| 7 | GrpfieldsuniqueValidation | `3G+1ZYBV+4I9` | 排序号唯一性校验 | `hbpm_positiontpltype` |
| 8 | GrpfieldsuniqueValidation | `3G+23/NAZ=MN` | 名称使用状态唯一性校验 | `hbpm_positiontpltype` |
...
| 2 | 1 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataStatusOp |
| 3 | 2 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
...
| 4 | CustValidation | `2+RE4J37K857` | HR基础资料删除校验 | `hbpm_positiontpltype` |
...
| 2 | GrpfieldsuniqueValidation | `3G+32ZH+BDBW` | 名称使用状态唯一性校验 | `hbpm_positiontpltype` |
...
| 6 | GrpfieldsuniqueValidation | `424b895300015bac` | 组合字段唯一性校验 | `hbpm_positiontpltype` |
| 7 | GrpfieldsuniqueValidation | `2DDGGGIVWM1U` | 名称唯一性校验 | `hbpm_positiontpltype` |
