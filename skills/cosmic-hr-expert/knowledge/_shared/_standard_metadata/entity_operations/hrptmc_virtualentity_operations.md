# hrptmc_virtualentity — 虚拟对象 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrptmc_virtualentity`  **操作数**: 44
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 6 | 8 |
...
| 43 | `33G1A19Z9ZJ0` | donothing | 新增 | newdata | `hrptmc_virtualentity` | 0 | 0 |
| 44 | `33G1BGF04+DE` | deleteentry | 删除分录 | deleteentry | `hrptmc_virtualentity` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 5 | GrpfieldsuniqueValidation | `33G49G4A40DN` | 组合字段唯一性校验 | `hrptmc_virtualentity` |
| 6 | GrpfieldsuniqueValidation | `33G4=825PC3Z` | 组合字段唯一性校验 | `hrptmc_virtualentity` |
| 7 | GrpfieldsuniqueValidation | `33G4ABWVWSCT` | 组合字段唯一性校验 | `hrptmc_virtualentity` |
| 8 | RegexValidation | `3HHFTL/NDSK0` | 文本格式检查 | `hrptmc_virtualentity` |
...
| 4 | 3 | `hrptmc_virtualentity` | `kd.hr.hrptmc.opplugin.web.repdesign.ReportVirtualEntityOp` | kd.hr.hrptmc.opplugin.web.repdesign.ReportVirtualEntityOp |
...
| 5 | GrpfieldsuniqueValidation | `33W+YVMPC1ET` | 组合字段唯一性校验 | `hrptmc_virtualentity` |
| 6 | GrpfieldsuniqueValidation | `33W+ZIZI8=HK` | 组合字段唯一性校验 | `hrptmc_virtualentity` |
| 7 | GrpfieldsuniqueValidation | `33W/+7+53I4T` | 组合字段唯一性校验 | `hrptmc_virtualentity` |
