# hbjm_jobhr — 职位 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_hisbutimeseqtpl` → `hbjm_hisbutimeseqtpl` → `hbjm_jobhr`  **操作数**: 61
---
## 操作总览
...
| 60 | `1OCUWIO/1X8C` | donothing | 空操作 | save_donothing | `hbjm_jobhr` | 0 | 0 |
| 61 | `5DYE92RNCR=1` | selecttplprint | 打印职位说明书 | selecttplprint | `hbjm_jobhr` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 8 | 8 | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
| 9 | 9 | `hbjm_jobhr` | `kd.hrmp.hbjm.opplugin.web.job.JobHrSaveOp` | 保存 |
...
| 2 | 3 | `hbjm_jobhr` | `kd.hrmp.hbjm.opplugin.web.job.JobHrAuditOp` | 职位审核op |
...
| 2 | 2 | `hbjm_jobhr` | `kd.hrmp.hbjm.opplugin.web.job.JobHrDisableOp` | 禁用 |
...
|---|--------|---------|------------|------|
| 1 | 1 | `hbp_hisbutimeseqtpl` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
| 2 | 2 | `hbjm_jobhr` | `kd.hrmp.hbjm.opplugin.web.job.JobHrEnableOp` | 启用 |
...
| 3 | 2 | `hbjm_jobhr` | `kd.hrmp.hbjm.opplugin.web.job.JobHrSaveOp` | 保存 |
