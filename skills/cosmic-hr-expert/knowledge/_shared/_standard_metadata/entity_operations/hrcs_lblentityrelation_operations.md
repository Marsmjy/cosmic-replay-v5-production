# hrcs_lblentityrelation — 标签实体关联关系 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hbp_entityrelationtpl` → `hrcs_lblentityrelation`  **操作数**: 12
---
## 操作总览
...
| 12 | `3+JR7IORAV3J` | delete | 删除 | delete | `hrcs_lblentityrelation` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
