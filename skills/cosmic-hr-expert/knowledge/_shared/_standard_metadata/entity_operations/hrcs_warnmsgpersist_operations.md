# hrcs_warnmsgpersist — 消息详情 操作清单
**继承链**: `hbp_bd_originaltpl` → `hrcs_warnmsgpersist`  **操作数**: 15
---
## 操作总览
...
| 12 | `48S7XFL7XA1Q` | donothing | 展开正文 | openmain | `hrcs_warnmsgpersist` | 0 | 0 |
| 13 | `48S7ZNDHCLKD` | donothing | 收起正文 | closemain | `hrcs_warnmsgpersist` | 0 | 0 |
| 14 | `504P2HIO6IKO` | donothing | 展开正文 | openmainen | `hrcs_warnmsgpersist` | 0 | 0 |
| 15 | `504P971AMRCM` | donothing | 收起正文 | closemainen | `hrcs_warnmsgpersist` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
