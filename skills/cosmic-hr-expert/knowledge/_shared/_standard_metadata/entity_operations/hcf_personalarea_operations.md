# hcf_personalarea — 拟入职人员区域信息 操作清单
**继承链**: `hbp_bd_originaltpl` → `hcf_candidatereltpl` → `hcf_personalarea`  **操作数**: 17
---
## 操作总览
...
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `4YZAO=OT5DWB` | 字段值合规性校验 | `hcf_personalarea` |
