# hrptmc_busiservice — 业务服务 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrptmc_busiservice`  **操作数**: 46
---
## 操作总览
...
| 43 | `2WJEC/SKUHXY` | newentry | 增行 | newentry | `hrptmc_busiservice` | 0 | 0 |
| 44 | `2WJEFBRZGWJT` | deleteentry | 删行 | deleteentry | `hrptmc_busiservice` | 0 | 0 |
| 45 | `2WJEGEOR00BW` | moveentryup | 上移 | moveentryup | `hrptmc_busiservice` | 0 | 0 |
| 46 | `2WJEIQ=OGGWN` | moveentrydown | 下移 | moveentrydown | `hrptmc_busiservice` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
