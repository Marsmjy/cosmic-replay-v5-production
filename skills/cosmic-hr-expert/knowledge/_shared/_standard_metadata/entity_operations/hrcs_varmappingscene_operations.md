# hrcs_varmappingscene — 变量映射场景 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `hrcs_varmappingscene`  **操作数**: 44
---
## 操作总览
...
| 43 | `5GF1+6+/L1I2` | donothing | 取值对象配置 | tplvariableconfig | `hrcs_varmappingscene` | 0 | 0 |
| 44 | `5GF18IH9EBQM` | donothing | 常用变量配置 | commonvariableconfig | `hrcs_varmappingscene` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
