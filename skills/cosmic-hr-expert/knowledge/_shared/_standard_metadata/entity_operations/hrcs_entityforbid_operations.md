# hrcs_entityforbid — 禁用权限 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_entityforbid`  **操作数**: 17
---
## 操作总览
...
| 12 | `2BQ6OS7DS0OD` | delete | 删除 | delete | `hrcs_entityforbid` | 0 | 0 |
| 13 | `3HV7GAK74OC6` | saveandnew | 保存并新增 | saveandnew | `hrcs_entityforbid` | 0 | 0 |
| 14 | `3N+UCDZE7OPD` | donothing | 导出脚本 | generatesql | `hrcs_entityforbid` | 0 | 0 |
| 15 | `3N/G=QNAYBWS` | donothing | 批量新增 | batchnew | `hrcs_entityforbid` | 0 | 0 |
| 16 | `3NZYPU5QNH2O` | donothing | 添加 | add | `hrcs_entityforbid` | 0 | 0 |
| 17 | `3NZYSR1F/K7M` | donothing | &lt;移除 | remove | `hrcs_entityforbid` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
