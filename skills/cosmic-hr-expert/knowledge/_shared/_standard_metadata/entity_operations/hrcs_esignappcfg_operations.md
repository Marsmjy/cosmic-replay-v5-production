# hrcs_esignappcfg — 应用配置 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_esignappcfg`  **操作数**: 44
---
## 操作总览
...
| 43 | `3GOD13WZED/8` | newentry | 新增分录 | newentry | `hrcs_esignappcfg` | 0 | 0 |
| 44 | `3GOHEZ0CKNB0` | deleteentry | 删行 | deleteentry | `hrcs_esignappcfg` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
