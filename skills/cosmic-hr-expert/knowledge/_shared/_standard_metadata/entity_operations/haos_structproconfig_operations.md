# haos_structproconfig — 架构方案配置 操作清单
**继承链**: `hbp_bd_originalmintpl` → `haos_structproconfig`  **操作数**: 17
---
## 操作总览
...
| 12 | `3D12Q9I5X3HK` | newentry | 新增 | newentry | `haos_structproconfig` | 0 | 0 |
| 13 | `3D12RP1VXU02` | deleteentry | 删除 | deleteentry | `haos_structproconfig` | 0 | 0 |
| 14 | `3D12U8Y7UQGB` | newentry | 新增 | newsubentry | `haos_structproconfig` | 0 | 0 |
| 15 | `3D12XBIYBWG6` | deleteentry | 删除 | deletesubentry | `haos_structproconfig` | 0 | 0 |
| 16 | `3EUMIUX657OQ` | importdata | 导入数据 | importdata | `haos_structproconfig` | 0 | 0 |
| 17 | `3FMJ1Y5EKZ69` | delete | 删除 | delete | `haos_structproconfig` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
|---|--------|---------|------------|------|
| 1 | — | `haos_structproconfig` | `kd.hr.haos.opplugin.web.structproject.StructProConfigSaveOp` | kd.hr.haos.opplugin.web.structproject.StructProConfigSaveOp |

**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `5GKNSYO3Z+GF` | 字段值合规性校验 | `haos_structproconfig` |
