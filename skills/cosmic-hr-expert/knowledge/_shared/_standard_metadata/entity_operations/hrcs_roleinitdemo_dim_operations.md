# hrcs_roleinitdemo_dim — 角色初始化角色维度样例 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_roleinitdemo_dim`  **操作数**: 14
---
## 操作总览
...
| 12 | `3FM=RB3KYXU6` | newentry | 新增分录 | newentry | `hrcs_roleinitdemo_dim` | 0 | 0 |
| 13 | `3FM=SLC9IYC8` | deleteentry | 删除分录 | deleteentry | `hrcs_roleinitdemo_dim` | 0 | 0 |
| 14 | `3G8R3V0V1K/B` | delete | 删除 | delete | `hrcs_roleinitdemo_dim` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
