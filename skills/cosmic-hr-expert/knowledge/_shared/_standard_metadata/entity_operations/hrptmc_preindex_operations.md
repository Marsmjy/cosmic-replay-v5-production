# hrptmc_preindex — 预置指标 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrptmc_preindex`  **操作数**: 50
---
## 操作总览
...
| 43 | `2WJMQKM2+H3F` | newentry | 增行 | newentry | `hrptmc_preindex` | 0 | 0 |
| 44 | `2WJMRQ2BB50B` | deleteentry | 删行 | deleteentry | `hrptmc_preindex` | 0 | 0 |
| 45 | `2WJMT=K20M97` | moveentryup | 上移 | moveentryup | `hrptmc_preindex` | 0 | 0 |
| 46 | `2WJMU3LV4PBT` | moveentrydown | 下移 | moveentrydown | `hrptmc_preindex` | 0 | 0 |
| 47 | `2WN8BUFA6NXY` | donothing | 添加 | addparam | `hrptmc_preindex` | 0 | 0 |
| 48 | `2WN8E0VNTI+O` | donothing | 删除 | deleteparam | `hrptmc_preindex` | 0 | 0 |
| 49 | `3PM9/RBX3472` | donothing | 导入配置 | importconfig | `hrptmc_preindex` | 0 | 0 |
| 50 | `3Q4ETPPS5IW9` | donothing | 导出配置 | exportconfig | `hrptmc_preindex` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
