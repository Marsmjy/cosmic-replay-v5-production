# hcf_cancontact — 拟入职人员紧急联系人 操作清单
**继承链**: `hbp_bd_originaltpl` → `hcf_candidatereltpl` → `hcf_cancontact`  **操作数**: 17
---
## 操作总览
...
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `4YZ=TGUY5L25` | 字段值合规性校验 | `hcf_cancontact` |
