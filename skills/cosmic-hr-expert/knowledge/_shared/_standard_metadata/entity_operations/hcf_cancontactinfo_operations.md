# hcf_cancontactinfo — 拟入职人员联系方式 操作清单
**继承链**: `hbp_bd_originaltpl` → `hcf_candidatereltpl` → `hcf_cancontactinfo`  **操作数**: 17
---
## 操作总览
...
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `4YZ=Z/XFIJAB` | 字段值合规性校验 | `hcf_cancontactinfo` |
