# haos_remainstafflist — 组织编制使用情况 操作清单
**继承链**: `hbp_bd_originalmintpl` → `haos_remainstafflist`  **操作数**: 12
---
## 操作总览
...
| 12 | `2ZY+AU3HB16O` | exportlist | 引出数据（按列表） | exportlist | `haos_remainstafflist` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
