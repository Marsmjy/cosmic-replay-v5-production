# hrcs_coordsceneconf — 协作场景应用配置 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_coordsceneconf`  **操作数**: 15
---
## 操作总览
...
| 12 | `4YZ4AFCHH7YC` | newentry | 新增分录 | newentry | `hrcs_coordsceneconf` | 0 | 0 |
| 13 | `4YZ4C+4KB/0J` | deleteentry | 删除分录 | deleteentry | `hrcs_coordsceneconf` | 0 | 0 |
| 14 | `4YZ4CQEDM0GR` | moveentryup | 上移一行 | moveentryup | `hrcs_coordsceneconf` | 0 | 0 |
| 15 | `4YZ4DPKJVN4P` | moveentrydown | 下移一行 | moveentrydown | `hrcs_coordsceneconf` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
