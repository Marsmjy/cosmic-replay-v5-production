# hrcs_roledimgrp — 角色维度组 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_roledimgrp`  **操作数**: 14
---
## 操作总览
...
| 12 | `2+6ZE=BSF4XF` | newentry | 新增分录 | newentry | `hrcs_roledimgrp` | 0 | 0 |
| 13 | `2+6ZHVHFZWI8` | deleteentry | 删除分录 | deleteentry | `hrcs_roledimgrp` | 0 | 0 |
| 14 | `3WB=CM3H0+=E` | new | 新增 | new | `hrcs_roledimgrp` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
