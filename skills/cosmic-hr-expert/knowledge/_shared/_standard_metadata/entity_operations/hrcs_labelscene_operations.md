# hrcs_labelscene — 标签场景 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_labelscene`  **操作数**: 48
---
## 操作总览
...
| 43 | `3MXCRTC6R6XT` | deleteentry | 删除分录 | deleteentry | `hrcs_labelscene` | 0 | 0 |
| 44 | `3MXVPSRHY1LS` | donothing | 添加 | addlabel | `hrcs_labelscene` | 0 | 0 |
| 45 | `3MY2C19PRFZN` | newentry | 新增分录 | newentry | `hrcs_labelscene` | 0 | 0 |
| 46 | `3MY48=T/RM1L` | lastentry | 末条分录 | lastentry | `hrcs_labelscene` | 0 | 0 |
| 47 | `3QOAEG9JET4L` | donothing | 关闭提示 | closetips | `hrcs_labelscene` | 0 | 0 |
| 48 | `3RQVXH6569O1` | submit | 提交 | listsubmit | `hrcs_labelscene` | 1 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 5 | `hrcs_labelscene` | `kd.hr.hrcs.opplugin.web.label.LabelSceneEditOp` | 修改后的保存检查插件 |
...
| 6 | 4 | `hrcs_labelscene` | `kd.hr.hrcs.opplugin.web.label.LabelSceneEditOp` | kd.hr.hrcs.opplugin.web.label.LabelSceneEditOp |
...
---
### 48. 提交（submit / Key: listsubmit / oid: 3RQVXH6569O1）
> 根定义: `hrcs_labelscene`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hrcs_labelscene` | `kd.hr.hrcs.opplugin.web.label.LabelSceneEditOp` | kd.hr.hrcs.opplugin.web.label.LabelSceneEditOp |
