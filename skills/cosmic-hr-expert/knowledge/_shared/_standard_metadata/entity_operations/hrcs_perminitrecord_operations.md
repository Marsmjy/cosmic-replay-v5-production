# hrcs_perminitrecord — 权限初始化任务 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_perminitrecord`  **操作数**: 66
---
## 操作总览
...
| 43 | `31RRW9KC=GA6` | newentry | 新增分录 | newentry | `hrcs_perminitrecord` | 0 | 0 |
| 44 | `31RRXF6IZWYC` | deleteentry | 删除分录 | deleteentry | `hrcs_perminitrecord` | 0 | 0 |
| 45 | `34+806BI9DNA` | newentry | 新增子分录 | newdimvalentry | `hrcs_perminitrecord` | 0 | 0 |
| 46 | `34+83YNA4K7V` | deleteentry | 删除子分录 | deletedimvalentry | `hrcs_perminitrecord` | 0 | 0 |
| 47 | `34KUIUW390D6` | newentry | 新增分录 | newdrentry | `hrcs_perminitrecord` | 0 | 0 |
| 48 | `34KUKP4CHE8=` | deleteentry | 删除分录 | deletedrentry | `hrcs_perminitrecord` | 0 | 0 |
| 49 | `34KUMSK7FPNQ` | newentry | 新增分录 | newbdentry | `hrcs_perminitrecord` | 0 | 0 |
| 50 | `34KUOAJ=45NR` | deleteentry | 删除分录 | deletebdentry | `hrcs_perminitrecord` | 0 | 0 |
| 51 | `34KUT1PYTPNK` | newentry | 新增分录 | newfdentry | `hrcs_perminitrecord` | 0 | 0 |
| 52 | `34KUTZ1F0DM9` | deleteentry | 删除分录 | deletefdentry | `hrcs_perminitrecord` | 0 | 0 |
| 53 | `34OG1RL709D8` | donothing | 初始化用户权限 | inituserrole | `hrcs_perminitrecord` | 0 | 0 |
| 54 | `350WY5314YOM` | donothing | 检测并完成初始化 | finishinit | `hrcs_perminitrecord` | 0 | 0 |
| 55 | `35O=3Q=TY=J+` | donothing | 导入用户权限 | userimport | `hrcs_perminitrecord` | 0 | 0 |
| 56 | `35XYBFNK9FIF` | donothing | 下载 | download | `hrcs_perminitrecord` | 0 | 0 |
| 57 | `3EQIO+6Q0UAD` | donothing | 角色权限初始化 | initrole | `hrcs_perminitrecord` | 0 | 0 |
| 58 | `3G4XC2PPK705` | donothing | 导入角色权限 | roleimport | `hrcs_perminitrecord` | 0 | 0 |
| 59 | `3H48RF5WDGWY` | deleteentry | 删除角色基本信息分录 | deletebaseroleentry | `hrcs_perminitrecord` | 0 | 0 |
| 60 | `3H4936QWR0F7` | copyentryrow | 复制角色基本信息分录 | copybaseentryrow | `hrcs_perminitrecord` | 0 | 0 |
| 61 | `3HGHMNK/EETQ` | newentry | 新增字段分录 | newfieldentry | `hrcs_perminitrecord` | 0 | 0 |
| 62 | `3HGHQAPI86F1` | deleteentry | 删除字段分录 | deletefieldentry | `hrcs_perminitrecord` | 0 | 0 |
| 63 | `3QNZZAV9ZR4F` | donothing | 下载用户权限示例 | dlusertip | `hrcs_perminitrecord` | 0 | 0 |
| 64 | `3QO2GDMZGMLS` | donothing | 下载角色示例 | dlroletip | `hrcs_perminitrecord` | 0 | 0 |
| 65 | `3QO2PDZWVVU5` | donothing | 下载角色模板 | dlroletemp | `hrcs_perminitrecord` | 0 | 0 |
| 66 | `3QO50MG10236` | donothing | 下载用户权限模板 | dlusertemp | `hrcs_perminitrecord` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 4 | 3 | `hrcs_perminitrecord` | `kd.hr.hrcs.opplugin.web.perm.PermInitRecordDeleteOp` | kd.hr.hrcs.opplugin.web.perm.PermInitRecordDeleteOp |
