# haos_adminorgfunction — 行政组织职能 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_bd_orgtpl_dlg` → `haos_adminorgfunction`  **操作数**: 51
---
## 操作总览
...
| 12 | `f381c03f00002cac` | submit | 提交 | submit | `bos_basetpl` | 6 | 6 |
...
| 50 | `21A5O/3PV7IL` | donothing | 查看全部日志 | logview | `haos_adminorgfunction` | 0 | 0 |
| 51 | `2COQ5049N75G` | donothing | 查看日志 | viewonelog | `haos_adminorgfunction` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 5 | `haos_adminorgfunction` | `kd.hr.haos.opplugin.web.BaseDataBuOp` | kd.hr.haos.opplugin.web.BaseDataBuOp |
...
| 5 | GrpfieldsuniqueValidation | `2+R3Y9FBSJ51` | 编码唯一性校验 | `haos_adminorgfunction` |
| 6 | GrpfieldsuniqueValidation | `2+R3ZR7WI4N2` | 名称唯一性校验 | `haos_adminorgfunction` |
| 7 | GrpfieldsuniqueValidation | `2NCU6CYKTZO=` | 创建组织和名称组合字段唯一性校验 | `haos_adminorgfunction` |
...
| 4 | CustValidation | `2+RE4J37K857` | HR基础资料删除校验 | `haos_adminorgfunction` |
...
| 3 | ConditionValidation | `2LUROHIZ8/W/` | 合法性校验 | `haos_adminorgfunction` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | 名称唯一性校验 |
...
| 2 | GrpfieldsuniqueValidation | `23TB/821XKAW` | 名称唯一性校验 | `haos_adminorgfunction` |
...
| 6 | GrpfieldsuniqueValidation | `2DDGGGIVWM1U` | 名称唯一性校验 | `haos_adminorgfunction` |
