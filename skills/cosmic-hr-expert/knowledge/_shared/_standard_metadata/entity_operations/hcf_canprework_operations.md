# hcf_canprework — 拟入职人员工作经历 操作清单
**继承链**: `hbp_bd_originaltpl` → `hcf_candidatereltpl` → `hcf_canprework`  **操作数**: 17
---
## 操作总览
...
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `4YLD=3MC2CY2` | 字段值合规性校验 | `hcf_canprework` |
