# hrcs_promptrule — 提示语映射 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_promptrule`  **操作数**: 45
---
## 操作总览
...
| 43 | `1HK52N071H9=` | donothing | 预览 | preview | `hrcs_promptrule` | 0 | 0 |
| 44 | `2+RI2R8SCK4H` | donothing | 跳转详情页面 | openform | `hrcs_promptrule` | 0 | 0 |
| 45 | `2+UU39MCYYWG` | donothing | 设置 | entrysetting | `hrcs_promptrule` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 3 | 1 | `hrcs_promptrule` | `kd.hr.hrcs.opplugin.web.PromptRuleBatchImportSaveOp` |  |
