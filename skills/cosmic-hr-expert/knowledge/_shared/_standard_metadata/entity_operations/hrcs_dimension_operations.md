# hrcs_dimension — 维度 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_dimension`  **操作数**: 44
---
## 操作总览
...
| 43 | `213PKUX19DB0` | newentry | 新增分录 | newentry | `hrcs_dimension` | 0 | 0 |
| 44 | `24I/=Y1P6V06` | deleteentry | 删除分录 | deleteentry | `hrcs_dimension` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 4 | GrpfieldsuniqueValidation | `21D14ND=5B43` | 组合字段唯一性校验 | `hrcs_dimension` |
| 5 | GrpfieldsuniqueValidation | `21D15FVULAGF` | 组合字段唯一性校验 | `hrcs_dimension` |
...
| 4 | 3 | `hrcs_dimension` | `kd.hr.hrcs.opplugin.web.perm.DimensionDeleteOp` | kd.hr.hrcs.opplugin.web.perm.DimensionDeleteOp |
