# hrpi_quittype — 离职类型 操作清单
**继承链**: `bos_basetpl` → `bos_basegrouptpl` → `hbp_bd_grouptpl_all` → `hbp_bd_grouptpl_dlg` → `hrpi_quittype`  **操作数**: 42
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 6 | 4 |
