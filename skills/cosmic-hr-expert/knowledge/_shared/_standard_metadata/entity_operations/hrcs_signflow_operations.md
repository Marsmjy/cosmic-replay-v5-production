# hrcs_signflow — 电子签署流程 操作清单
**继承链**: `bos_billtpl` → `hbp_hrbilltpl` → `hrcs_signflow`  **操作数**: 52
---
## 操作总览
...
| 47 | `3E3C=L8Y/B64` | deleteentry | 删除扩展信息分录 | deleteentry | `hrcs_signflow` | 0 | 0 |
| 48 | `3E3CAOZV8/8O` | newentry | 新增扩展信息分录 | newentry | `hrcs_signflow` | 0 | 0 |
| 49 | `3E3YRMJ+/CN1` | newentry | 新增合同签署主体分录 | neworgentry | `hrcs_signflow` | 0 | 0 |
| 50 | `3E3YWE5+1OEZ` | deleteentry | 删除合同签约主体分录 | deleteorgentry | `hrcs_signflow` | 0 | 0 |
| 51 | `3E3YYYHKB+10` | newentry | 新增签署人分录 | newpersonentry | `hrcs_signflow` | 0 | 0 |
| 52 | `3E3Z0S1G+WP5` | deleteentry | 删除签署人分录 | deletepersonentry | `hrcs_signflow` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
