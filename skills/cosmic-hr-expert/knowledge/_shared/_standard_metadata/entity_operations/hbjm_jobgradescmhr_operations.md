# hbjm_jobgradescmhr — 职等方案 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_bd_orgtpl_dlg` → `hbjm_bd_orgtpl_dlg` → `hbjm_jobgradescmhr`  **操作数**: 66
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 10 | 13 |
| 5 | `b599405400001bac` | delete | 删除 | delete | `bos_basetpl` | 5 | 4 |
| 6 | `b599405400001cac` | audit | 审核 | audit | `bos_basetpl` | 2 | 3 |
| 7 | `b599405400001dac` | unaudit | 反审核 | unaudit | `bos_basetpl` | 1 | 3 |
| 8 | `b599405400001eac` | disable | 禁用 | disable | `bos_basetpl` | 3 | 2 |
...
| 12 | `f381c03f00002cac` | submit | 提交 | submit | `bos_basetpl` | 5 | 5 |
...
| 50 | `20KPN/W=M4GG` | donothing | 历史版本信息 | hisversioninfo | `hbjm_jobgradescmhr` | 0 | 0 |
| 51 | `20KPPRMXGF/V` | donothing | 变更 | change | `hbjm_jobgradescmhr` | 0 | 0 |
| 52 | `20KQI22R5KE2` | donothing | 复制 | hiscopy | `hbjm_jobgradescmhr` | 0 | 0 |
| 53 | `23LKXRJB52SD` | donothing | 管理权转让 | orgpermchange | `hbjm_jobgradescmhr` | 0 | 0 |
| 54 | `2BL9A7LJ+MLD` | donothing | 新增数据版本 | newhisversion | `hbjm_jobgradescmhr` | 0 | 1 |
| 55 | `2NY+GRV0I75K` | donothing | 修订 | revise | `hbjm_jobgradescmhr` | 0 | 0 |
| 56 | `2NY+IA24TJAH` | donothing | 版本修订历史 | reviserecord | `hbjm_jobgradescmhr` | 0 | 0 |
| 57 | `2P7P1YQ616DW` | donothing | 版本对比 | versionchangecompare | `hbjm_jobgradescmhr` | 0 | 0 |
| 58 | `2XZ45+=QLS0M` | donothing | 查看所有版本 | showallversion | `hbjm_jobgradescmhr` | 0 | 0 |
| 59 | `4V/7ENQAUB31` | save | 确认变更 | confirmchange | `hbjm_jobgradescmhr` | 2 | 3 |
| 60 | `1PLCK21XCP27` | newentry | 新增分录 | newentry | `hbjm_jobgradescmhr` | 0 | 0 |
| 61 | `1PLCKV+G5S9Y` | new | 新增 | new | `hbjm_jobgradescmhr` | 0 | 0 |
| 62 | `22=IIU=KBMNK` | donothing | 管理权转让 | transfermanage | `hbjm_jobgradescmhr` | 0 | 0 |
| 63 | `22C2SIKYYBE5` | deleteentry | 删除分录 | deleteentry | `hbjm_jobgradescmhr` | 0 | 0 |
| 64 | `22C2ZWY4UE2M` | moveentryup | 上移一行 | moveentryup | `hbjm_jobgradescmhr` | 0 | 0 |
| 65 | `22C3/NHO6/1P` | moveentrydown | 下移一行 | moveentrydown | `hbjm_jobgradescmhr` | 0 | 0 |
| 66 | `22C3151AT+/A` | insertentry | 插入分录 | insertentry | `hbjm_jobgradescmhr` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | 7 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp |
| 7 | 8 | `hbjm_jobgradescmhr` | `kd.hr.hbp.opplugin.web.history.HisUniqueValidateOp` | 历史模型唯一性校验插件 |
| 8 | 9 | `hbjm_jobgradescmhr` | `kd.hrmp.hbjm.opplugin.web.JobGradeScmSaveOp` | 保存插件 |
| 9 | 10 | `hbjm_jobgradescmhr` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
| 10 | 11 | `hbjm_jobgradescmhr` | `kd.hrmp.hbjm.opplugin.web.HbjmBaseNewDataOp` | hbjm基础新增保存op |
...
| 7 | GrpfieldsuniqueValidation | `2=K9URZCEUUS` | 编码唯一性校验 | `hbjm_jobgradescmhr` |
| 8 | GrpfieldsuniqueValidation | `23ILP6JS0TBC` | 创建组织和名称组合字段唯一性校验 | `hbjm_jobgradescmhr` |
| 9 | ConditionValidation | `2M42D=Y0/0XK` | 生效日期不能填写未来 | `hbjm_jobgradescmhr` |
| 10 | GrpfieldsuniqueValidation | `23X0R8U5R1YS` | 职等顺序码唯一性校验 | `hbjm_jobgradescmhr` |
| 11 | GrpfieldsuniqueValidation | `244PJ3BX2Z9H` | 职等编码唯一性校验 | `hbjm_jobgradescmhr` |
| 12 | GrpfieldsuniqueValidation | `244PKBH1PJM/` | 职等名称唯一性校验 | `hbjm_jobgradescmhr` |
| 13 | ConditionValidation | `2G+O55K=V=8/` | 职等顺序码取值范围 | `hbjm_jobgradescmhr` |
...
| 3 | 4 | `hbjm_jobgradescmhr` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
| 4 | 5 | `hbjm_jobgradescmhr` | `kd.hrmp.hbjm.opplugin.web.JobGradeScmDeleteOp` | JobGradeScmDeleteOp |
...
| 4 | CustValidation | `0R6UAC9LYGXN` | HR基础资料删除校验 | `hbjm_jobgradescmhr` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 2 | `hbjm_jobgradescmhr` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
...
| 2 | 2 | `hbjm_jobgradescmhr` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
| 3 | — | `bos_baseorgtpl` | `kd.bos.form.plugin.bdctrl.BaseDataDisablePlugin` |  |
...
|---|--------|---------|------------|------|
| 1 | 1 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
| 2 | 2 | `hbjm_jobgradescmhr` | `kd.hrmp.hbjm.opplugin.web.JobGradeScmEnableOp` | 职等方案启用OP |
| 3 | — | `bos_baseorgtpl` | `kd.bos.form.plugin.bdctrl.BaseDataEnablePlugin` |  |
...
---
### 54. 新增数据版本（donothing / Key: newhisversion / oid: 2BL9A7LJ+MLD）
> 根定义: `hbjm_jobgradescmhr`
**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | ConditionValidation | `2K+JH30V7OJV` | 合法性校验 | `hbjm_jobgradescmhr` |

---
### 59. 确认变更（save / Key: confirmchange / oid: 4V/7ENQAUB31）
> 根定义: `hbjm_jobgradescmhr`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hbjm_jobgradescmhr` | `kd.hr.hbp.opplugin.web.history.HisModelOPCommonPlugin` | 历史模型OP操作通用插件 |
| 2 | 1 | `hbjm_jobgradescmhr` | `kd.hr.hbp.opplugin.web.history.HisUniqueValidateOp` | 历史模型唯一性校验插件 |

**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `4V/78ID=HERR` | 字段值合规性校验 | `hbjm_jobgradescmhr` |
| 2 | GrpfieldsuniqueValidation | `4V/7C958CRVD` | 名称唯一性校验 | `hbjm_jobgradescmhr` |
| 3 | GrpfieldsuniqueValidation | `4V/7I6HFRZ3+` | 创建组织字段和编码唯一性校验 | `hbjm_jobgradescmhr` |
