# hrcs_lbldimension — 打标对象维度（废弃） 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `hrcs_lbldimension`  **操作数**: 42
---
## 操作总览
...
| 5 | GrpfieldsuniqueValidation | `2YI9RKM724DB` | 组合字段唯一性校验 | `hrcs_lbldimension` |
| 6 | GrpfieldsuniqueValidation | `2YI9SQNE5TFI` | 组合字段唯一性校验 | `hrcs_lbldimension` |
