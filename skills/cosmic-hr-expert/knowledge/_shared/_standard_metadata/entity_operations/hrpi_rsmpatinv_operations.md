# hrpi_rsmpatinv — 专利发明 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_rsmpatinv`  **操作数**: 19
---
## 操作总览
...
| 19 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_rsmpatinv` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 3 | 3 | `hrpi_rsmpatinv` | `kd.hrmp.hrpi.opplugin.web.employee.attach.RsmPatInvSaveOp` | 专利发明操作 |
...
| 4 | MustInputValidation | `4VU3WADUFWJ8` | 字段值合规性校验 | `hrpi_rsmpatinv` |
