# hrcs_roleinitdemo_role — 角色初始化角色清单样例 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_roleinitdemo_role`  **操作数**: 12
---
## 操作总览
...
| 12 | `3G8R1=2VOQQF` | delete | 删除 | delete | `hrcs_roleinitdemo_role` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
