# hrptmc_colcustomsort — 自定义排序（废弃） 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrptmc_colcustomsort`  **操作数**: 15
---
## 操作总览
...
| 12 | `354D2R7HOAPU` | close | 取消 | close | `hrptmc_colcustomsort` | 0 | 0 |
| 13 | `354DAW1IRYSH` | moveentryup | 上移 | moveentryup | `hrptmc_colcustomsort` | 0 | 0 |
| 14 | `354DBW3G4UH8` | moveentrydown | 下移 | moveentrydown | `hrptmc_colcustomsort` | 0 | 0 |
| 15 | `357675V2V89F` | donothing | 确定 | enter | `hrptmc_colcustomsort` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
