# hrcs_roleexdimgrp — 角色例外维度组 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_roleexdimgrp`  **操作数**: 13
---
## 操作总览
...
| 12 | `4IQ22OKL5+HI` | newentry | 新增分录 | newentry | `hrcs_roleexdimgrp` | 0 | 0 |
| 13 | `4IQ24PP8VJ1I` | deleteentry | 删除分录 | deleteentry | `hrcs_roleexdimgrp` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
