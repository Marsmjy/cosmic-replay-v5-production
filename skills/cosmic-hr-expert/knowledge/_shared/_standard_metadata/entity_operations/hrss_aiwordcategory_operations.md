# hrss_aiwordcategory — AI词性 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `hrss_aiwordcategory`  **操作数**: 43
---
## 操作总览
...
| 43 | `2KBGYJHF/XVL` | donothing | 查看排序权重详情 | weightview | `hrss_aiwordcategory` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
