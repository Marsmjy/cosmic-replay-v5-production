# hrpi_emptrainfile — 培训经历 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_emptrainfile`  **操作数**: 19
---
## 操作总览
...
| 19 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_emptrainfile` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 3 | 3 | `hrpi_emptrainfile` | `kd.hrmp.hrpi.opplugin.web.employee.attach.EmpTrainFileSaveOp` | 培训经历插件 |
