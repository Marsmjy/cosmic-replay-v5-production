# hrcs_esigncoauth — 企业授权管理 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `hrcs_esigncoauth`  **操作数**: 43
---
## 操作总览
...
| 43 | `3H47N2YL6GUC` | donothing | 企业授权 | companyauth | `hrcs_esigncoauth` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 5 | GrpfieldsuniqueValidation | `3INIFL1FMFOF` | 一个企业在一个应用中只能有一条记录 | `hrcs_esigncoauth` |
