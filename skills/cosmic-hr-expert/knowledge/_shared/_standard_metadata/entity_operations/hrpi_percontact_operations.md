# hrpi_percontact — 联系方式 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_percontact`  **操作数**: 19
---
## 操作总览
...
| 19 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_percontact` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 4 | DynamicValidation | `4XO9MBKM=IAC` | 手机号唯一性校验 | `hrpi_percontact` |
| 5 | DynamicValidation | `4XO9NV0R1T70` | 个人邮箱唯一性校验 | `hrpi_percontact` |
