# hrcs_warnpluginservice — 预警插件服务 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_warnpluginservice`  **操作数**: 44
---
## 操作总览
...
| 43 | `3ZUD9CL=3U/I` | newentry | 新增 | newitem | `hrcs_warnpluginservice` | 0 | 0 |
| 44 | `3ZUDA2/YUTZH` | deleteentry | 删除 | deleteitem | `hrcs_warnpluginservice` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 6 | `hrcs_warnpluginservice` | `kd.hr.hrcs.opplugin.web.earlywarn.plugin.CommonConditionPluginOp` | 常用条件插件字段op |
...
| 4 | 3 | `hrcs_warnpluginservice` | `kd.hr.hrcs.opplugin.web.earlywarn.plugin.CommonConditionPluginOp` | 常用条件插件字段op |
