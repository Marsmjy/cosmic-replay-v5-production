# hbjm_jobseqhr — 职位序列 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_hisbutimeseqtpl` → `hbjm_hisbutimeseqtpl` → `hbjm_jobseqhr`  **操作数**: 60
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 9 | 7 |
...
| 60 | `239TRDB9=Z4C` | donothing | 管理权转让 | transfermanage | `hbjm_jobseqhr` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 8 | 7 | `hbjm_jobseqhr` | `kd.hrmp.hbjm.opplugin.web.HbjmBaseNewDataOp` | hbjm基础新增op |
...
| 7 | GrpfieldsuniqueValidation | `23MX2FGF285+` | 组合字段唯一性校验 | `hbjm_jobseqhr` |
...
| 4 | 6 | `hbjm_jobseqhr` | `kd.hrmp.hbjm.opplugin.web.DeleteIgnorInitMetaOp` | DeleteIgnorInitMetaOp |
...
| 4 | CustValidation | `0R6UAC9LYGXN` | HR基础资料删除校验 | `hbjm_jobseqhr` |
...
| 4 | ConditionValidation | `/U2/165YZ4K5` | 合法性校验 | `hbjm_jobseqhr` |
...
| 2 | 2 | `hbjm_jobseqhr` | `kd.hrmp.hbjm.opplugin.web.JobSeqDisableOp` | JobSeqDisableOp |
