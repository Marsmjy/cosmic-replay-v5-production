# hbpm_basedatalist — 岗位基础资料 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `hbpm_bd_tpl_dlg` → `hbpm_basedatalist`  **操作数**: 42
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 6 | 6 |
...
| 9 | `b599405400001fac` | enable | 启用 | enable | `bos_basetpl` | 1 | 2 |
...
| 5 | GrpfieldsuniqueValidation | `enable` |  | `hbpm_bd_tpl_dlg` |
| 6 | RegexValidation | `1=UYHZNPKO+W` | 文本格式检查 | `hbpm_basedatalist` |
...
| 2 | GrpfieldsuniqueValidation | `2AC0CT/9CUHO` | 名称唯一性校验 | `hbpm_bd_tpl_dlg` |
