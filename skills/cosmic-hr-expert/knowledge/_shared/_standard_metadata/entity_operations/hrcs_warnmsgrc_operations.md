# hrcs_warnmsgrc — 消息接收人 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_warnmsgrc`  **操作数**: 42
---
## 操作总览
...
| 4 | 3 | `hrcs_warnmsgrc` | `kd.hr.hrcs.opplugin.web.earlywarn.warnmsgrc.WarnMsgRcOp` | kd.hr.hrcs.opplugin.web.earlywarn.warnmsgrc.WarnMsgRcOp |
