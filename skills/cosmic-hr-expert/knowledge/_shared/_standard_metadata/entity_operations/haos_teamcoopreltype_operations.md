# haos_teamcoopreltype — 团队协作类型 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_bd_orgtpl_dlg` → `haos_teamcoopreltype`  **操作数**: 51
---
## 操作总览
...
| 50 | `2COQ5049N75G` | donothing | 查看日志 | viewonelog | `haos_teamcoopreltype` | 0 | 0 |
| 51 | `23MCQ/C=2U7X` | donothing | 查看全部日志 | logview | `haos_teamcoopreltype` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 5 | `haos_teamcoopreltype` | `kd.hr.haos.opplugin.web.TeamcoopreltypeOp` | 名称唯一性校验 |
| 8 | 6 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp |
| 9 | 6 | `haos_teamcoopreltype` | `kd.hr.haos.opplugin.web.BaseDataBuOp` | kd.hr.haos.opplugin.web.BaseDataBuOp |
...
| 5 | GrpfieldsuniqueValidation | `name` | 创建组织和名称组合字段唯一性校验 | `haos_teamcoopreltype` |
| 6 | GrpfieldsuniqueValidation | `1B9SI1HB3NKW` | 编码唯一性校验 | `haos_teamcoopreltype` |
| 7 | GrpfieldsuniqueValidation | `1B9SIU+IP6+=` | 名称唯一性校验 | `haos_teamcoopreltype` |
| 8 | ConditionValidation | `1a51dc0a0000a1ac` | 合法性校验 | `haos_teamcoopreltype` |
...
| 4 | CustValidation | `0R6U8WEZK8/W` | HR基础资料删除校验 | `haos_teamcoopreltype` |
...
| 3 | ConditionValidation | `2LUTRQ/=8IQQ` | 合法性校验 | `haos_teamcoopreltype` |
...
|---|--------|---------|------------|------|
| 1 | 1 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | HRBaseDataLogOp |
| 2 | 1 | `haos_teamcoopreltype` | `kd.hr.haos.opplugin.web.TeamcoopreltypeOp` | TeamcoopreltypeOp |
...
| 6 | GrpfieldsuniqueValidation | `424b895300015bac` | 组合字段唯一性校验 | `haos_teamcoopreltype` |
| 7 | GrpfieldsuniqueValidation | `2DDGGGIVWM1U` | 名称唯一性校验 | `haos_teamcoopreltype` |
