# hrss_searchweight — 排序权重配置 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrss_searchweight`  **操作数**: 45
---
## 操作总览
...
| 42 | `2KSWH0VAYBWV` | newentry | 新增分录 | newentry | `hrss_searchweight` | 0 | 0 |
| 43 | `2KSWI3R9T/ZE` | deleteentry | 删除分录 | deleteentry | `hrss_searchweight` | 0 | 0 |
| 44 | `3UGHREX4IK26` | deleteentry | 删除 | deletesubentry | `hrss_searchweight` | 0 | 0 |
| 45 | `3Z/PQ+DDCYTO` | newentry | 新增分录 | addsubentry | `hrss_searchweight` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 6 | `hrss_searchweight` | `kd.hr.hrss.opplugin.web.searchweight.SearchWeightSaveOp` | kd.hr.hrss.opplugin.web.searchweight.SearchWeightSaveOp |
