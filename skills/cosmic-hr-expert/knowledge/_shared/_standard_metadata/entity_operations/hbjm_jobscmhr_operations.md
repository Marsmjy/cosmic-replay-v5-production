# hbjm_jobscmhr — 职位体系方案 操作清单
**继承链**: `bos_basetpl` → `bos_baseorgtpl` → `hbp_bd_orgtpl_all` → `hbp_bd_orgtpl_dlg` → `hbjm_bd_orgtpl_dlg` → `hbjm_jobscmhr`  **操作数**: 50
---
## 操作总览
...
| 5 | `b599405400001bac` | delete | 删除 | delete | `bos_basetpl` | 6 | 3 |
...
| 50 | `22=H/GXY9E9F` | donothing | 新增空操作 | donothing_new | `hbjm_jobscmhr` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 8 | 6 | `hbjm_bd_orgtpl_dlg` | `kd.hrmp.hbjm.opplugin.web.HBJMDataBaseOp` | 使用状态和初始化状态校验 |
...
| 4 | 4 | `hbjm_jobscmhr` | `kd.hrmp.hbjm.opplugin.web.JobScmDeleteOp` |  |
| 5 | 5 | `hbjm_jobscmhr` | `kd.hrmp.hbjm.opplugin.web.DeleteIgnorInitMetaOp` | 排除引用 |
| 6 | — | `bos_baseorgtpl` | `kd.bos.form.plugin.bdctrl.BaseDataDeletePlugin` |  |
...
| 3 | CustValidation | `0R6UAC9LYGXN` | HR基础资料删除校验 | `hbjm_jobscmhr` |
...
| 4 | ConditionValidation | `/U2/165YZ4K5` | 合法性校验 | `hbjm_jobscmhr` |
...
|---|--------|---------|------------|------|
| 1 | 1 | `hbp_bd_orgtpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp` | kd.hr.hbp.opplugin.web.config.HRBaseDataLogOp |
| 2 | 1 | `hbjm_jobscmhr` | `kd.hrmp.hbjm.opplugin.web.JobScmDisableOp` |  |
...
| 5 | GrpfieldsuniqueValidation | `424b895300015bac` | 编码唯一性校验 | `hbjm_jobscmhr` |
| 6 | GrpfieldsuniqueValidation | `62a4cf9800016fac` | 名称唯一性校验 | `hbjm_jobscmhr` |
