# hrpi_perregion — 区域信息 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrpi_employeetpl` → `hrpi_perregion`  **操作数**: 19
---
## 操作总览
...
| 19 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_perregion` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 4 | MustInputValidation | `4THXW1YSDSG6` | 字段值合规性校验 | `hrpi_perregion` |
