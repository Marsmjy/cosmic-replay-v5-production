# haos_staffcase — 不占编员工明细 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `haos_staffcase`  **操作数**: 36
---
## 操作总览
...
| 5 | `b599405400001bac` | delete | 删除 | delete | `bos_basetpl` | 3 | 4 |
| 6 | `b599405400001cac` | audit | 审核 | audit | `bos_basetpl` | 1 | 3 |
| 7 | `b599405400001dac` | unaudit | 反审核 | unaudit | `bos_basetpl` | 1 | 3 |
| 8 | `b599405400001eac` | disable | 禁用 | disable | `bos_basetpl` | 1 | 4 |
...
| 23 | `13NUAIBA368/` | exportlist | 导出数据（按列表） | exportlistbyselectfields | `bos_basetpl` | 0 | 0 |
| 24 | `/J6LFFUQC1K0` | exportlist_expt | 导出数据（按导出模板） | exportlist_expt | `bos_basetpl` | 0 | 0 |
| 25 | `2MMZBM6FC174` | mobtoolbarselect | 选择 | mobtoolbarselect | `bos_basetpl` | 0 | 0 |
| 26 | `2MMZF4V/MARY` | mobtoolbarcancel | 取消 | mobtoolbarcancel | `bos_basetpl` | 0 | 0 |
| 27 | `2PVU302I5+FH` | donothing | 改名 | namehistory | `bos_basetpl` | 0 | 0 |
| 28 | `2PVU5DLAO/49` | donothing | 名称历史查询 | namehistoryview | `bos_basetpl` | 0 | 0 |
| 29 | `21A5O/3PV7IL` | donothing | 查看全部日志 | logview | `hbp_bd_tpl_all` | 0 | 0 |
| 30 | `2COQ5049N75G` | donothing | 查看日志 | viewonelog | `hbp_bd_tpl_all` | 0 | 0 |
| 31 | `36NMYUPXH7+Y` | importdata_hr | 导入数据 | importdata_hr | `hbp_bd_tpl_all` | 0 | 0 |
| 32 | `36NN+52WYF1Y` | show_import_record_hr | 查看导入记录 | show_import_record_hr | `hbp_bd_tpl_all` | 0 | 0 |
| 33 | `36NN1BHX+R/A` | export_from_list_hr | 按列表导出 | export_from_list_hr | `hbp_bd_tpl_all` | 0 | 0 |
| 34 | `36NN2SRUE7N/` | export_from_impttpl_hr | 按导入模板导出 | export_from_impttpl_hr | `hbp_bd_tpl_all` | 0 | 0 |
| 35 | `36NN3ZT9PZNE` | export_from_expttpl_hr | 按导出模板导出 | export_from_expttpl_hr | `hbp_bd_tpl_all` | 0 | 0 |
| 36 | `36NN590J0H1R` | show_export_record_hr | 查看导出记录 | show_export_record_hr | `hbp_bd_tpl_all` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 5 | `haos_staffcase` | `kd.hr.haos.opplugin.web.staff.StaffCaseSaveOp` | 编制个例保存op |
...
| 2 | ConditionValidation | `f789ca66000000ac` | 只能删除待启用的数据。 | `bos_basetpl` |
| 3 | CustValidation | `2+RE4J37K857` | HR基础资料删除校验 | `hbp_bd_tpl_all` |
| 4 | ConditionValidation | `34I2QVGMOKVG` | 数据已经启用，不能删除 | `haos_staffcase` |
...
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | ConditionValidation | `f2843bab0000baac` | 暂存数据不能禁用 | `bos_basetpl` |
| 2 | ConditionValidation | `f2843bab0000bbac` | 数据已为禁用状态 | `bos_basetpl` |
| 3 | ConditionValidation | `35AN1287AAQJ` | 待启用数据不能禁用 | `haos_staffcase` |
| 4 | ConditionValidation | `35AN4CAOADK4` | 已提交数据不能禁用 | `haos_staffcase` |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `haos_staffcase` | `kd.hr.haos.opplugin.web.staff.StaffCaseEnableOp` | 编制个例启用op |
...
| 5 | GrpfieldsuniqueValidation | `424b895300015bac` |  | `haos_staffcase` |
