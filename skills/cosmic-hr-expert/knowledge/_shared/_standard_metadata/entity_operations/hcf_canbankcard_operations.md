# hcf_canbankcard — 拟入职人员银行卡 操作清单
**继承链**: `hbp_bd_originaltpl` → `hcf_candidatereltpl` → `hcf_canbankcard`  **操作数**: 17
---
## 操作总览
...
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | MustInputValidation | `4YZ=P4D8VDP3` | 字段值合规性校验 | `hcf_canbankcard` |
