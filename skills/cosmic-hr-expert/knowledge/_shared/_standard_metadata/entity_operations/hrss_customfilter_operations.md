# hrss_customfilter — 自定义过滤项 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrss_customfilter`  **操作数**: 46
---
## 操作总览
...
| 42 | `3U=HU0HP6LKV` | newentry | 新增 | newentry | `hrss_customfilter` | 0 | 0 |
| 43 | `3U=HV5CF593I` | deleteentry | 删除 | deleteentry | `hrss_customfilter` | 0 | 0 |
| 44 | `3UDN24MR7GQ4` | donothing | 添加 | additem | `hrss_customfilter` | 0 | 0 |
| 45 | `3V75O4GSCHUN` | moveentryup | 上移 | moveentryup | `hrss_customfilter` | 0 | 0 |
| 46 | `3V75PKK=OA+1` | moveentrydown | 下移 | moveentrydown | `hrss_customfilter` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
