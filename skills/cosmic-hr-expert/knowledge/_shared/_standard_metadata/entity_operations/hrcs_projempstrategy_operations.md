# hrcs_projempstrategy — 项目团队-员工管理关系策略设置 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_managestrategy` → `hrcs_empstrategy_tpl` → `hrcs_projempstrategy`  **操作数**: 45
---
## 操作总览
...
| 45 | `2J2QW458TZ9P` | donothing | 初始化员工管理关系策略 | initstrategy | `hrcs_projempstrategy` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | 4 | `hrcs_projempstrategy` | `kd.hr.hrcs.opplugin.web.projteam.EmpProjManageStrategySaveOp` | kd.hr.hrcs.opplugin.web.projteam.EmpProjManageStrategySaveOp |
