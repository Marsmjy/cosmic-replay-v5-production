# hrcs_roleinitdemo_fc — 角色初始化功能权限样例 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_roleinitdemo_fc`  **操作数**: 15
---
## 操作总览
...
| 12 | `3FG+WW0OAX28` | newentry | 新增分录 | newentry | `hrcs_roleinitdemo_fc` | 0 | 0 |
| 13 | `3FG+XWUIC2B=` | deleteentry | 删除分录 | deleteentry | `hrcs_roleinitdemo_fc` | 0 | 0 |
| 14 | `3FWR5UNUPGNV` | copyentryrow | 复制分录 | copyentryrow | `hrcs_roleinitdemo_fc` | 0 | 0 |
| 15 | `3G8QJVY3RJNY` | delete | 删除 | delete | `hrcs_roleinitdemo_fc` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
