# hrpi_rotationinfo — 轮岗情况 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hbp_bd_timelinemintpl` → `hrpi_assigntimelinetpl` → `hrpi_rotationinfo`  **操作数**: 21
---
## 操作总览
...
| 21 | `23/AQ3FTXY0B` | close | 退出 | close | `hrpi_rotationinfo` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | 5 | `hrpi_rotationinfo` | `kd.hrmp.hrpi.opplugin.web.assignment.attach.RotationSaveOp` | 轮岗情况保存插件 |
