# haos_orgchangetype — 变动类型 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hbp_bd_tpl_dlg` → `haos_orgchangetype`  **操作数**: 42
---
## 操作总览
...
| 5 | `b599405400001bac` | delete | 删除 | delete | `bos_basetpl` | 3 | 1 |
...
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | CustValidation | `2+RE4J37K857` | HR基础资料删除校验 | `hbp_bd_tpl_all` |
