# hrptmc_rowcustomsort — 自定义排序（废弃） 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrptmc_rowcustomsort`  **操作数**: 15
---
## 操作总览
...
| 12 | `354D2R7HOAPU` | close | 取消 | close | `hrptmc_rowcustomsort` | 0 | 0 |
| 13 | `354DAW1IRYSH` | moveentryup | 上移 | moveentryup | `hrptmc_rowcustomsort` | 0 | 0 |
| 14 | `354DBW3G4UH8` | moveentrydown | 下移 | moveentrydown | `hrptmc_rowcustomsort` | 0 | 0 |
| 15 | `35764FSMR56T` | donothing | 确定 | enter | `hrptmc_rowcustomsort` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
