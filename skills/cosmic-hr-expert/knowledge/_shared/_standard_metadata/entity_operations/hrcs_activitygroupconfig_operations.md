# hrcs_activitygroupconfig — 活动组配置 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_activitygroupconfig`  **操作数**: 12
---
## 操作总览
...
| 12 | `3HAGR+V2M76K` | delete | 删除 | delete | `hrcs_activitygroupconfig` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
