# hrcs_warnscene — 预警场景 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_warnscene`  **操作数**: 46
---
## 操作总览
...
| 4 | `b599405400001aac` | save | 保存 | save | `bos_basetpl` | 9 | 4 |
...
| 43 | `441ZLCCYDQJ7` | donothing | 下一步 | nextstep | `hrcs_warnscene` | 1 | 2 |
| 44 | `441ZNS5O1ZQB` | donothing | 上一步 | laststep | `hrcs_warnscene` | 0 | 0 |
| 45 | `44DQ5Q4EGH/8` | donothing | 刷新常用条件值 | refreshcommoncondition | `hrcs_warnscene` | 0 | 0 |
| 46 | `47IU6TW8RL6D` | deleteentry | 删除分录 | deleteentry | `hrcs_warnscene` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 6 | `hrcs_warnscene` | `kd.hr.hrcs.opplugin.web.earlywarn.scene.WarnSceneOp` | 操作插件 |
| 8 | 7 | `hrcs_warnscene` | `kd.hr.hrcs.opplugin.web.earlywarn.scene.WarnSceneCommonConditionOp` | 预警场景常用条件op |
| 9 | 8 | `hrcs_warnscene` | `kd.hr.hrcs.opplugin.web.earlywarn.scene.WarnSceneAdConditionOp` | 预警场景高级条件op |
...
| 4 | 3 | `hrcs_warnscene` | `kd.hr.hrcs.opplugin.web.earlywarn.scene.WarnSceneOp` | 操作插件 |
| 5 | 4 | `hrcs_warnscene` | `kd.hr.hrcs.opplugin.web.earlywarn.scene.WarnSceneCommonConditionOp` | 预警场景常用条件op |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hrcs_warnscene` | `kd.hr.hrcs.opplugin.web.earlywarn.scene.WarnSceneOp` | kd.hr.hrcs.opplugin.web.earlywarn.scene.WarnSceneOp |
...
---
### 43. 下一步（donothing / Key: nextstep / oid: 441ZLCCYDQJ7）
> 根定义: `hrcs_warnscene`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hrcs_warnscene` | `kd.hr.hrcs.opplugin.web.earlywarn.scene.WarnSceneOp` | 预警场景op插件 |

**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | GrpfieldsuniqueValidation | `441ZFOVHCXCX` | 编码唯一性校验 | `hrcs_warnscene` |
| 2 | GrpfieldsuniqueValidation | `441ZIW86NI=0` | 名称唯一性校验 | `hrcs_warnscene` |
