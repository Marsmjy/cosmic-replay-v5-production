# hrptmc_subscriberecord — 订阅记录 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrptmc_subscriberecord`  **操作数**: 13
---
## 操作总览
...
| 12 | `48+7+RVFJJ6Q` | donothing | 订阅规则 | subscriberule | `hrptmc_subscriberecord` | 0 | 0 |
| 13 | `48+70X6Z76=6` | donothing | 取消订阅 | cancelsubscribe | `hrptmc_subscriberecord` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
