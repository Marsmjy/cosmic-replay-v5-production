# hrcs_permrelatcfg — 独立授权 操作清单
**继承链**: `hbp_bd_originalmintpl` → `hrcs_permrelatcfg`  **操作数**: 13
---
## 操作总览
...
| 12 | `2NQBWJ31MEL6` | donothing | 允许 | enable | `hrcs_permrelatcfg` | 0 | 0 |
| 13 | `2NQC+0MV+8C8` | donothing | 不允许 | disable | `hrcs_permrelatcfg` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
