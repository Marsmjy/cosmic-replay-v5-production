# hrcs_lblstrategy — 打标策略 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_lblstrategy`  **操作数**: 51
---
## 操作总览
...
| 43 | `2Z=5K63ZQP4T` | donothing | 打标结果 | viewresults | `hrcs_lblstrategy` | 0 | 0 |
| 44 | `2ZUHOTM+K59F` | donothing | 下一步 | nextone | `hrcs_lblstrategy` | 0 | 2 |
| 45 | `2ZXGW+J1ISEX` | donothing | 删除 | deleteone | `hrcs_lblstrategy` | 0 | 0 |
| 46 | `3+IUVP=XRPL/` | donothing | 执行记录 | viewexecute | `hrcs_lblstrategy` | 0 | 0 |
| 47 | `310PXCXALWBC` | donothing | 立即打标 | execute | `hrcs_lblstrategy` | 0 | 0 |
| 48 | `3N38Z9Y4W7S/` | donothing | 删除 | deletestrategy | `hrcs_lblstrategy` | 1 | 2 |
| 49 | `3NG53ZYB58NP` | deleteentry | 删除分录 | deleteentry | `hrcs_lblstrategy` | 0 | 0 |
| 50 | `3NG58+G+PLN8` | donothing | 添加 | adddata | `hrcs_lblstrategy` | 0 | 0 |
| 51 | `3PE0X+2UPZPE` | donothing | 关闭提示 | closetips | `hrcs_lblstrategy` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 7 | 5 | `hrcs_lblstrategy` | `kd.hr.hrcs.opplugin.web.label.LabelStrategyOp` | kd.hr.hrcs.opplugin.web.label.LabelStrategyOp |
...
| 4 | 3 | `hrcs_lblstrategy` | `kd.hr.hrcs.opplugin.web.label.LabelStrategyOp` | kd.hr.hrcs.opplugin.web.label.LabelStrategyOp |
...
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | 1 | `hrcs_lblstrategy` | `kd.hr.hrcs.opplugin.web.label.LabelStrategyOp` | kd.hr.hrcs.opplugin.web.label.LabelStrategyOp |
...
---
### 44. 下一步（donothing / Key: nextone / oid: 2ZUHOTM+K59F）
> 根定义: `hrcs_lblstrategy`
**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | GrpfieldsuniqueValidation | `2ZUHO9YB3VYF` | 编码唯一性校验 | `hrcs_lblstrategy` |
| 2 | RegexValidation | `33TAL1V/0+YD` | 文本格式检查 | `hrcs_lblstrategy` |

---
### 48. 删除（donothing / Key: deletestrategy / oid: 3N38Z9Y4W7S/）
> 根定义: `hrcs_lblstrategy`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hrcs_lblstrategy` | `kd.hr.hrcs.opplugin.web.label.LabelStrategyOp` | kd.hr.hrcs.opplugin.web.label.LabelStrategyOp |

**校验器**：
| # | 类型 | Id | 说明 | 来源 |
|---|-----|----|------|------|
| 1 | CustValidation | `3N3E1XJNOMY7` | HR基础资料删除校验 | `hrcs_lblstrategy` |
| 2 | ConditionValidation | `3N3E=2TI70CL` | 数据已经禁用，不能删除。 | `hrcs_lblstrategy` |
