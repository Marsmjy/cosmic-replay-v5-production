# hrcs_function — 函数配置 操作清单
**继承链**: `bos_basetpl` → `bos_basegrouptpl` → `hbp_bd_grouptpl_all` → `hrcs_function`  **操作数**: 51
---
## 操作总览
...
| 35 | `21A5YKHUI0BU` | donothing | 查看全部日志 | logview | `hbp_bd_grouptpl_all` | 0 | 0 |
| 36 | `2COQP7Q25HZ+` | donothing | 查看日志 | viewonelog | `hbp_bd_grouptpl_all` | 0 | 0 |
| 37 | `36NOT5VY949N` | importdata_hr | 导入数据 | importdata_hr | `hbp_bd_grouptpl_all` | 0 | 0 |
| 38 | `36NOV4R/9F0D` | show_import_record_hr | 查看导入记录 | show_import_record_hr | `hbp_bd_grouptpl_all` | 0 | 0 |
| 39 | `36NOWM/N/6Y1` | export_from_list_hr | 按列表导出 | export_from_list_hr | `hbp_bd_grouptpl_all` | 0 | 0 |
| 40 | `36NOY6+O/K+T` | export_from_impttpl_hr | 按导入模板导出 | export_from_impttpl_hr | `hbp_bd_grouptpl_all` | 0 | 0 |
| 41 | `36NOZPB=/ZO4` | export_from_expttpl_hr | 按导出模板导出 | export_from_expttpl_hr | `hbp_bd_grouptpl_all` | 0 | 0 |
| 42 | `36NP+T+I3=RA` | show_export_record_hr | 查看导出记录 | show_export_record_hr | `hbp_bd_grouptpl_all` | 0 | 0 |
| 43 | `23J4YG5FW+G=` | newentry | 新增参数分录 | newentry_params | `hrcs_function` | 0 | 0 |
| 44 | `23J5+8P216CZ` | deleteentry | 删除参数分录 | deleteentry_params | `hrcs_function` | 0 | 0 |
| 45 | `23J5/Y5U8BVB` | moveentryup | 上移参数一行 | moveentryup_params | `hrcs_function` | 0 | 0 |
| 46 | `23J51=Y8+72O` | moveentrydown | 下移参数一行 | moveentrydown_params | `hrcs_function` | 0 | 0 |
| 47 | `23J530E5NJKB` | newentry | 新增import分录 | newentry_import | `hrcs_function` | 0 | 0 |
| 48 | `23J54VEF+5XZ` | deleteentry | 删除import分录 | deleteentry_import | `hrcs_function` | 0 | 0 |
| 49 | `23J56N3=35DG` | moveentryup | 上移import一行 | moveentryup_import | `hrcs_function` | 0 | 0 |
| 50 | `23J586NO0ANB` | moveentrydown | 下移import一行 | moveentrydown_import | `hrcs_function` | 0 | 0 |
| 51 | `49OGJ40N2F3F` | donothing | 在线调试函数 | onlinetestfunc | `hrcs_function` | 1 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 6 | 4 | `hrcs_function` | `kd.hr.hrcs.opplugin.web.function.FunctionOp` | 函数saveOp |
| 7 | 5 | `hbp_bd_grouptpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp |
...
| 4 | 3 | `hrcs_function` | `kd.hr.hrcs.opplugin.web.function.FunctionOp` | 函数Op |
...
| 5 | 4 | `hbp_bd_grouptpl_all` | `kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp` | kd.hr.hbp.opplugin.web.config.HRBaseOriginalOp |
...
---
### 51. 在线调试函数（donothing / Key: onlinetestfunc / oid: 49OGJ40N2F3F）
> 根定义: `hrcs_function`
**插件清单**：
| # | RowKey | 来源层级 | 插件类全路径 | 说明 |
|---|--------|---------|------------|------|
| 1 | — | `hrcs_function` | `kd.hr.hrcs.opplugin.web.function.FunctionOp` | 函数op |
