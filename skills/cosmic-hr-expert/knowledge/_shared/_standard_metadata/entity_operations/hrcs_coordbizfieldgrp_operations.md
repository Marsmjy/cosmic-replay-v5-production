# hrcs_coordbizfieldgrp — 业务协作字段分组 操作清单
**继承链**: `bos_basetpl` → `hbp_bd_tpl_all` → `hrcs_coordbizfieldgrp`  **操作数**: 46
---
## 操作总览
...
| 43 | `5+BK7QP+7QDN` | newentry | 新增分录 | newentry | `hrcs_coordbizfieldgrp` | 0 | 0 |
| 44 | `5+BK8JIYQYA5` | deleteentry | 删除分录 | deleteentry | `hrcs_coordbizfieldgrp` | 0 | 0 |
| 45 | `5/+S/L=YE/9V` | moveentryup | 上移一行 | moveentryup | `hrcs_coordbizfieldgrp` | 0 | 0 |
| 46 | `5/+S0KPVF37V` | moveentrydown | 下移一行 | moveentrydown | `hrcs_coordbizfieldgrp` | 0 | 0 |
---
## 操作详情（仅展示有插件或校验器的操作）
---
...
| 5 | GrpfieldsuniqueValidation | `4YLJFJAL8DWE` | 组合字段唯一性校验 | `hrcs_coordbizfieldgrp` |
