...
## 实体: hbss_laborrelstatus（用工关系状态） [BaseEntity]

- **数据库表**: `t_hbss_laborrelstatus`  
...
| istrial | 是否试用 | CheckBoxField | fistrial |  |  |
| ishired | 是否在职 | CheckBoxField | fishired |  |  |
