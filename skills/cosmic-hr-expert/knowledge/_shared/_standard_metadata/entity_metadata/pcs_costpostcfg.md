...
# pcs_costpostcfg — 岗位薪酬成本设置

**表单编码**: `pcs_costpostcfg`  
**表单ID**: `1B9F8Z5VQY8M`  
**归属**: 薪酬福利云 / 薪酬成本  
...
## 实体: pcs_costpostcfg（岗位薪酬成本设置） [BaseEntity]

### 物理表

| 表名 | 说明 |
|------|------|
| `t_pcs_costcfg` | 主表 · 31 列 |
...
| source | 岗位 | BasedataField | t_pcs_costcfg.fsourceid |  | hbpm_positionhrf7 |
...
| positionname | 岗位名称 | BasedataPropField | — |  |  |
| positionsim | 岗位简称 | BasedataPropField | — |  |  |
| positionbumber | 岗位编码 | BasedataPropField | — |  |  |
| adminorgname | 行政组织 | BasedataPropField | — |  |  |
