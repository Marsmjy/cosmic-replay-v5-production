...
## 实体: hbss_laborreltype（用工关系类型） [BaseEntity]

- **数据库表**: `t_hbss_laborreltype`  
...
| laborreltypecls | 用工关系类型分类 | BasedataField | flaborreltypeclsid | ✓ | hbss_laborreltypecls |
