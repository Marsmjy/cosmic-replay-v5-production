...
## 实体: hbpm_positiontype（岗位类型） [BaseEntity]

- **数据库表**: `t_hbpm_positiontype`  
...
| ismanagetype | 是否管理类 | ComboField | fismanagetype | ✓ |  |
