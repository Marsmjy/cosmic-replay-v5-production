# haos_commbasedatalist — 公共基础资料

**表单编码**: `haos_commbasedatalist`  
**表单ID**: `23G+WUW2B4Z7`  
**归属**: HR基础服务云 / HR基础组织  
**来源系统**: 金蝶苍穹 HCM 人力资源  
...
## 实体: haos_commbasedatalist（公共基础资料） [BaseEntity]

- **数据库表**: `t_haos_commbasedatalist`  
...
| pagekey | 页面标识 | TextField | fpagekey | ✓ |  |
