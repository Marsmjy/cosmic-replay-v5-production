...
## 实体: hbss_safeuri（链接明细信息） [BaseEntity]
...
| safeuriconfig | 短链配置 | BasedataField | fsafeuriconfigid |  | hbss_safeuriconfig |
| originuri | 原始链接 | TextField | foriginuri |  |  |
| safeuri | 安全链接 | TextField | fsafeuri |  |  |
| expirytime | 失效时间 | DateTimeField | fexpirytime |  |  |
| businessid | 业务id | TextField | fbusinessid |  |  |
| args | 参数 | TextField | fargs |  |  |
