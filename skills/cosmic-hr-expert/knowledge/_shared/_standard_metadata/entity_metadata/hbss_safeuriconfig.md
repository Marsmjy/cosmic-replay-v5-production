...
## 实体: hbss_safeuriconfig（链接有效期配置） [BaseEntity]

- **数据库表**: `t_hbss_safeuriconfig`  
...
| expiryduration | 有效期 | IntegerField | fexpiryduration | ✓ |  |
| expiryunit | 　 | ComboField | fexpiryunit | ✓ |  |
