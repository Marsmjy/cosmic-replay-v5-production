...
# wtte_recordreport — 考勤记录-明细项目

**表单编码**: `wtte_recordreport`  
**表单ID**: `21YK26C1L50N`  
**归属**: 工时假勤云 / 考勤核算  
...
## 实体: wtte_recordreport（考勤记录-明细项目） [ReportEntity]
...
| con_attmain | 主表 | BasedataField | — |  | wtte_attrecordbase |
