...
## 实体: haos_teamcoopreltype（团队协作类型） [BaseEntity]

- **数据库表**: `t_haos_teamcoopreltype`  
...
| orgteamtype | 所属组织分类 | MulBasedataField | t_haos_coopotclassify（子表） | ✓ |  |
