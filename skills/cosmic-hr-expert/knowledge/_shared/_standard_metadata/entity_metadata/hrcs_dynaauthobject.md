...
## 实体: hrcs_dynaauthobject（动态授权对象） [BaseEntity]

- **数据库表**: `t_hrcs_dynaauthobject`  
...
| authobjectsrc | 授权对象来源 | ComboField | fauthobjectsrc | ✓ |  |
| entitytype | 业务对象 | BasedataField | fentitytype | ✓ | bos_entityobject |
| userfield | 业务对象属性 | ComboField | fuserfield | ✓ |  |
