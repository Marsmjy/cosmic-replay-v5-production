...
# wtam_busitripselfbill — 出差申请

**表单编码**: `wtam_busitripselfbill`  
**表单ID**: `2Y19QZYN32I5`  
**归属**: 工时假勤云 / 日常考勤  
...
## 实体: wtam_busitripselfbill（出差申请） [BillEntity]
...
| startdate | 开始时间 | DateTimeField | t_wtam_tripbillentry.fstartdate |  |  |
...
| enddate | 结束时间 | DateTimeField | t_wtam_tripbillentry.fenddate |  |  |
...
| startmethod | 开始日期类型 | ComboField | t_wtam_tripbillentry.fstartmethod |  |  |
| endmethod | 结束日期类型 | ComboField | t_wtam_tripbillentry.fendmethod |  |  |
