# hrcs_serviceregister — 日历控件微服务注册

**表单编码**: `hrcs_serviceregister`  
**表单ID**: `263K9=TMGYGE`  
**归属**: HR基础服务云 / HR通用服务  
**来源系统**: 金蝶苍穹 HCM 人力资源  
...
## 实体: hrcs_serviceregister（日历控件微服务注册） [BaseEntity]

- **数据库表**: `t_hrcs_calserviceregister`  
...
| cloud | 云 | TextField | fcloud | ✓ |  |
| service | 服务名 | TextField | fservice | ✓ |  |
| method | 方法名 | TextField | fmethod | ✓ |  |
| app | 应用 | TextField | fapp | ✓ |  |
| param | 参数名 | TextField | fparam |  |  |
| returntype | 返回类型 | TextField | — |  |  |
