...
## 实体: hrptmc_unitestentity02（报表单元测试实体02） [BaseEntity]

- **数据库表**: `t_hrptmc_unitestentity02`  
...
| report01 | 报表单元测试实体01 | BasedataField | freport01 |  | hrptmc_unitestentity01 |
