...
## 实体: haos_staffcase（不占编员工明细） [BaseEntity]

- **数据库表**: `t_haos_staffcase`  
...
| adminorg | 所属公司 | HRAdminOrgField | fadminorgid |  | haos_adminorghrf7 |
| empposorgrel | 员工 | EmployeeField | fempposorgrelid | ✓ | hrpi_empposf7query |
