...
## 实体: hrptmc_virtentityclass（虚拟对象处理类） [BaseEntity]

- **数据库表**: `t_hrptmc_virtentityclass`  
...
| classname | 全路径类名 | TextField | fclassname | ✓ |  |
| businessfield | 所属业务领域 | BasedataField | fbusinessfieldid | ✓ | hbss_hrbusinessfield |
| summaryquerybybatch | 汇总表分页分批取数 | CheckBoxField | fsummaryquerybybatch |  |  |
