...
## 实体: hbss_hrbuca（HR业务管理视图） [BaseEntity]
...
| dybutton | 跳转按钮 | TextField | fdybutton |  |  |
| parent | HR业务管理视图 | BasedataField | fparentid |  | hbss_hrbuca |
| sync | 与已有HR业务管理视图保持一致 | RadioField | — |  |  |
| syncstrategy | 同步策略 | RadioGroupField | fsyncstrategy |  |  |
| customize | 自定义 | RadioField | — |  |  |
