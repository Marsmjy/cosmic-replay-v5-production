...
## 实体: haos_adminorgtype（行政组织类型） [BaseEntity]

- **数据库表**: `t_haos_adminorgtype`  
...
| adminorgtypestd | 类型归属 | BasedataField | fadminorgtypestdid | ✓ | haos_adminorgtypestd |
| orgpattern | 形态 | BasedataField | forgpatternid |  | bos_org_pattern |
