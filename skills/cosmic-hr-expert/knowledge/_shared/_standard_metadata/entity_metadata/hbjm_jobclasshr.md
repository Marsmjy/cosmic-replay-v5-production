...
## 实体: hbjm_jobclasshr（职位类） [BaseEntity]

- **数据库表**: `t_hbjm_jobclass`  
...
| jobclasslevel | 职位类层级 | IntegerField | fjobclasslevel |  |  |
| jobseq | 职位序列 | HisModelBasedataField | fjobseqid | ✓ | hbjm_jobseqhr |
| jobfamily | 职位族 | HisModelBasedataField | fjobfamilyid | ✓ | hbjm_jobfamilyhr |
| parent | 上级职位类 | HisModelBasedataField | fparentjobclassid |  | hbjm_jobclasshr |
