...
# wtte_dailydetailslist — 考勤记录-日明细

**表单编码**: `wtte_dailydetailslist`  
**表单ID**: `1PADOB=H7YB9`  
**归属**: 工时假勤云 / 考勤核算  
...
## 实体: wtte_dailydetailslist（考勤记录-日明细） [ReportEntity]
...
| con_showplan | 显示方案 | BasedataField | — | ✓ | wtte_dailydetscheme |
