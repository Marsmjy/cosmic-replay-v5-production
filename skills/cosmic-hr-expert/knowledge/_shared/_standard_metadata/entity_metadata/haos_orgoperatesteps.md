# haos_orgoperatesteps — 行政组织变更操作步骤

**表单编码**: `haos_orgoperatesteps`  
**表单ID**: `3KLRKF/=TPMS`  
**归属**: HR基础服务云 / HR基础组织  
**来源系统**: 金蝶苍穹 HCM 人力资源  
...
## 实体: haos_orgoperatesteps（行政组织变更操作步骤） [BaseEntity]

- **数据库表**: `t_haos_orgoperatesteps`  
...
| steptype | 步骤类型 | ComboField | fsteptype |  |  |
