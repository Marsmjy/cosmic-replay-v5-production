...
## 实体: hbss_bussinessfield（业务类型） [BaseEntity]

- **数据库表**: `t_hbss_bussinessfield`  
...
| group | 业务领域 | GroupField | — |  | hbss_hrbusinessfield |
...
| controlfuntype | HR职能 | BasedataField | fcontrolfuntypeid | ✓ | bos_org_biz |
