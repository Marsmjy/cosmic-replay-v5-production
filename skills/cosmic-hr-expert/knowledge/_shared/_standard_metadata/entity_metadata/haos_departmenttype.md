# haos_departmenttype — 部门类型

**表单编码**: `haos_departmenttype`  
**表单ID**: `XYV164AO1SY`  
**归属**: HR基础服务云 / HR基础组织  
**来源系统**: 金蝶苍穹 HCM 人力资源  
...
## 实体: haos_departmenttype（部门类型） [BaseEntity]

- **数据库表**: `t_haos_departmenttype`  
...
| sysdescription | 系统定义 | MuliLangTextField | fsysdescription |  |  |
