...
# pcs_costsalaryitemcfg — 档案项目成本设置

**表单编码**: `pcs_costsalaryitemcfg`  
**表单ID**: `1F3+AM4YD8/V`  
**归属**: 薪酬福利云 / 薪酬成本  
...
## 实体: pcs_costsalaryitemcfg（档案项目成本设置） [BaseEntity]

### 物理表

| 表名 | 说明 |
|------|------|
| `t_pcs_costcfg` | 主表 · 40 列 |
...
| hidekeyandvalue | 隐藏成本维度组合值 | TextField | — |  |  |
| entryboid | 分录业务ID | BigIntField | t_pcs_costcfgent.fentryboid |  |  |
| calcostproportion | 百分比(%) | DecimalField | — |  |  |
| creatorobj | 薪资档案 | BasedataField | t_pcs_costcfg.fcreatorobjid |  | hsas_salaryfile |
...
| empposinfo | 任职信息 | BasedataField | — |  | hsbs_empposorgrel |
| basedatapropfield | 姓名 | BasedataPropField | t_pcs_costcfg.fbasedatapropfield |  |  |
| basedatapropfield1 | 工号 | BasedataPropField | t_pcs_costcfg.fbasedatapropfield1 |  |  |
| basedatapropfield2 | 薪资档案编号 | BasedataPropField | t_pcs_costcfg.fbasedatapropfield2 |  |  |
| basedatapropfield3 | 行政组织 | BasedataPropField | t_pcs_costcfg.fbasedatapropfield3 |  |  |
| basedatapropfield4 | 发薪管理属地 | BasedataPropField | t_pcs_costcfg.fbasedatapropfield4 |  |  |
| basedatapropfield5 | 薪资核算组 | BasedataPropField | t_pcs_costcfg.fbasedatapropfield5 |  |  |
| basedatapropfield21 | 薪酬项目 | BasedataPropField | t_pcs_costcfg.fbasedatapropfield21 |  |  |
