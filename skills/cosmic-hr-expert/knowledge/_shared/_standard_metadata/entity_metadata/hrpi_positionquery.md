# hrpi_positionquery — 岗位下人员清单

**表单编码**: `hrpi_positionquery`  
**表单ID**: `26UHDD9L1/QU`  
**归属**: HR基础服务云 / 员工信息中心  
**来源系统**: 金蝶苍穹 HCM 人力资源  
...
## hrpi_positionquery（岗位下人员清单） [查询列表]
...
| `hrpi_empjobrel.company` | 职级职等基础页面.公司 |
| `hrpi_empjobrel.company.number` | 职级职等基础页面.公司.行政组织编码 |
| `hrpi_empjobrel.company.name` | 职级职等基础页面.公司.行政组织名称 |
| `hrpi_empjobrel.adminorg` | 职级职等基础页面.部门 |
| `hrpi_empjobrel.adminorg.number` | 职级职等基础页面.部门.行政组织编码 |
| `hrpi_empjobrel.adminorg.name` | 职级职等基础页面.部门.行政组织名称 |
| `hrpi_empjobrel.position` | 职级职等基础页面.岗位 |
| `hrpi_empjobrel.position.number` | 职级职等基础页面.岗位.岗位编码 |
| `hrpi_empjobrel.position.name` | 职级职等基础页面.岗位.岗位名称 |
| `hrpi_empjobrel.job` | 职级职等基础页面.职位 |
| `hrpi_empjobrel.job.number` | 职级职等基础页面.职位.职位编码 |
| `hrpi_empjobrel.job.name` | 职级职等基础页面.职位.职位名称 |
| `postype` | 任职类型 |
...
| `company` | 公司 |
| `company.number` | 公司.行政组织编码 |
| `company.name` | 公司.行政组织名称 |
| `position` | 岗位 |
...
| `number` | 业务编码 |
| `adminorg` | 部门 |
| `adminorg.number` | 部门.行政组织编码 |
| `adminorg.name` | 部门.行政组织名称 |
