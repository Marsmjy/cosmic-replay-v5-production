...
## 实体: hrcs_lblfieldtype（因子分类） [BaseEntity]

- **数据库表**: `t_hrcs_lblfieldtype`  

### 字段列表

| 字段Key | 中文名 | 类型 | 数据库字段名 | 必填 | 引用 |
|---------|--------|------|-------------|------|------|
| number | 分类编码 | TextField | fnumber |  |  |
| name | 分类名称 | MuliLangTextField | fname |  |  |
...
| labelobjectid | 打标对象 | BasedataField | flabelobjectid | ✓ | hrcs_labelobject |
