...
## 实体: hrcs_labelobject（打标对象） [BaseEntity]

- **数据库表**: `t_hrcs_labelobject`  
...
| type | 对象类别 | ComboField | ftype |  |  |
| parent | 所属主对象 | BasedataField | fparentid |  | hrcs_labelobject |
| condition | 数据过滤条件 | TextField | fcondition |  |  |
| publishstatus | 状态 | BillStatusField | fpublishstatus |  |  |
