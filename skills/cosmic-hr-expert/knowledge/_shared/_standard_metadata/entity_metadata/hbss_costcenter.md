...
## 实体: hbss_costcenter（HR成本承担单位） [BaseEntity]

- **数据库表**: `t_hbss_costcenter`  
...
| englishname | 通用英文名称 | TextField | fenglishname |  |  |
| parent | 上级单位 | BasedataField | fparentid |  | hbss_costcenter |
