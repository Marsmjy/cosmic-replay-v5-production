...
## 实体: haos_staffactivity（编制业务活动） [BaseEntity]

- **数据库表**: `t_haos_staffactivity`  
...
| staffactivitytype | 活动类型 | BasedataField | fstaffactivitytypeid |  | haos_staffactivitytype |
| controltype | 控制类型 | ComboField | fcontroltype |  |  |
