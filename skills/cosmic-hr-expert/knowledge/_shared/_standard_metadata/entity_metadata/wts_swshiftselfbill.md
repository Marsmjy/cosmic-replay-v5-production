...
# wts_swshiftselfbill — 调班申请

**表单编码**: `wts_swshiftselfbill`  
**表单ID**: `3ZXX3MZQ/KBX`  
**归属**: 工时假勤云 / 排班管理  
...
## 实体: wts_swshiftselfbill（调班申请） [BillEntity]
...
| attfile | 考勤档案 | BasedataField | t_wts_swshiftbill.fattfileid |  | wtp_attfilebase |
