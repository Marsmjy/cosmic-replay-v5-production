...
## 实体: hrcs_activity（活动） [BaseEntity]

- **数据库表**: `t_hrcs_activity`  
...
| activitytype | 活动类型 | BasedataField | factivitytypeid | ✓ | hrcs_activitytype |
| bizobj | 业务对象 | BasedataField | fbizobjid |  | bos_entityobject |
| app | 所属应用 | BasedataField | fappid |  | bos_devportal_bizapp |
| bizclassify | 业务分类 | TextField | fbizclassify |  |  |
| adminorg | 管理行政组织 | HRAdminOrgField | fadminorgid | ✓ | haos_adminorghrf7 |
| newtype | 单据实例生成方式 | ComboField | fnewtype | ✓ |  |
