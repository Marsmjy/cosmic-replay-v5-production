...
## 实体: hbjm_jobgradehr（职等） [BaseEntity]

- **数据库表**: `t_hbjm_jobgrade`  
...
| jobgradeseq | 职等顺序码 | IntegerField | fjobgradeseq | ✓ |  |
| entryboid | boid | BigIntField | fentryboid |  |  |
| jobgradescm | 职等方案 | MulBasedataField | t_hbjm_jobgradescmmul（子表） | ✓ |  |
| iscorjobgrade | 是否集团职等 | CheckBoxField | fiscorjobgrade |  |  |
| corjobgrade | 集团职等 | BasedataField | fcorjobgradeid |  | hbjm_jobgradehr |
