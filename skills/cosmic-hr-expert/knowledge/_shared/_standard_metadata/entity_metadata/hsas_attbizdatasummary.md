...
# hsas_attbizdatasummary — 单据体

**表单编码**: `hsas_attbizdatasummary`  
**表单ID**: `4760HWR+6I+I`  
**归属**: 薪酬福利云 / 薪资核算  
...
| bizuniquecode | 唯一识别码 | TextField | t_hsas_attbizdata.fbizuniquecode |  |  |
| groupid | 分组id | TextField | t_hsas_attbizdata.fgroupid |  |  |
| empnumber | 工号 | TextField | t_hsas_attbizdata.fempnumber |  |  |
| personfield | 人员 | EmployeeField | — |  | hsbs_empposf7query |
| nocounttimes | 非薪资发放消费次数 | IntegerField | t_hsas_attbizdata.fnocounttimes |  |  |
| basedatapropfield | 工号 | BasedataPropField | — |  |  |
| basedatapropfield1 | 用于名单生成 | BasedataPropField | — |  |  |
| empposorgrel | 任职经历 | BasedataField | t_hsas_attbizdata.fempposorgrelid |  | hsbs_empposorgrel |
| empposorgrelnumber | 任职经历任职编号 | TextField | — |  |  |
| assignment | 工作分配 | BasedataField | t_hsas_attbizdata.fassignmentid |  | hsbs_assignment |
