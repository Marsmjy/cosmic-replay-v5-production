...
## 实体: hbss_capacityaction（能力行为） [BaseEntity]

- **数据库表**: `t_hbss_capacityaction`  
...
| keypoint | 行为关键点 | MuliLangTextField | fkeypoint |  |  |
| acdescription | 行为描述 | MuliLangTextField | facdescription |  |  |
