...
## 实体: hrcs_bussinesstype（业务类型关系） [BaseEntity]

- **数据库表**: `t_hbss_bussinesstype`  
...
| bussinessobject | 业务对象 | BasedataField | fbussinessobjectid | ✓ | hrcs_businessobject |
| isallfield | 是否全部领域 | CheckBoxField | fisallfield |  |  |
| bussinesstype | 业务类型 | BasedataField | fbussinessfieldid |  | hbss_bussinessfield |
