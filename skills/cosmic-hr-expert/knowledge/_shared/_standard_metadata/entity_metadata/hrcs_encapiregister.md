# hrcs_encapiregister — 微服务加密注册

**表单编码**: `hrcs_encapiregister`  
**表单ID**: `3BM0M1U+GBKE`  
**归属**: HR基础服务云 / HR通用服务  
**来源系统**: 金蝶苍穹 HCM 人力资源  
...
## 实体: hrcs_encapiregister（微服务加密注册） [BaseEntity]

- **数据库表**: `t_hrcs_encapiregister`  
...
| servicename | 接口服务类 | TextField | fservicename |  |  |
| methodname | 方法名 | TextField | fmethodname |  |  |
| encryptscheme | 加密方案 | BasedataField | fencryptschemeid |  | perm_encryptionscheme |
