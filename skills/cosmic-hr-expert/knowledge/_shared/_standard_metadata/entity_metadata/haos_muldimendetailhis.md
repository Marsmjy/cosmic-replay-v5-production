...
## 实体: haos_muldimendetailhis（多维控编明细历史） [BaseEntity]

- **数据库表**: `t_haos_muldimendetailhis`  
...
| muldimendetail | 多维控编明细内码 | BasedataField | fentryid |  | haos_muldimendetail |
