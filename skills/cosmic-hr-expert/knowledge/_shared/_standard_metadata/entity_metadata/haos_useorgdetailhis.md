...
## 实体: haos_useorgdetailhis（使用组织明细历史） [BaseEntity]

- **数据库表**: `t_haos_useorgdetailhis`  
...
| useorgdetail | 使用组织明细内码 | BasedataField | fentryid |  | haos_useorgdetail |
...
| staffdimension | 编制维度 | MulBasedataField | t_haos_uosdimensionhis（子表） |  |  |
