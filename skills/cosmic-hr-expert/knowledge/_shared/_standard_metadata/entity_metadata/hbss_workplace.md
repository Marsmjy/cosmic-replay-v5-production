...
## 实体: hbss_workplace（工作地） [BaseEntity]

- **数据库表**: `t_hbss_workplace`  
...
| ispermanworkplace | 是否常驻工作地 | CheckBoxField | fispermanworkplace |  |  |
| iscontractworkplace | 是否协议工作地 | CheckBoxField | fiscontractworkplace |  |  |
