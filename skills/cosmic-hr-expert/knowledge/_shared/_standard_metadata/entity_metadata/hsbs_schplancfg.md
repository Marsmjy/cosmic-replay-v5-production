...
# hsbs_schplancfg — 调度计划配置

**表单编码**: `hsbs_schplancfg`  
**表单ID**: `3YNP9HNGLJY9`  
**归属**: 薪酬福利云 / 薪酬基础服务  
...
## 实体: hsbs_schplancfg（调度计划配置） [BaseEntity]

### 物理表

| 表名 | 说明 |
|------|------|
| `t_hsbs_schplancfg` | 主表 · 19 列 |
| `t_hsbs_schplancfg_l` | 多语言表 · 3 列 |

### 字段列表

| 字段Key | 中文名 | 类型 | 数据库字段名 | 必填 | 引用 |
|---------|--------|------|-------------|------|------|
| number | 编码 | TextField | t_hsbs_schplancfg.fnumber | ✓ |  |
| name | 名称 | MuliLangTextField | t_hsbs_schplancfg_l.fname | ✓ |  |
| status | 数据状态 | BillStatusField | t_hsbs_schplancfg.fstatus |  |  |
| creator | 创建人 | CreaterField | t_hsbs_schplancfg.fcreatorid |  | bos_user |
| modifier | 修改人 | ModifierField | t_hsbs_schplancfg.fmodifierid |  | bos_user |
| enable | 使用状态 | BillStatusField | t_hsbs_schplancfg.fenable |  |  |
| createtime | 创建时间 | CreateDateField | t_hsbs_schplancfg.fcreatetime |  |  |
| modifytime | 修改时间 | ModifyDateField | t_hsbs_schplancfg.fmodifytime |  |  |
| masterid | 主数据内码 | MasterIdField | t_hsbs_schplancfg.fmasterid |  |  |
| simplename | 简称 | MuliLangTextField | t_hsbs_schplancfg_l.fsimplename |  |  |
| description | 描述 | MuliLangTextField | t_hsbs_schplancfg_l.fdescription |  |  |
| index | 排序号 | IntegerField | t_hsbs_schplancfg.findex |  |  |
| issyspreset | 系统预置 | CheckBoxField | t_hsbs_schplancfg.fissyspreset |  |  |
| disabler | 禁用人 | UserField | t_hsbs_schplancfg.fdisablerid |  | bos_user |
| disabledate | 禁用时间 | DateTimeField | t_hsbs_schplancfg.fdisabledate |  |  |
| initdatasource | 数据来源 | ComboField | — |  |  |
| orinumber | 出厂编码 | TextField | — |  |  |
| oristatus | 出厂数据编辑状态 | ComboField | — |  |  |
| oriname | 出厂名称 | MuliLangTextField | — |  |  |
| useobj | 适用对象 | BasedataField | t_hsbs_schplancfg.fuseobjid | ✓ | hsbs_schuseobj |
| starttime | 生效时间 | DateTimeField | t_hsbs_schplancfg.fstarttime | ✓ |  |
| endtime | 失效时间 | DateTimeField | t_hsbs_schplancfg.fendtime | ✓ |  |
...
| 物理表 | 字段数 |
|--------|--------|
| t_hsbs_schplancfg（主表） | 15 |
| t_hsbs_schplancfg_l | 3 |
