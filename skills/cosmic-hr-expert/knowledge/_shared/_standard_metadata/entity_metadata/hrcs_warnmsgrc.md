...
## 实体: hrcs_warnmsgrc（消息接收人） [BaseEntity]

- **数据库表**: `t_hrcs_warnmsgrcr`  
...
| relationclass | 实现类 | TextField | frelationclass |  |  |
| radiocust | 业务自定义 | CheckBoxField | fradiocust |  |  |
