...
# hcss_agentincomeproofbill — 收入证明代申请

**表单编码**: `hcss_agentincomeproofbill`  
**表单ID**: `435RKOOU5N4G`  
**归属**: 薪酬福利云 / 员工薪酬服务  
...
## 实体: hcss_agentincomeproofbill（收入证明代申请） [BillEntity]

### 物理表

| 表名 | 说明 |
|------|------|
| `t_hcss_incomeproofbill` | 主表 · 40 列 |
...
| incometpl | 收入证明方案版本 | BasedataField | t_hcss_incomeproofbill.fincometplid |  | hcss_incomeproofscheme |
...
| employee | 代申请员工 | EmployeeField | t_hcss_incomeproofbill.femployeeid | ✓ | hsbs_employeequery |
