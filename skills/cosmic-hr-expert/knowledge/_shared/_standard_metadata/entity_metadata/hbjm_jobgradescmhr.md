...
## 实体: hbjm_jobgradescmhr（职等方案） [BaseEntity]

- **数据库表**: `t_hbjm_jobgradescm`  
...
| jobgradedetail | 职等明细 | TextField | — |  |  |
| iscorjobgradescm | 是否集团职等方案 | RadioOptGroupField | fiscorjobgradescm |  |  |
