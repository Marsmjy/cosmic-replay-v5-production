...
## 实体: hbss_addressdetail（详细地址） [BaseEntity]

- **数据库表**: `t_hbss_addressdetail`  
...
| city | 城市 | BasedataField | fcityid | ✓ | bd_admindivision |
| detailaddr | 详细地址 | AddressField | fdetailaddrid | ✓ | cts_address |
| addresstype | 地址类型 | MulComboField | faddresstype | ✓ |  |
