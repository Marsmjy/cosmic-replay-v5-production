...
## 实体: hrcs_permfilegrp（用户权限档案组） [BaseEntity]

- **数据库表**: `t_hbss_permfilegrp`  
...
| isleaf | 是否叶子节点 | CheckBoxField | fisleaf |  |  |
| parent | 上级分组 | ParentBasedataField | fparentid |  | hrcs_permfilegrp |
...
| orgfield | 组织 | OrgField | forgid |  | bos_org |
