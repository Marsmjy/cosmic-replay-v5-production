...
# pcs_costpayrollcalmap — 算发薪管理组织层映射

**表单编码**: `pcs_costpayrollcalmap`  
**表单ID**: `2=H+F+=GO327`  
**归属**: 薪酬福利云 / 薪酬成本  
...
## 实体: pcs_costpayrollcalmap（算发薪管理组织层映射） [BaseEntity]

### 物理表

| 表名 | 说明 |
|------|------|
| `t_pcs_costitemmap` | 主表 · 32 列 |
