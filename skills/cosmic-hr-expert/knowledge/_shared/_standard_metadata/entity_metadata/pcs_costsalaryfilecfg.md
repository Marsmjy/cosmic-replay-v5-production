...
# pcs_costsalaryfilecfg — 薪资档案成本设置

**表单编码**: `pcs_costsalaryfilecfg`  
**表单ID**: `1F2W7/QI=31=`  
**归属**: 薪酬福利云 / 薪酬成本  
...
## 实体: pcs_costsalaryfilecfg（薪资档案成本设置） [BaseEntity]

### 物理表

| 表名 | 说明 |
|------|------|
| `t_pcs_costcfg` | 主表 · 33 列 |
...
| creatorobj | 创建对象薪资档案 | BasedataField | t_pcs_costcfg.fcreatorobjid |  | hsas_salaryfile |
| sourcetype | 人力成本业务对象 | BasedataField | t_pcs_costcfg.fsourcetypeid |  | lcs_costbizobj |
| source | 薪资档案 | BasedataField | t_pcs_costcfg.fsourceid |  | hsas_salaryfile |
| cardtypename | 卡片来源类型 | TextField | t_pcs_costcfg.fcardtypename |  |  |
...
| employeepersonname | 姓名 | BasedataPropField | — |  |  |
| employeeempnumber | 工号 | BasedataPropField | — |  |  |
| basedatapropfield2 | 薪资档案编号 | BasedataPropField | — |  |  |
| basedatapropfield3 | 行政组织 | BasedataPropField | — |  |  |
| basedatapropfield4 | 发薪管理属地 | BasedataPropField | — |  |  |
| basedatapropfield5 | 薪资核算组 | BasedataPropField | — |  |  |
