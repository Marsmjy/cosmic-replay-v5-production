...
## 实体: hrcs_varmappingscene（变量映射场景） [BaseEntity]

- **数据库表**: `t_hrcs_varmappingscene`  
...
| parententity | 取值对象主实体 | BasedataField | fparententityid | ✓ | hbp_entityobject |
