...
## 实体: hbjm_jobseqhr（职位序列） [BaseEntity]
...
| simplename | 序列简称 | MuliLangTextField | fsimplename |  |  |
...
| standardjobseq | 标准职位序列 | BasedataField | fstandardjobseqid |  | hbjm_standardjobseqhr |
