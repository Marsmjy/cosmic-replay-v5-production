...
## 实体: hrcs_labelgroup（标签分类） [BaseEntity]

- **数据库表**: `t_hrcs_labelgroup`  
...
| isleaf | 末级分组 | CheckBoxField | fisleaf |  |  |
| parent | 上级 | ParentBasedataField | fparentid |  | hrcs_labelgroup |
...
| isleafcache | 末级分组缓存 | CheckBoxField | — |  |  |
