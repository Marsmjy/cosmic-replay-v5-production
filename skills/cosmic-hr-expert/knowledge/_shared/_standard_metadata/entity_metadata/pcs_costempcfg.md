...
## 实体: pcs_costempcfg（员工薪酬成本设置） [BaseEntity]
...
| source | 员工 | BasedataField | t_pcs_costcfg.fsourceid |  | hsbs_employee |
...
| personname | 姓名 | BasedataPropField | — |  |  |
| personnumber | 工号 | BasedataPropField | — |  |  |
| empposrelcompanyname | 所属公司 | BasedataPropField | — |  |  |
| empposrelpositionname | 岗位 | BasedataPropField | — |  |  |
| empposorgrel | 任职信息 | BasedataField | t_pcs_costcfg.fempposorgrelid |  | hsbs_empposorgrel |
| empposreladminorgname | 行政组织 | BasedataPropField | — |  |  |
| employee | 计薪人员 | EmployeeField | — |  | hsbs_employeequery |
