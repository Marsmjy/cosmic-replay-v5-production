...
## 实体: wtabm_vaapply（为他人申请休假） [BillEntity]

### 物理表

| 表名 | 说明 |
|------|------|
| `t_wtabm_vaapply` | 主表 · 42 列 |
...
| vaentrystartdate | 休假开始时间 | DateTimeField | — |  |  |
| entryvatime | 有效时长 | DecimalField | — |  |  |
| entrystartdate | 开始日期 | DateField | — |  |  |
| vaentryenddate | 休假结束时间 | DateTimeField | — |  |  |
...
| offtimeperday | 每日可申请时长 | DecimalField | — |  |  |
...
| attfilebasef7 | 休假员工 | BasedataField | — | ✓ | wtp_attfilebase |
...
| hasvaplan | 是否有休假方案 | CheckBoxField | — |  |  |
...
| initdatasource | 数据来源 | ComboField | t_wtabm_vaapply.finitdatasource |  |  |
| sourcesyskey | 来源系统唯一标识 | TextField | t_wtabm_vaapply.fsourcesyskey |  |  |
