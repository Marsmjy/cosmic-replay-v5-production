...
## 实体: hbss_credentialstype（证件类型） [BaseEntity]

- **数据库表**: `t_hbss_credentialstype`  
...
| isidentity | 是否身份认证 | CheckBoxField | fisidentity |  |  |
| certnumformat | 证件号码格式 | BasedataField | fcertnumformat |  | cts_personal_identity |
