...
# homs_position_cardstyle — 关系卡片样式设置

**表单编码**: `homs_position_cardstyle`  
**表单ID**: `2P49I0+V//VJ`  
**归属**: 组织发展云 / 组织管理  
...
## 实体: homs_position_cardstyle（关系卡片样式设置） [BaseEntity]

### 物理表

| 表名 | 说明 |
|------|------|
| `t_homs_cardstyle` | 主表 · 27 列 |
| `t_homs_cardstyleorgentry` | 分录表 · 2 列 |
| `t_homs_cardstyleentry` | 分录表 · 11 列 |
...
| basedatapropfield | 组织编码 | BasedataPropField | — |  |  |
...
| 物理表 | 字段数 |
|--------|--------|
| t_homs_cardstyle（主表） | 22 |
| t_homs_cardstyle_l | 4 |
| t_homs_cardstyleentry | 9 |
