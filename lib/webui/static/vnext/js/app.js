...
import { bindReportDialog, renderReportDialog } from "./workspaces/report-workspace.js";
...
function render(state) {
  ...
  if (tools) {
    tools.innerHTML =
      `<button class="text-link ${state.stage === "logs" ? "is-active" : ""}" id="open-logs">日志</button>` +
      `<button class="text-link ${state.stage === "settings" ? "is-active" : ""}" id="open-settings">设置</button>` +
